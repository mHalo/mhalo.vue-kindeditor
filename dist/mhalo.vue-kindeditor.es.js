...
(function(Ve, ht) {
  (function(ee, ie) {
    ...
    function mt(e) {
      ...
      return e.replace(/rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/gi, function(n, o, i, s) {
        return "#" + t(o) + t(i) + t(s);
      });
    }
    function re(e, t) {
    ...
    function me(e, t, n) {
      ...
      if (t) {
        ...
        i.prototype = t.prototype, o = new i(), z(n, function(s, c) {
          o[s] = c;
        });
      } else
        o = n;
    ...
    function ze(e, t, n) {
      ...
      var i = oe[o][t];
      i && i.length > 0 ? gt(e, t, i[0]) : (oe[o][t] = [], oe[o].el = e), i = oe[o][t], i.length === 0 && (i[0] = function(s) {
        var c = s ? new tn(e, s) : void 0;
        z(i, function(a, r) {
          a > 0 && r && r.call(e, c);
        });
    ...
    function Ye(e, t, n) {
      ...
      if (o) {
        if (t === void 0)
          return void (o in oe && (z(oe[o], function(c, a) {
            c != "el" && a.length > 0 && gt(e, c, a[0]);
          }), delete oe[o], nn(e)));
        if (oe[o]) {
          var i = oe[o][t];
          if (i && i.length > 0) {
            n === void 0 ? (gt(e, t, i[0]), delete oe[o][t]) : (z(i, function(c, a) {
              c > 0 && a === n && i.splice(c, 1);
            }), i.length == 1 && (gt(e, t, i[0]), delete oe[o][t]));
            var s = 0;
            z(oe[o], function() {
              s++;
            }), 2 > s && (delete oe[o], nn(e));
          }
        }
      }
    }
    ...
    function Pe(e) {
      ...
      for (var t, n = {}, o = /\s*([\w\-]+)\s*:([^;]*)(;|$)/g; t = o.exec(e); ) {
        var i = te(t[1].toLowerCase()), s = te(mt(t[2]));
        n[i] = s;
      }
      return n;
    }
    function we(e) {
      for (var t, n = {}, o = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g; t = o.exec(e); ) {
        var i = (t[1] || t[2] || t[4] || t[6]).toLowerCase(), s = (t[2] ? t[3] : t[4] ? t[5] : t[7]) || "";
        n[i] = s;
      }
      return n;
    }
    function Zn(e, t) {
      return e = /\s+class\s*=/.test(e) ? e.replace(/(\s+class=["']?)([^"']*)(["']?[\s>])/, function(n, o, i, s) {
        return (" " + i + " ").indexOf(" " + t + " ") < 0 ? i === "" ? o + t + s : o + i + " " + t + s : n;
    ...
    function Ze(e, t, n, o) {
      ...
      function s(r, d) {
        ...
        return (a = /^(.*)\//.exec(r)) ? s(a[1], ++d) : void 0;
      }
      ...
      if (a = /^(\w+:\/\/[^\/]*)/.exec(e)) {
        ...
        return e;
      return /^\//.test(e) ? e = n + i(e.substr(1)) : /^\w+:\/\//.test(e) || (e = n + i(o + "/" + e)), t === "relative" ? e = s(n + o, 0).substr(2) : t === "absolute" && e.substr(0, n.length) === n && (e = e.substr(n.length)), e;
    }
...
`;
        ...
        if (M !== "") {
          ...
          if (_ === "font") {
            var T = {}, x = "";
            z(E, function(C, D) {
              C === "color" && (T.color = D, delete E[C]), C === "size" && (T["font-size"] = s[parseInt(D, 10) - 1] || "", delete E[C]), C === "face" && (T["font-family"] = D, delete E[C]), C === "style" && (x = D);
            }), x && !/;$/.test(x) && (x += ";"), z(T, function(C, D) {
              D !== "" && (/\s/.test(D) && (D = "'" + D + "'"), x += C + ":" + D + ";");
            }), E.style = x;
          }
          z(E, function(C, D) {
            if (_i[C] && (E[C] = C), he(C, ["src", "href"]) >= 0 && (E[C] = Ze(D, n)), (t && C !== "style" && !c[_]["*"] && !c[_][C] || _ === "body" && C === "contenteditable" || /^kindeditor_\d+$/.test(C)) && delete E[C], C === "style" && D !== "") {
              var I = Pe(D);
              z(I, function(R, O) {
                !t || c[_].style || c[_]["." + R] || delete I[R];
              });
              var L = "";
              z(I, function(R, O) {
                L += R + ":" + O + ";";
...
`), te(e);
    ...
    function sn(e, t) {
      var n = t.width, o = t.height, i = t.type || ln(t.src), s = Rt(t), c = "";
    ...
    function kt(e, t) {
      ...
      function d(C, D) {
        ...
        if (I = /#((?:[\w\-]|\\.)+)$/.exec(C))
          ...
          L = O === "id" ? s(U, R, D) : O === "class" ? c(U, R, D) : O === "name" ? a(U, R, D) : r(O, U, R, D);
        } else
    ...
    function ri(e, t) {
      ...
      if (n.getComputedStyle) {
        ...
        i = s[o] || s.getPropertyValue(t) || e.style[o];
      } else
    ...
    function Bt(e, t, n) {
          ...
          if (N = A.nextSibling, d > 0) {
            if (A.nodeType == 1)
              if (u >= 0 && 0 >= l)
                ...
                var B;
                if (t && (B = A.cloneNode(!1), M.appendChild(B)), s(A, B) === !1)
                  return !1;
              }
      ...
      var c = e.doc, a = [], r = e.cloneRange().down(), d = -1, u = -1, l = -1, f = -1, p = e.commonAncestor(), m = c.createDocumentFragment();
      if (p.nodeType == 3) {
    ...
    function fn(e, t) {
      ...
      o.collapse(t);
      var i = o.parentElement(), s = i.childNodes;
      if (s.length === 0)
      ...
      if (d = e.duplicate(), Xe(d, i), d.setEndPoint("StartToEnd", o), a -= d.text.replace(/\r\n|\n|\r/g, "").length, r > 0 && c.nodeType == 3)
        for (var w = c.previousSibling; w && w.nodeType == 3; )
    ...
    function pn(e, t) {
      ...
      if (e.nodeType == 1 && e.childNodes.length > 0) {
        var i, s, c = e.childNodes;
        if (t === 0 ? (s = c[0], i = !0) : (s = c[t - 1], i = !1), !s)
          return o;
        if (v(s).name === "head")
          return t === 1 && (i = !0), t === 2 && (i = !1), o.collapse(i), o;
        if (s.nodeType == 1) {
          var a, r = v(s);
          return r.isControl() && (a = n.createElement("span"), i ? r.before(a) : r.after(a), s = a), Xe(o, s), o.collapse(i), a && v(a).remove(), o;
        }
        e = s, t = i ? 0 : s.nodeValue.length;
      }
    ...
    function hn(e) {
      ...
      if (be) {
        ...
        var i = fn(e, !0), s = fn(e, !1);
        return t(i), t(s), o = new _e(n), o.setStart(i.node, i.offset), o.setEnd(s.node, s.offset), o;
      }
      var c = e.startContainer;
      return n = c.ownerDocument || c, o = new _e(n), o.setStart(c, e.startOffset), o.setEnd(e.endContainer, e.endOffset), o;
    }
    function _e(e) {
      this.init(e);
    }
    ...
    function vn(e, t, n) {
      ...
      if (!o[n])
        return !1;
      for (var i = o[n].split(","), s = 0, c = i.length; c > s; s++) {
        var a = i[s];
        if (a === "*")
          return !0;
    ...
    function yn(e, t, n) {
      if (n = n || e.name, e.type === 1) {
        var o = gn(t);
        if (o[n]) {
          for (var i = o[n].split(","), s = !1, c = 0, a = i.length; a > c; c++) {
            var r = i[c];
            if (r === "*") {
              s = !0;
              break;
    ...
    function Ht(e) {
      var t = e.moveEl, n = e.moveFn, o = e.clickEl || t, i = e.beforeDrag, s = e.iframeFix === void 0 ? !0 : e.iframeFix, c = [document];
      s && v("iframe").each(function() {
        ...
        function u(b) {
          b.preventDefault(), v(c).unbind("mousemove", r).unbind("mouseup", u).unbind("selectstart", d), l.releaseCapture && l.releaseCapture();
        }
        if (a.button === 0 || a.button === 1) {
          a.stopPropagation();
          var l = o.get(), f = Z(t.css("left")), p = Z(t.css("top")), m = t.width(), g = t.height(), y = a.pageX, w = a.pageY;
          i && i(), v(c).mousemove(r).mouseup(u).bind("selectstart", d), l.setCapture && l.setCapture();
        }
      });
    }
    function De(e) {
...
`);
    ...
    function pi(e) {
      var t = qt(e), n = t.remove, o = e.afterSelect, i = t.div, s = [];
      ...
      return i.append(c), t.add = function(a) {
        ...
        r.data("tab", a), s.push(r), c.append(r);
      }, t.selectedIndex = 0, t.select = function(a) {
        t.selectedIndex = a, z(s, function(r, d) {
    ...
    function Gt(e) {
      for (var t = document.getElementsByTagName("head")[0] || (Ne ? document.body : document.documentElement), n = document.createElement("link"), o = Tn(Ze(e, "absolute")), i = v('link[rel="stylesheet"]', t), s = 0, c = i.length; c > s; s++)
        if (Tn(Ze(i[s].href, "absolute")) === o)
          return;
    ...
    function Dn(e, t) {
      ...
      z(e, function(i, s) {
        var c = En(i);
        Se[t] || (Se[t] = {}), Se[t][c.ns] || (Se[t][c.ns] = {}), Se[t][c.ns][c.key] = s;
      });
    }
    function wt(e, t) {
      if (!e.collapsed) {
    ...
    function mi() {
      ...
      v(t).contextmenu(function(n) {
        ...
        if (e._contextmenus.length !== 0) {
          ...
          var s = null;
          if (z(i, function(u) {
            this.title == "-" && s.title == "-" && delete i[u], s = this;
          }), i.length > 0) {
            n.preventDefault();
            var c = v(e.edit.iframe).pos(), a = $t({ x: c.x + n.clientX, y: c.y + n.clientY, width: o, css: { visibility: "hidden" }, shadowMode: e.shadowMode });
            z(i, function() {
    ...
    function gi() {
      ...
      if (!(Y && o !== "br" || Be && 3 > ce && o !== "p" || Qt && 9 > ce)) {
        var i = re("h1,h2,h3,h4,h5,h6,pre,li"), s = re("p,h1,h2,h3,h4,h5,h6,pre,li,blockquote");
        v(n).keydown(function(c) {
          if (!(c.which != 13 || c.shiftKey || c.ctrlKey || c.altKey)) {
            ...
            if (r != "marquee" && r != "select")
              return o !== "br" || i[r] ? void (s[r] || Ee(n, "formatblock", "<p>")) : (c.preventDefault(), void t.insertHtml("<br />" + (Y && 9 > ce ? "" : "\u200B")));
          }
          ...
          if (!(c.which != 13 || c.shiftKey || c.ctrlKey || c.altKey) && o != "br") {
            ...
            f != "marquee" && f != "select" && (s[f] || Ee(n, "formatblock", "<p>"));
          }
        });
      }
    }
    ...
    function Nn(e, t) {
      var n, o, i = this, s = i.edit, c = s.doc.body;
      if (e.length === 0)
        return i;
      s.designMode ? (n = i.cmd.range, o = n.createBookmark(!0), o.html = c.innerHTML) : o = { html: c.innerHTML }, Mn(t, o);
      var a = e.pop();
      return Me(o.html) === Me(a.html) && e.length > 0 && (a = e.pop()), s.designMode ? (s.html(a.html), a.start && (n.moveToBookmark(a), i.select())) : v(c).html(Me(a.html)), i;
    }
    function ot(e) {
      function t(i, s) {
        ot.prototype[i] === void 0 && (n[i] = s), n.options[i] = s;
      }
      var n = this;
      n.options = {}, z(e, function(i, s) {
        t(i, e[i]);
      }), z(v.options, function(i, s) {
        n[i] === void 0 && t(i, s);
      });
    ...
    function In(e, t) {
      function n(c) {
        return z(Te, function(a, r) {
          ie(r) && (r.call(c, KindEditor), c._pluginStatus || (c._pluginStatus = {}), c._pluginStatus[a] = "inited");
        }), c.create();
      }
      ...
      if (i && i.length !== 0) {
        ...
        t.srcElement = i[0];
        var s = new ot(t);
        return ut.push(s), Se[s.langType] ? n(s) : (Kt(s.langPath + s.langType + ".js?ver=" + encodeURIComponent(v.DEBUG ? _t : Ct), function() {
          n(s);
        }), s);
      }
    }
    function lt(e, t) {
      v(e).each(function(n, o) {
        v.each(ut, function(i, s) {
          return s && s.srcElement[0] == o ? (t.call(s, i), !1) : void 0;
        });
      });
    }
    (function(e) {
        ...
        return G.matches = function(h, k) {
          ...
          return this.each(function($, q) {
            for (; q && !(F ? F.indexOf(q) >= 0 : G.matches(q, h)); )
              q = q !== k && !s(q) && q.parentNode;
            q && S.indexOf(q) < 0 && S.push(q);
          }), T(S);
        }, parents: function(h) {
          for (var k = [], S = this; S.length > 0; )
            S = T.map(S, function(F) {
              return (F = F.parentNode) && !s(F) && k.indexOf(F) < 0 ? (k.push(F), F) : void 0;
            });
          return b(k, h);
        }, parent: function(h) {
          ...
          T.fn[h] = function(S) {
            var F, $ = this[0];
            return S === B ? i($) ? $["inner" + k] : s($) ? $.documentElement["scroll" + k] : (F = this.offset()) && F[h] : this.each(function(q) {
      ...
      return e.Zepto = t, e.$ === void 0 && (e.$ = t), function(n) {
        ...
        function o(s) {
          ...
          }), r.promise(d), s && s.call(d, d), d;
        }
        var i = Array.prototype.slice;
        n.when = function(s) {
          var c, a, r, d = i.call(arguments), u = d.length, l = 0, f = u !== 1 || s && n.isFunction(s.promise) ? u : 0, p = f === 1 ? s : o(), m = function(g, y, w) {
            return function(b) {
              y[g] = this, w[g] = arguments.length > 1 ? i.call(arguments) : b, w === c ? p.notifyWith(y, w) : --f || p.resolveWith(y, w);
            };
          };
          if (u > 1)
            for (c = new Array(u), a = new Array(u), r = new Array(u); u > l; ++l)
        ...
        n.Callbacks = function(o) {
          o = n.extend({}, o);
          var i, s, c, a, r, d, u = [], l = !o.once && [], f = function(m) {
            for (i = o.memory && m, s = !0, d = a || 0, a = 0, r = u.length, c = !0; u && r > d; ++d)
              if (u[d].apply(m[0], m[1]) === !1 && o.stopOnFalse) {
                i = !1;
                break;
              }
            c = !1, u && (l ? l.length && f(l.shift()) : i ? u.length = 0 : p.disable());
          }, p = { add: function() {
            if (u) {
      ...
      return t("dollar-third", [], function() {
        ...
        return a = { on: function(l, f, p) {
          var m, g = this;
          return f ? (m = this._events || (this._events = []), s(l, f, function(y, w) {
            var b = { e: y };
        ...
        var c = o.$;
        return s.options = {}, i.installTo(s.prototype), c.each({ upload: "start-upload", stop: "stop-upload", getFile: "get-file", getFiles: "get-files", addFile: "add-file", addFiles: "add-file", sort: "sort-files", removeFile: "remove-file", cancelFile: "cancel-file", skipFile: "skip-file", retry: "retry", isInProgress: "is-in-progress", makeThumb: "make-thumb", md5File: "md5-file", getDimension: "get-dimension", addButton: "add-btn", predictRuntimeType: "predict-runtime-type", refresh: "refresh", disable: "disable", enable: "enable", reset: "reset" }, function(a, r) {
          ...
          return !(i.trigger.apply(this, arguments) === !1 || c.isFunction(d[u]) && d[u].apply(this, r) === !1 || c.isFunction(this[u]) && this[u].apply(this, r) === !1 || i.trigger.apply(i, [this, a].concat(r)) === !1);
        }, destroy: function() {
      ...
      }), t("runtime/client", ["base", "mediator", "runtime/runtime"], function(o, i, s) {
        function c(r, d) {
          var u, l = o.Deferred();
      ...
      }), t("lib/dnd", ["base", "mediator", "runtime/client"], function(o, i, s) {
        function c(r) {
          r = this.options = a.extend({}, c.options, r), r.container = a(r.container), r.container.length && s.call(this, "DragAndDrop");
        }
        var a = o.$;
      ...
      }), t("widgets/filednd", ["base", "uploader", "lib/dnd", "widgets/widget"], function(o, i, s) {
        var c = o.$;
        return i.options.dnd = "", i.register({ name: "dnd", init: function(a) {
          if (a.dnd && this.request("predict-runtime-type") === "html5") {
            var r, d = this, u = o.Deferred(), l = c.extend({}, { disableGlobalDnd: a.disableGlobalDnd, container: a.dnd, accept: a.accept });
            return this.dnd = r = new s(l), r.once("ready", u.resolve), r.on("drop", function(f) {
      ...
      }), t("lib/filepaste", ["base", "mediator", "runtime/client"], function(o, i, s) {
        function c(r) {
          r = this.options = a.extend({}, r), r.container = a(r.container || document.body), s.call(this, "FilePaste");
        }
        var a = o.$;
      ...
      }), t("widgets/filepaste", ["base", "uploader", "lib/filepaste", "widgets/widget"], function(o, i, s) {
        var c = o.$;
        return i.register({ name: "paste", init: function(a) {
          if (a.paste && this.request("predict-runtime-type") === "html5") {
            var r, d = this, u = o.Deferred(), l = c.extend({}, { container: a.paste, accept: a.accept });
            return this.paste = r = new s(l), r.once("ready", u.resolve), r.on("paste", function(f) {
        ...
        return o.inherits(i, { constructor: s, slice: function(c, a) {
        ...
        function s(r, d) {
          var u;
          this.name = d.name || "untitled" + c++, u = a.exec(d.name) ? RegExp.$1.toLowerCase() : "", !u && d.type && (u = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(d.type) ? RegExp.$1.toLowerCase() : "", this.name += "." + u), this.ext = u, this.lastModifiedDate = d.lastModifiedDate || d.lastModified && new Date(d.lastModified).toLocaleString() || new Date().toLocaleString(), i.apply(this, arguments);
        }
        var c = 1, a = /\.([^.]+)$/;
        return o.inherits(i, s);
      }), t("lib/filepicker", ["base", "runtime/client", "lib/file"], function(o, i, s) {
        function c(r) {
            ...
            switch (f) {
              ...
              case "change":
                p = r.exec("getFiles"), r.trigger("select", a.map(p, function(m) {
                  return m = new s(r.getRuid(), m), m._refer = d.container, m;
                }), d.container);
            }
      ...
      }), t("widgets/filepicker", ["base", "uploader", "lib/filepicker", "widgets/widget"], function(o, i, s) {
        var c = o.$;
      ...
      }), t("lib/image", ["base", "runtime/client", "lib/blob"], function(o, i, s) {
        function c(r) {
      ...
      }), t("widgets/image", ["base", "uploader", "lib/image", "widgets/widget"], function(o, i, s) {
        var c, a = o.$;
        return c = function(r) {
          ...
          var f, p;
          return r = this.request("get-file", r), r.type.match(/^image/) ? (f = a.extend({}, this.options.thumb), a.isPlainObject(u) && (f = a.extend(f, u), u = null), u = u || f.width, l = l || f.height, p = new s(f), p.once("load", function() {
          ...
          return r = this.request("get-file", r), !l || !~"image/jpeg,image/jpg".indexOf(r.type) || r.size < f || r._compressed ? void 0 : (l = a.extend({}, l), u = o.Deferred(), d = new s(l), u.always(function() {
            d.destroy(), d = null;
      ...
      }), t("queue", ["base", "mediator", "file"], function(o, i, s) {
        function c() {
      ...
      }), t("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"], function(o, i, s, c, a, r) {
        ...
        return i.register({ name: "queue", init: function(f) {
          ...
          return M.queue = new s(), M.stats = M.queue.stats, this.request("predict-runtime-type") === "html5" ? (p = o.Deferred(), this.placeholder = _ = new r("Placeholder"), _.connectRuntime({ runtimeOrder: "html5" }, function() {
        ...
        return o.support = function() {
          ...
          var s, c, a = this.options.runtimeOrder || i.orders, r = this.type;
          if (!r) {
      ...
      }), t("lib/transport", ["base", "runtime/client", "mediator"], function(o, i, s) {
        function c(r) {
          var d = this;
        ...
        var a = o.$;
        return c.options = { server: "", method: "POST", withCredentials: !1, fileVal: "file", timeout: 12e4, formData: {}, headers: {}, sendAsBinary: !1 }, a.extend(c.prototype, { appendBlob: function(r, d, u) {
      ...
      }), t("widgets/upload", ["base", "uploader", "file", "lib/transport", "widgets/widget"], function(o, i, s, c) {
        function a(l, f) {
        ...
        var r = o.$, d = o.isPromise, u = s.Status;
        r.extend(i.options, { prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, chunkRetryDelay: 1e3, threads: 3, formData: {} }), i.register({ name: "upload", init: function() {
          ...
          var f, p, m = this, g = m.owner, y = r.extend({}, m.options, l.options), w = l.file, b = new c(y), _ = r.extend({}, y.formData), M = r.extend({}, y.headers);
      ...
      }), t("widgets/validator", ["base", "uploader", "file", "widgets/widget"], function(o, i, s) {
        var c, a = o.$, r = {};
        ...
        return o;
      }), t("runtime/html5/runtime", ["base", "runtime/runtime", "runtime/compbase"], function(o, i, s) {
        function c() {
        ...
        return o.register("Blob", { slice: function(s, c) {
          ...
          return a = r.call(a, s, c), new i(this.getRuid(), a);
        } });
      }), t("runtime/html5/dnd", ["base", "runtime/html5/runtime", "lib/file"], function(o, i, s) {
      ...
      }), t("runtime/html5/filepaste", ["base", "runtime/html5/runtime", "lib/file"], function(o, i, s) {
        return i.register("FilePaste", { init: function() {
          var c, a, r, d, u = this.options, l = this.elem = u.container, f = ".*";
          if (u.accept) {
            for (c = [], a = 0, r = u.accept.length; r > a; a++)
          ...
          for (c = c.originalEvent || c, a = c.clipboardData.items, u = 0, l = a.length; l > u; u++)
            r = a[u], r.kind === "file" && (d = r.getAsFile()) && f.push(new s(p, d));
        ...
        return i.register("FilePicker", { init: function() {
          var c, a, r, d, u, l = this.getRuntime().getContainer(), f = this, p = f.owner, m = f.options, g = this.label = s(document.createElement("label")), y = this.input = s(document.createElement("input"));
          ...
          l.append(y), l.append(g), d = function(w) {
            ...
            var b;
            return w.target.files.length === 0 ? !1 : (f.files = w.target.files, b = this.cloneNode(!0), b.value = null, this.parentNode.replaceChild(b, this), y.off(), y = s(b).on("change", u).on("mouseenter mouseleave", d), void p.trigger("change"));
        ...
        var i = e.createObjectURL && e || e.URL && URL.revokeObjectURL && URL || e.webkitURL, s = o.noop, c = s;
        return i && (s = function() {
        ...
        var i;
        return i = { parsers: { 65505: [] }, maxMetaDataSize: 262144, parse: function(s, c) {
          ...
          }, s = s.slice(0, a.maxMetaDataSize), r.readAsArrayBuffer(s.getSource());
        }, _parse: function(s, c) {
          if (!(s.byteLength < 6)) {
            var a, r, d, u, l = new DataView(s), f = 2, p = l.byteLength - 4, m = f, g = {};
          ...
          var a, r, d, u = this._parse(s, !0);
          return d = 2, u.imageHead && (d = 2 + u.imageHead.byteLength), r = s.slice ? s.slice(d) : new Uint8Array(s).subarray(d), a = new Uint8Array(c.byteLength + 2 + r.byteLength), a[0] = 255, a[1] = 216, a.set(new Uint8Array(c), 2), a.set(new Uint8Array(r), c.byteLength + 2), a.buffer;
        ...
        return s.ExifMap = function() {
        ...
        }, size: 8 } }, s.exifTagTypes[7] = s.exifTagTypes[1], s.getExifValue = function(c, a, r, d, u, l) {
          var f, p, m, g, y, w, b = s.exifTagTypes[d];
          if (!b)
            return void o.log("Invalid Exif data: Invalid tag type.");
          if (f = b.size * u, p = f > 4 ? a + c.getUint32(r + 8, l) : r + 8, p + f > c.byteLength)
            return void o.log("Invalid Exif data: Invalid data offset.");
          if (u === 1)
            return b.getValue(c, p, l);
          for (m = [], g = 0; u > g; g += 1)
            m[g] = b.getValue(c, p + g * b.size, l);
          if (b.ascii) {
          ...
          return m;
        }, s.parseExifTag = function(c, a, r, d, u) {
          var l = c.getUint16(r, d);
          u.exif[l] = s.getExifValue(c, a, r, c.getUint16(r + 2, d), c.getUint32(r + 4, d), d);
        }, s.parseExifTags = function(c, a, r, d, u) {
          var l, f, p;
          if (r + 6 > c.byteLength)
          ...
          for (p = 0; l > p; p += 1)
            this.parseExifTag(c, a, r + 2 + 12 * p, d, u);
          return c.getUint32(f, d);
        }, s.parseExifData = function(c, a, r, d) {
          var u, l, f = a + 10;
        ...
        }, i.parsers[65505].push(s.parseExifData), s;
      }), t("runtime/html5/image", ["base", "runtime/html5/runtime", "runtime/html5/util"], function(o, i, s) {
        ...
        return i.register("Image", { modified: !1, init: function() {
          ...
          var r = this, d = r._img;
          r._blob = a, r.type = a.type, d.src = s.createObjectURL(a.getSource()), r.owner.once("load", function() {
          ...
          if (a = a || this.type, this.modified || this.type !== a) {
            if (r = this._canvas, a === "image/jpeg") {
              if (d = s.canvasToDataUrl(r, a, u.quality), u.preserveHeaders && this._metas && this._metas.imageHead)
                return d = s.dataURL2ArrayBuffer(d), d = s.updateImageHead(d, this._metas.imageHead), d = s.arrayBufferToBlob(d, a);
            } else
              d = s.canvasToDataUrl(r, a);
            d = s.dataURL2Blob(d);
          }
          return d;
        }, getAsDataUrl: function(a) {
          var r = this.options;
          return a = a || this.type, a === "image/jpeg" ? s.canvasToDataUrl(this._canvas, a, r.quality) : this._canvas.toDataURL(a);
        ...
        return i.register("Transport", { init: function() {
          ...
          l.sendAsBinary ? (m += l.attachInfoToQuery !== !1 ? (/\?/.test(m) ? "&" : "?") + c.param(u._formData) : "", r = p.getSource()) : (a = new FormData(), c.each(u._formData, function(g, y) {
            a.append(g, y);
          ...
          return !d.withCredentials || "withCredentials" in r || typeof XDomainRequest > "u" || (r = new XDomainRequest()), r.upload.onprogress = function(u) {
            ...
            if (r.readyState === 4) {
              r.upload.onprogress = s, r.onreadystatechange = s, a._xhr = null, a._status = r.status;
    ...
    me(tn, { init: function(e, t) {
      ...
      if (n.event = t, z(Ei, function(c, a) {
        n[a] = t[a];
        ...
        var i = o.documentElement, s = o.body;
        n.pageX = n.clientX + (i && i.scrollLeft || s && s.scrollLeft || 0) - (i && i.clientLeft || s && s.clientLeft || 0), n.pageY = n.clientY + (i && i.scrollTop || s && s.scrollTop || 0) - (i && i.clientTop || s && s.clientTop || 0);
      }
    ...
    v.query = ti, v.queryAll = kt, me(de, { init: function(e) {
      ...
      if (t)
        if (t.getBoundingClientRect) {
          var i = t.getBoundingClientRect(), s = je(e.doc);
          n = i.left + s.x, o = i.top + s.y;
        } else
          for (; t; )
        ...
        if (o.parentNode) {
          if (Ye(o), e)
            for (var i = o.firstChild; i; ) {
              var s = i.nextSibling;
              o.parentNode.insertBefore(i, o), i = s;
            }
      ...
      function n(o) {
        for (var i = t ? o.firstChild : o.lastChild; i; ) {
          var s = t ? i.nextSibling : i.previousSibling;
          if (e(i) === !1 || n(i) === !1)
            return !1;
          i = s;
        }
      ...
      if (e != null) {
        if (typeof e == "string") {
          ...
          if (e.charAt(0) === "@" && (e = e.substr(1)), e.length !== o || /<.+>/.test(e)) {
            var i = t ? t.ownerDocument || t : document, s = i.createElement("div"), c = [];
            s.innerHTML = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />' + e;
            for (var a = 0, r = s.childNodes.length; r > a; a++) {
    ...
    me(_e, { init: function(e) {
      ...
      for (var t, n, o = e(this.startContainer), i = e(this.endContainer), s = 0, c = o.length, a = i.length; ++s && (t = o[c - s], n = i[a - s], t && n && t === n); )
        ;
      return o[c - s + 1];
      ...
      var s = n.compareEndPoints(i[e], o);
      if (s !== 0)
        return s;
      var c, a, r, d, u;
      if ((e === at || e === ct) && (c = this.startContainer, d = this.startOffset), (e === st || e === qe) && (c = this.endContainer, d = this.endOffset), (e === at || e === st) && (a = t.startContainer, u = t.startOffset), (e === qe || e === ct) && (a = t.endContainer, u = t.endOffset), c === a) {
        var l = d - u;
      ...
      for (r = c; r && r.parentNode !== a; )
        r = r.parentNode;
      return r ? v(r).index() >= u ? 1 : -1 : (r = v(a).next(), r && r.contains(c) ? 1 : (r = v(c).next(), r && r.contains(a) ? -1 : void 0));
    }, cloneRange: function() {
      ...
      var t, n, o, i = this, s = i.startContainer, c = i.startOffset, a = i.endContainer, r = i.endOffset, d = 1;
      return e.nodeName.toLowerCase() === "#document-fragment" && (t = e.firstChild, n = e.lastChild, d = e.childNodes.length), s.nodeType == 1 ? (o = s.childNodes[c], o ? (s.insertBefore(e, o), s === a && (r += d)) : s.appendChild(e)) : s.nodeType == 3 && (c === 0 ? (s.parentNode.insertBefore(e, s), s.parentNode === a && (r += d)) : c >= s.nodeValue.length ? s.nextSibling ? s.parentNode.insertBefore(e, s.nextSibling) : s.parentNode.appendChild(e) : (o = c > 0 ? s.splitText(c) : s, s.parentNode.insertBefore(e, o), s === a && (a = o, r -= c))), t ? i.setStartBefore(t).setEndAfter(n) : i.selectNode(e), i.compareBoundaryPoints(qe, i.cloneRange().setEnd(a, r)) >= 1 ? i : i.setEnd(a, r);
      ...
      function e(n, o, i) {
        if (n.nodeType == 1) {
          ...
          if (s.length !== 0) {
            var c, a, r, d;
            o > 0 && (c = s.eq(o - 1)), o < s.length && (a = s.eq(o)), c && c.type == 3 && (r = c[0], d = r.nodeValue.length), a && a.type == 3 && (r = a[0], d = 0), r && (i ? t.setStart(r, d) : t.setEnd(r, d));
          }
        }
      }
      var t = this;
      ...
      e = V(e, !0);
      var t, n = this, o = n.sel, i = n.range.cloneRange().shrink(), s = i.startContainer, c = i.startOffset, a = (i.endContainer, i.endOffset, Le(s)), r = n.win, d = !1;
      if (e && s.nodeType == 1 && i.collapsed) {
        if (be) {
          var u = v("<span>&nbsp;</span>", a);
        ...
        if (Oe) {
          var l = s.childNodes;
          (v(s).isInline() || c > 0 && v(l[c - 1]).isInline() || l[c] && v(l[c]).isInline()) && (i.insertNode(a.createTextNode("\u200B")), d = !0);
        }
      }
      if (be)
        try {
      ...
      if (t.isBlock()) {
        for (var s = t.clone(!0), c = s; c.first(); )
          c = c.first();
        return c.append(i.extractContents()), i.insertNode(s[0]).selectNode(s[0]), n;
      }
      i.enlarge();
      ...
      for (var n, o = this.range, i = o.doc, s = o.cloneRange().collapse(e), c = s.startContainer, a = s.startOffset, r = c.nodeType == 3 ? c.parentNode : c, d = !1; r && r.parentNode; ) {
        if (n = v(r), t) {
          if (!n.isStyle() || !zt(n, t))
            break;
        } else if (Tt[n.name])
      ...
      if (d) {
        ...
        o.cloneRange().collapse(!e).insertNode(u), e ? s.setStartBefore(r.firstChild).setEnd(c, a) : s.setStart(c, a).setEndAfter(r.lastChild);
        var l = s.extractContents(), f = l.firstChild, p = l.lastChild;
        e ? (s.insertNode(l), o.setStartAfter(p).setEndBefore(u)) : (r.appendChild(l), o.setStartBefore(u).setEndBefore(f));
        var m = u.parentNode;
        if (m == o.endContainer) {
      ...
      if (o.enlarge(), o.startOffset === 0) {
        for (var i, s = v(o.startContainer); (i = s.parent()) && i.isStyle() && i.children().length == 1; )
          s = i;
        o.setStart(s[0], 0), s = v(o.startContainer), s.isBlock() && Pt(s, e);
        var c = s.parent();
        c && c.isBlock() && Pt(c, e);
      }
      var a, r;
      ...
      var n = this.range, o = n.endContainer, i = n.endOffset, s = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], c = t(s);
      if (c)
        return c;
      if (!s)
        return null;
      if (s.nodeType == 1 || o.nodeType == 3 && i === 0) {
        var a = v(s).prev();
        if (a)
          return t(a);
      }
      ...
      var n = this.range, o = n.startContainer, i = n.startOffset, s = n.endContainer, c = n.endOffset, a = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], r = s.nodeType == 3 || c === 0 ? s : s.childNodes[c - 1], d = t(a), u = t(r);
      ...
      n.range, e = t(e);
      var i, s = "";
      return e === "fontfamily" || e === "fontname" ? (s = mn(o, "fontname"), s = s.replace(/['"]/g, ""), t(s)) : e === "formatblock" ? (s = mn(o, e), s === "" && (i = n.commonNode({ "h1,h2,h3,h4,h5,h6,p,div,pre,address": "*" }), i && (s = i.name)), s === "Normal" && (s = "p"), t(s)) : e === "fontsize" ? (i = n.commonNode({ "*": ".font-size" }), i && (s = i.css("font-size")), t(s)) : e === "forecolor" ? (i = n.commonNode({ "*": ".color" }), i && (s = i.css("color")), s = mt(s), s === "" && (s = "default"), t(s)) : e === "hilitecolor" ? (i = n.commonNode({ "*": ".background-color" }), i && (s = i.css("background-color")), s = mt(s), s === "" && (s = "default"), t(s)) : s;
    }, toggle: function(e, t) {
      var n = this;
      ...
      function n(c, a) {
        ...
        var u = hn(r);
        c.setEnd(u.endContainer, u.endOffset), c.collapse(!1), i.select(!1);
      }
      function o(c, a) {
    ...
    }, insertimage: function(e, t, n, o, i, s, c, a) {
      t = V(t, ""), c = V(c, "");
      var r = '<img data-ke-class="' + c + '" src="' + se(e) + '" data-ke-src="' + se(e) + '" ';
      return n && (r += 'width="' + se(n) + '" '), o && (r += 'height="' + se(o) + '" '), t && (r += 'title="' + se(t) + '" '), s && (r += 'align="' + se(s) + '" '), r += 'alt="' + se(t) + '" ', r += "/>", a && (r = "<" + a + ">" + r + "</" + a + ">"), this.inserthtml(r);
    }, createlink: function(e, t) {
      function n(m, g, y) {
        v(m).attr("href", g).attr("data-ke-src", g), y ? v(m).attr("target", y) : v(m).removeAttr("target");
      }
      var o = this, i = o.doc, s = o.range;
      o.select();
      ...
      if (s.isControl()) {
        var r = v(s.startContainer.childNodes[s.startOffset]);
        return a += "></a>", r.after(v(a, i)), r.next().append(r), s.selectNode(r[0]), o.select();
      }
      ...
      if (t.name = e.name || "", t.doc = e.doc || document, t.win = Fe(t.doc), t.x = J(e.x), t.y = J(e.y), t.z = e.z, t.width = J(e.width), t.height = J(e.height), t.div = v('<div style="display:block;"></div>'), t.options = e, t._alignEl = e.alignEl, t.width && t.div.css("width", t.width), t.height && t.div.css("height", t.height), t.z && t.div.css({ position: "absolute", left: t.x, top: t.y, "z-index": t.z }), !t.z || t.x !== void 0 && t.y !== void 0 || t.autoPos(t.width, t.height), e.cls && t.div.addClass(e.cls), e.shadowMode && t.div.addClass("ke-shadow"), e.css && t.div.css(e.css), e.src ? v(e.src).replaceWith(t.div) : v(t.doc.body).append(t.div), e.html && t.div.html(e.html), e.autoScroll)
        if (Y && 7 > ce || Ne) {
          ...
          v(t.win).bind("scroll", function(o) {
            var i = je(), s = i.x - n.x, c = i.y - n.y;
            t.pos(Z(t.x) + s, Z(t.y) + c, !1);
          });
        } else
      ...
      var n, o, i = this, s = Z(e) || 0, c = Z(t) || 0, a = je();
      if (i._alignEl) {
        var r = v(i._alignEl), d = r.pos(), u = Ie(r[0].clientWidth / 2 - s / 2), l = Ie(r[0].clientHeight / 2 - c / 2);
        n = 0 > u ? d.x : d.x + u, o = 0 > l ? d.y : d.y + l;
      } else {
        var f = ye(i.doc);
        n = Ie(a.x + (f.clientWidth - s) / 2), o = Ie(a.y + (f.clientHeight - c) / 2);
      }
      ...
      var t = this;
      return e = e || {}, e.moveEl = t.div, e.moveFn = function(n, o, i, s, c, a) {
    ...
    (Et = document.getElementsByTagName("html")) && (Xt = Et[0].dir), me(tt, De, { init: function(e) {
      function t() {
        var u = Wt(n.iframe);
        u.open(), a && (u.domain = document.domain), u.write(ui(o, i, s, c)), u.close(), n.win = n.iframe[0].contentWindow, n.doc = u;
      ...
      var o = V(e.themesPath, ""), i = e.bodyClass, s = e.cssPath, c = e.cssData, a = location.protocol != "res:" && location.host.replace(/:\d+/, "") !== document.domain, r = "document.open();" + (a ? 'document.domain="' + document.domain + '";' : "") + "document.close();", d = Y ? ' src="javascript:void(function(){' + encodeURIComponent(r) + '}())"' : "";
      ...
      if (e)
        return v(o).keyup(function(s) {
          s.ctrlKey || s.altKey || !Zt[s.which] || e(s);
      ...
      bt.parent.init.call(o, e), o.disableMode = V(e.disableMode, !1), o.noDisableItemMap = re(V(e.noDisableItems, [])), o._itemMap = {}, o.div.addClass("ke-toolbar").bind("contextmenu,mousedown,mousemove", function(i) {
        ...
        if (s) {
          if (s.hasClass("ke-disabled"))
            return;
          o.options.click.call(this, i, s.attr("data-name"));
        }
      });
    }, get: function(e) {
      ...
      return t && (o = re(t)), (e === void 0 ? !n.disableMode : e) ? (v("span.ke-outline", n.div).each(function() {
        var i = v(this), s = i[0].getAttribute("data-name", 2);
        o[s] || n.disable(i);
      ...
      var n = v('<div class="ke-menu-item" unselectable="on"></div>'), o = v('<div class="ke-inline-block ke-menu-item-left"></div>'), i = v('<div class="ke-inline-block ke-menu-item-right"></div>'), s = J(e.height), c = V(e.iconClass, "");
      t.div.append(n), s && (n.css("height", s), i.css("line-height", s));
      var a;
      return t.centerLineMode && (a = v('<div class="ke-inline-block ke-menu-item-center"></div>'), s && a.css("height", s)), n.mouseover(function(r) {
      ...
      var i = o.insertRow(0), s = i.insertCell(0);
      s.colSpan = n[0].length, t._addAttr(s, "", "ke-colorpicker-cell-top");
      for (var c = 0; c < n.length; c++) {
        i = o.insertRow(c + 1);
        for (var a = 0; a < n[c].length; a++)
          s = i.insertCell(a), t._addAttr(s, n[c][a], "ke-colorpicker-cell");
      }
      ...
      var t = this, n = v(e.button), o = e.fieldName || "file", i = e.url || "", s = n.val(), c = e.extraParams || {}, a = e.uploadResponseFilter, r = e.uploadCompress, d = n[0].className || "", u = e.target || "kindeditor_upload_iframe_" + new Date().getTime();
      e.afterError = e.afterError || function(b) {
        alert(b);
      };
      var l = [];
      for (var f in c)
        l.push('<input type="hidden" name="' + f + '" value="' + c[f] + '" />');
      var p = ['<div class="ke-inline-block ' + d + '">', e.target ? "" : '<iframe name="' + u + '" style="display:none;"></iframe>', e.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + u + '" action="' + i + '">', '<span class="ke-button-common">', l.join(""), '<input type="button" class="ke-button-common ke-button" value="' + s + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + o + '" tabindex="-1" />', e.form ? "</div>" : "</form>", "</div>"].join(""), m = v(p, n.doc);
      ...
      var o = e.title, i = v(e.body, t.doc), s = e.previewBtn, c = e.yesBtn, a = e.noBtn, r = e.closeBtn, d = V(e.showMask, !0);
      ...
      if ((s || c || a) && u.append(p), z([{ btn: s, name: "preview" }, { btn: c, name: "yes" }, { btn: a, name: "no" }], function() {
        if (this.btn) {
          var w = fi(this.btn);
    ...
    return v.remove = function(e) {
      ...
      if (t.afterSetHtml(function() {
        ...
        if (t.syncType == "form") {
          for (var i = e(t.srcElement), s = !1; i = i.parent(); )
            if (i.name == "form") {
              s = !0;
              break;
            }
      ...
      z("undo,redo".split(","), function(i, s) {
        n[s] && t.afterCreate(function() {
          At(this.edit.doc, n[s], function() {
            t.clickToolbar(s);
          });
        ...
        var i = t.lang("formatblock.formatBlock"), s = { h1: 28, h2: 24, h3: 18, H4: 14, p: 12 }, c = t.cmd.val("formatblock"), a = t.createMenu({ name: "formatblock", width: t.langType == "en" ? 200 : 150 });
        z(i, function(r, d) {
          var u = "font-size:" + s[r] + "px;";
          r.charAt(0) === "h" && (u += "font-weight:bold;"), a.addItem({ title: '<span style="' + u + '" unselectable="on">' + d + "</span>", height: s[r] + 12, checked: c === r || c === d, click: function() {
            t.select().exec("formatblock", "<" + r + ">").hideMenu();
          } });
        });
      }), t.clickToolbar("fontname", function() {
        var i = t.cmd.val("fontname"), s = t.createMenu({ name: "fontname", width: 150 });
        z(t.lang("fontname.fontName"), function(c, a) {
          s.addItem({ title: '<span style="font-family: ' + c + ';" unselectable="on">' + a + "</span>", height: 30, checked: i === c.toLowerCase() || i === a.toLowerCase(), click: function() {
            t.exec("fontname", c).hideMenu();
          } });
        });
      }), t.clickToolbar("fontsize", function() {
        var i = t.cmd.val("fontsize"), s = t.createMenu({ name: "fontsize", width: 150 });
        z(t.fontSizeTable, function(c, a) {
          s.addItem({ title: '<span style="font-size:' + a + ';" unselectable="on">' + a + "</span>", height: Z(a) + 12, checked: i === a, click: function() {
            t.exec("fontsize", a).hideMenu();
          } });
        });
      }), z("forecolor,hilitecolor".split(","), function(i, s) {
        t.clickToolbar(s, function() {
          t.createMenu({ name: s, selectedColor: t.cmd.val(s) || "default", colors: t.colorTable, click: function(c) {
            t.exec(s, c).hideMenu();
          } });
        });
      }), z("cut,copy,paste".split(","), function(i, s) {
        t.clickToolbar(s, function() {
          t.focus();
          try {
            t.exec(s, null);
      ...
      }, t.plugin.getSelectedPreCode = function() {
        return t.cmd.commonAncestor("pre");
      ...
      }, z("link,image,flash,media,anchor".split(","), function(i, s) {
        ...
        z("edit,delete".split(","), function(a, r) {
          t.addContextmenu({ title: t.lang(r + c), click: function() {
            t.loadPlugin(s, function() {
              t.plugin[s][r](), t.hideMenu();
            });
          }, cond: t.plugin["getSelected" + c], width: 150, iconClass: r == "edit" ? "ke-icon-" + s : void 0 });
      ...
      }, z("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function(i, s) {
        var c = he(s, ["prop", "delete"]) < 0 ? t.plugin.getSelectedCell : t.plugin.getSelectedTable;
      ...
      }), t.addContextmenu({ title: "-" }), z("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function(i, s) {
        n[s] && t.afterCreate(function() {
          At(this.edit.doc, n[s], function() {
        ...
        function i() {
          s.range.moveToBookmark(c), s.select(), Oe && (e("div." + d, a).each(function() {
...
`), l = l.replace(/<[^>]+>/g, ""), l = l.replace(/ {2}/g, " &nbsp;"), t.newlineTag == "p" ? /\n/.test(l) && (l = l.replace(/^/, "<p>").replace(/$/, "<br /></p>").replace(/\n/g, "<br /></p><p>")) : l = l.replace(/\n/g, "<br />$&")), t.insertHtml(l, !0));
        ...
        var s, c, a, r = t.edit.doc, d = "__kindeditor_paste__", u = !1;
        e(r.body).bind("paste", function(l) {
          if (t.pasteType === 0)
            return void l.stop();
          if (!u) {
            if (u = !0, e("div." + d, r).remove(), s = t.cmd.selection(), c = s.range.createBookmark(), a = e('<div class="' + d + '"></div>', r).css({ position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: e(c.start).pos().y + "px", "white-space": "nowrap" }), e(r.body).append(a), Y) {
              var f = s.range.get(!0);
        ...
        return Y && 8 >= ce && (i = i.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/gi, function(s, c) {
          return unescape(c);
        }), i = i.replace(/(<input)((?:\s+[^>]*)?>)/gi, function(s, c, a) {
          return /\s+type="[^"]+"/i.test(s) ? s : c + ' type="text"' + a;
        })), i.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/gi, function(s, c, a, r) {
          return c + Ge(a).replace(/\s+/g, " ") + r;
        }).replace(/<img[^>]*class="?ke-(flash|rm|media)"?[^>]*>/gi, function(s) {
          var c = we(s), a = Pe(c.style || ""), r = an(c["data-ke-tag"]), d = V(a.width, ""), u = V(a.height, "");
          return /px/i.test(d) && (d = Z(d)), /px/i.test(u) && (u = Z(u)), r.width = V(c.width, d), r.height = V(c.height, u), Rt(r);
        ...
        }).replace(/(<[^>]*)data-ke-src="([^"]*)"([^>]*>)/gi, function(s, c, a, r) {
        ...
        return Y && 8 >= ce && (i = i.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/gi, function(s) {
          var c = we(s), a = Pe(c.style || "");
          return a.display == "none" ? '<div class="ke-display-none" data-ke-input-tag="' + escape(s) + '"></div>' : s;
        })), i.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/gi, function(s) {
          var c = we(s);
          return c.src = V(c.src, ""), c.width = V(c.width, 0), c.height = V(c.height, 0), sn(t.themesPath + "common/blank.gif", c);
        ...
        }).replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/gi, function(s, c, a, r, d) {
          return s.match(/\sdata-ke-src="[^"]*"/i) ? s : s = c + a + '="' + r + '" data-ke-src="' + se(r) + '"' + d;
        }).replace(/(<[^>]+\s)(on\w+="[^"]*"[^>]*>)/gi, function(s, c, a) {
          return c + "data-ke-" + a;
        }).replace(/<table[^>]*\s+border="0"[^>]*>/gi, function(s) {
          return s.indexOf("ke-zeroborder") >= 0 ? s : Zn(s, "ke-zeroborder");
        });
      });
    }), function(e) {
      return e.KindEditor ? e.KindEditor : void 0;
...
Allowed file extension: swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb`, invalidWidth: "The width must be number.", invalidHeight: "The height must be number.", invalidBorder: "The border must be number.", invalidUrl: "Please type valid URL.", invalidRows: "Invalid rows.", invalidCols: "Invalid columns.", invalidPadding: "The padding must be number.", invalidSpacing: "The spacing must be number.", invalidJson: "Invalid JSON string.", uploadSuccess: "Upload success.", cutError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+X) instead.", copyError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+C) instead.", pasteError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+V) instead.", ajaxLoading: "Loading ...", uploadLoading: "Uploading ...", uploadError: "Upload Error", "plainpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "wordpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "code.pleaseInput": "Please input code.", "link.url": "URL", "link.linkType": "Target", "link.newWindow": "New window", "link.selfWindow": "Same window", "flash.url": "URL", "flash.width": "Width", "flash.height": "Height", "flash.upload": "Upload", "flash.viewServer": "Browse", "media.url": "URL", "media.width": "Width", "media.height": "Height", "media.autostart": "Auto start", "media.upload": "Upload", "media.viewServer": "Browse", "image.remoteImage": "Insert URL", "image.localImage": "Upload", "image.remoteUrl": "URL", "image.localUrl": "File", "image.size": "Size", "image.width": "Width", "image.height": "Height", "image.resetSize": "Reset dimensions", "image.align": "Align", "image.defaultAlign": "Default", "image.leftAlign": "Left", "image.rightAlign": "Right", "image.imgTitle": "Title", "image.upload": "Browse", "image.viewServer": "Browse", "multiimage.uploadDesc": "Allows users to upload <%=uploadLimit%> images, single image size not exceeding <%=sizeLimit%>", "multiimage.startUpload": "Start upload", "multiimage.clearAll": "Clear all", "multiimage.insertAll": "Insert all", "multiimage.queueLimitExceeded": "Queue limit exceeded.", "multiimage.fileExceedsSizeLimit": "File exceeds size limit.", "multiimage.zeroByteFile": "Zero byte file.", "multiimage.invalidFiletype": "Invalid file type.", "multiimage.unknownError": "Unknown upload error.", "multiimage.pending": "Pending ...", "multiimage.uploadError": "Upload error", "filemanager.emptyFolder": "Blank", "filemanager.moveup": "Parent folder", "filemanager.viewType": "Display: ", "filemanager.viewImage": "Thumbnails", "filemanager.listImage": "List", "filemanager.orderType": "Sorting: ", "filemanager.fileName": "By name", "filemanager.fileSize": "By size", "filemanager.fileType": "By type", "insertfile.url": "URL", "insertfile.title": "Title", "insertfile.upload": "Upload", "insertfile.viewServer": "Browse", "table.cells": "Cells", "table.rows": "Rows", "table.cols": "Columns", "table.size": "Dimensions", "table.width": "Width", "table.height": "Height", "table.percent": "%", "table.px": "px", "table.space": "Space", "table.padding": "Padding", "table.spacing": "Spacing", "table.align": "Align", "table.textAlign": "Horizontal", "table.verticalAlign": "Vertical", "table.alignDefault": "Default", "table.alignLeft": "Left", "table.alignCenter": "Center", "table.alignRight": "Right", "table.alignTop": "Top", "table.alignMiddle": "Middle", "table.alignBottom": "Bottom", "table.alignBaseline": "Baseline", "table.border": "Border", "table.borderWidth": "Width", "table.borderColor": "Color", "table.backgroundColor": "Background", "map.address": "Address: ", "map.search": "Search", "baidumap.address": "Address: ", "baidumap.search": "Search", "baidumap.insertDynamicMap": "Dynamic Map", "anchor.name": "Anchor name", "formatblock.formatBlock": { h1: "Heading 1", h2: "Heading 2", h3: "Heading 3", h4: "Heading 4", p: "Normal" }, "fontname.fontName": { Arial: "Arial", "Arial Black": "Arial Black", "Comic Sans MS": "Comic Sans MS", "Courier New": "Courier New", Garamond: "Garamond", Georgia: "Georgia", Tahoma: "Tahoma", "Times New Roman": "Times New Roman", "Trebuchet MS": "Trebuchet MS", Verdana: "Verdana" }, "lineheight.lineHeight": [{ 1: "Line height 1" }, { 1.5: "Line height 1.5" }, { 2: "Line height 2" }, { 2.5: "Line height 2.5" }, { 3: "Line height 3" }], "template.selectTemplate": "Template", "template.replaceContent": "Replace current content", "template.fileList": { "1.html": "Image and Text", "2.html": "Table", "3.html": "List" } }, "en"), KindEditor.each(KindEditor.options.items, function(e, t) {
      ...
      t.plugin.anchor = { edit: function() {
        var i = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keName">' + o.name + "</label>", '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:260px;" />', "</div>", "</div>"].join(""), s = t.createDialog({ name: n, width: 360, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(d) {
          t.insertHtml('<a name="' + a.val() + '">').hideDialog().focus();
        } } }), c = s.div, a = e('input[name="name"]', c), r = t.plugin.getSelectedAnchor();
      ...
      function n() {
        if (!i.fullscreenMode) {
          var c = i.edit, a = c.doc.body;
          c.iframe.height(s);
          var r = i.toolbar, d = e(r.div).height(), u = Math.max(e.IE ? a.scrollHeight : a.offsetHeight, s, e(a).height()) + d + 30;
          i.resize(null, u), a.scrollTo({ top: 0 });
        }
      }
      function o() {
        s = e.removeUnit(i.height), i.edit.afterChange(n), i.fullscreenMode || t(), n();
      }
      var i = this;
      if (i.autoHeightMode) {
        var s;
      ...
      var t = this, n = "baidumap", o = t.lang(n + "."), i = e.undef(t.baiduMapAk, "9yfaQtWDimlbXuo4TMLmIk7yDjl36eCy"), s = e.undef(t.mapWidth, 558), c = e.undef(t.mapHeight, 360);
      t.clickToolbar(n, function() {
        ...
        var r, d, u = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', o.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:450px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + o.search + '" />', "</span>", "</div>", '<div class="ke-map" style="width:' + s + "px;height:" + c + 'px;"></div>', "</div>"].join(""), l = t.createDialog({ name: n, width: s + 42, title: t.lang(n), body: u, yesBtn: { name: t.lang("yes"), click: function(w) {
          var b = r.map, _ = b.getCenter(), M = _.lng + "," + _.lat, N = b.getZoom(), A = ["http://api.map.baidu.com/staticimage/v2?ak=" + i, "&center=" + encodeURIComponent(M), "&zoom=" + encodeURIComponent(N), "&width=" + 1.5 * s, "&height=" + 1.5 * c, "&markers=" + encodeURIComponent(M), "&markerStyles=" + encodeURIComponent("l,A")].join("");
          t.exec("insertimage", A, "title", s + "", c + "", 0, "", "ke-map"), t.hideDialog().focus();
...
` + e.escape(p) + `
      ...
      t.emojiConfig && t.emojiConfig instanceof Function && t.emojiConfig.call(null, o, i), t.clickToolbar(n, function() {
        function s(_, M) {
          _.mouseover(function() {
            ...
            t.insertHtml(M).hideMenu(), setTimeout(function() {
              t.focus(), t.cmd.select(), t.cmd.selection(!0);
            }, 100), N.stop();
          });
        }
        function c(_, M) {
        ...
        function r(_, M) {
          _.click(function(N) {
            a(), w.parentNode.removeChild(w), y.remove(), w = c(M, l), d(M), i.current = M, N.stop();
          });
        }
        function d(_) {
        ...
        f.div.append(l);
        var y, w = c(i.current, l), b = e(l).width();
      ...
      var o = this, i = "filemanager", s = e.undef(o.fileManagerJson, o.basePath + "_404.html"), c = o.pluginsPath + i + "/images/", a = o.lang(i + ".");
      o.plugin.filemanagerDialog = function(r) {
        function d(x, C, D) {
          var I = "path=" + x + "&order=" + C + "&dir=" + y;
          M.showLoading(o.lang("ajaxLoading")), e.ajax(e.addParam(s, I + "&" + new Date().getTime()), function(L) {
            M.hideLoading(), D(L);
          });
        }
        function u(x, C, D, I) {
        ...
        function f(x) {
          ...
          for (var D = x.file_list, I = 0, L = D.length; L > I; I++) {
            ...
            var U = c + (R.is_dir ? "folder-16.gif" : "file-16.gif"), H = e('<img src="' + U + '" width="16" height="16" alt="' + R.filename + '" align="absmiddle" />'), j = e(O[0].insertCell(0)).addClass("ke-cell ke-name").append(H).append(document.createTextNode(" " + R.filename));
        ...
        function p(x) {
          ...
          for (var C = x.file_list, D = 0, I = C.length; I > D; D++) {
            ...
            R.append(O);
            var U = x.current_url + L.filename, H = L.is_dir ? c + "folder-64.gif" : L.is_photo ? U : c + "file-64.gif", j = e('<img src="' + H + '" width="80" height="80" alt="' + L.filename + '" />');
      ...
      t.plugin.imageDialog = function(b) {
        ...
        var ae = e.uploadbutton({ button: e(".ke-upload-button", L)[0], width: "auto", fieldName: l, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: c, uploadData: u, uploadUrl: e.addParam(f, "dir=image"), uploadResponseFilter: d, uploadCompress: m, afterUpload: function(Q) {
      ...
      t.plugin.fileDialog = function(m) {
        ...
        if (o) {
          var B = e.uploadbutton({ button: e(".ke-upload-button", M)[0], width: "auto", fieldName: u, fileSizeLimit: c, fileTypeLimit: a, uploadHeader: s, uploadData: d, uploadUrl: e.addParam(l, "dir=file"), uploadResponseFilter: r, afterUpload: function(E) {
      ...
      t.plugin.link = { edit: function() {
        ...
        } } }), c = s.div, a = e('input[name="url"]', c), r = e('select[name="type"]', c);
      ...
      t.plugin.media = { edit: function() {
        ...
        if (b.val("http://"), i) {
          var T = e.uploadbutton({ button: e(".ke-upload-button", w)[0], width: "auto", fieldName: l, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: c, uploadData: u, uploadUrl: e.addParam(f, "dir=media"), uploadResponseFilter: d, afterUpload: function(x) {
      ...
      e.extend(t, { init: function(n) {
        ...
        o.bodyDiv.append(i);
        var s = e('<div class="ke-inline-block ke-photo"></div>').mouseover(function(r) {
          e(this).addClass("ke-on");
        }).mouseout(function(r) {
          e(this).removeClass("ke-on");
        });
      ...
      t.plugin.multiImageDialog = function(f) {
        var p = f.clickFn, m = e.tmpl(l.uploadDesc, { uploadLimit: d, sizeLimit: a }), g = ['<div style="padding:10px 20px;">', '<div class="swfupload">', "</div>", "</div>"].join(""), y = t.createDialog({ name: n, width: 650, height: 500, title: t.lang(n), body: g, previewBtn: { name: l.insertAll, click: function(_) {
          ...
          b.destroy();
        } }), w = y.div, b = e.swfupload({ container: e(".swfupload", w), buttonImageUrl: c + (t.langType == "zh-CN" ? "select-files-zh-CN.png" : "select-files-en.png"), buttonWidth: t.langType == "zh-CN" ? 72 : 88, buttonHeight: 23, fileIconUrl: c + "image.png", uploadDesc: m, startButtonValue: l.startUpload, uploadUrl: e.addParam(o, "dir=image"), uploadData: s, uploadHeader: i, uploadResponseFilter: r, uploadCompress: t.uploadCompress, formatUploadUrl: t.formatUploadUrl, flashUrl: c + "swfupload.swf", filePostName: u, fileTypes: "*.jpg;*.jpeg;*.gif;*.png;*.bmp", fileTypesDesc: "Image Files", fileUploadLimit: d, fileSizeLimit: a, postParams: e.undef(t.extraFileUploadParams, {}), queueLimitExceeded: l.queueLimitExceeded, fileExceedsSizeLimit: l.fileExceedsSizeLimit, zeroByteFile: l.zeroByteFile, invalidFiletype: l.invalidFiletype, unknownError: l.unknownError, pendingMessage: l.pending, errorMessage: l.uploadError, afterError: function(_) {
          t.errorDialog(_);
        } });
      ...
      t.clickToolbar(n, function() {
        ...
        if (t.insertHtml(o + c), c !== "") {
          ...
          s.selectNodeContents(a[0]), a.removeAttr("id"), i.select();
        }
      });
    }), KindEditor.plugin("plainpaste", function(e) {
      var t = this, n = "plainpaste";
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><textarea class="ke-textarea" style="width:518px;height:260px;"></textarea></div>', s = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(a) {
          var r = c.val();
      ...
      t.clickToolbar(n, function() {
        var o = (t.lang(n + "."), '<div style="padding:10px 20px;"><iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe></div>'), i = t.createDialog({ name: n, width: 750, title: t.lang(n), body: o }), s = e("iframe", i.div), c = e.iframeDoc(s);
      ...
      function t(i) {
        for (var s = e(i.commonAncestor()); s && (s.type != 1 || s.isStyle()); )
          s = s.parent();
        return s;
      }
      var n = this, o = "quote";
      n.clickToolbar(o, function() {
        n.focus();
        var i = "\u200B", s = n.cmd.range, c = t(n.cmd.range);
        if (s) {
          var a = s.extractContents(), r = e(a).outer();
          i = r || e(a).html();
        }
        i = i || "\u200B";
      ...
      n.clickToolbar(o, function() {
        n.focus();
        for (var s, c = n.edit.doc, a = n.cmd.range, r = e(c.body).first(), d = [], u = [], l = a.createBookmark(!0); r; ) {
          s = r.next();
          var f = t(r);
          f && f.name == "img" || (i[r.name] ? (r.html(r.html().replace(/^(\s|&nbsp;|　)+/gi, "")), r.css("text-indent", "2em")) : u.push(r), (!s || i[s.name] || i[r.name] && !i[s.name]) && (u.length > 0 && d.push(u), u = [])), r = s;
        }
      ...
      var i = this, s = "table", c = i.lang(s + "."), a = "ke-zeroborder", r = [];
      ...
      } }, i.clickToolbar(s, i.plugin.table.prop);
    }), KindEditor.plugin("template", function(e) {
      var t = this, n = "template", o = (t.lang(n + "."), t.pluginsPath + n + "", e.undef(t.templates, e.Templates));
      t.clickToolbar(n, function() {
        var i = t.lang(n + "."), s = ['<div style="padding:10px 20px;">', '<div class="ke-header">', '<div class="ke-left">', i.selectTemplate + " <select>"];
        ...
        var c = t.createDialog({ name: n, width: 560, title: t.lang(n), body: Et, yesBtn: { name: t.lang("yes"), click: function(u) {
      ...
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:518px;height:260px;"></iframe></div>', s = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(d) {
          var u = r.body.innerHTML;
          u = e.clearMsWord(u, t.filterMode ? t.htmlTags : e.options.htmlTags), t.insertHtml(u).hideDialog().focus();
        } } }), c = s.div, a = e("iframe", c), r = e.iframeDoc(a);
      ...
      function t() {
        ...
        }), s.css("width", e(c).width() + "px"), e(i).bind("scroll", function() {
          var a = c.pos().y, r = i.pos().y;
          r >= a ? (s.css("position", "fixed"), s.css("top", r + "px"), s.css("border-top", "1px solid #ccc")) : (s.css("position", "static"), s.css("top", "auto"), s.css("border-top", "none"));
        });
      }
      var n = this, o = e("body");
      if (n.fixToolBar) {
