...
(function(Ve, ht) {
  (function(ee, ie) {
    ...
    function mt(e) {
      ...
      return e.replace(/rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/gi, function(n, o, i, c) {
        return "#" + t(o) + t(i) + t(c);
      });
    }
    function re(e, t) {
      t = t === void 0 ? "," : t;
      var n, o = {}, i = ee(e) ? e : e.split(t);
      return z(i, function(c, s) {
        if (n = /^(\d+)\.\.(\d+)$/.exec(s))
    ...
    function me(e, t, n) {
      ...
      if (t) {
        ...
        i.prototype = t.prototype, o = new i(), z(n, function(c, s) {
          o[c] = s;
        });
      } else
        o = n;
    ...
    function Gn(e, t, n) {
      e.addEventListener ? e.addEventListener(t, n, On) : e.attachEvent && e.attachEvent("on" + t, n);
    }
    function gt(e, t, n) {
      e.removeEventListener ? e.removeEventListener(t, n, On) : e.detachEvent && e.detachEvent("on" + t, n);
    }
    function tn(e, t) {
      this.init(e, t);
    }
    ...
    function ze(e, t, n) {
      ...
      var o = It(e);
      o || (o = Qn(e)), oe[o] === void 0 && (oe[o] = {});
      var i = oe[o][t];
      i && i.length > 0 ? gt(e, t, i[0]) : (oe[o][t] = [], oe[o].el = e), i = oe[o][t], i.length === 0 && (i[0] = function(c) {
        var s = c ? new tn(e, c) : void 0;
        z(i, function(a, r) {
          a > 0 && r && r.call(e, s);
        });
      }), he(n, i) < 0 && i.push(n), Gn(e, t, i[0]);
    }
    function Ye(e, t, n) {
      if (t && t.indexOf(",") >= 0)
        return void z(t.split(","), function() {
      ...
      if (o) {
        if (t === void 0)
          return void (o in oe && (z(oe[o], function(s, a) {
            s != "el" && a.length > 0 && gt(e, s, a[0]);
          }), delete oe[o], nn(e)));
        if (oe[o]) {
          var i = oe[o][t];
          if (i && i.length > 0) {
            n === void 0 ? (gt(e, t, i[0]), delete oe[o][t]) : (z(i, function(s, a) {
              s > 0 && a === n && i.splice(s, 1);
            }), i.length == 1 && (gt(e, t, i[0]), delete oe[o][t]));
            var c = 0;
            z(oe[o], function() {
              c++;
            }), 2 > c && (delete oe[o], nn(e));
          }
        }
      }
    }
    ...
    function At(e, t, n) {
      t = /^\d{2,}$/.test(t) ? t : t.toUpperCase().charCodeAt(0), ze(e, "keydown", function(o) {
        !o.ctrlKey || o.which != t || o.shiftKey || o.altKey || (n.call(e), o.stop());
      });
    }
    function Yn(e) {
      function t() {
        i || (i = !0, e(KindEditor), Pn = !0);
      }
      function n() {
        if (!i) {
          try {
      ...
      if (document.addEventListener)
        ze(document, "DOMContentLoaded", t);
      else if (document.attachEvent) {
        ze(document, "readystatechange", o);
        var c = !1;
        try {
          c = window.frameElement == null;
        } catch {
        }
        document.documentElement.doScroll && c && n();
      }
      ze(window, "load", t);
    }
    function Pe(e) {
      ...
      for (var t, n = {}, o = /\s*([\w\-]+)\s*:([^;]*)(;|$)/g; t = o.exec(e); ) {
        var i = te(t[1].toLowerCase()), c = te(mt(t[2]));
        n[i] = c;
      }
      return n;
    }
    function we(e) {
      for (var t, n = {}, o = /\s+(?:([\w\-:]+)|(?:([\w\-:]+)=([^\s"'<>]+))|(?:([\w\-:"]+)="([^"]*)")|(?:([\w\-:"]+)='([^']*)'))(?=(?:\s|\/|>)+)/g; t = o.exec(e); ) {
        var i = (t[1] || t[2] || t[4] || t[6]).toLowerCase(), c = (t[2] ? t[3] : t[4] ? t[5] : t[7]) || "";
        n[i] = c;
      }
      return n;
    }
    function Zn(e, t) {
      return e = /\s+class\s*=/.test(e) ? e.replace(/(\s+class=["']?)([^"']*)(["']?[\s>])/, function(n, o, i, c) {
        return (" " + i + " ").indexOf(" " + t + " ") < 0 ? i === "" ? o + t + c : o + i + " " + t + c : n;
      }) : e.substr(0, e.length - 1) + ' class="' + t + '">';
    }
    function Xn(e) {
      var t = "";
      return z(Pe(e), function(n, o) {
        t += n + ":" + o + ";";
      }), t;
    }
    function Ze(e, t, n, o) {
      function i(r) {
        for (var d = r.split("/"), u = [], l = 0, f = d.length; f > l; l++) {
          var p = d[l];
      ...
      function c(r, d) {
        if (e.substr(0, r.length) === r) {
          for (var u = [], l = 0; d > l; l++)
            u.push("..");
          var f = ".";
          return u.length > 0 && (f += "/" + u.join("/")), o == "/" && (f += "/"), f + e.substr(r.length);
        }
        return (a = /^(.*)\//.exec(r)) ? c(a[1], ++d) : void 0;
      }
      if (t = V(t, "").toLowerCase(), e.substr(0, 5) != "data:" && (e = e.replace(/([^:])\/\//g, "$1/")), he(t, ["absolute", "relative", "domain"]) < 0)
        return e;
      ...
      if (a = /^(\w+:\/\/[^\/]*)/.exec(e)) {
        ...
        return e;
      return /^\//.test(e) ? e = n + i(e.substr(1)) : /^\w+:\/\//.test(e) || (e = n + i(o + "/" + e)), t === "relative" ? e = c(n + o, 0).substr(2) : t === "absolute" && e.substr(0, n.length) === n && (e = e.substr(n.length)), e;
    }
    function Re(e, t, n, o, i) {
      e == null && (e = ""), n = n || "", o = V(o, !1), i = V(i, "	");
      var c = "xx-small,x-small,small,medium,large,x-large,xx-large".split(",");
...
`) + f;
      ...
      t && (z(t, function(d, u) {
        for (var l = d.split(","), f = 0, p = l.length; p > f; f++)
          s[l[f]] = re(u);
      }), s.script || (e = e.replace(/(<(?:script|script\s[^>]*)>)([\s\S]*?)(<\/script>)/gi, "")), s.style || (e = e.replace(/(<(?:style|style\s[^>]*)>)([\s\S]*?)(<\/style>)/gi, "")));
      var a = /(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g, r = [];
      return e = e.replace(a, function(d, u, l, f, p, m, g) {
        var y = d, w = u || "", b = l || "", _ = f.toLowerCase(), M = p || "", N = m ? " " + m : "", A = g || "";
        if (t && !s[_])
          return "";
        if (N === "" && Fn[_] && (N = " /"), Rn[_] && (w && (w = " "), A && (A = " ")), Yt[_] && (b ? A = `
` : w = `
`), o && _ == "br" && (A = `
`), Ln[_] && !Yt[_])
          if (o) {
            b && r.length > 0 && r[r.length - 1] === _ ? r.pop() : r.push(_), w = `
`, A = `
`;
            for (var P = 0, B = b ? r.length : r.length - 1; B > P; P++)
              w += i, b || (A += i);
            N ? r.pop() : b || (A += i);
          } else
            w = A = "";
        if (M !== "") {
          ...
          if (_ === "font") {
            var T = {}, x = "";
            z(E, function(C, D) {
              C === "color" && (T.color = D, delete E[C]), C === "size" && (T["font-size"] = c[parseInt(D, 10) - 1] || "", delete E[C]), C === "face" && (T["font-family"] = D, delete E[C]), C === "style" && (x = D);
            }), x && !/;$/.test(x) && (x += ";"), z(T, function(C, D) {
              D !== "" && (/\s/.test(D) && (D = "'" + D + "'"), x += C + ":" + D + ";");
            }), E.style = x;
          }
          z(E, function(C, D) {
            if (_i[C] && (E[C] = C), he(C, ["src", "href"]) >= 0 && (E[C] = Ze(D, n)), (t && C !== "style" && !s[_]["*"] && !s[_][C] || _ === "body" && C === "contenteditable" || /^kindeditor_\d+$/.test(C)) && delete E[C], C === "style" && D !== "") {
              var I = Pe(D);
              z(I, function(R, O) {
                !t || s[_].style || s[_]["." + R] || delete I[R];
              });
              var L = "";
              z(I, function(R, O) {
                L += R + ":" + O + ";";
        ...
        return _ === "font" && (_ = "span"), w + "<" + b + _ + M + N + ">" + A;
      }), e = e.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/gi, function(d, u, l, f) {
...
`), te(e);
    ...
    function sn(e, t) {
      var n = t.width, o = t.height, i = t.type || ln(t.src), c = Rt(t), s = "";
      /\D/.test(n) ? s += "width:" + n + ";" : n > 0 && (s += "width:" + n + "px;"), /\D/.test(o) ? s += "height:" + o + ";" : o > 0 && (s += "height:" + o + "px;");
      var a = '<img class="' + Jn(i) + '" src="' + e + '" ';
      return s !== "" && (a += 'style="' + s + '" '), a += 'data-ke-tag="' + escape(c) + '" alt="" />';
    }
    function ei(e, t) {
    ...
    function yt(e, t) {
      t = t.toLowerCase();
      var n = null;
      if (Di || e.nodeName.toLowerCase() == "script")
        try {
      ...
      return t === "style" && n !== null && (n = Xn(n)), n;
    }
    function kt(e, t) {
      function n(C) {
        return typeof C != "string" ? C : C.replace(/([^\w\-])/g, "\\$1");
      }
      function o(C) {
        return C.replace(/\\/g, "");
      }
      function i(C, D) {
        return C === "*" || C.toLowerCase() === n(D.toLowerCase());
      }
      function c(C, D, I) {
        var L = [], R = I.ownerDocument || I, O = R.getElementById(o(C));
        return O && i(D, O.nodeName) && vt(I, O) && L.push(O), L;
      }
      function s(C, D, I) {
        var L, R, O, U, H = I.ownerDocument || I, j = [];
        if (I.getElementsByClassName)
          for (L = I.getElementsByClassName(o(C)), R = 0, O = L.length; O > R; R++)
            U = L[R], i(D, U.nodeName) && j.push(U);
        else if (H.querySelectorAll)
          for (L = H.querySelectorAll((I.nodeName !== "#document" ? I.nodeName + " " : "") + D + "." + C), R = 0, O = L.length; O > R; R++)
            U = L[R], vt(I, U) && j.push(U);
        else
          for (L = I.getElementsByTagName(D), C = " " + C + " ", R = 0, O = L.length; O > R; R++)
            if (U = L[R], U.nodeType == 1) {
              var W = U.className;
              W && (" " + W + " ").indexOf(C) > -1 && j.push(U);
            }
        return j;
      }
      function a(C, D, I) {
        for (var L, R = [], O = I.ownerDocument || I, U = O.getElementsByName(o(C)), H = 0, j = U.length; j > H; H++)
          L = U[H], i(D, L.nodeName) && vt(I, L) && L.getAttribute("name") !== null && R.push(L);
        return R;
      }
      function r(C, D, I, L) {
        for (var R, O = [], U = L.getElementsByTagName(I), H = 0, j = U.length; j > H; H++)
          R = U[H], R.nodeType == 1 && (D === null ? yt(R, C) !== null && O.push(R) : D === n(yt(R, C)) && O.push(R));
        return O;
      }
      function d(C, D) {
        var I, L = [];
        ...
        if (I = /#((?:[\w\-]|\\.)+)$/.exec(C))
          ...
          L = r(I[1].toLowerCase(), null, R, D);
        else if (I = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(C)) {
          var O = I[1].toLowerCase(), U = I[2];
          L = O === "id" ? c(U, R, D) : O === "class" ? s(U, R, D) : O === "name" ? a(U, R, D) : r(O, U, R, D);
        } else
          for (var H, j = D.getElementsByTagName(R), W = 0, le = j.length; le > W; W++)
            H = j[W], H.nodeType == 1 && L.push(H);
        return L;
      }
      var u = e.split(",");
      if (u.length > 1) {
      ...
      if (p.length == 1)
        return d(p[0], t);
      var y, w, b, _, M, N, A, P, B, E, T, x = !1;
      for (N = 0, B = p.length; B > N; N++)
        if (y = p[N], y !== ">") {
          if (N > 0) {
            for (w = [], A = 0, E = g.length; E > A; A++)
              for (_ = g[A], b = d(y, _), P = 0, T = b.length; T > P; P++)
                M = b[P], x ? _ === M.parentNode && w.push(M) : w.push(M);
            g = w;
          } else
            g = d(y, t);
          if (g.length === 0)
    ...
    function Ft(e, t, n) {
      Y && 8 > ce && t.toLowerCase() == "class" && (t = "className"), e.setAttribute(t, "" + n);
    }
    function ii(e, t) {
      Y && 8 > ce && t.toLowerCase() == "class" && (t = "className"), Ft(e, t, ""), e.removeAttribute(t);
    }
    function cn(e) {
    ...
    function ri(e, t) {
      ...
      if (n.getComputedStyle) {
        var c = n.getComputedStyle(e, null);
        i = c[o] || c.getPropertyValue(t) || e.style[o];
      } else
    ...
    function ye(e) {
      return e = e || document, Ne ? e.body : e.documentElement;
    }
    function je(e) {
      e = e || document;
      var t, n;
      return Y || bi || Qt ? (t = ye(e).scrollLeft, n = ye(e).scrollTop) : (t = Fe(e).scrollX, n = Fe(e).scrollY), { x: t, y: n };
    }
    function de(e) {
      this.init(e);
    }
    ...
    function Bt(e, t, n) {
      function o(_, M, N) {
        var A, P = _.nodeValue.length;
        if (t) {
          var B = _.cloneNode(!0);
          A = M > 0 ? B.splitText(M) : B, P > N && A.splitText(N - M);
        }
        if (n) {
          var E = _;
          if (M > 0 && (E = _.splitText(M), e.setStart(_, M)), P > N) {
            var T = E.splitText(N - M);
            e.setEnd(T, 0);
          }
          a.push(E);
        }
      ...
      function c(_, M) {
        for (var N, A = _.firstChild; A; ) {
          var P = new _e(s).selectNode(A);
          if (d = P.compareBoundaryPoints(st, e), d >= 0 && 0 >= u && (u = P.compareBoundaryPoints(at, e)), u >= 0 && 0 >= l && (l = P.compareBoundaryPoints(qe, e)), l >= 0 && 0 >= f && (f = P.compareBoundaryPoints(ct, e)), f >= 0)
            return !1;
          if (N = A.nextSibling, d > 0) {
            if (A.nodeType == 1)
              if (u >= 0 && 0 >= l)
                t && M.appendChild(A.cloneNode(!0)), n && a.push(A);
              else {
                var B;
                if (t && (B = A.cloneNode(!1), M.appendChild(B)), c(A, B) === !1)
                  return !1;
              }
      ...
      var s = e.doc, a = [], r = e.cloneRange().down(), d = -1, u = -1, l = -1, f = -1, p = e.commonAncestor(), m = s.createDocumentFragment();
      if (p.nodeType == 3) {
        var g = o(p, e.startOffset, e.endOffset);
        return t && m.appendChild(g), i(), t ? m : e;
      }
      c(p, m), n && e.up().collapse(!0);
      for (var y = 0, w = a.length; w > y; y++) {
        var b = a[y];
    ...
    function fn(e, t) {
      ...
      o.collapse(t);
      var i = o.parentElement(), c = i.childNodes;
      if (c.length === 0)
        return { node: i.parentNode, offset: v(i).index() };
      var s = n, a = 0, r = -1, d = e.duplicate();
      Xe(d, i);
      ...
      if (r > 0)
        for (; s.nextSibling && s.nodeType == 1; )
          s = s.nextSibling;
      if (d = e.duplicate(), Xe(d, i), d.setEndPoint("StartToEnd", o), a -= d.text.replace(/\r\n|\n|\r/g, "").length, r > 0 && s.nodeType == 3)
        for (var w = s.previousSibling; w && w.nodeType == 3; )
          a -= w.nodeValue.length, w = w.previousSibling;
      return { node: s, offset: a };
    }
    function pn(e, t) {
      ...
      if (e.nodeType == 1 && e.childNodes.length > 0) {
        var i, c, s = e.childNodes;
        if (t === 0 ? (c = s[0], i = !0) : (c = s[t - 1], i = !1), !c)
          return o;
        if (v(c).name === "head")
          return t === 1 && (i = !0), t === 2 && (i = !1), o.collapse(i), o;
        if (c.nodeType == 1) {
          var a, r = v(c);
          return r.isControl() && (a = n.createElement("span"), i ? r.before(a) : r.after(a), c = a), Xe(o, c), o.collapse(i), a && v(a).remove(), o;
        }
        e = c, t = i ? 0 : c.nodeValue.length;
      }
    ...
    function hn(e) {
      ...
      if (be) {
        if (e.item)
          return n = Le(e.item(0)), o = new _e(n), o.selectNode(e.item(0)), o;
        n = e.parentElement().ownerDocument;
        var i = fn(e, !0), c = fn(e, !1);
        return t(i), t(c), o = new _e(n), o.setStart(i.node, i.offset), o.setEnd(c.node, c.offset), o;
      }
      var s = e.startContainer;
      return n = s.ownerDocument || s, o = new _e(n), o.setStart(s, e.startOffset), o.setEnd(e.endContainer, e.endOffset), o;
    }
    function _e(e) {
      this.init(e);
    }
    function Ot(e) {
      return e.nodeName ? new _e(e) : e.constructor === _e ? e : hn(e);
    }
    function Ee(e, t, n) {
      try {
        e.execCommand(t, !1, n);
    ...
    function Ut(e) {
      var t = Fe(e);
      return be ? e.selection : t.getSelection();
    }
    function oi(e) {
      var t, n = Ut(e);
      try {
      ...
      return !be || t && (t.item || t.parentElement().ownerDocument === e) ? t : null;
    }
    function gn(e) {
      var t, n, o = {};
      return z(e, function(i, c) {
        t = i.split(",");
    ...
    function vn(e, t, n) {
      ...
      if (!o[n])
        return !1;
      for (var i = o[n].split(","), c = 0, s = i.length; s > c; c++) {
        var a = i[c];
        if (a === "*")
          return !0;
    ...
    function Pt(e, t) {
      e.type == 1 && (yn(e, t, "*"), yn(e, t));
    }
    function yn(e, t, n) {
      if (n = n || e.name, e.type === 1) {
        var o = gn(t);
        if (o[n]) {
          for (var i = o[n].split(","), c = !1, s = 0, a = i.length; a > s; s++) {
            var r = i[s];
            if (r === "*") {
              c = !0;
              break;
    ...
    function li(e, t) {
      e = e.clone(!0);
      for (var n = jt(e), o = e, i = !1; t; ) {
        for (; o; )
          o.name === t.name && (si(o, t.attr(), t.css()), i = !0), o = o.first();
    ...
    function ci(e) {
      for (; e && e.name != "body"; ) {
        if (Yt[e.name] || e.name == "div" && e.hasClass("ke-script"))
          return !0;
        e = e.parent();
      }
      return !1;
    ...
    function kn(e, t) {
      if (e.nodeName) {
        var n = Le(e);
        e = Ot(n).selectNodeContents(n.body).collapse(!1);
      }
      return new Je(e, t);
    }
    function Ht(e) {
      var t = e.moveEl, n = e.moveFn, o = e.clickEl || t, i = e.beforeDrag, c = e.iframeFix === void 0 ? !0 : e.iframeFix, s = [document];
      c && v("iframe").each(function() {
        ...
        if (!/^https?:\/\//.test(a)) {
          ...
          if (r) {
            var d = v(this).pos();
            v(r).data("pos-x", d.x), v(r).data("pos-y", d.y), s.push(r);
          }
        }
      }), o.mousedown(function(a) {
        function r(b) {
          b.preventDefault();
          var _ = v(Le(b.target)), M = Ie((_.data("pos-x") || 0) + b.pageX - y), N = Ie((_.data("pos-y") || 0) + b.pageY - w);
          n.call(o, f, p, m, g, M, N);
        }
        function d(b) {
          b.preventDefault();
        }
        function u(b) {
          b.preventDefault(), v(s).unbind("mousemove", r).unbind("mouseup", u).unbind("selectstart", d), l.releaseCapture && l.releaseCapture();
        }
        if (a.button === 0 || a.button === 1) {
          a.stopPropagation();
          var l = o.get(), f = Z(t.css("left")), p = Z(t.css("top")), m = t.width(), g = t.height(), y = a.pageX, w = a.pageY;
          i && i(), v(s).mousemove(r).mouseup(u).bind("selectstart", d), l.setCapture && l.setCapture();
        }
      });
    }
    function De(e) {
    ...
    function ui(e, t, n, o) {
      ...
      return ee(n) || (n = [n]), z(n, function(c, s) {
        s && i.push('<link href="' + s + '" rel="stylesheet" />');
...
`);
    ...
    function pi(e) {
      var t = qt(e), n = t.remove, o = e.afterSelect, i = t.div, c = [];
      i.addClass("ke-tabs").bind("contextmenu,mousedown,mousemove", function(a) {
        a.preventDefault();
      });
      var s = v('<ul class="ke-tabs-ul ke-clearfix"></ul>');
      return i.append(s), t.add = function(a) {
        var r = v('<li class="ke-tabs-li">' + a.title + "</li>");
        r.data("tab", a), c.push(r), s.append(r);
      }, t.selectedIndex = 0, t.select = function(a) {
        t.selectedIndex = a, z(c, function(r, d) {
    ...
    function Kt(e, t) {
      var n = document.getElementsByTagName("head")[0] || (Ne ? document.body : document.documentElement), o = document.createElement("script");
    ...
    function Gt(e) {
      for (var t = document.getElementsByTagName("head")[0] || (Ne ? document.body : document.documentElement), n = document.createElement("link"), o = Tn(Ze(e, "absolute")), i = v('link[rel="stylesheet"]', t), c = 0, s = i.length; s > c; c++)
        if (Tn(Ze(i[c].href, "absolute")) === o)
          return;
    ...
    function hi(e, t, n, o, i) {
      ...
      if (c.open(n, e, !0), c.onreadystatechange = function() {
        if (c.readyState == 4 && c.status == 200 && t) {
          var a = te(c.responseText);
          i == "json" && (a = en(a)), t(a);
        }
      }, n == "POST") {
        var s = [];
    ...
    function Sn(e, t) {
      return e === void 0 ? Te : t ? void (Te[e] = t) : Te[e];
    }
    function En(e) {
      var t, n = "core";
    ...
    function Dn(e, t) {
      if (t = t === void 0 ? v.options.langType : t, typeof e == "string") {
        ...
        var n = e.length - 1;
        if (e.substr(n) === ".")
          return Se[t][e.substr(0, n)];
        var o = En(e);
        return Se[t][o.ns][o.key];
      }
      z(e, function(i, c) {
        var s = En(i);
        Se[t] || (Se[t] = {}), Se[t][s.ns] || (Se[t][s.ns] = {}), Se[t][s.ns][s.key] = c;
      });
    }
    function wt(e, t) {
      if (!e.collapsed) {
    ...
    function mi() {
      ...
      v(t).contextmenu(function(n) {
        ...
        if (e._contextmenus.length !== 0) {
          ...
          var c = null;
          if (z(i, function(u) {
            this.title == "-" && c.title == "-" && delete i[u], c = this;
          }), i.length > 0) {
            n.preventDefault();
            var s = v(e.edit.iframe).pos(), a = $t({ x: s.x + n.clientX, y: s.y + n.clientY, width: o, css: { visibility: "hidden" }, shadowMode: e.shadowMode });
            z(i, function() {
              this.title && a.addItem(this);
            });
            var r = ye(a.doc), d = a.div.height();
            n.clientY + d >= r.clientHeight - 100 && a.pos(a.x, Z(a.y) - d), a.div.css("visibility", "visible"), e.menu = a;
          }
        }
      });
    }
    function gi() {
      function e(s) {
        for (var a = v(s.commonAncestor()); a && (a.type != 1 || a.isStyle()); )
          a = a.parent();
        return a;
      }
      var t = this, n = t.edit.doc, o = t.newlineTag;
      if (!(Y && o !== "br" || Be && 3 > ce && o !== "p" || Qt && 9 > ce)) {
        var i = re("h1,h2,h3,h4,h5,h6,pre,li"), c = re("p,h1,h2,h3,h4,h5,h6,pre,li,blockquote");
        v(n).keydown(function(s) {
          if (!(s.which != 13 || s.shiftKey || s.ctrlKey || s.altKey)) {
            t.cmd.selection();
            var a = e(t.cmd.range), r = (v(a).prev(), v(a).parent(), a.name);
            if (r != "marquee" && r != "select")
              return o !== "br" || i[r] ? void (c[r] || Ee(n, "formatblock", "<p>")) : (s.preventDefault(), void t.insertHtml("<br />" + (Y && 9 > ce ? "" : "\u200B")));
          }
        }), v(n).keyup(function(s) {
          if (!(s.which != 13 || s.shiftKey || s.ctrlKey || s.altKey) && o != "br") {
            if (Be) {
            ...
            if (p == "blockquote" && m == "<br />") {
              s.preventDefault(), v(u).remove(), v(d).remove(), v(l).after("<p>\u200B</p>");
              var g = v(l).next();
              return t.cmd.range.selectNodeContents(g).collapse(!0), t.cmd.select(), void g.focus();
            }
            f != "marquee" && f != "select" && (c[f] || Ee(n, "formatblock", "<p>"));
          }
        });
      }
    }
    ...
    function Mn(e, t) {
      ...
      var n = e[e.length - 1];
      Me(t.html) !== Me(n.html) && e.push(t);
    }
    function Nn(e, t) {
      var n, o, i = this, c = i.edit, s = c.doc.body;
      if (e.length === 0)
        return i;
      c.designMode ? (n = i.cmd.range, o = n.createBookmark(!0), o.html = s.innerHTML) : o = { html: s.innerHTML }, Mn(t, o);
      var a = e.pop();
      return Me(o.html) === Me(a.html) && e.length > 0 && (a = e.pop()), c.designMode ? (c.html(a.html), a.start && (n.moveToBookmark(a), i.select())) : v(s).html(Me(a.html)), i;
    }
    function ot(e) {
      function t(i, c) {
        ot.prototype[i] === void 0 && (n[i] = c), n.options[i] = c;
      }
      var n = this;
      n.options = {}, z(e, function(i, c) {
        t(i, e[i]);
      }), z(v.options, function(i, c) {
        n[i] === void 0 && t(i, c);
      });
      var o = v(n.srcElement || "<textarea/>");
      n.width || (n.width = o[0].style.width || o.width()), n.height || (n.height = o[0].style.height || o.height()), t("width", V(n.width, n.minWidth)), t("height", V(n.height, n.minHeight)), t("width", J(n.width)), t("height", J(n.height)), wi && (!xi || 534 > ce) && (n.designMode = !1), n.srcElement = o, n.initContent = "", n.plugin = {}, n.isCreated = !1, n._handlers = {}, n._contextmenus = [], n._undoStack = [], n._redoStack = [], n._firstAddBookmark = !0, n.menu = n.contextmenu = null, n.dialogs = [];
    }
    function ki(e) {
      return new ot(e);
    }
    function In(e, t) {
      function n(s) {
        return z(Te, function(a, r) {
          ie(r) && (r.call(s, KindEditor), s._pluginStatus || (s._pluginStatus = {}), s._pluginStatus[a] = "inited");
        }), s.create();
      }
      if (t = t || {}, t.basePath = V(t.basePath, v.basePath), t.themesPath = V(t.themesPath, t.basePath + "themes/"), t.langPath = V(t.langPath, t.basePath + "lang/"), t.pluginsPath = V(t.pluginsPath, t.basePath + "plugins/"), V(t.loadStyleMode, v.options.loadStyleMode)) {
        ...
        Gt(t.themesPath + "default/default.css"), Gt(t.themesPath + o + "/" + o + ".css");
      }
      var i = v(e);
      if (i && i.length !== 0) {
        if (i.length > 1)
        ...
        t.srcElement = i[0];
        var c = new ot(t);
        return ut.push(c), Se[c.langType] ? n(c) : (Kt(c.langPath + c.langType + ".js?ver=" + encodeURIComponent(v.DEBUG ? _t : Ct), function() {
          n(c);
        }), c);
      }
    }
    function lt(e, t) {
      v(e).each(function(n, o) {
        v.each(ut, function(i, c) {
          return c && c.srcElement[0] == o ? (t.call(c, i), !1) : void 0;
        });
      });
    }
    (function(e) {
      ...
      var t = function() {
        function n(h) {
          return h == null ? String(h) : dt[Mt.call(h)] || "object";
        }
        function o(h) {
          return n(h) == "function";
        }
        ...
        function a(h) {
          return s(h) && !i(h) && Object.getPrototypeOf(h) == Object.prototype;
        }
        function r(h) {
          var k = !!h && "length" in h && h.length, S = T.type(h);
          return S != "function" && !i(h) && (S == "array" || k === 0 || typeof k == "number" && k > 0 && k - 1 in h);
        }
        function d(h) {
          return R.call(h, function(k) {
            return k != null;
          });
        }
        function u(h) {
        ...
        function f(h) {
          return h in j ? j[h] : j[h] = new RegExp("(^|\\s)" + h + "(\\s|$)");
        }
        function p(h, k) {
          return typeof k != "number" || W[l(h)] ? k : k + "px";
        }
        function m(h) {
          var k, S;
          return H[h] || (k = U.createElement(h), U.body.appendChild(k), S = getComputedStyle(k, "").getPropertyValue("display"), k.parentNode.removeChild(k), S == "none" && (S = "block"), H[h] = S), H[h];
        }
        function g(h) {
          return "children" in h ? O.call(h.children) : T.map(h.childNodes, function(k) {
            return k.nodeType == 1 ? k : void 0;
          });
        }
        function y(h, k) {
          var S, F = h ? h.length : 0;
          for (S = 0; F > S; S++)
            this[S] = h[S];
          this.length = F, this.selector = k || "";
        }
        function w(h, k, S) {
          for (E in k)
            S && (a(k[E]) || $e(k[E])) ? (a(k[E]) && !a(h[E]) && (h[E] = {}), $e(k[E]) && !$e(h[E]) && (h[E] = []), w(h[E], k[E], S)) : k[E] !== B && (h[E] = k[E]);
        }
        function b(h, k) {
          return k == null ? T(h) : T(h).filter(k);
        }
        function _(h, k, S, F) {
          return o(k) ? k.call(h, S, F) : k;
        }
        function M(h, k, S) {
          S == null ? h.removeAttribute(k) : h.setAttribute(k, S);
        }
        function N(h, k) {
          var S = h.className || "", F = S && S.baseVal !== B;
          return k === B ? F ? S.baseVal : S : void (F ? S.baseVal = k : h.className = k);
        }
        function A(h) {
          try {
        ...
        function P(h, k) {
          k(h);
          for (var S = 0, F = h.childNodes.length; F > S; S++)
            P(h.childNodes[S], k);
        }
        var B, E, T, x, C, D, I = [], L = I.concat, R = I.filter, O = I.slice, U = e.document, H = {}, j = {}, W = { "column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1 }, le = /^\s*<(\w+|!)[^>]*>/, K = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ge = /^(?:body|html)$/i, fe = /([A-Z])/g, ne = ["val", "css", "html", "text", "data", "width", "height", "offset"], xe = ["after", "prepend", "before", "append"], Q = U.createElement("table"), X = U.createElement("tr"), We = { tr: U.createElement("tbody"), tbody: Q, thead: Q, tfoot: Q, td: X, th: X, "*": U.createElement("div") }, Dt = /^[\w-]*$/, dt = {}, Mt = dt.toString, G = {}, qn = U.createElement("div"), Jt = { tabindex: "tabIndex", readonly: "readOnly", for: "htmlFor", class: "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable" }, $e = Array.isArray || function(h) {
        ...
        return G.matches = function(h, k) {
          ...
          if (S)
            return S.call(h, k);
          var F, $ = h.parentNode, q = !$;
          return q && ($ = qn).appendChild(h), F = ~G.qsa($, k).indexOf(h), q && qn.removeChild(h), F;
        }, C = function(h) {
          return h.replace(/-+(.)?/g, function(k, S) {
            return S ? S.toUpperCase() : "";
          });
        }, D = function(h) {
          return R.call(h, function(k, S) {
            return h.indexOf(k) == S;
          });
        }, G.fragment = function(h, k, S) {
          var F, $, q;
          return K.test(h) && (F = T(U.createElement(RegExp.$1))), F || (h.replace && (h = h.replace(ae, "<$1></$2>")), k === B && (k = le.test(h) && RegExp.$1), k in We || (k = "*"), q = We[k], q.innerHTML = "" + h, F = T.each(O.call(q.childNodes), function() {
            q.removeChild(this);
          })), a(S) && ($ = T(F), T.each(S, function(ve, pe) {
            ne.indexOf(ve) > -1 ? $[ve](pe) : $.attr(ve, pe);
          })), F;
        }, G.Z = function(h, k) {
          return new y(h, k);
        }, G.isZ = function(h) {
          ...
          if (!h)
            return G.Z();
          if (typeof h == "string")
            if (h = h.trim(), h[0] == "<" && le.test(h))
              S = G.fragment(h, RegExp.$1, k), h = null;
            else {
              if (k !== B)
                return T(k).find(h);
              S = G.qsa(U, h);
            ...
            if ($e(h))
              ...
              S = G.fragment(h.trim(), RegExp.$1, k), h = null;
            else {
              if (k !== B)
                return T(k).find(h);
              S = G.qsa(U, h);
          ...
          var k, S = O.call(arguments, 1);
          return typeof h == "boolean" && (k = h, h = S.shift()), S.forEach(function(F) {
            w(h, F, k);
          }), h;
        }, G.qsa = function(h, k) {
          var S, F = k[0] == "#", $ = !F && k[0] == ".", q = F || $ ? k.slice(1) : k, ve = Dt.test(q);
          return h.getElementById && ve && F ? (S = h.getElementById(q)) ? [S] : [] : h.nodeType !== 1 && h.nodeType !== 9 && h.nodeType !== 11 ? [] : O.call(ve && !F && h.getElementsByClassName ? $ ? h.getElementsByClassName(q) : h.getElementsByTagName(k) : h.querySelectorAll(k));
        }, T.contains = U.documentElement.contains ? function(h, k) {
          ...
          var k = Number(h), S = typeof h;
          return h != null && S != "boolean" && (S != "string" || h.length) && !isNaN(k) && isFinite(k) || !1;
        }, T.inArray = function(h, k, S) {
          return I.indexOf.call(k, h, S);
        }, T.camelCase = C, T.trim = function(h) {
          ...
          if (r(h))
            for (F = 0; F < h.length; F++)
              S = k(h[F], F), S != null && q.push(S);
          else
            for ($ in h)
              S = k(h[$], $), S != null && q.push(S);
          return u(q);
        }, T.each = function(h, k) {
          var S, F;
          if (r(h)) {
            for (S = 0; S < h.length; S++)
              if (k.call(h[S], S, h[S]) === !1)
                return h;
          } else
            for (F in h)
              if (k.call(h[F], F, h[F]) === !1)
                return h;
          return h;
        }, T.grep = function(h, k) {
          return R.call(h, k);
        }, e.JSON && (T.parseJSON = JSON.parse), T.each("Boolean Number String Function Array Date RegExp Object Error".split(" "), function(h, k) {
          dt["[object " + k + "]"] = k.toLowerCase();
        }), T.fn = { constructor: G.Z, length: 0, forEach: I.forEach, reduce: I.reduce, push: I.push, sort: I.sort, splice: I.splice, indexOf: I.indexOf, concat: function() {
          var h, k, S = [];
          for (h = 0; h < arguments.length; h++)
            k = arguments[h], S[h] = G.isZ(k) ? k.toArray() : k;
          return L.apply(G.isZ(this) ? this.toArray() : this, S);
        }, map: function(h) {
          return T(T.map(this, function(k, S) {
            return h.call(k, S, k);
          }));
        }, slice: function() {
          ...
          if (U.readyState === "complete" || U.readyState !== "loading" && !U.documentElement.doScroll)
            ...
            var k = function() {
              U.removeEventListener("DOMContentLoaded", k, !1), e.removeEventListener("load", k, !1), h(T);
            };
            U.addEventListener("DOMContentLoaded", k, !1), e.addEventListener("load", k, !1);
          }
          return this;
        }, get: function(h) {
          return h === B ? O.call(this) : this[h >= 0 ? h : h + this.length];
        }, toArray: function() {
          return this.get();
        }, size: function() {
          return this.length;
          ...
          return I.every.call(this, function(k, S) {
            return h.call(k, S, k) !== !1;
          }), this;
        }, filter: function(h) {
          return o(h) ? this.not(this.not(h)) : T(R.call(this, function(k) {
            return G.matches(k, h);
          }));
        }, add: function(h, k) {
          return T(D(this.concat(T(h, k))));
        }, is: function(h) {
          ...
          if (o(h) && h.call !== B)
            this.each(function(F) {
              h.call(this, F) || k.push(this);
            });
          else {
            var S = typeof h == "string" ? this.filter(h) : r(h) && o(h.item) ? O.call(h) : T(h);
            this.forEach(function(F) {
              S.indexOf(F) < 0 && k.push(F);
            });
          }
          return T(k);
        }, has: function(h) {
          return this.filter(function() {
            return s(h) ? T.contains(this, h) : T(this).find(h).size();
          });
        }, eq: function(h) {
          ...
          return h ? typeof h == "object" ? T(h).filter(function() {
            var S = this;
            return I.some.call(k, function(F) {
              return T.contains(F, S);
            });
          }) : this.length == 1 ? T(G.qsa(this[0], h)) : this.map(function() {
            return G.qsa(this, h);
          }) : T();
        }, closest: function(h, k) {
          var S = [], F = typeof h == "object" && T(h);
          return this.each(function($, q) {
            for (; q && !(F ? F.indexOf(q) >= 0 : G.matches(q, h)); )
              q = q !== k && !c(q) && q.parentNode;
            q && S.indexOf(q) < 0 && S.push(q);
          }), T(S);
        }, parents: function(h) {
          for (var k = [], S = this; S.length > 0; )
            S = T.map(S, function(F) {
              return (F = F.parentNode) && !c(F) && k.indexOf(F) < 0 ? (k.push(F), F) : void 0;
            });
          return b(k, h);
        }, parent: function(h) {
          return b(D(this.pluck("parentNode")), h);
        }, children: function(h) {
          ...
          return b(this.map(function(k, S) {
            return R.call(g(S.parentNode), function(F) {
              return F !== S;
            });
          }), h);
        }, empty: function() {
          ...
          var k = o(h);
          if (this[0] && !k)
            var S = T(h).get(0), F = S.parentNode || this.length > 1;
          return this.each(function($) {
            T(this).wrapAll(k ? h.call(this, $) : F ? S.cloneNode(!0) : S);
          });
        }, wrapAll: function(h) {
          if (this[0]) {
          ...
          return this.each(function(S) {
            var F = T(this), $ = F.contents(), q = k ? h.call(this, S) : h;
            $.length ? $.wrapAll(q) : F.append(q);
          });
        }, unwrap: function() {
          ...
          return this.each(function() {
            var k = T(this);
            (h === B ? k.css("display") == "none" : h) ? k.show() : k.hide();
          });
        }, prev: function(h) {
          ...
          return 0 in arguments ? this.each(function(k) {
            ...
            T(this).empty().append(_(this, h, k, S));
          }) : 0 in this ? this[0].innerHTML : null;
        }, text: function(h) {
          return 0 in arguments ? this.each(function(k) {
            var S = _(this, h, k, this.textContent);
            this.textContent = S == null ? "" : "" + S;
          }) : 0 in this ? this.pluck("textContent").join("") : null;
        }, attr: function(h, k) {
          var S;
          return typeof h != "string" || 1 in arguments ? this.each(function(F) {
            if (this.nodeType === 1)
              if (s(h))
                for (E in h)
                  M(this, E, h[E]);
              else
                M(this, h, _(this, k, F, this.getAttribute(h)));
          }) : 0 in this && this[0].nodeType == 1 && (S = this[0].getAttribute(h)) != null ? S : B;
          ...
          return h = Jt[h] || h, typeof h != "string" || 1 in arguments ? this.each(function(S) {
            if (s(h))
              for (E in h)
                this[Jt[E] || E] = h[E];
            else
              this[h] = _(this, k, S, this[h]);
          }) : this[0] && this[0][h];
        }, removeProp: function(h) {
          return h = Jt[h] || h, this.each(function() {
            delete this[h];
          });
        }, data: function(h, k) {
          var S = "data-" + h.replace(fe, "-$1").toLowerCase(), F = 1 in arguments ? this.attr(S, k) : this.attr(S);
          return F !== null ? A(F) : B;
        }, val: function(h) {
          return 0 in arguments ? (h == null && (h = ""), this.each(function(k) {
            this.value = _(this, h, k, this.value);
          ...
          if (h)
            return this.each(function(S) {
              var F = T(this), $ = _(this, h, S, F.offset()), q = F.offsetParent().offset(), ve = { top: $.top - q.top, left: $.left - q.left };
              F.css("position") == "static" && (ve.position = "relative"), F.css(ve);
            });
          if (!this.length)
            return null;
          ...
          if (arguments.length < 2) {
            var S = this[0];
            if (typeof h == "string")
              return S ? S.style[C(h)] || getComputedStyle(S, "").getPropertyValue(h) : void 0;
            if ($e(h)) {
              if (!S)
                return;
              var F = {}, $ = getComputedStyle(S, "");
              return T.each(h, function(ve, pe) {
                F[pe] = S.style[C(pe)] || $.getPropertyValue(pe);
              }), F;
            }
          }
          var q = "";
          if (n(h) == "string")
            k || k === 0 ? q = l(h) + ":" + p(h, k) : this.each(function() {
          ...
          return h ? I.some.call(this, function(k) {
          ...
          return h ? this.each(function(k) {
            if ("className" in this) {
              x = [];
              var S = N(this), F = _(this, h, k, S);
              F.split(/\s+/g).forEach(function($) {
                T(this).hasClass($) || x.push($);
              }, this), x.length && N(this, S + (S ? " " : "") + x.join(" "));
            }
          }) : this;
          ...
          return this.each(function(k) {
            if ("className" in this) {
              if (h === B)
                return N(this, "");
              x = N(this), _(this, h, k, x).split(/\s+/g).forEach(function(S) {
                x = x.replace(f(S), " ");
              }), N(this, x.trim());
            }
          });
          ...
          return h ? this.each(function(S) {
            var F = T(this), $ = _(this, h, S, N(this));
            $.split(/\s+/g).forEach(function(q) {
              (k === B ? !F.hasClass(q) : k) ? F.addClass(q) : F.removeClass(q);
            });
          }) : this;
        }, scrollTop: function(h) {
          if (this.length) {
            var k = "scrollTop" in this[0];
            return h === B ? k ? this[0].scrollTop : this[0].pageYOffset : this.each(k ? function() {
              this.scrollTop = h;
            } : function() {
          ...
          if (this.length) {
            ...
            return h === B ? k ? this[0].scrollLeft : this[0].pageXOffset : this.each(k ? function() {
              this.scrollLeft = h;
            } : function() {
          ...
          if (this.length) {
            var h = this[0], k = this.offsetParent(), S = this.offset(), F = ge.test(k[0].nodeName) ? { top: 0, left: 0 } : k.offset();
            return S.top -= parseFloat(T(h).css("margin-top")) || 0, S.left -= parseFloat(T(h).css("margin-left")) || 0, F.top += parseFloat(T(k[0]).css("border-top-width")) || 0, F.left += parseFloat(T(k[0]).css("border-left-width")) || 0, { top: S.top - F.top, left: S.left - F.left };
          }
        }, offsetParent: function() {
          return this.map(function() {
            for (var h = this.offsetParent || U.body; h && !ge.test(h.nodeName) && T(h).css("position") == "static"; )
              h = h.offsetParent;
            return h;
          });
        } }, T.fn.detach = T.fn.remove, ["width", "height"].forEach(function(h) {
          var k = h.replace(/./, function(S) {
            return S[0].toUpperCase();
          });
          T.fn[h] = function(S) {
            var F, $ = this[0];
            return S === B ? i($) ? $["inner" + k] : c($) ? $.documentElement["scroll" + k] : (F = this.offset()) && F[h] : this.each(function(q) {
              $ = T(this), $.css(h, _(this, S, q, $[h]()));
            });
          };
        }), xe.forEach(function(h, k) {
          var S = k % 2;
          T.fn[h] = function() {
            var F, $, q = T.map(arguments, function(pe) {
              var ue = [];
              return F = n(pe), F == "array" ? (pe.forEach(function(Ue) {
                return Ue.nodeType !== B ? ue.push(Ue) : T.zepto.isZ(Ue) ? ue = ue.concat(Ue.get()) : void (ue = ue.concat(G.fragment(Ue)));
              }), ue) : F == "object" || pe == null ? pe : G.fragment(pe);
            }), ve = this.length > 1;
            return q.length < 1 ? this : this.each(function(pe, ue) {
              $ = S ? ue : ue.parentNode, ue = k == 0 ? ue.nextSibling : k == 1 ? ue.firstChild : k == 2 ? ue : null;
              var Ue = T.contains(U.documentElement, $);
              q.forEach(function(ft) {
                if (ve)
                  ft = ft.cloneNode(!0);
                else if (!$)
                  return T(ft).remove();
                $.insertBefore(ft, ue), Ue && P(ft, function(Ae) {
                  if (!(Ae.nodeName == null || Ae.nodeName.toUpperCase() !== "SCRIPT" || Ae.type && Ae.type !== "text/javascript" || Ae.src)) {
                    var Wn = Ae.ownerDocument ? Ae.ownerDocument.defaultView : e;
                    Wn.eval.call(Wn, Ae.innerHTML);
                  }
                });
              });
            });
          }, T.fn[S ? h + "To" : "insert" + (k ? "Before" : "After")] = function(F) {
            return T(F)[h](this), this;
          };
        }), G.Z.prototype = y.prototype = T.fn, G.uniq = D, G.deserializeValue = A, T.zepto = G, T;
      }();
      return e.Zepto = t, e.$ === void 0 && (e.$ = t), function(n) {
        function o(x) {
          return x._zid || (x._zid = m++);
        }
        function i(x, C, D, I) {
          if (C = c(C), C.ns)
            var L = s(C.ns);
          return (b[o(x)] || []).filter(function(R) {
            return R && (!C.e || R.e == C.e) && (!C.ns || L.test(R.ns)) && (!D || o(R.fn) === o(D)) && (!I || R.sel == I);
          });
        }
        function c(x) {
          var C = ("" + x).split(".");
        ...
        function a(x, C) {
          return x.del && !M && x.e in N || !!C;
        }
        function r(x) {
          return A[x] || M && N[x] || x;
        }
        function d(x, C, D, I, L, R, O) {
          var U = o(x), H = b[U] || (b[U] = []);
          C.split(/\s/).forEach(function(j) {
            if (j == "ready")
              return n(document).ready(D);
            var W = c(j);
            W.fn = D, W.sel = L, W.e in A && (D = function(K) {
              var ae = K.relatedTarget;
              return !ae || ae !== this && !n.contains(this, ae) ? W.fn.apply(this, arguments) : void 0;
            }), W.del = R;
            var le = R || D;
            W.proxy = function(K) {
              if (K = l(K), !K.isImmediatePropagationStopped()) {
                K.data = I;
                var ae = le.apply(x, K._args == p ? [K] : [K].concat(K._args));
                return ae === !1 && (K.preventDefault(), K.stopPropagation()), ae;
              }
            }, W.i = H.length, H.push(W), "addEventListener" in x && x.addEventListener(r(W.e), W.proxy, a(W, O));
          });
        }
        function u(x, C, D, I, L) {
          var R = o(x);
          (C || "").split(/\s/).forEach(function(O) {
            i(x, O, D, I).forEach(function(U) {
              delete b[R][U.i], "removeEventListener" in x && x.removeEventListener(r(U.e), U.proxy, a(U, L));
            });
          });
        }
        function l(x, C) {
          if (C || !x.isDefaultPrevented) {
            C || (C = x), n.each(T, function(D, I) {
              var L = C[D];
              x[D] = function() {
                return this[I] = P, L && L.apply(C, arguments);
              }, x[I] = B;
            });
            try {
              x.timeStamp || (x.timeStamp = Date.now());
            } catch {
            }
            (C.defaultPrevented !== p ? C.defaultPrevented : "returnValue" in C ? C.returnValue === !1 : C.getPreventDefault && C.getPreventDefault()) && (x.isDefaultPrevented = P);
          }
          return x;
        }
        function f(x) {
          var C, D = { originalEvent: x };
          for (C in x)
            E.test(C) || x[C] === p || (D[C] = x[C]);
          return l(D, x);
        }
        var p, m = 1, g = Array.prototype.slice, y = n.isFunction, w = function(x) {
          return typeof x == "string";
        }, b = {}, _ = {}, M = "onfocusin" in e, N = { focus: "focusin", blur: "focusout" }, A = { mouseenter: "mouseover", mouseleave: "mouseout" };
        _.click = _.mousedown = _.mouseup = _.mousemove = "MouseEvents", n.event = { add: d, remove: u }, n.proxy = function(x, C) {
          var D = 2 in arguments && g.call(arguments, 2);
          if (y(x)) {
            var I = function() {
              return x.apply(C, D ? D.concat(g.call(arguments)) : arguments);
            };
            return I._zid = o(x), I;
          }
          if (w(C))
            return D ? (D.unshift(x[C], x), n.proxy.apply(null, D)) : n.proxy(x[C], x);
          throw new TypeError("expected function");
        }, n.fn.bind = function(x, C, D) {
          return this.on(x, C, D);
        }, n.fn.unbind = function(x, C) {
          return this.off(x, C);
        }, n.fn.one = function(x, C, D, I) {
          return this.on(x, C, D, I, 1);
        };
        var P = function() {
          return !0;
        }, B = function() {
        ...
        n.fn.delegate = function(x, C, D) {
          return this.on(C, x, D);
        }, n.fn.undelegate = function(x, C, D) {
          return this.off(C, x, D);
        }, n.fn.live = function(x, C) {
          return n(document.body).delegate(this.selector, x, C), this;
        }, n.fn.die = function(x, C) {
          return n(document.body).undelegate(this.selector, x, C), this;
        }, n.fn.on = function(x, C, D, I, L) {
          var R, O, U = this;
          return x && !w(x) ? (n.each(x, function(H, j) {
            U.on(H, C, D, j, L);
          }), U) : (w(C) || y(I) || I === !1 || (I = D, D = C, C = p), (I === p || D === !1) && (I = D, D = p), I === !1 && (I = B), U.each(function(H, j) {
            L && (R = function(W) {
              return u(j, W.type, I), I.apply(this, arguments);
            }), C && (O = function(W) {
              var le, K = n(W.target).closest(C, j).get(0);
              return K && K !== j ? (le = n.extend(f(W), { currentTarget: K, liveFired: j }), (R || I).apply(K, [le].concat(g.call(arguments, 1)))) : void 0;
            }), d(j, x, I, D, C, O || R);
          }));
        }, n.fn.off = function(x, C, D) {
          var I = this;
          return x && !w(x) ? (n.each(x, function(L, R) {
            I.off(L, C, R);
          }), I) : (w(C) || y(D) || D === !1 || (D = C, C = p), D === !1 && (D = B), I.each(function() {
            u(this, x, D, C);
          }));
        }, n.fn.trigger = function(x, C) {
          return x = w(x) || n.isPlainObject(x) ? n.Event(x) : l(x), x._args = C, this.each(function() {
            x.type in N && typeof this[x.type] == "function" ? this[x.type]() : "dispatchEvent" in this ? this.dispatchEvent(x) : n(this).triggerHandler(x, C);
          });
        }, n.fn.triggerHandler = function(x, C) {
          var D, I;
          return this.each(function(L, R) {
            D = f(w(x) ? n.Event(x) : x), D._args = C, D.target = R, n.each(i(R, x.type || x), function(O, U) {
              return I = U.proxy(D), D.isImmediatePropagationStopped() ? !1 : void 0;
            });
          }), I;
        }, "focusin focusout focus blur load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select keydown keypress keyup error".split(" ").forEach(function(x) {
          n.fn[x] = function(C) {
            return 0 in arguments ? this.bind(x, C) : this.trigger(x);
          };
        }), n.Event = function(x, C) {
          w(x) || (C = x, x = C.type);
          var D = document.createEvent(_[x] || "Events"), I = !0;
          if (C)
            for (var L in C)
              L == "bubbles" ? I = !!C[L] : D[L] = C[L];
          return D.initEvent(x, I, !0), l(D);
        };
      }(t), function(n) {
        function o(c) {
          var s = [["resolve", "done", n.Callbacks({ once: 1, memory: 1 }), "resolved"], ["reject", "fail", n.Callbacks({ once: 1, memory: 1 }), "rejected"], ["notify", "progress", n.Callbacks({ memory: 1 })]], a = "pending", r = { state: function() {
            return a;
          }, always: function() {
              ...
              n.each(s, function(f, p) {
                ...
                d[p[1]](function() {
                  ...
                  if (g && n.isFunction(g.promise))
                    ...
                    var y = this === r ? l.promise() : this, w = m ? [g] : arguments;
                    l[p[0] + "With"](y, w);
                  }
                });
              }), u = null;
            ...
            return u != null ? n.extend(u, r) : r;
          } }, d = {};
          return n.each(s, function(u, l) {
            var f = l[2], p = l[3];
            r[l[1]] = f.add, p && f.add(function() {
              a = p;
            }, s[1 ^ u][2].disable, s[2][2].lock), d[l[0]] = function() {
              return d[l[0] + "With"](this === d ? r : this, arguments), this;
            }, d[l[0] + "With"] = f.fireWith;
          }), r.promise(d), c && c.call(d, d), d;
        }
        var i = Array.prototype.slice;
        n.when = function(c) {
          var s, a, r, d = i.call(arguments), u = d.length, l = 0, f = u !== 1 || c && n.isFunction(c.promise) ? u : 0, p = f === 1 ? c : o(), m = function(g, y, w) {
            return function(b) {
              y[g] = this, w[g] = arguments.length > 1 ? i.call(arguments) : b, w === s ? p.notifyWith(y, w) : --f || p.resolveWith(y, w);
            };
          };
          if (u > 1)
            for (s = new Array(u), a = new Array(u), r = new Array(u); u > l; ++l)
              d[l] && n.isFunction(d[l].promise) ? d[l].promise().done(m(l, r, d)).fail(p.reject).progress(m(l, a, s)) : --f;
          return f || p.resolveWith(r, d), p.promise();
        }, n.Deferred = o;
      }(t), function(n) {
        n.Callbacks = function(o) {
          o = n.extend({}, o);
          var i, c, s, a, r, d, u = [], l = !o.once && [], f = function(m) {
            for (i = o.memory && m, c = !0, d = a || 0, a = 0, r = u.length, s = !0; u && r > d; ++d)
              if (u[d].apply(m[0], m[1]) === !1 && o.stopOnFalse) {
                i = !1;
                break;
              }
            s = !1, u && (l ? l.length && f(l.shift()) : i ? u.length = 0 : p.disable());
          }, p = { add: function() {
            if (u) {
              var m = u.length, g = function(y) {
                n.each(y, function(w, b) {
                  typeof b == "function" ? o.unique && p.has(b) || u.push(b) : b && b.length && typeof b != "string" && g(b);
                });
              };
              g(arguments), s ? r = u.length : i && (a = m, f(i));
            }
            return this;
          }, remove: function() {
            return u && n.each(arguments, function(m, g) {
              for (var y; (y = n.inArray(g, u, y)) > -1; )
                u.splice(y, 1), s && (r >= y && --r, d >= y && --d);
            }), this;
          }, has: function(m) {
            return !(!u || !(m ? n.inArray(m, u) > -1 : u.length));
          }, empty: function() {
            return r = u.length = 0, this;
          }, disable: function() {
            return u = l = i = void 0, this;
          }, disabled: function() {
            return !u;
          }, lock: function() {
            ...
            return !u || c && !l || (g = g || [], g = [m, g.slice ? g.slice() : g], s ? l.push(g) : f(g)), this;
          }, fire: function() {
      ...
      var n, o = {}, i = function(u, l) {
        ...
        var p, m = { exports: l };
        typeof l == "function" && (f.length || (f = [i, m.exports, m]), p = l.apply(null, f), p !== void 0 && (m.exports = p)), o[u] = m.exports;
      }, a = function(u) {
        var l = o[u] || e[u];
        if (!l)
      ...
      return t("dollar-third", [], function() {
        ...
        return { version: "0.1.8-alpha", $: o, Deferred: i.Deferred, isPromise: i.isPromise, when: i.when, browser: function(u) {
          var l = {}, f = u.match(/WebKit\/([\d.]+)/), p = u.match(/Chrome\/([\d.]+)/) || u.match(/CriOS\/([\d.]+)/), m = u.match(/MSIE\s([\d\.]+)/) || u.match(/(?:trident)(?:.*rv:([\w.]+))?/i), g = u.match(/Firefox\/([\d.]+)/), y = u.match(/Safari\/([\d.]+)/), w = u.match(/OPR\/([\d.]+)/);
          return f && (l.webkit = parseFloat(f[1])), p && (l.chrome = parseFloat(p[1])), m && (l.ie = parseFloat(m[1])), g && (l.firefox = parseFloat(g[1])), y && (l.safari = parseFloat(y[1])), w && (l.opera = parseFloat(w[1])), l;
        ...
        }, noop: r, bindFn: s, log: function() {
          return e.console ? s(console.log, console) : r;
        }(), nextTick: function() {
          return function(u) {
            setTimeout(u, 1);
          };
        ...
        var a, r = o.$, d = [].slice, u = /\s+/;
        return a = { on: function(l, f, p) {
          var m, g = this;
          return f ? (m = this._events || (this._events = []), c(l, f, function(y, w) {
            var b = { e: y };
            b.cb = w, b.ctx = p, b.ctx2 = p || g, b.id = m.length, m.push(b);
          }), this) : this;
        }, once: function(l, f, p) {
          var m = this;
          return f && c(l, f, function(g, y) {
            var w = function() {
              return m.off(g, w), y.apply(p || m, arguments);
            };
            w._cb = y, m.on(g, w, p);
          }), m;
        }, off: function(l, f, p) {
          var m = this._events;
          return m ? l || f || p ? (c(l, f, function(g, y) {
            r.each(i(m, g, y, p), function() {
              delete m[this.id];
            });
          }), this) : (this._events = [], this) : this;
        }, trigger: function(l) {
          var f, p, m;
          return this._events && l ? (f = d.call(arguments, 1), p = i(this._events, l), m = i(this._events, "all"), s(p, f) && s(m, arguments)) : this;
        } }, r.extend({ installTo: function(l) {
          return r.extend(l, a);
        } }, a);
      }), t("uploader", ["base", "mediator"], function(o, i) {
        function c(a) {
          this.options = s.extend(!0, {}, c.options, a), this._init(this.options);
        }
        var s = o.$;
        return c.options = {}, i.installTo(c.prototype), s.each({ upload: "start-upload", stop: "stop-upload", getFile: "get-file", getFiles: "get-files", addFile: "add-file", addFiles: "add-file", sort: "sort-files", removeFile: "remove-file", cancelFile: "cancel-file", skipFile: "skip-file", retry: "retry", isInProgress: "is-in-progress", makeThumb: "make-thumb", md5File: "md5-file", getDimension: "get-dimension", addButton: "add-btn", predictRuntimeType: "predict-runtime-type", refresh: "refresh", disable: "disable", enable: "enable", reset: "reset" }, function(a, r) {
          c.prototype[a] = function() {
            return this.request(r, arguments);
          };
        }), s.extend(c.prototype, { state: "pending", _init: function(a) {
          var r = this;
          ...
          var d = this.options;
          return arguments.length > 1 ? void (s.isPlainObject(r) && s.isPlainObject(d[a]) ? s.extend(d[a], r) : d[a] = r) : a ? d[a] : d;
        }, getStats: function() {
          ...
          var r = [].slice.call(arguments, 1), d = this.options, u = "on" + a.substring(0, 1).toUpperCase() + a.substring(1);
          return !(i.trigger.apply(this, arguments) === !1 || s.isFunction(d[u]) && d[u].apply(this, r) === !1 || s.isFunction(this[u]) && this[u].apply(this, r) === !1 || i.trigger.apply(i, [this, a].concat(r)) === !1);
        }, destroy: function() {
          this.request("destroy", arguments), this.off();
        }, request: o.noop }), o.create = c.create = function(a) {
          return new c(a);
        }, o.Uploader = c, c;
      }), t("runtime/runtime", ["base", "mediator"], function(o, i) {
        function c(d) {
          this.options = s.extend({ container: document.body }, d), this.uid = o.guid("rt_");
        }
        var s = o.$, a = {}, r = function(d) {
          for (var u in d)
            if (d.hasOwnProperty(u))
              return u;
          return null;
        };
        return s.extend(c.prototype, { getContainer: function() {
          var d, u, l = this.options;
          return this._container ? this._container : (d = s(l.container || document.body), u = s(document.createElement("div")), u.attr("id", "rt_" + this.uid), u.css({ position: "absolute", top: "0px", left: "0px", width: "1px", height: "1px", overflow: "hidden", cursor: "pointer", lineHeight: "0" }), d.append(u), d.addClass("webuploader-container"), this._container = u, this._parent = d, u);
        ...
        } }), c.orders = "html5,flash", c.addRuntime = function(d, u) {
          a[d] = u;
        }, c.hasRuntime = function(d) {
          return !!(d ? a[d] : r(a));
        }, c.create = function(d, u) {
          var l;
          if (u = u || c.orders, s.each(u.split(/\s*,\s*/g), function() {
            return a[this] ? (l = this, !1) : void 0;
          }), l = l || r(a), !l)
            throw new Error("Runtime Error");
          return new a[l](d);
        }, i.installTo(c.prototype), c;
      }), t("runtime/client", ["base", "mediator", "runtime/runtime"], function(o, i, c) {
        function s(r, d) {
          var u, l = o.Deferred();
          this.uid = o.guid("client_"), this.runtimeReady = function(f) {
            ...
            return l.done(p), typeof f == "string" && a.get(f) && (u = a.get(f)), u = u || a.get(null, d), u ? (o.$.extend(u.options, f), u.__promise.then(l.resolve), u.__client++) : (u = c.create(f, f.runtimeOrder), u.__promise = l.promise(), u.once("ready", l.resolve), u.init(), a.add(u), u.__client = 1), d && (u.__standalone = d), u;
            ...
            if (u) {
              ...
              return r && f.unshift(r), u.exec.apply(this, f);
            }
        ...
        return a = function() {
          ...
          return { add: function(d) {
            ...
            if (d)
              return r[d];
            for (l in r)
              if (!u || !r[l].__standalone)
                return r[l];
            return null;
          }, remove: function(d) {
            delete r[d.uid];
          } };
        }(), i.installTo(s.prototype), s;
      }), t("lib/dnd", ["base", "mediator", "runtime/client"], function(o, i, c) {
        function s(r) {
          r = this.options = a.extend({}, s.options, r), r.container = a(r.container), r.container.length && c.call(this, "DragAndDrop");
        }
        var a = o.$;
        return s.options = { accept: null, disableGlobalDnd: !1 }, o.inherits(c, { constructor: s, init: function() {
          var r = this;
        ...
        var a = o.$, r = i.prototype._init, d = i.prototype.destroy, u = {}, l = [];
        return a.extend(s.prototype, { init: o.noop, invoke: function(f, p) {
          ...
          var g, y, w, b, _ = 0, M = this._widgets, N = M && M.length, A = [], P = [];
          for (p = c(p) ? p : [p]; N > _; _++)
            g = M[_], y = g.invoke(f, p), y !== u && (o.isPromise(y) ? P.push(y) : A.push(y));
          return m || P.length ? (w = o.when.apply(o, P), b = w.pipe ? "pipe" : "then", w[b](function() {
            var B = o.Deferred(), E = arguments;
            return E.length === 1 && (E = E[0]), setTimeout(function() {
              B.resolve(E);
            }, 1), B.promise();
          })[m ? b : "done"](m || o.noop)) : A[0];
        }, destroy: function() {
          d.apply(this, arguments), this._widgets = null;
        } }), i.register = s.register = function(f, p) {
          ...
          })) : g = a.extend(g, f), p.responseMap = g, m = o.inherits(s, p), m._name = g.name, l.push(m), m;
        }, i.unRegister = s.unRegister = function(f) {
          if (f && f !== "anonymous")
            for (var p = l.length; p--; )
              l[p]._name === f && l.splice(p, 1);
        }, s;
      }), t("widgets/filednd", ["base", "uploader", "lib/dnd", "widgets/widget"], function(o, i, c) {
        var s = o.$;
        return i.options.dnd = "", i.register({ name: "dnd", init: function(a) {
          if (a.dnd && this.request("predict-runtime-type") === "html5") {
            var r, d = this, u = o.Deferred(), l = s.extend({}, { disableGlobalDnd: a.disableGlobalDnd, container: a.dnd, accept: a.accept });
            return this.dnd = r = new c(l), r.once("ready", u.resolve), r.on("drop", function(f) {
      ...
      }), t("lib/filepaste", ["base", "mediator", "runtime/client"], function(o, i, c) {
        function s(r) {
          r = this.options = a.extend({}, r), r.container = a(r.container || document.body), c.call(this, "FilePaste");
        }
        var a = o.$;
        return o.inherits(c, { constructor: s, init: function() {
          var r = this;
          r.connectRuntime(r.options, function() {
            r.exec("init"), r.trigger("ready");
          });
        } }), i.installTo(s.prototype), s;
      }), t("widgets/filepaste", ["base", "uploader", "lib/filepaste", "widgets/widget"], function(o, i, c) {
        var s = o.$;
        return i.register({ name: "paste", init: function(a) {
          if (a.paste && this.request("predict-runtime-type") === "html5") {
            var r, d = this, u = o.Deferred(), l = s.extend({}, { container: a.paste, accept: a.accept });
            return this.paste = r = new c(l), r.once("ready", u.resolve), r.on("paste", function(f) {
        ...
        function c(s, a) {
          var r = this;
          r.source = a, r.ruid = s, this.size = a.size || 0, this.type = !a.type && this.ext && ~"jpg,jpeg,png,gif,bmp".indexOf(this.ext) ? "image/" + (this.ext === "jpg" ? "jpeg" : this.ext) : a.type || "application/octet-stream", i.call(r, "Blob"), this.uid = a.uid || this.uid, s && r.connectRuntime(s);
        }
        return o.inherits(i, { constructor: c, slice: function(s, a) {
          return this.exec("slice", s, a);
        }, getSource: function() {
          return this.source;
        } }), c;
        ...
        function c(r, d) {
          var u;
          this.name = d.name || "untitled" + s++, u = a.exec(d.name) ? RegExp.$1.toLowerCase() : "", !u && d.type && (u = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(d.type) ? RegExp.$1.toLowerCase() : "", this.name += "." + u), this.ext = u, this.lastModifiedDate = d.lastModifiedDate || d.lastModified && new Date(d.lastModified).toLocaleString() || new Date().toLocaleString(), i.apply(this, arguments);
        }
        var s = 1, a = /\.([^.]+)$/;
        return o.inherits(i, c);
      }), t("lib/filepicker", ["base", "runtime/client", "lib/file"], function(o, i, c) {
        function s(r) {
          if (r = this.options = a.extend({}, s.options, r), r.container = a(r.id), !r.container.length)
        ...
        var a = o.$;
        return s.options = { button: null, container: null, label: null, innerHTML: null, multiple: !0, accept: null, name: "file", style: "webuploader-pick" }, o.inherits(i, { constructor: s, init: function() {
          var r = this, d = r.options, u = d.button, l = d.style;
          l && u.addClass("webuploader-pick"), r.on("all", function(f) {
            var p;
            switch (f) {
              case "mouseenter":
              ...
              case "change":
                p = r.exec("getFiles"), r.trigger("select", a.map(p, function(m) {
                  return m = new c(r.getRuid(), m), m._refer = d.container, m;
                }), d.container);
            }
          ...
          var r = this.getRuntime().getContainer(), d = this.options.button, u = d[0] && d[0].offsetWidth || d.outerWidth() || d.width(), l = d[0] && d[0].offsetHeight || d.outerHeight() || d.height(), f = d.offset();
          u && l && r.css({ bottom: "auto", right: "auto", width: u + "px", height: l + "px" }).offset(f);
        }, enable: function() {
      ...
      }), t("widgets/filepicker", ["base", "uploader", "lib/filepicker", "widgets/widget"], function(o, i, c) {
        var s = o.$;
        return s.extend(i.options, { pick: null, accept: null }), i.register({ name: "picker", init: function(a) {
          ...
          var r = this, d = r.options, u = d.accept, l = [];
          return a ? (s.isPlainObject(a) || (a = { id: a }), s(a.id).each(function() {
            var f, p, m;
            m = o.Deferred(), f = s.extend({}, a, { accept: s.isPlainObject(u) ? [u] : u, swf: d.swf, runtimeOrder: d.runtimeOrder, id: this }), p = new c(f), p.once("ready", m.resolve), p.on("select", function(g) {
      ...
      }), t("lib/image", ["base", "runtime/client", "lib/blob"], function(o, i, c) {
        function s(r) {
          this.options = a.extend({}, s.options, r), i.call(this, "Image"), this.on("load", function() {
            this._info = this.exec("info"), this._meta = this.exec("meta");
          });
        }
        var a = o.$;
        return s.options = { quality: 90, crop: !1, preserveHeaders: !1, allowMagnify: !1 }, o.inherits(i, { constructor: s, info: function(r) {
          return r ? (this._info = r, this) : this._info;
        }, meta: function(r) {
          return r ? (this._meta = r, this) : this._meta;
        }, loadFromBlob: function(r) {
          var d = this, u = r.getRuid();
          ...
          return new c(this.getRuid(), d);
        } }), s;
      }), t("widgets/image", ["base", "uploader", "lib/image", "widgets/widget"], function(o, i, c) {
        var s, a = o.$;
        return s = function(r) {
          var d = 0, u = [], l = function() {
            for (var f; u.length && r > d; )
              f = u.shift(), d += f[0], f[1]();
          };
        ...
        }(5242880), a.extend(i.options, { thumb: { width: 110, height: 110, quality: 70, allowMagnify: !0, crop: !0, preserveHeaders: !1, type: "image/jpeg" }, compress: { width: 1600, height: 1600, quality: 90, allowMagnify: !1, crop: !1, preserveHeaders: !0 } }), i.register({ name: "image", makeThumb: function(r, d, u, l) {
          var f, p;
          return r = this.request("get-file", r), r.type.match(/^image/) ? (f = a.extend({}, this.options.thumb), a.isPlainObject(u) && (f = a.extend(f, u), u = null), u = u || f.width, l = l || f.height, p = new c(f), p.once("load", function() {
            r._info = r._info || p.info(), r._meta = r._meta || p.meta(), 1 >= u && u > 0 && (u = r._info.width * u), 1 >= l && l > 0 && (l = r._info.height * l), p.resize(u, l);
          }), p.once("complete", function() {
            d(!1, p.getAsDataUrl(f.type)), p.destroy();
          }), p.once("error", function(m) {
            d(m || !0), p.destroy();
          }), void s(p, r.source.size, function() {
          ...
          return r = this.request("get-file", r), !l || !~"image/jpeg,image/jpg".indexOf(r.type) || r.size < f || r._compressed ? void 0 : (l = a.extend({}, l), u = o.Deferred(), d = new c(l), u.always(function() {
            d.destroy(), d = null;
            ...
            var m, g;
            try {
              m = d.getAsBlob(l.type), g = r.size, (!p || m.size < g) && (r.source = m, r.size = m.size, r.trigger("resize", m.size, g)), r._compressed = !0, u.resolve();
            } catch {
              u.resolve();
            }
          }), r._info && d.info(r._info), r._meta && d.meta(r._meta), d.loadFromBlob(r.source), u.promise());
        } });
        ...
        function s(f) {
          this.name = f.name || "Untitled", this.size = f.size || 0, this.type = f.type || "application/octet-stream", this.lastModifiedDate = f.lastModifiedDate || 1 * new Date(), this.id = c(), this.ext = u.exec(this.name) ? RegExp.$1 : "", this.statusText = "", l[this.id] = s.Status.INITED, this.source = f, this.loaded = 0, this.on("error", function(p) {
            this.setStatus(s.Status.ERROR, p);
          });
        }
        var a = o.$, r = "WU_FILE_", d = 0, u = /\.([^.]+)$/, l = {};
        return a.extend(s.prototype, { setStatus: function(f, p) {
          var m = l[this.id];
        ...
        } }), i.installTo(s.prototype), s.Status = { INITED: "inited", QUEUED: "queued", PROGRESS: "progress", ERROR: "error", COMPLETE: "complete", CANCELLED: "cancelled", INTERRUPT: "interrupt", INVALID: "invalid" }, s;
      }), t("queue", ["base", "mediator", "file"], function(o, i, c) {
        function s() {
        ...
        var a = o.$, r = c.Status;
        return a.extend(s.prototype, { append: function(d) {
      ...
      }), t("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"], function(o, i, c, s, a, r) {
        var d = o.$, u = /\.\w+$/, l = s.Status;
        return i.register({ name: "queue", init: function(f) {
          var p, m, g, y, w, b, _, M = this;
          if (d.isPlainObject(f.accept) && (f.accept = [f.accept]), f.accept) {
            for (w = [], g = 0, m = f.accept.length; m > g; g++)
              y = f.accept[g].extensions, y && w.push(y);
            w.length && (b = "\\." + w.join(",").replace(/,/g, "$|\\.").replace(/\*/g, ".*") + "$"), M.accept = new RegExp(b, "i");
          }
          return M.queue = new c(), M.stats = M.queue.stats, this.request("predict-runtime-type") === "html5" ? (p = o.Deferred(), this.placeholder = _ = new r("Placeholder"), _.connectRuntime({ runtimeOrder: "html5" }, function() {
            M._ruid = _.getRuid(), p.resolve();
          }), p.promise()) : void 0;
          ...
          var m, g, y, w = this;
          if (f)
            return f = f.id ? f : w.queue.getFile(f), f.setStatus(l.QUEUED), void (p || w.request("start-upload"));
          for (m = w.queue.getFiles(l.ERROR), g = 0, y = m.length; y > g; g++)
            f = m[g], f.setStatus(l.QUEUED);
          w.request("start-upload");
        }, sortFiles: function() {
        ...
        return o.support = function() {
          ...
          var c, s, a = this.options.runtimeOrder || i.orders, r = this.type;
          if (!r) {
            for (a = a.split(/\s*,\s*/g), c = 0, s = a.length; s > c; c++)
              if (i.hasRuntime(a[c])) {
                this.type = r = a[c];
                break;
              }
      ...
      }), t("lib/transport", ["base", "runtime/client", "mediator"], function(o, i, c) {
        function s(r) {
          var d = this;
          r = d.options = a.extend(!0, {}, s.options, r || {}), i.call(this, "Transport"), this._blob = null, this._formData = r.formData || {}, this._headers = r.headers || {}, this.on("progress", this._timeout), this.on("load error", function() {
            d.trigger("progress", 1), clearTimeout(d._timer);
          });
        }
        var a = o.$;
        return s.options = { server: "", method: "POST", withCredentials: !1, fileVal: "file", timeout: 12e4, formData: {}, headers: {}, sendAsBinary: !1 }, a.extend(s.prototype, { appendBlob: function(r, d, u) {
          var l = this, f = l.options;
          l.getRuid() && l.disconnectRuntime(), l.connectRuntime(d.ruid, function() {
            l.exec("init");
          }), l._blob = d, f.fileVal = r || f.fileVal, f.filename = u || f.filename;
        }, append: function(r, d) {
        ...
        } }), c.installTo(s.prototype), s;
      }), t("widgets/upload", ["base", "uploader", "file", "lib/transport", "widgets/widget"], function(o, i, c, s) {
        function a(l, f) {
          var p, m, g = [], y = l.source, w = y.size, b = f ? Math.ceil(w / f) : 1, _ = 0, M = 0;
          for (m = { file: l, has: function() {
            ...
            p = Math.min(f, w - _), g.push({ file: l, start: _, end: f ? _ + p : w, total: w, chunks: b, chunk: M++, cuted: m }), _ += p;
          return l.blocks = g.concat(), l.remaning = g.length, m;
        }
        var r = o.$, d = o.isPromise, u = c.Status;
        r.extend(i.options, { prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, chunkRetryDelay: 1e3, threads: 3, formData: {} }), i.register({ name: "upload", init: function() {
          ...
          var f = this;
          if (r.each(f.request("get-files", u.INVALID), function() {
            f.request("remove-file", this);
          }), l ? (l = l.id ? l : f.request("get-file", l), l.getStatus() === u.INTERRUPT ? (l.setStatus(u.QUEUED), r.each(f.pool, function(m, g) {
            g.file === l && (g.transport && g.transport.send(), l.setStatus(u.PROGRESS));
          })) : l.getStatus() !== u.PROGRESS && l.setStatus(u.QUEUED)) : r.each(f.request("get-files", [u.INITED]), function() {
          ...
          }), l || r.each(f.request("get-files", u.INTERRUPT), function() {
            this.setStatus(u.PROGRESS);
          ...
          if (l === !0 && (f = l, l = null), p.runing !== !1) {
            if (l)
              return l = l.id ? l : p.request("get-file", l), l.getStatus() !== u.PROGRESS && l.getStatus() !== u.QUEUED ? void 0 : (l.setStatus(u.INTERRUPT), r.each(p.pool, function(m, g) {
                g.file === l && (g.transport && g.transport.abort(), f && (p._putback(g), p._popBlock(g)));
              }), p.owner.trigger("stopUpload", l), o.nextTick(p.__tick));
            p.runing = !1, this._promise && this._promise.file && this._promise.file.setStatus(u.INTERRUPT), f && r.each(p.pool, function(m, g) {
          ...
          l = l.id ? l : this.request("get-file", l), l.setStatus(f || u.COMPLETE), l.skipped = !0, l.blocks && r.each(l.blocks, function(p, m) {
            var g = m.transport;
          ...
          return (l = this._getStack()) ? (y.prepareNextFile && !g.pending.length && g._prepareNextFile(), l.shift()) : g.runing ? (!g.pending.length && g._getStats().numOfQueue && g._prepareNextFile(), f = g.pending.shift(), p = function(w) {
            return w ? (l = a(w, y.chunked ? y.chunkSize : 0), g.stack.push(l), l.shift()) : null;
          ...
          var f, p, m = this, g = m.owner, y = r.extend({}, m.options, l.options), w = l.file, b = new s(y), _ = r.extend({}, y.formData), M = r.extend({}, y.headers);
          l.transport = b, b.on("destroy", function() {
            delete l.transport, m._popBlock(l), o.nextTick(m.__tick);
          }), b.on("progress", function(N) {
            l.percentage = N, m.updateFileProgress(w);
          }), f = function(N) {
            var A;
            return p = b.getResponseAsJson() || {}, p._raw = b.getResponse(), p._headers = b.getResponseHeaders(), l.response = p, A = function(P) {
              N = P;
            }, g.trigger("uploadAccept", l, p, A) || (N = N || "server"), N;
          }, b.on("error", function(N, A) {
            var P, B, E = N.split("|");
            N = E[0], P = parseFloat(E[1]), B = E[2], l.retried = l.retried || 0, l.chunks > 1 && ~"http,abort,server".indexOf(N.replace(/-.*/, "")) && l.retried < y.chunkRetry ? (l.retried++, m.retryTimer = setTimeout(function() {
              b.send();
            }, y.chunkRetryDelay || 1e3)) : (A || N !== "server" || (N = f(N)), w.setStatus(u.ERROR, N), g.trigger("uploadError", w, N, P, B), g.trigger("uploadComplete", w));
          }), b.on("load", function() {
            var N;
            return (N = f()) ? void b.trigger("error", N, !0) : void (w.remaning === 1 ? m._finishFile(w, p) : b.destroy());
          }), _ = r.extend(_, { id: w.id, name: w.name, type: w.type, lastModifiedDate: w.lastModifiedDate, size: w.size }), l.chunks > 1 && r.extend(_, { chunks: l.chunks, chunk: l.chunk }), g.trigger("uploadBeforeSend", l, _, M), b.appendBlob(y.fileVal, l.blob, w.name), b.append(_), b.setRequestHeader(M), b.send();
      ...
      }), t("widgets/validator", ["base", "uploader", "file", "widgets/widget"], function(o, i, c) {
        var s, a = o.$, r = {};
        return s = { addValidator: function(d, u) {
          r[d] = u;
          ...
          l && d.on("beforeFileQueued", function(f) {
            return f.size > l ? (f.setStatus(c.Status.INVALID, "exceed_size"), this.trigger("error", "F_EXCEED_SIZE", l, f), !1) : void 0;
          });
        }), s.addValidator("duplicate", function() {
          function d(p) {
            for (var m, g = 0, y = 0, w = p.length; w > y; y++)
        ...
        return o;
      }), t("runtime/html5/runtime", ["base", "runtime/runtime", "runtime/compbase"], function(o, i, c) {
        function s() {
          var d = {}, u = this, l = this.destroy;
          i.apply(u, arguments), u.type = a, u.exec = function(f, p) {
            var m, g = this, y = g.uid, w = o.slice(arguments, 2);
            return r[f] && (m = d[y] = d[y] || new r[f](g, u), m[p]) ? m[p].apply(m, w) : void 0;
          }, u.destroy = function() {
            return l && l.apply(this, arguments);
          };
        }
        var a = "html5", r = {};
        return o.inherits(i, { constructor: s, init: function() {
          var d = this;
          setTimeout(function() {
            d.trigger("ready");
          }, 1);
        } }), s.register = function(d, u) {
          var l = r[d] = o.inherits(c, u);
          return l;
        }, e.Blob && e.FileReader && e.DataView && i.addRuntime(a, s), s;
      }), t("runtime/html5/blob", ["runtime/html5/runtime", "lib/blob"], function(o, i) {
        return o.register("Blob", { slice: function(c, s) {
          var a = this.owner.source, r = a.slice || a.webkitSlice || a.mozSlice;
          return a = r.call(a, c, s), new i(this.getRuid(), a);
        } });
      }), t("runtime/html5/dnd", ["base", "runtime/html5/runtime", "lib/file"], function(o, i, c) {
        var s = o.$, a = "webuploader-dnd-";
        return i.register("DragAndDrop", { init: function() {
          var r = this.elem = this.options.container;
          this.dragEnterHandler = o.bindFn(this._dragEnterHandler, this), this.dragOverHandler = o.bindFn(this._dragOverHandler, this), this.dragLeaveHandler = o.bindFn(this._dragLeaveHandler, this), this.dropHandler = o.bindFn(this._dropHandler, this), this.dndOver = !1, r.on("dragenter", this.dragEnterHandler), r.on("dragover", this.dragOverHandler), r.on("dragleave", this.dragLeaveHandler), r.on("drop", this.dropHandler), this.options.disableGlobalDnd && (s(document).on("dragover", this.dragOverHandler), s(document).on("drop", this.dropHandler));
        }, _dragEnterHandler: function(r) {
          var d, u = this, l = u._denied || !1;
          return r = r.originalEvent || r, u.dndOver || (u.dndOver = !0, d = r.dataTransfer.items, d && d.length && (u._denied = l = !u.trigger("accept", d)), u.elem.addClass(a + "over"), u.elem[l ? "addClass" : "removeClass"](a + "denied")), r.dataTransfer.dropEffect = l ? "none" : "copy", !1;
        }, _dragOverHandler: function(r) {
          var d = this.elem.parent().get(0);
          return d && !s.contains(d, r.currentTarget) || (clearTimeout(this._leaveTimer), this._dragEnterHandler.call(this, r)), !1;
          ...
          if (p && !s.contains(p, r.currentTarget))
            return !1;
          ...
          return l.dndOver = !1, l.elem.removeClass(a + "over"), d && !u ? (l._getTansferFiles(d, function(m) {
            l.trigger("drop", s.map(m, function(g) {
              return new c(f, g);
            }));
          }), !1) : void 0;
        }, _getTansferFiles: function(r, d) {
          var u, l, f, p, m, g, y, w = [], b = [];
          for (u = r.items, l = r.files, y = !(!u || !u[0].webkitGetAsEntry), m = 0, g = l.length; g > m; m++)
            f = l[m], p = u && u[m], y && p.webkitGetAsEntry().isDirectory ? b.push(this._traverseDirectoryTree(p.webkitGetAsEntry(), w)) : w.push(f);
          o.when.apply(o, b).done(function() {
            w.length && d(w);
          });
          ...
          var r = this.elem;
          r && (r.off("dragenter", this.dragEnterHandler), r.off("dragover", this.dragOverHandler), r.off("dragleave", this.dragLeaveHandler), r.off("drop", this.dropHandler), this.options.disableGlobalDnd && (s(document).off("dragover", this.dragOverHandler), s(document).off("drop", this.dropHandler)));
        } });
      }), t("runtime/html5/filepaste", ["base", "runtime/html5/runtime", "lib/file"], function(o, i, c) {
        return i.register("FilePaste", { init: function() {
          var s, a, r, d, u = this.options, l = this.elem = u.container, f = ".*";
          if (u.accept) {
            for (s = [], a = 0, r = u.accept.length; r > a; a++)
              d = u.accept[a].mimeTypes, d && s.push(d);
            s.length && (f = s.join(","), f = f.replace(/,/g, "|").replace(/\*/g, ".*"));
          }
          this.accept = f = new RegExp(f, "i"), this.hander = o.bindFn(this._pasteHander, this), l.on("paste", this.hander);
        }, _pasteHander: function(s) {
          var a, r, d, u, l, f = [], p = this.getRuid();
          for (s = s.originalEvent || s, a = s.clipboardData.items, u = 0, l = a.length; l > u; u++)
            r = a[u], r.kind === "file" && (d = r.getAsFile()) && f.push(new c(p, d));
          f.length && (s.preventDefault(), s.stopPropagation(), this.trigger("paste", f));
        }, destroy: function() {
        ...
        return i.register("FilePicker", { init: function() {
          var s, a, r, d, u, l = this.getRuntime().getContainer(), f = this, p = f.owner, m = f.options, g = this.label = c(document.createElement("label")), y = this.input = c(document.createElement("input"));
          if (y.attr("type", "file"), y.attr("capture", "camera"), y.attr("name", m.name), y.addClass("webuploader-element-invisible"), g.on("click", function(w) {
            y.trigger("click"), w.stopPropagation(), p.trigger("dialogopen");
            ...
            for (s = [], a = 0, r = m.accept.length; r > a; a++)
              s.push(m.accept[a].mimeTypes);
            y.attr("accept", s.join(","));
          }
          l.append(y), l.append(g), d = function(w) {
            p.trigger(w.type);
          }, u = function(w) {
            var b;
            return w.target.files.length === 0 ? !1 : (f.files = w.target.files, b = this.cloneNode(!0), b.value = null, this.parentNode.replaceChild(b, this), y.off(), y = c(b).on("change", u).on("mouseenter mouseleave", d), void p.trigger("change"));
        ...
        var i = e.createObjectURL && e || e.URL && URL.revokeObjectURL && URL || e.webkitURL, c = o.noop, s = c;
        return i && (c = function() {
          return i.createObjectURL.apply(i, arguments);
        }, s = function() {
          return i.revokeObjectURL.apply(i, arguments);
        }), { createObjectURL: c, revokeObjectURL: s, dataURL2Blob: function(a) {
          var r, d, u, l, f, p;
          for (p = a.split(","), r = ~p[0].indexOf("base64") ? atob(p[1]) : decodeURIComponent(p[1]), u = new ArrayBuffer(r.length), d = new Uint8Array(u), l = 0; l < r.length; l++)
            d[l] = r.charCodeAt(l);
          return f = p[0].split(":")[1].split(";")[0], this.arrayBufferToBlob(u, f);
        }, dataURL2ArrayBuffer: function(a) {
          var r, d, u, l;
          for (l = a.split(","), r = ~l[0].indexOf("base64") ? atob(l[1]) : decodeURIComponent(l[1]), d = new Uint8Array(r.length), u = 0; u < r.length; u++)
            d[u] = r.charCodeAt(u);
          return d.buffer;
        }, arrayBufferToBlob: function(a, r) {
          var d, u = e.BlobBuilder || e.WebKitBlobBuilder;
          return u ? (d = new u(), d.append(a), d.getBlob(r)) : new Blob([a], r ? { type: r } : {});
        ...
        var i;
        return i = { parsers: { 65505: [] }, maxMetaDataSize: 262144, parse: function(c, s) {
          var a = this, r = new FileReader();
          r.onload = function() {
            s(!1, a._parse(this.result)), r = r.onload = r.onerror = null;
          }, r.onerror = function(d) {
            s(d.message), r = r.onload = r.onerror = null;
          }, c = c.slice(0, a.maxMetaDataSize), r.readAsArrayBuffer(c.getSource());
        }, _parse: function(c, s) {
          if (!(c.byteLength < 6)) {
            var a, r, d, u, l = new DataView(c), f = 2, p = l.byteLength - 4, m = f, g = {};
            if (l.getUint16(0) === 65496) {
              for (; p > f && (a = l.getUint16(f), a >= 65504 && 65519 >= a || a === 65534) && (r = l.getUint16(f + 2) + 2, !(f + r > l.byteLength)); ) {
                if (d = i.parsers[a], !s && d)
                  for (u = 0; u < d.length; u += 1)
                    d[u].call(i, l, f, r, g);
                f += r, m = f;
              }
              m > 6 && (g.imageHead = c.slice ? c.slice(2, m) : new Uint8Array(c).subarray(2, m));
            }
            return g;
          }
        }, updateImageHead: function(c, s) {
          var a, r, d, u = this._parse(c, !0);
          return d = 2, u.imageHead && (d = 2 + u.imageHead.byteLength), r = c.slice ? c.slice(d) : new Uint8Array(c).subarray(d), a = new Uint8Array(s.byteLength + 2 + r.byteLength), a[0] = 255, a[1] = 216, a.set(new Uint8Array(s), 2), a.set(new Uint8Array(r), s.byteLength + 2), a.buffer;
        ...
        return c.ExifMap = function() {
          return this;
        }, c.ExifMap.prototype.map = { Orientation: 274 }, c.ExifMap.prototype.get = function(s) {
          return this[s] || this[this.map[s]];
        }, c.exifTagTypes = { 1: { getValue: function(s, a) {
          return s.getUint8(a);
        }, size: 1 }, 2: { getValue: function(s, a) {
          return String.fromCharCode(s.getUint8(a));
        }, size: 1, ascii: !0 }, 3: { getValue: function(s, a, r) {
          return s.getUint16(a, r);
        }, size: 2 }, 4: { getValue: function(s, a, r) {
          return s.getUint32(a, r);
        }, size: 4 }, 5: { getValue: function(s, a, r) {
          return s.getUint32(a, r) / s.getUint32(a + 4, r);
        }, size: 8 }, 9: { getValue: function(s, a, r) {
          return s.getInt32(a, r);
        }, size: 4 }, 10: { getValue: function(s, a, r) {
          return s.getInt32(a, r) / s.getInt32(a + 4, r);
        }, size: 8 } }, c.exifTagTypes[7] = c.exifTagTypes[1], c.getExifValue = function(s, a, r, d, u, l) {
          var f, p, m, g, y, w, b = c.exifTagTypes[d];
          if (!b)
            return void o.log("Invalid Exif data: Invalid tag type.");
          if (f = b.size * u, p = f > 4 ? a + s.getUint32(r + 8, l) : r + 8, p + f > s.byteLength)
            return void o.log("Invalid Exif data: Invalid data offset.");
          if (u === 1)
            return b.getValue(s, p, l);
          for (m = [], g = 0; u > g; g += 1)
            m[g] = b.getValue(s, p + g * b.size, l);
          if (b.ascii) {
            for (y = "", g = 0; g < m.length && (w = m[g], w !== "\0"); g += 1)
              y += w;
            return y;
          }
          return m;
        }, c.parseExifTag = function(s, a, r, d, u) {
          var l = s.getUint16(r, d);
          u.exif[l] = c.getExifValue(s, a, r, s.getUint16(r + 2, d), s.getUint32(r + 4, d), d);
        }, c.parseExifTags = function(s, a, r, d, u) {
          var l, f, p;
          if (r + 6 > s.byteLength)
            return void o.log("Invalid Exif data: Invalid directory offset.");
          if (l = s.getUint16(r, d), f = r + 2 + 12 * l, f + 4 > s.byteLength)
            return void o.log("Invalid Exif data: Invalid directory size.");
          for (p = 0; l > p; p += 1)
            this.parseExifTag(s, a, r + 2 + 12 * p, d, u);
          return s.getUint32(f, d);
        }, c.parseExifData = function(s, a, r, d) {
          var u, l, f = a + 10;
          if (s.getUint32(a + 4) === 1165519206) {
            if (f + 8 > s.byteLength)
              return void o.log("Invalid Exif data: Invalid segment size.");
            if (s.getUint16(a + 8) !== 0)
              return void o.log("Invalid Exif data: Missing byte alignment offset.");
            switch (s.getUint16(f)) {
              case 18761:
                u = !0;
                break;
              case 19789:
            ...
            if (s.getUint16(f + 2, u) !== 42)
              return void o.log("Invalid Exif data: Missing TIFF marker.");
            l = s.getUint32(f + 4, u), d.exif = new c.ExifMap(), l = c.parseExifTags(s, f, f + l, u, d);
          }
        }, i.parsers[65505].push(c.parseExifData), c;
      }), t("runtime/html5/image", ["base", "runtime/html5/runtime", "runtime/html5/util"], function(o, i, c) {
        var s = "data:image/gif;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs%3D";
        return i.register("Image", { modified: !1, init: function() {
          var a = this, r = new Image();
          r.onload = function() {
            a._info = { type: a.type, width: this.width, height: this.height }, a._metas || a.type !== "image/jpeg" ? a.owner.trigger("load") : c.parseMeta(a._blob, function(d, u) {
          ...
          var r = this, d = r._img;
          r._blob = a, r.type = a.type, d.src = c.createObjectURL(a.getSource()), r.owner.once("load", function() {
        ...
        }, crop: function(a, r, d, u, l) {
          var f = this._canvas || (this._canvas = document.createElement("canvas")), p = this.options, m = this._img, g = m.naturalWidth, y = m.naturalHeight, w = this.getOrientation();
          l = l || 1, f.width = d, f.height = u, p.preserveHeaders || this._rotate2Orientaion(f, w), this._renderImageToCanvas(f, m, -a, -r, g * l, y * l), this._blob = null, this.modified = !0, this.owner.trigger("complete", "crop");
        }, getAsBlob: function(a) {
          var r, d = this._blob, u = this.options;
          if (a = a || this.type, this.modified || this.type !== a) {
            if (r = this._canvas, a === "image/jpeg") {
              if (d = c.canvasToDataUrl(r, a, u.quality), u.preserveHeaders && this._metas && this._metas.imageHead)
                return d = c.dataURL2ArrayBuffer(d), d = c.updateImageHead(d, this._metas.imageHead), d = c.arrayBufferToBlob(d, a);
            } else
              d = c.canvasToDataUrl(r, a);
            d = c.dataURL2Blob(d);
          }
          return d;
        }, getAsDataUrl: function(a) {
          var r = this.options;
          return a = a || this.type, a === "image/jpeg" ? c.canvasToDataUrl(this._canvas, a, r.quality) : this._canvas.toDataURL(a);
          ...
          var a = this._canvas;
          this._img.onload = null, a && (a.getContext("2d").clearRect(0, 0, a.width, a.height), a.width = a.height = 0, this._canvas = null), this._img.src = s, this._img = this._blob = null;
        }, _resize: function(a, r, d, u) {
          var l, f, p, m, g, y = this.options, w = a.width, b = a.height, _ = this.getOrientation();
          ~[5, 6, 7, 8].indexOf(_) && (d ^= u, u ^= d, d ^= u), l = Math[y.crop ? "max" : "min"](d / w, u / b), y.allowMagnify || (l = Math.min(1, l)), f = w * l, p = b * l, y.crop ? (r.width = d, r.height = u) : (r.width = f, r.height = p), m = (r.width - f) / 2, g = (r.height - p) / 2, y.preserveHeaders || this._rotate2Orientaion(r, _), this._renderImageToCanvas(r, a, m, g, f, p);
          ...
          function a(d, u, l) {
            var f, p, m, g = document.createElement("canvas"), y = g.getContext("2d"), w = 0, b = l, _ = l;
            for (g.width = 1, g.height = l, y.drawImage(d, 0, 0), f = y.getImageData(0, 0, 1, l).data; _ > w; )
              p = f[4 * (_ - 1) + 3], p === 0 ? b = _ : w = _, _ = b + w >> 1;
          ...
          return o.os.ios ? o.os.ios >= 7 ? function(d, u, l, f, p, m) {
            var g = u.naturalWidth, y = u.naturalHeight, w = a(u, g, y);
            return d.getContext("2d").drawImage(u, 0, 0, g * w, y * w, l, f, p, m);
          } : function(d, u, l, f, p, m) {
            var g, y, w, b, _, M, N, A = u.naturalWidth, P = u.naturalHeight, B = d.getContext("2d"), E = r(u), T = this.type === "image/jpeg", x = 1024, C = 0, D = 0;
            for (E && (A /= 2, P /= 2), B.save(), g = document.createElement("canvas"), g.width = g.height = x, y = g.getContext("2d"), w = T ? a(u, A, P) : 1, b = Math.ceil(x * p / A), _ = Math.ceil(x * m / P / w); P > C; ) {
              for (M = 0, N = 0; A > M; )
                y.clearRect(0, 0, x, x), y.drawImage(u, -M, -C), B.drawImage(g, 0, 0, x, x, l + N, f + D, b, _), M += x, N += b;
              C += x, D += _;
            }
            B.restore(), g = y = null;
          } : function(d) {
        ...
        return i.register("Transport", { init: function() {
          ...
          var a, r, d, u = this.owner, l = this.options, f = this._initAjax(), p = u._blob, m = l.server;
          l.sendAsBinary ? (m += l.attachInfoToQuery !== !1 ? (/\?/.test(m) ? "&" : "?") + s.param(u._formData) : "", r = p.getSource()) : (a = new FormData(), s.each(u._formData, function(g, y) {
            a.append(g, y);
          ...
          return !d.withCredentials || "withCredentials" in r || typeof XDomainRequest > "u" || (r = new XDomainRequest()), r.upload.onprogress = function(u) {
            var l = 0;
            return u.lengthComputable && (l = u.loaded / u.total), a.trigger("progress", l);
          }, r.onreadystatechange = function() {
            if (r.readyState === 4) {
              r.upload.onprogress = c, r.onreadystatechange = c, a._xhr = null, a._status = r.status;
              var u = "|", l = u + r.status + u + r.statusText;
    ...
    var Ei = "altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which".split(",");
    me(tn, { init: function(e, t) {
      var n = this, o = e.ownerDocument || e.document || e;
      if (n.event = t, z(Ei, function(s, a) {
        n[a] = t[a];
        ...
        var i = o.documentElement, c = o.body;
        n.pageX = n.clientX + (i && i.scrollLeft || c && c.scrollLeft || 0) - (i && i.clientLeft || c && c.clientLeft || 0), n.pageY = n.clientY + (i && i.scrollTop || c && c.scrollTop || 0) - (i && i.clientTop || c && c.clientTop || 0);
      }
    ...
    var St = "kindeditor_" + _t, zn = 0, oe = {}, Pn = !1;
    window.attachEvent && window.attachEvent("onunload", function() {
      z(oe, function(e, t) {
        t.el && Ye(t.el);
      });
    }), v.ctrl = At, v.ready = Yn, v.formatUrl = Ze, v.formatHtml = Re, v.getCssList = Pe, v.getAttrList = we, v.mediaType = ln, v.mediaAttrs = an, v.mediaEmbed = Rt, v.mediaImg = sn, v.clearMsWord = on, v.tmpl = ei;
    var jn = document.createElement("div");
    jn.setAttribute("className", "t");
    var Di = jn.className !== "t";
    v.query = ti, v.queryAll = kt, me(de, { init: function(e) {
      var t = this;
      e = ee(e) ? e : [e];
      for (var n = 0, o = 0, i = e.length; i > o; o++)
        e[o] && (t[o] = e[o].constructor === de ? e[o][0] : e[o], n++);
      t.length = n, t.doc = Le(t[0]), t.name = cn(t[0]), t.type = t.length > 0 ? t[0].nodeType : null, t.win = Fe(t[0]);
    }, each: function(e) {
      ...
      return this.length < 1 ? this : (rn(this[0], e), this);
    }, hasAttr: function(e) {
      ...
      return this.length < 1 ? !1 : Lt(this[0], e);
    }, addClass: function(e) {
      return this.each(function() {
        Lt(this, e) || (this.className = te(this.className + " " + e));
      }), this;
    }, removeClass: function(e) {
      return this.each(function() {
        Lt(this, e) && (this.className = te(this.className.replace(new RegExp("(^|\\s)" + e + "(\\s|$)"), " ")));
      }), this;
    }, html: function(e) {
      var t = this;
      return e === void 0 ? t.length < 1 || t.type != 1 ? "" : Re(t[0].innerHTML) : (t.each(function() {
        ni(this, e);
      }), t);
    }, text: function() {
      var e = this;
      return e.length < 1 ? "" : Y ? e[0].innerText : e[0].textContent;
    }, hasVal: function() {
      return this.length < 1 ? !1 : un(this[0]);
    }, val: function(e) {
      var t = this;
      return e === void 0 ? t.length < 1 ? "" : t.hasVal() ? t[0].value : t.attr("value") : (t.each(function() {
        un(this) ? this.value = e : Ft(this, "value", e);
      }), t);
    }, css: function(e, t) {
      var n = this;
      return e === void 0 ? Pe(n.attr("style")) : typeof e == "object" ? (z(e, function(o, i) {
        n.css(o, i);
      }), n) : t === void 0 ? n.length < 1 ? "" : n[0].style[Qe(e)] || ri(n[0], e) || "" : (n.each(function() {
        this.style[Qe(e)] = t;
      }), n);
    }, width: function(e) {
      var t = this;
      ...
      if (t)
        if (t.getBoundingClientRect) {
          var i = t.getBoundingClientRect(), c = je(e.doc);
          n = i.left + c.x, o = i.top + c.y;
        } else
          for (; t; )
            n += t.offsetLeft, o += t.offsetTop, t = t.offsetParent;
      return { x: Ie(n), y: Ie(o) };
    }, clone: function(e) {
      return new de(this.length < 1 ? [] : this[0].cloneNode(e));
    }, append: function(e) {
      return this.each(function() {
        this.appendChild && this.appendChild(Ce(e));
      }), this;
    }, appendTo: function(e) {
      return this.each(function() {
        Ce(e).appendChild(this);
      }), this;
    }, before: function(e) {
      return this.each(function() {
        this.parentNode.insertBefore(Ce(e), this);
      }), this;
    }, after: function(e) {
      return this.each(function() {
        this.nextSibling ? this.parentNode.insertBefore(Ce(e), this.nextSibling) : this.parentNode.appendChild(Ce(e));
      }), this;
        ...
        if (o.parentNode) {
          if (Ye(o), e)
            for (var i = o.firstChild; i; ) {
              var c = i.nextSibling;
              o.parentNode.insertBefore(i, o), i = c;
            }
      ...
      return n.appendChild(e[0].cloneNode(!0)), t = Re(n.innerHTML), n = null, t;
    }, isSingle: function() {
      return !!Fn[this.name];
    }, isInline: function() {
      return !!Rn[this.name];
      ...
      return this.length < 1 ? !1 : vt(this[0], Ce(e));
    }, parent: function() {
      if (this.length < 1)
        return null;
      ...
      function n(o) {
        for (var i = t ? o.firstChild : o.lastChild; i; ) {
          var c = t ? i.nextSibling : i.previousSibling;
          if (e(i) === !1 || n(i) === !1)
            return !1;
          i = c;
        }
      ...
      if (e != null) {
        if (typeof e == "string") {
          ...
          if (e.charAt(0) === "@" && (e = e.substr(1)), e.length !== o || /<.+>/.test(e)) {
            var i = t ? t.ownerDocument || t : document, c = i.createElement("div"), s = [];
            c.innerHTML = '<img id="__kindeditor_temp_tag__" width="0" height="0" style="display:none;" />' + e;
            for (var a = 0, r = c.childNodes.length; r > a; a++) {
              var d = c.childNodes[a];
              d.id != "__kindeditor_temp_tag__" && s.push(d);
            }
            return n(s);
          }
          return n(kt(e, t));
        }
        return e && e.constructor === de ? e : (e.toArray && (e = e.toArray()), n(ee(e) ? e : Nt(arguments)));
      }
    }, z(Mi, function(e, t) {
      v[e] = t;
    }), v.NodeClass = de, window.KindEditor = v;
    var at = 0, st = 1, qe = 2, ct = 3, Hn = 0;
    me(_e, { init: function(e) {
      var t = this;
      ...
      for (var t, n, o = e(this.startContainer), i = e(this.endContainer), c = 0, s = o.length, a = i.length; ++c && (t = o[s - c], n = i[a - c], t && n && t === n); )
        ;
      return o[s - c + 1];
    }, setStart: function(e, t) {
      var n = this, o = n.doc;
      return n.startContainer = e, n.startOffset = t, n.endContainer === o && (n.endContainer = e, n.endOffset = t), dn(this);
    }, setEnd: function(e, t) {
      var n = this, o = n.doc;
      return n.endContainer = e, n.endOffset = t, n.startContainer === o && (n.startContainer = e, n.startOffset = t), dn(this);
      ...
      var i = {};
      i[at] = "StartToStart", i[st] = "EndToStart", i[qe] = "EndToEnd", i[ct] = "StartToEnd";
      var c = n.compareEndPoints(i[e], o);
      if (c !== 0)
        return c;
      var s, a, r, d, u;
      if ((e === at || e === ct) && (s = this.startContainer, d = this.startOffset), (e === st || e === qe) && (s = this.endContainer, d = this.endOffset), (e === at || e === st) && (a = t.startContainer, u = t.startOffset), (e === qe || e === ct) && (a = t.endContainer, u = t.endOffset), s === a) {
        var l = d - u;
        return l > 0 ? 1 : 0 > l ? -1 : 0;
      }
      for (r = a; r && r.parentNode !== s; )
        r = r.parentNode;
      if (r)
        return v(r).index() >= d ? -1 : 1;
      for (r = s; r && r.parentNode !== a; )
        r = r.parentNode;
      return r ? v(r).index() >= u ? 1 : -1 : (r = v(a).next(), r && r.contains(s) ? 1 : (r = v(s).next(), r && r.contains(a) ? -1 : void 0));
    }, cloneRange: function() {
      return new _e(this.doc).setStart(this.startContainer, this.startOffset).setEnd(this.endContainer, this.endOffset);
    }, toString: function() {
      var e = this.get(), t = be ? e.text : e.toString();
      return t.replace(/\r\n|\n|\r/g, "");
      ...
      var t, n, o, i = this, c = i.startContainer, s = i.startOffset, a = i.endContainer, r = i.endOffset, d = 1;
      return e.nodeName.toLowerCase() === "#document-fragment" && (t = e.firstChild, n = e.lastChild, d = e.childNodes.length), c.nodeType == 1 ? (o = c.childNodes[s], o ? (c.insertBefore(e, o), c === a && (r += d)) : c.appendChild(e)) : c.nodeType == 3 && (s === 0 ? (c.parentNode.insertBefore(e, c), c.parentNode === a && (r += d)) : s >= c.nodeValue.length ? c.nextSibling ? c.parentNode.insertBefore(e, c.nextSibling) : c.parentNode.appendChild(e) : (o = s > 0 ? c.splitText(s) : c, c.parentNode.insertBefore(e, o), c === a && (a = o, r -= s))), t ? i.setStartBefore(t).setEndAfter(n) : i.selectNode(e), i.compareBoundaryPoints(qe, i.cloneRange().setEnd(a, r)) >= 1 ? i : i.setEnd(a, r);
      ...
      return t = o.body.createTextRange(), t.setEndPoint("StartToStart", pn(i.startContainer, i.startOffset)), t.setEndPoint("EndToStart", pn(i.endContainer, i.endOffset)), t;
    }, html: function() {
      ...
      function e(n, o, i) {
        if (n.nodeType == 1) {
          ...
          if (c.length !== 0) {
            var s, a, r, d;
            o > 0 && (s = c.eq(o - 1)), o < c.length && (a = c.eq(o)), s && s.type == 3 && (r = s[0], d = r.nodeValue.length), a && a.type == 3 && (r = a[0], d = 0), r && (i ? t.setStart(r, d) : t.setEnd(r, d));
          }
        }
      }
      var t = this;
      ...
      function t(o, i, c) {
        ...
        if (!(a.type == 3 || Tt[a.name] || !e && a.isBlock())) {
          if (i === 0) {
            for (; !a.prev() && (s = a.parent(), s && !Tt[s.name] && (e || !s.isBlock())); )
              a = s;
            c ? n.setStartBefore(a[0]) : n.setEndBefore(a[0]);
          } else if (i == a.children().length) {
            for (; !a.next() && (s = a.parent(), s && !Tt[s.name] && (e || !s.isBlock())); )
              a = s;
            c ? n.setStartAfter(a[0]) : n.setEndAfter(a[0]);
          }
        }
      }
      var n = this;
      ...
      return i.id = "__kindeditor_bookmark_start_" + Hn++ + "__", n.collapsed || (t = i.cloneNode(!0), t.id = "__kindeditor_bookmark_end_" + Hn++ + "__"), t && n.cloneRange().collapse(!1).insertNode(t).setEndBefore(t), n.insertNode(i).setStartAfter(i), { start: e ? "#" + i.id : i, end: t ? e ? "#" + t.id : t : null };
    ...
    } }), v.RangeClass = _e, v.range = Ot, v.START_TO_START = at, v.START_TO_END = st, v.END_TO_END = qe, v.END_TO_START = ct, me(Je, { init: function(e, t) {
      var n = this, o = e.doc;
      n.doc = o, n.win = Fe(o), n.sel = Ut(o), n.range = e, n.editorOptions = t;
    }, selection: function(e) {
      var t = this, n = t.doc, o = oi(n);
      return t.sel = Ut(n), o ? (t.range = Ot(o), v(t.range.startContainer).name == "html" && t.range.selectNodeContents(n.body).collapse(!1), t) : (e && t.range.selectNodeContents(n.body).collapse(!1), t);
    }, select: function(e) {
      e = V(e, !0);
      var t, n = this, o = n.sel, i = n.range.cloneRange().shrink(), c = i.startContainer, s = i.startOffset, a = (i.endContainer, i.endOffset, Le(c)), r = n.win, d = !1;
      if (e && c.nodeType == 1 && i.collapsed) {
        if (be) {
          var u = v("<span>&nbsp;</span>", a);
          i.insertNode(u[0]), t = a.body.createTextRange();
          try {
            t.moveToElementText(u[0]);
          } catch {
          }
          return t.collapse(!1), t.select(), u.remove(), r.focus(), n;
        }
        if (Oe) {
          var l = c.childNodes;
          (v(c).isInline() || s > 0 && v(l[s - 1]).isInline() || l[s] && v(l[s]).isInline()) && (i.insertNode(a.createTextNode("\u200B")), d = !0);
        }
      }
      if (be)
        try {
      ...
      if (t.isBlock()) {
        for (var c = t.clone(!0), s = c; s.first(); )
          s = s.first();
        return s.append(i.extractContents()), i.insertNode(c[0]).selectNode(c[0]), n;
      }
      i.enlarge();
      var a = i.createBookmark(), r = i.commonAncestor(), d = !1;
      return v(r).scan(function(u) {
        if (!d && u == a.start)
          return void (d = !0);
        if (d) {
          if (u == a.end)
      ...
      for (var n, o = this.range, i = o.doc, c = o.cloneRange().collapse(e), s = c.startContainer, a = c.startOffset, r = s.nodeType == 3 ? s.parentNode : s, d = !1; r && r.parentNode; ) {
        if (n = v(r), t) {
          if (!n.isStyle() || !zt(n, t))
            break;
        } else if (Tt[n.name])
      ...
      if (d) {
        ...
        o.cloneRange().collapse(!e).insertNode(u), e ? c.setStartBefore(r.firstChild).setEnd(s, a) : c.setStart(s, a).setEndAfter(r.lastChild);
        var l = c.extractContents(), f = l.firstChild, p = l.lastChild;
        e ? (c.insertNode(l), o.setStartAfter(p).setEndBefore(u)) : (r.appendChild(l), o.setStartBefore(u).setEndBefore(f));
        var m = u.parentNode;
        if (m == o.endContainer) {
      ...
      if (o.enlarge(), o.startOffset === 0) {
        for (var i, c = v(o.startContainer); (i = c.parent()) && i.isStyle() && i.children().length == 1; )
          c = i;
        o.setStart(c[0], 0), c = v(o.startContainer), c.isBlock() && Pt(c, e);
        var s = c.parent();
        s && s.isBlock() && Pt(s, e);
      }
      var a, r;
      if (o.collapsed) {
        if (t.split(!0, e), a = o.startContainer, r = o.startOffset, r > 0) {
          ...
          d && He(d) && (d.remove(), o.setStart(a, r - 1));
        }
        var u = v(a.childNodes[r]);
        return u && He(u) && u.remove(), He(a) && (o.startBefore(a), a.remove()), o.collapse(!0), t;
      }
      ...
      if (r > 0) {
        var w = v(a.childNodes[r - 1]);
        w && He(w) && (w.remove(), o.setStart(a, r - 1), a == g && o.setEnd(g, y - 1));
        var b = v(a.childNodes[r]);
        b && He(b) && (b.remove(), a == g && o.setEnd(g, y - 1));
      }
      var _ = v(g.childNodes[o.endOffset]);
      _ && He(_) && _.remove();
      var M = o.createBookmark(!0);
      return z(p, function(N, A) {
        Pt(v(A), e);
      }), o.moveToBookmark(M), t;
      ...
      var n = this.range, o = n.endContainer, i = n.endOffset, c = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], s = t(c);
      if (s)
        return s;
      if (!c)
        return null;
      if (c.nodeType == 1 || o.nodeType == 3 && i === 0) {
        var a = v(c).prev();
        if (a)
          return t(a);
      }
      ...
      var n = this.range, o = n.startContainer, i = n.startOffset, c = n.endContainer, s = n.endOffset, a = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], r = c.nodeType == 3 || s === 0 ? c : c.childNodes[s - 1], d = t(a), u = t(r);
      ...
      n.range, e = t(e);
      var i, c = "";
      return e === "fontfamily" || e === "fontname" ? (c = mn(o, "fontname"), c = c.replace(/['"]/g, ""), t(c)) : e === "formatblock" ? (c = mn(o, e), c === "" && (i = n.commonNode({ "h1,h2,h3,h4,h5,h6,p,div,pre,address": "*" }), i && (c = i.name)), c === "Normal" && (c = "p"), t(c)) : e === "fontsize" ? (i = n.commonNode({ "*": ".font-size" }), i && (c = i.css("font-size")), t(c)) : e === "forecolor" ? (i = n.commonNode({ "*": ".color" }), i && (c = i.css("color")), c = mt(c), c === "" && (c = "default"), t(c)) : e === "hilitecolor" ? (i = n.commonNode({ "*": ".background-color" }), i && (c = i.css("background-color")), c = mt(c), c === "" && (c = "default"), t(c)) : c;
    }, toggle: function(e, t) {
      var n = this;
      ...
      function n(s, a) {
        ...
        var d = s.doc.getElementById("__kindeditor_temp_tag__");
        d.parentNode.removeChild(d);
        var u = hn(r);
        s.setEnd(u.endContainer, u.endOffset), s.collapse(!1), i.select(!1);
      }
      function o(s, a) {
        var r = s.doc, d = r.createDocumentFragment();
        v("@" + a, r).each(function() {
          d.appendChild(this);
        }), s.deleteContents(), s.insertNode(d), s.collapse(!1), i.select(!1);
      }
      var i = this, c = i.range;
      if (e === "")
        return i;
      if (be && t) {
        try {
    ...
    }, insertimage: function(e, t, n, o, i, c, s, a) {
      t = V(t, ""), s = V(s, "");
      var r = '<img data-ke-class="' + s + '" src="' + se(e) + '" data-ke-src="' + se(e) + '" ';
      return n && (r += 'width="' + se(n) + '" '), o && (r += 'height="' + se(o) + '" '), t && (r += 'title="' + se(t) + '" '), c && (r += 'align="' + se(c) + '" '), r += 'alt="' + se(t) + '" ', r += "/>", a && (r = "<" + a + ">" + r + "</" + a + ">"), this.inserthtml(r);
    }, createlink: function(e, t) {
      function n(m, g, y) {
        v(m).attr("href", g).attr("data-ke-src", g), y ? v(m).attr("target", y) : v(m).removeAttr("target");
      }
      var o = this, i = o.doc, c = o.range;
      o.select();
      var s = o.commonNode({ a: "*" });
      s && !c.isControl() && (c.selectNode(s.get()), o.select());
      var a = '<a href="' + se(e) + '" data-ke-src="' + se(e) + '" ';
      if (t && (a += ' target="' + se(t) + '"'), c.collapsed)
        return a += ">" + se(e) + "</a>", o.inserthtml(a);
      if (c.isControl()) {
        var r = v(c.startContainer.childNodes[c.startOffset]);
        return a += "></a>", r.after(v(a, i)), r.next().append(r), c.selectNode(r[0]), o.select();
      }
      var d = c.startContainer, u = c.startOffset, l = c.endContainer, f = c.endOffset;
      if (d.nodeType == 1 && d === l && u + 1 === f) {
        var p = d.childNodes[u];
        if (p.nodeName.toLowerCase() == "a")
          return n(p, e, t), o;
      }
      return Ee(i, "createlink", "__kindeditor_temp_url__"), v('a[href="__kindeditor_temp_url__"]', i).each(function() {
        n(this, e, t);
      }), o;
    }, unlink: function() {
      ...
      if (e.select(), n.collapsed) {
        ...
        if (o && (n.selectNode(o.get()), e.select()), Ee(t, "unlink", null), Oe && v(n.startContainer).name === "img") {
      ...
      Je.prototype[t] = function(n) {
        var o = this;
        return o.select(), Ee(o.doc, t, n), be && he(t, "justifyleft,justifycenter,justifyright,justifyfull".split(",")) >= 0 && o.selection(), (!be || he(t, "formatblock,selectall,insertorderedlist,insertunorderedlist".split(",")) >= 0) && o.selection(), o;
      };
      ...
      var n, o, i = this, c = Z(e) || 0, s = Z(t) || 0, a = je();
      if (i._alignEl) {
        var r = v(i._alignEl), d = r.pos(), u = Ie(r[0].clientWidth / 2 - c / 2), l = Ie(r[0].clientHeight / 2 - s / 2);
        n = 0 > u ? d.x : d.x + u, o = 0 > l ? d.y : d.y + l;
      } else {
        var f = ye(i.doc);
        n = Ie(a.x + (f.clientWidth - c) / 2), o = Ie(a.y + (f.clientHeight - s) / 2);
      }
      return Y && 7 > ce || Ne || (n -= a.x, o -= a.y), i.pos(n, o);
    }, remove: function() {
      var e = this;
      return (Y && 7 > ce || Ne) && v(e.win).unbind("scroll"), e.div.remove(), z(e, function(t) {
        e[t] = null;
      }), this;
    }, show: function() {
      ...
      var t = this;
      return e = e || {}, e.moveEl = t.div, e.moveFn = function(n, o, i, c, s, a) {
        (n += s) < 0 && (n = 0), (o += a) < 0 && (o = 0), t.pos(n, o);
      }, Ht(e), t;
    } }), v.WidgetClass = De, v.widget = qt;
    var Et, Xt = "";
    (Et = document.getElementsByTagName("html")) && (Xt = Et[0].dir), me(tt, De, { init: function(e) {
      function t() {
        var u = Wt(n.iframe);
        u.open(), a && (u.domain = document.domain), u.write(ui(o, i, c, s)), u.close(), n.win = n.iframe[0].contentWindow, n.doc = u;
        var l = kn(u, e.editorOptions);
        ...
        })), n.cmd = l, n.html(et(n.srcElement)), Y ? (u.body.disabled = !0, u.body.contentEditable = !0, u.body.removeAttribute("disabled")) : u.designMode = "on", e.afterCreate && e.afterCreate.call(n);
      }
      var n = this;
      ...
      var o = V(e.themesPath, ""), i = e.bodyClass, c = e.cssPath, s = e.cssData, a = location.protocol != "res:" && location.host.replace(/:\d+/, "") !== document.domain, r = "document.open();" + (a ? 'document.domain="' + document.domain + '";' : "") + "document.close();", d = Y ? ' src="javascript:void(function(){' + encodeURIComponent(r) + '}())"' : "";
      n.iframe = v('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"' + d + "></iframe>").css("width", "100%"), n.textarea = v('<textarea class="ke-edit-textarea" hidefocus="true"></textarea>').css("width", "100%"), n.tabIndex = isNaN(parseInt(e.tabIndex, 10)) ? n.srcElement.attr("tabindex") : parseInt(e.tabIndex, 10), n.iframe.attr("tabindex", n.tabIndex), n.textarea.attr("tabindex", n.tabIndex), n.width && n.setWidth(n.width), n.height && n.setHeight(n.height), n.designMode ? n.textarea.hide() : n.iframe.hide(), a && n.iframe.bind("load", function(u) {
        n.iframe.unbind("load"), Y ? t() : setTimeout(t, 0);
      ...
      var t = this;
      return e = J(e), t.height = e, t.div.css("height", e), t.iframe.css("height", e), (Y && 8 > ce || Ne) && (e = J(Z(e) - 2)), t.textarea.css("height", e), t;
    }, remove: function() {
      var e = this, t = e.doc;
      ...
      if (n.designMode) {
        var i = o.body;
        return e === void 0 ? (e = t ? "<!doctype html><html>" + i.parentNode.innerHTML + "</html>" : i.innerHTML, n.beforeGetHtml && (e = n.beforeGetHtml(e)), Be && e == "<br />" && (e = ""), e) : (n.beforeSetHtml && (e = n.beforeSetHtml(e)), Y && ce >= 9 && (e = e.replace(/(<.*?checked=")checked(".*>)/gi, "$1$2")), v(i).html(e), n.afterSetHtml && n.afterSetHtml(), n);
      }
      ...
      if (e)
        return v(o).keyup(function(c) {
          c.ctrlKey || c.altKey || !Zt[c.which] || e(c);
        }), v(o).mouseup(e).contextmenu(e), v(n.win).blur(e), v(i).bind("paste", t), v(i).bind("cut", t), n;
    } }), v.EditClass = tt, v.edit = bn, v.iframeDoc = Wt, me(bt, De, { init: function(e) {
      function t(i) {
        var c = v(i);
        return c.hasClass("ke-outline") ? c : c.hasClass("ke-toolbar-icon") ? c.parent() : void 0;
      }
      function n(i, c) {
        var s = t(i.target);
        if (s) {
          if (s.hasClass("ke-disabled") || s.hasClass("ke-selected"))
            return;
          s[c]("ke-on");
        }
      }
      var o = this;
      bt.parent.init.call(o, e), o.disableMode = V(e.disableMode, !1), o.noDisableItemMap = re(V(e.noDisableItems, [])), o._itemMap = {}, o.div.addClass("ke-toolbar").bind("contextmenu,mousedown,mousemove", function(i) {
        i.preventDefault();
        ...
        var c = t(i.target);
        if (c) {
          if (c.hasClass("ke-disabled"))
            return;
          o.options.click.call(this, i, c.attr("data-name"));
        }
      });
    }, get: function(e) {
      return this._itemMap[e] ? this._itemMap[e] : this._itemMap[e] = v("span.ke-icon-" + e, this.div).parent();
    }, select: function(e) {
      return wn.call(this, e, function(t) {
      ...
      return t && (o = re(t)), (e === void 0 ? !n.disableMode : e) ? (v("span.ke-outline", n.div).each(function() {
        var i = v(this), c = i[0].getAttribute("data-name", 2);
        o[c] || n.disable(i);
      }), n.disableMode = !0) : (v("span.ke-outline", n.div).each(function() {
        var i = v(this), c = i[0].getAttribute("data-name", 2);
        o[c] || n.enable(i);
      }), n.disableMode = !1), n;
    } }), v.ToolbarClass = bt, v.toolbar = xn, me(nt, De, { init: function(e) {
      var t = this;
      ...
      var n = v('<div class="ke-menu-item" unselectable="on"></div>'), o = v('<div class="ke-inline-block ke-menu-item-left"></div>'), i = v('<div class="ke-inline-block ke-menu-item-right"></div>'), c = J(e.height), s = V(e.iconClass, "");
      t.div.append(n), c && (n.css("height", c), i.css("line-height", c));
      var a;
      return t.centerLineMode && (a = v('<div class="ke-inline-block ke-menu-item-center"></div>'), c && a.css("height", c)), n.mouseover(function(r) {
      ...
      }).append(o), a && n.append(a), n.append(i), e.checked && (s = "ke-icon-checked icon-ke-font"), s !== "" && o.html('<span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-toolbar-icon-url ' + s + '"></span>'), i.html(e.title), t;
    }, remove: function() {
      var e = this;
      return e.options.beforeRemove && e.options.beforeRemove.call(e), v(".ke-menu-item", e.div[0]).unbind(), nt.parent.remove.call(e), e;
    } }), v.MenuClass = nt, v.menu = $t, me(it, De, { init: function(e) {
      var t = this;
      ...
      var i = o.insertRow(0), c = i.insertCell(0);
      c.colSpan = n[0].length, t._addAttr(c, "", "ke-colorpicker-cell-top");
      for (var s = 0; s < n.length; s++) {
        i = o.insertRow(s + 1);
        for (var a = 0; a < n[s].length; a++)
          c = i.insertCell(a), t._addAttr(c, n[s][a], "ke-colorpicker-cell");
      }
    ...
    } }), v.ColorPickerClass = it, v.colorpicker = Cn, me(Vt, { init: function(e) {
      var t = this, n = v(e.button), o = e.fieldName || "file", i = e.url || "", c = n.val(), s = e.extraParams || {}, a = e.uploadResponseFilter, r = e.uploadCompress, d = n[0].className || "", u = e.target || "kindeditor_upload_iframe_" + new Date().getTime();
      e.afterError = e.afterError || function(b) {
        alert(b);
      };
      var l = [];
      for (var f in s)
        l.push('<input type="hidden" name="' + f + '" value="' + s[f] + '" />');
      var p = ['<div class="ke-inline-block ' + d + '">', e.target ? "" : '<iframe name="' + u + '" style="display:none;"></iframe>', e.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + u + '" action="' + i + '">', '<span class="ke-button-common">', l.join(""), '<input type="button" class="ke-button-common ke-button" value="' + c + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + o + '" tabindex="-1" />', e.form ? "</div>" : "</form>", "</div>"].join(""), m = v(p, n.doc);
      n.hide(), n.before(m), t.div = m, t.button = n, t.fileBox = v(".ke-upload-file", m), t.form = e.form ? v(e.form) : v("form", m);
      var g = v.undef(e.fileSizeLimit, "1MB"), y = v.undef(e.fileTypeLimit, "*.jpg;*.gif;*.png");
      t.uploader = WebUploader.create({ server: e.uploadUrl, resize: !1, fileVal: "file", accept: { title: "Images", extensions: y.replace(/\*\./g, "").replace(/;/g, ","), mimeTypes: "image/*" }, headers: e.uploadHeader, formData: e.uploadData, fileNumLimit: 1, fileSingleSizeLimit: 1 * g.replace(/MB/g, "") * 1024 * 1024 }), r !== void 0 && (t.uploader.options.compress = r), t.uploader.on("uploadStart", function(b) {
      }), t.uploader.on("uploadSuccess", function(b, _) {
        var M = _;
        a && (M = a.call(null, _)), t.options.afterUpload.call(t, M);
      }), t.uploader.on("uploadError", function(b, _) {
        t.options.afterUpload.call(t, { error: 1, message: "[http-error]\u56FE\u7247\u4E0A\u4F20\u5931\u8D25\uFF01" });
      }), t.uploader.on("error", function(b) {
        var _ = "\u6587\u4EF6\u4E0A\u4F20\u51FA\u73B0\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\uFF01";
        b === "Q_TYPE_DENIED" ? _ = "[" + arguments[1].name + "]\u6587\u4EF6\u7C7B\u578B\u4E0D\u6B63\u786E\uFF01" : b === "F_EXCEED_SIZE" ? _ = "\u6587\u4EF6\u5927\u5C0F\u8D85\u51FA\u9650\u5236\uFF08\u6700\u5927" + 1 * e.fileSizeLimit.replace(/MB/g, "") + "M\uFF09\uFF01" : b === "F_DUPLICATE" && (_ = "[" + arguments[1].name + "]\u6587\u4EF6\u5DF2\u5B58\u5728\u4E8E\u5F85\u4E0A\u4F20\u5217\u8868\u4E2D\uFF01"), console.error("\u6587\u4EF6\u4E0A\u4F20\u51FA\u73B0\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\uFF01", arguments), t.options.afterUpload.call(t, { error: 1, message: _ }), t.uploader.reset(), t.form && t.form[0] && t.form[0].reset && t.form[0].reset();
      }), t.fileBox.bind("change", function() {
        t.uploader.reset(), this.files && t.uploader.addFiles(this.files);
      });
      var w = e.width || v(".ke-button-common", m).width();
      v(".ke-upload-area", m).width(w), t.options = e;
    }, submit: function() {
    ...
    } }), v.UploadButtonClass = Vt, v.uploadbutton = di, me(rt, De, { init: function(e) {
      var t = this, n = V(e.shadowMode, !0);
      e.z = e.z || 811213, e.shadowMode = !1, e.autoScroll = V(e.autoScroll, !0), rt.parent.init.call(t, e);
      var o = e.title, i = v(e.body, t.doc), c = e.previewBtn, s = e.yesBtn, a = e.noBtn, r = e.closeBtn, d = V(e.showMask, !0);
      t.div.addClass("ke-dialog").bind("click,mousedown", function(w) {
        w.stopPropagation();
      });
      var u = v('<div class="ke-dialog-content"></div>').appendTo(t.div);
      Y && 7 > ce ? t.iframeMask = v('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(t.div) : n && v('<div class="ke-dialog-shadow"></div>').appendTo(t.div);
      var l = v('<div class="ke-dialog-header"></div>');
      u.append(l), l.html(o), t.closeIcon = v('<span class="ke-dialog-icon-close" title="' + r.name + '"></span>').click(r.click), l.append(t.closeIcon), t.draggable({ clickEl: l, beforeDrag: e.beforeDrag });
      var f = v('<div class="ke-dialog-body"></div>');
      u.append(f), f.append(i);
      var p = v('<div class="ke-dialog-footer"></div>');
      if ((c || s || a) && u.append(p), z([{ btn: c, name: "preview" }, { btn: s, name: "yes" }, { btn: a, name: "no" }], function() {
        if (this.btn) {
          var w = fi(this.btn);
          w.addClass("ke-dialog-" + this.name), p.append(w);
        }
      }), t.height && f.height(Z(t.height) - l.height() - p.height() - 2), t.div.width(t.div.width()), t.div.height(t.div.height()), t.mask = null, d) {
        var m = ye(t.doc), g = Math.max(m.scrollWidth, m.clientWidth), y = Math.max(m.scrollHeight, m.clientHeight);
        t.mask = qt({ x: 0, y: 0, z: t.z - 1, cls: "ke-dialog-mask", width: g, height: y });
      }
    ...
    ot.prototype = { lang: function(e) {
      ...
      var u = t.toolbar = xn({ src: s, html: d.join(""), noDisableItems: t.noDisableItems, click: function(p, m) {
        if (p.stop(), t.menu) {
          var g = t.menu.name;
          if (t.hideMenu(), g === m)
            return;
      ...
      return r.removeClass("statusbar").addClass("ke-statusbar").append('<span class="ke-inline-block ke-statusbar-center-icon"><i></i><i></i><i></i></span>').append('<span class="ke-inline-block ke-statusbar-right-icon"></span>'), t._fullscreenResizeHandler && (v(window).unbind("resize", t._fullscreenResizeHandler), t._fullscreenResizeHandler = null), e(), n ? (t._fullscreenResizeHandler = function(p) {
        ...
        t._scrollPos = je();
      }), t.resizeType > 0 ? Ht({ moveEl: c, clickEl: r, moveFn: function(p, m, g, y, w, b) {
        y += b, t.resize(null, y);
      } }) : r.first().css("visibility", "hidden"), t.resizeType === 2 ? Ht({ moveEl: c, clickEl: r.last(), moveFn: function(p, m, g, y, w, b) {
      ...
      e = V(e, !0);
      var t, n = this, o = n.edit, i = o.doc.body, c = xt(i.innerHTML);
      if (e && n._undoStack.length > 0) {
        var s = n._undoStack[n._undoStack.length - 1];
        if (Math.abs(c.length - Me(s.html).length) < n.minChangeSize)
          return n;
      }
      ...
      var t = this;
      if (e.name, e.z = t.options.zIndex, e.shadowMode = V(e.shadowMode, t.shadowMode), e.closeBtn = V(e.closeBtn, { name: t.lang("close"), click: function(c) {
        t.hideDialog(), Y && t.cmd && t.cmd.select();
      } }), e.noBtn = V(e.noBtn, { name: t.lang(e.yesBtn ? "no" : "close"), click: function(c) {
        t.hideDialog(), Y && t.cmd && t.cmd.select();
    ...
    return v.remove = function(e) {
    ...
    }, Y && 7 > ce && Ee(document, "BackgroundImageCache", !0), v.EditorClass = ot, v.editor = ki, v.create = In, v.instances = ut, v.plugin = Sn, v.lang = Dn, Sn("core", function(e) {
      ...
      if (t.afterSetHtml(function() {
        ...
        if (t.syncType == "form") {
          for (var i = e(t.srcElement), c = !1; i = i.parent(); )
            if (i.name == "form") {
              c = !0;
              break;
            }
      ...
      z("undo,redo".split(","), function(i, c) {
        n[c] && t.afterCreate(function() {
          At(this.edit.doc, n[c], function() {
            t.clickToolbar(c);
          });
        }), t.clickToolbar(c, function() {
          t[c]();
        });
      }), t.clickToolbar("formatblock", function() {
        var i = t.lang("formatblock.formatBlock"), c = { h1: 28, h2: 24, h3: 18, H4: 14, p: 12 }, s = t.cmd.val("formatblock"), a = t.createMenu({ name: "formatblock", width: t.langType == "en" ? 200 : 150 });
        z(i, function(r, d) {
          var u = "font-size:" + c[r] + "px;";
          r.charAt(0) === "h" && (u += "font-weight:bold;"), a.addItem({ title: '<span style="' + u + '" unselectable="on">' + d + "</span>", height: c[r] + 12, checked: s === r || s === d, click: function() {
            t.select().exec("formatblock", "<" + r + ">").hideMenu();
          } });
        });
      }), t.clickToolbar("fontname", function() {
        var i = t.cmd.val("fontname"), c = t.createMenu({ name: "fontname", width: 150 });
        z(t.lang("fontname.fontName"), function(s, a) {
          c.addItem({ title: '<span style="font-family: ' + s + ';" unselectable="on">' + a + "</span>", height: 30, checked: i === s.toLowerCase() || i === a.toLowerCase(), click: function() {
            t.exec("fontname", s).hideMenu();
          } });
        });
      }), t.clickToolbar("fontsize", function() {
        var i = t.cmd.val("fontsize"), c = t.createMenu({ name: "fontsize", width: 150 });
        z(t.fontSizeTable, function(s, a) {
          c.addItem({ title: '<span style="font-size:' + a + ';" unselectable="on">' + a + "</span>", height: Z(a) + 12, checked: i === a, click: function() {
            t.exec("fontsize", a).hideMenu();
          } });
        });
      }), z("forecolor,hilitecolor".split(","), function(i, c) {
        t.clickToolbar(c, function() {
          t.createMenu({ name: c, selectedColor: t.cmd.val(c) || "default", colors: t.colorTable, click: function(s) {
            t.exec(c, s).hideMenu();
          } });
        });
      }), z("cut,copy,paste".split(","), function(i, c) {
        t.clickToolbar(c, function() {
          t.focus();
          try {
            t.exec(c, null);
          } catch {
            alert(t.lang(c + "Error"));
          }
        });
      ...
      }, z("link,image,flash,media,anchor".split(","), function(i, c) {
        var s = c.charAt(0).toUpperCase() + c.substr(1);
        z("edit,delete".split(","), function(a, r) {
          t.addContextmenu({ title: t.lang(r + s), click: function() {
            t.loadPlugin(c, function() {
              t.plugin[c][r](), t.hideMenu();
            });
          }, cond: t.plugin["getSelected" + s], width: 150, iconClass: r == "edit" ? "ke-icon-" + c : void 0 });
      ...
      }, z("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function(i, c) {
        var s = he(c, ["prop", "delete"]) < 0 ? t.plugin.getSelectedCell : t.plugin.getSelectedTable;
        t.addContextmenu({ title: t.lang("table" + c), click: function() {
          t.loadPlugin("table", function() {
            t.plugin.table[c](), t.hideMenu();
          });
        }, cond: s, width: 170, iconClass: "ke-icon-table" + c });
      }), t.addContextmenu({ title: "-" }), z("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function(i, c) {
        n[c] && t.afterCreate(function() {
          At(this.edit.doc, n[c], function() {
            t.cmd.selection(), t.clickToolbar(c);
          });
        }), t.clickToolbar(c, function() {
          t.focus().exec(c, null);
        });
        ...
        function i() {
          c.range.moveToBookmark(s), c.select(), Oe && (e("div." + d, a).each(function() {
          ...
          var l = a[0].innerHTML;
          a.remove(), l !== "" && (Oe && (l = l.replace(/(<br>)\1/gi, "$1")), t.pasteType === 2 && (l = l.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/gi, ""), /schemas-microsoft-com|worddocument|mso-\w+/i.test(l) ? l = on(l, t.filterMode ? t.htmlTags : e.options.htmlTags) : (l = Re(l, t.filterMode ? t.htmlTags : null), l = t.beforeSetHtml(l))), t.pasteType === 1 && (l = l.replace(/&nbsp;/gi, " "), l = l.replace(/\n\s*\n/g, `
`), l = l.replace(/<br[^>]*>/gi, `
`), l = l.replace(/<\/p><p[^>]*>/gi, `
`), l = l.replace(/<[^>]+>/g, ""), l = l.replace(/ {2}/g, " &nbsp;"), t.newlineTag == "p" ? /\n/.test(l) && (l = l.replace(/^/, "<p>").replace(/$/, "<br /></p>").replace(/\n/g, "<br /></p><p>")) : l = l.replace(/\n/g, "<br />$&")), t.insertHtml(l, !0));
        ...
        var c, s, a, r = t.edit.doc, d = "__kindeditor_paste__", u = !1;
        e(r.body).bind("paste", function(l) {
          if (t.pasteType === 0)
            return void l.stop();
          if (!u) {
            if (u = !0, e("div." + d, r).remove(), c = t.cmd.selection(), s = c.range.createBookmark(), a = e('<div class="' + d + '"></div>', r).css({ position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: e(s.start).pos().y + "px", "white-space": "nowrap" }), e(r.body).append(a), Y) {
              var f = c.range.get(!0);
              f.moveToElementText(a[0]), f.select(), f.execCommand("paste"), l.preventDefault();
            } else
              c.range.selectNodeContents(a[0]), c.select(), a[0].tabIndex = -1, a[0].focus();
            setTimeout(function() {
              i(), u = !1;
            }, 0);
          }
        ...
        return Y && 8 >= ce && (i = i.replace(/<div\s+[^>]*data-ke-input-tag="([^"]*)"[^>]*>([\s\S]*?)<\/div>/gi, function(c, s) {
          return unescape(s);
        }), i = i.replace(/(<input)((?:\s+[^>]*)?>)/gi, function(c, s, a) {
          return /\s+type="[^"]+"/i.test(c) ? c : s + ' type="text"' + a;
        })), i.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/gi, function(c, s, a, r) {
          return s + Ge(a).replace(/\s+/g, " ") + r;
        }).replace(/<img[^>]*class="?ke-(flash|rm|media)"?[^>]*>/gi, function(c) {
          var s = we(c), a = Pe(s.style || ""), r = an(s["data-ke-tag"]), d = V(a.width, ""), u = V(a.height, "");
          return /px/i.test(d) && (d = Z(d)), /px/i.test(u) && (u = Z(u)), r.width = V(s.width, d), r.height = V(s.height, u), Rt(r);
        }).replace(/<img[^>]*class="?ke-anchor"?[^>]*>/gi, function(c) {
          var s = we(c);
          return '<a name="' + unescape(s["data-ke-name"]) + '"></a>';
        }).replace(/<div\s+[^>]*data-ke-script-attr="([^"]*)"[^>]*>([\s\S]*?)<\/div>/gi, function(c, s, a) {
          return "<script" + unescape(s) + ">" + unescape(a) + "<\/script>";
        }).replace(/<div\s+[^>]*data-ke-noscript-attr="([^"]*)"[^>]*>([\s\S]*?)<\/div>/gi, function(c, s, a) {
          return "<noscript" + unescape(s) + ">" + unescape(a) + "</noscript>";
        }).replace(/(<[^>]*)data-ke-src="([^"]*)"([^>]*>)/gi, function(c, s, a, r) {
          return c = c.replace(/(\s+(?:href|src)=")[^"]*(")/i, function(d, u, l) {
            return u + Ge(a) + l;
          }), c = c.replace(/\s+data-ke-src="[^"]*"/i, "");
        }).replace(/(<[^>]+\s)data-ke-(on\w+="[^"]*"[^>]*>)/gi, function(c, s, a) {
          return s + a;
        });
      }), t.beforeSetHtml(function(i) {
        return Y && 8 >= ce && (i = i.replace(/<input[^>]*>|<(select|button)[^>]*>[\s\S]*?<\/\1>/gi, function(c) {
          var s = we(c), a = Pe(s.style || "");
          return a.display == "none" ? '<div class="ke-display-none" data-ke-input-tag="' + escape(c) + '"></div>' : c;
        })), i.replace(/<embed[^>]*type="([^"]+)"[^>]*>(?:<\/embed>)?/gi, function(c) {
          var s = we(c);
          return s.src = V(s.src, ""), s.width = V(s.width, 0), s.height = V(s.height, 0), sn(t.themesPath + "common/blank.gif", s);
        }).replace(/<a[^>]*name="([^"]+)"[^>]*>(?:<\/a>)?/gi, function(c) {
          var s = we(c);
          return s.href !== void 0 ? c : '<img class="ke-anchor" src="data:image/svg+xml;base64," data-ke-name="' + escape(s.name) + '" style="vertical-align:text-bottom" />';
        }).replace(/<script([^>]*)>([\s\S]*?)<\/script>/gi, function(c, s, a) {
          return '<div class="ke-script" data-ke-script-attr="' + escape(s) + '">' + escape(a) + "</div>";
        }).replace(/<noscript([^>]*)>([\s\S]*?)<\/noscript>/gi, function(c, s, a) {
          return '<div class="ke-noscript" data-ke-noscript-attr="' + escape(s) + '">' + escape(a) + "</div>";
        }).replace(/(<[^>]*)(href|src)="([^"]*)"([^>]*>)/gi, function(c, s, a, r, d) {
          return c.match(/\sdata-ke-src="[^"]*"/i) ? c : c = s + a + '="' + r + '" data-ke-src="' + se(r) + '"' + d;
        }).replace(/(<[^>]+\s)(on\w+="[^"]*"[^>]*>)/gi, function(c, s, a) {
          return s + "data-ke-" + a;
        }).replace(/<table[^>]*\s+border="0"[^>]*>/gi, function(c) {
          return c.indexOf("ke-zeroborder") >= 0 ? c : Zn(c, "ke-zeroborder");
        });
      });
    }), function(e) {
      return e.KindEditor ? e.KindEditor : void 0;
...
Allowed file extension: swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb`, invalidWidth: "The width must be number.", invalidHeight: "The height must be number.", invalidBorder: "The border must be number.", invalidUrl: "Please type valid URL.", invalidRows: "Invalid rows.", invalidCols: "Invalid columns.", invalidPadding: "The padding must be number.", invalidSpacing: "The spacing must be number.", invalidJson: "Invalid JSON string.", uploadSuccess: "Upload success.", cutError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+X) instead.", copyError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+C) instead.", pasteError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+V) instead.", ajaxLoading: "Loading ...", uploadLoading: "Uploading ...", uploadError: "Upload Error", "plainpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "wordpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "code.pleaseInput": "Please input code.", "link.url": "URL", "link.linkType": "Target", "link.newWindow": "New window", "link.selfWindow": "Same window", "flash.url": "URL", "flash.width": "Width", "flash.height": "Height", "flash.upload": "Upload", "flash.viewServer": "Browse", "media.url": "URL", "media.width": "Width", "media.height": "Height", "media.autostart": "Auto start", "media.upload": "Upload", "media.viewServer": "Browse", "image.remoteImage": "Insert URL", "image.localImage": "Upload", "image.remoteUrl": "URL", "image.localUrl": "File", "image.size": "Size", "image.width": "Width", "image.height": "Height", "image.resetSize": "Reset dimensions", "image.align": "Align", "image.defaultAlign": "Default", "image.leftAlign": "Left", "image.rightAlign": "Right", "image.imgTitle": "Title", "image.upload": "Browse", "image.viewServer": "Browse", "multiimage.uploadDesc": "Allows users to upload <%=uploadLimit%> images, single image size not exceeding <%=sizeLimit%>", "multiimage.startUpload": "Start upload", "multiimage.clearAll": "Clear all", "multiimage.insertAll": "Insert all", "multiimage.queueLimitExceeded": "Queue limit exceeded.", "multiimage.fileExceedsSizeLimit": "File exceeds size limit.", "multiimage.zeroByteFile": "Zero byte file.", "multiimage.invalidFiletype": "Invalid file type.", "multiimage.unknownError": "Unknown upload error.", "multiimage.pending": "Pending ...", "multiimage.uploadError": "Upload error", "filemanager.emptyFolder": "Blank", "filemanager.moveup": "Parent folder", "filemanager.viewType": "Display: ", "filemanager.viewImage": "Thumbnails", "filemanager.listImage": "List", "filemanager.orderType": "Sorting: ", "filemanager.fileName": "By name", "filemanager.fileSize": "By size", "filemanager.fileType": "By type", "insertfile.url": "URL", "insertfile.title": "Title", "insertfile.upload": "Upload", "insertfile.viewServer": "Browse", "table.cells": "Cells", "table.rows": "Rows", "table.cols": "Columns", "table.size": "Dimensions", "table.width": "Width", "table.height": "Height", "table.percent": "%", "table.px": "px", "table.space": "Space", "table.padding": "Padding", "table.spacing": "Spacing", "table.align": "Align", "table.textAlign": "Horizontal", "table.verticalAlign": "Vertical", "table.alignDefault": "Default", "table.alignLeft": "Left", "table.alignCenter": "Center", "table.alignRight": "Right", "table.alignTop": "Top", "table.alignMiddle": "Middle", "table.alignBottom": "Bottom", "table.alignBaseline": "Baseline", "table.border": "Border", "table.borderWidth": "Width", "table.borderColor": "Color", "table.backgroundColor": "Background", "map.address": "Address: ", "map.search": "Search", "baidumap.address": "Address: ", "baidumap.search": "Search", "baidumap.insertDynamicMap": "Dynamic Map", "anchor.name": "Anchor name", "formatblock.formatBlock": { h1: "Heading 1", h2: "Heading 2", h3: "Heading 3", h4: "Heading 4", p: "Normal" }, "fontname.fontName": { Arial: "Arial", "Arial Black": "Arial Black", "Comic Sans MS": "Comic Sans MS", "Courier New": "Courier New", Garamond: "Garamond", Georgia: "Georgia", Tahoma: "Tahoma", "Times New Roman": "Times New Roman", "Trebuchet MS": "Trebuchet MS", Verdana: "Verdana" }, "lineheight.lineHeight": [{ 1: "Line height 1" }, { 1.5: "Line height 1.5" }, { 2: "Line height 2" }, { 2.5: "Line height 2.5" }, { 3: "Line height 3" }], "template.selectTemplate": "Template", "template.replaceContent": "Replace current content", "template.fileList": { "1.html": "Image and Text", "2.html": "Table", "3.html": "List" } }, "en"), KindEditor.each(KindEditor.options.items, function(e, t) {
      ...
      t.plugin.anchor = { edit: function() {
        var i = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keName">' + o.name + "</label>", '<input class="ke-input-text" type="text" id="keName" name="name" value="" style="width:260px;" />', "</div>", "</div>"].join(""), c = t.createDialog({ name: n, width: 360, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(d) {
          t.insertHtml('<a name="' + a.val() + '">').hideDialog().focus();
        } } }), s = c.div, a = e('input[name="name"]', s), r = t.plugin.getSelectedAnchor();
      ...
      function t() {
        var s = i.edit, a = s.doc.body;
        s.iframe[0].scroll = "no", a.style.overflowY = "hidden";
      }
      function n() {
        if (!i.fullscreenMode) {
          var s = i.edit, a = s.doc.body;
          s.iframe.height(c);
          var r = i.toolbar, d = e(r.div).height(), u = Math.max(e.IE ? a.scrollHeight : a.offsetHeight, c, e(a).height()) + d + 30;
          i.resize(null, u), a.scrollTo({ top: 0 });
        }
      }
      function o() {
        c = e.removeUnit(i.height), i.edit.afterChange(n), i.fullscreenMode || t(), n();
      }
      var i = this;
      if (i.autoHeightMode) {
        var c;
      ...
      var t = this, n = "baidumap", o = t.lang(n + "."), i = e.undef(t.baiduMapAk, "9yfaQtWDimlbXuo4TMLmIk7yDjl36eCy"), c = e.undef(t.mapWidth, 558), s = e.undef(t.mapHeight, 360);
      t.clickToolbar(n, function() {
        function a() {
          r = y[0].contentWindow, d = e.iframeDoc(y), d.open(), d.write(g), d.close();
        }
        var r, d, u = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', o.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:450px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + o.search + '" />', "</span>", "</div>", '<div class="ke-map" style="width:' + c + "px;height:" + s + 'px;"></div>', "</div>"].join(""), l = t.createDialog({ name: n, width: c + 42, title: t.lang(n), body: u, yesBtn: { name: t.lang("yes"), click: function(w) {
          var b = r.map, _ = b.getCenter(), M = _.lng + "," + _.lat, N = b.getZoom(), A = ["http://api.map.baidu.com/staticimage/v2?ak=" + i, "&center=" + encodeURIComponent(M), "&zoom=" + encodeURIComponent(N), "&width=" + 1.5 * c, "&height=" + 1.5 * s, "&markers=" + encodeURIComponent(M), "&markerStyles=" + encodeURIComponent("l,A")].join("");
          t.exec("insertimage", A, "title", c + "", s + "", 0, "", "ke-map"), t.hideDialog().focus();
...
`), y = e('<iframe class="ke-textarea" frameborder="0" style="width:558px;height:360px;"></iframe>');
      ...
      var t = this, n = "code";
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', '<select class="ke-code-type">', '<option value="js">JavaScript</option>', '<option value="html">HTML</option>', '<option value="css">CSS</option>', '<option value="php">PHP</option>', '<option value="pl">Perl</option>', '<option value="py">Python</option>', '<option value="rb">Ruby</option>', '<option value="java">Java</option>', '<option value="vb">ASP/VB</option>', '<option value="cpp">C/C++</option>', '<option value="cs">C#</option>', '<option value="xml">XML</option>', '<option value="bsh">Shell</option>', '<option value="">Other</option>', "</select>", "</div>", '<textarea class="ke-textarea" style="width:518px;height:260px;"></textarea>', "</div>"].join(""), c = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(a) {
          var r = e(".ke-code-type", c.div).val(), d = s.val().replace(/^\s+/g, "").replace(/\s+$/g, `
`).replace(/(\s*<!--)/g, `
$1`).replace(/>(\s*)(?=<!--\s*\/)/g, "> "), u = r === "" ? "" : " lang-" + r, l = '<pre class="' + u + `">
` + e.escape(d) + `
</pre> `;
          return e.trim(d) === "" ? (alert(o.pleaseInput), void s[0].focus()) : void t.insertHtml(l).hideDialog().focus();
        } } }), s = e("textarea", c.div);
        s[0].focus();
      });
      ...
      t.emojiConfig && t.emojiConfig instanceof Function && t.emojiConfig.call(null, o, i), t.clickToolbar(n, function() {
        function c(_, M) {
          _.mouseover(function() {
            ...
            t.insertHtml(M).hideMenu().focus(), N.stop();
          });
        }
        function s(_, M) {
          var N = document.createElement("ul");
          M.append(N), N.className = "ke-ul";
          for (var A, P = Math.ceil(o[_].length / i.cols), B = 0; P > B; B++) {
            var E = document.createElement("li");
            e(E).addClass("ke-li"), e(N).append(E);
            for (var T = 0; T < i.cols; T++)
              if (A = o[_][i.cols * B + T], A !== void 0) {
                var x = e('<span class="ke-emoji">' + A + "</span>");
                c(x, A), e(E).append(x), u.push(x);
              }
          }
          return N;
        }
        ...
        function r(_, M) {
          _.click(function(N) {
            a(), w.parentNode.removeChild(w), y.remove(), w = s(M, l), d(M), i.current = M, N.stop();
          });
        }
        function d(_) {
        ...
        f.div.append(l);
        var y, w = s(i.current, l), b = e(l).width();
        p + b > g && e(f.div).css({ left: p - (b - m) + "px" }), d(i.current);
      });
      ...
      t.symbolConfig && t.symbolConfig instanceof Function && t.symbolConfig.call(null, o, i), t.clickToolbar(n, function() {
        ...
        function s(_, M) {
          var N = document.createElement("ul");
          M.append(N), N.className = "ke-ul";
          for (var A, P = o[_].split(","), B = Math.ceil(P.length / i.cols), E = 0; B > E; E++) {
            var T = document.createElement("li");
            e(T).addClass("ke-li"), e(N).append(T);
            for (var x = 0; x < i.cols; x++)
              if (A = P[i.cols * E + x], A !== void 0) {
                var C = e('<span class="ke-symbol">' + A + "</span>");
                c(C, A), e(T).append(C), u.push(C);
              }
          }
          return N;
        }
        ...
        function d(_) {
          ...
          for (var M in i.tags) {
            ...
            if (M !== _) {
              ...
              y.append(e('<span class="ke-page-item ke-page-active">[' + N + "]</span>"));
          }
        }
        var u = [], l = e('<div class="ke-plugin-symbol"></div>'), f = t.createMenu({ name: n, beforeRemove: function() {
          a();
      ...
      function t(r, d, u) {
        return r + " (" + Math.ceil(d / 1024) + "KB, " + u + ")";
      }
      function n(r, d) {
        d.is_dir ? r.attr("title", d.filename) : r.attr("title", t(d.filename, d.filesize, d.datetime));
      }
      var o = this, i = "filemanager", c = e.undef(o.fileManagerJson, o.basePath + "_404.html"), s = o.pluginsPath + i + "/images/", a = o.lang(i + ".");
      o.plugin.filemanagerDialog = function(r) {
        function d(x, C, D) {
          var I = "path=" + x + "&order=" + C + "&dir=" + y;
          M.showLoading(o.lang("ajaxLoading")), e.ajax(e.addParam(c, I + "&" + new Date().getTime()), function(L) {
            M.hideLoading(), D(L);
          });
        }
        function u(x, C, D, I) {
          var L = e.formatUrl(C.current_url + D.filename, "absolute"), R = encodeURIComponent(C.current_dir_path + D.filename + "/");
          D.is_dir ? x.click(function(O) {
            d(R, E.val(), I);
          }) : D.is_photo ? x.click(function(O) {
            b.call(this, L, D.filename);
          }) : x.click(function(O) {
            b.call(this, L, D.filename);
          }), T.push(x);
        }
        function l(x, C) {
          function D() {
            B.val() == "VIEW" ? d(x.current_dir_path, E.val(), p) : d(x.current_dir_path, E.val(), f);
          }
          e.each(T, function() {
            this.unbind();
          }), P.unbind(), B.unbind(), E.unbind(), x.current_dir_path && P.click(function(I) {
            d(x.moveup_dir_path, E.val(), C);
          }), B.change(D), E.change(D), A.html("");
        }
        function f(x) {
          l(x, f);
          var C = document.createElement("table");
          C.className = "ke-table", C.cellPadding = 0, C.cellSpacing = 0, C.border = 0, A.append(C);
          for (var D = x.file_list, I = 0, L = D.length; L > I; I++) {
            var R = D[I], O = e(C.insertRow(I));
            O.mouseover(function(W) {
              e(this).addClass("ke-on");
            }).mouseout(function(W) {
              e(this).removeClass("ke-on");
            });
            var U = s + (R.is_dir ? "folder-16.gif" : "file-16.gif"), H = e('<img src="' + U + '" width="16" height="16" alt="' + R.filename + '" align="absmiddle" />'), j = e(O[0].insertCell(0)).addClass("ke-cell ke-name").append(H).append(document.createTextNode(" " + R.filename));
            !R.is_dir || R.has_file ? (O.css("cursor", "pointer"), j.attr("title", R.filename), u(j, x, R, f)) : j.attr("title", a.emptyFolder), e(O[0].insertCell(1)).addClass("ke-cell ke-size").html(R.is_dir ? "-" : Math.ceil(R.filesize / 1024) + "KB"), e(O[0].insertCell(2)).addClass("ke-cell ke-datetime").html(R.datetime);
          }
        }
        function p(x) {
          l(x, p);
          for (var C = x.file_list, D = 0, I = C.length; I > D; D++) {
            var L = C[D], R = e('<div class="ke-inline-block ke-item"></div>');
            A.append(R);
            var O = e('<div class="ke-inline-block ke-photo"></div>').mouseover(function(W) {
              e(this).addClass("ke-on");
            }).mouseout(function(W) {
              e(this).removeClass("ke-on");
            });
            R.append(O);
            var U = x.current_url + L.filename, H = L.is_dir ? s + "folder-64.gif" : L.is_photo ? U : s + "file-64.gif", j = e('<img src="' + H + '" width="80" height="80" alt="' + L.filename + '" />');
            !L.is_dir || L.has_file ? (O.css("cursor", "pointer"), n(O, L), u(O, x, L, p)) : O.attr("title", a.emptyFolder), O.append(j), R.append('<div class="ke-name" title="' + L.filename + '">' + L.filename + "</div>");
          }
        }
        var m = e.undef(r.width, 650), g = e.undef(r.height, 510), y = e.undef(r.dirName, ""), w = e.undef(r.viewType, "VIEW").toUpperCase(), b = r.clickFn, _ = ['<div style="padding:10px 20px;">', '<div class="ke-plugin-filemanager-header">', '<div class="ke-left">', '<img class="ke-inline-block" name="moveupImg" src="' + s + 'go-up.gif" width="16" height="16" border="0" alt="" /> ', '<a class="ke-inline-block" name="moveupLink" href="javascript:;">' + a.moveup + "</a>", "</div>", '<div class="ke-right">', a.viewType + ' <select class="ke-inline-block" name="viewType">', '<option value="VIEW">' + a.viewImage + "</option>", '<option value="LIST">' + a.listImage + "</option>", "</select> ", a.orderType + ' <select class="ke-inline-block" name="orderType">', '<option value="NAME">' + a.fileName + "</option>", '<option value="SIZE">' + a.fileSize + "</option>", '<option value="TYPE">' + a.fileType + "</option>", "</select>", "</div>", '<div class="ke-clearfix"></div>', "</div>", '<div class="ke-plugin-filemanager-body"></div>', "</div>"].join(""), M = o.createDialog({ name: i, width: m, height: g, title: o.lang(i), body: _ }), N = M.div, A = e(".ke-plugin-filemanager-body", N), P = (e('[name="moveupImg"]', N), e('[name="moveupLink"]', N)), B = (e('[name="viewServer"]', N), e('[name="viewType"]', N)), E = e('[name="orderType"]', N), T = [];
        return B.val(w), d("", E.val(), w == "VIEW" ? p : f), M;
      };
    }), KindEditor.plugin("image", function(e) {
      var t = this, n = "image", o = e.undef(t.allowImageUpload, !0), i = e.undef(t.allowImageRemote, !0), c = e.undef(t.allowFileManager, !1), f = e.undef(t.uploadJson, t.basePath + "_404.html"), s = e.undef(t.uploadHeader, {}), a = e.undef(t.uploadFileSizeLimit, "2MB"), r = e.undef(t.uploadFileTypeLimit, "*.jpg;*.gif;*.png;*.jpeg,*.bmp"), d = e.undef(t.uploadResponseFilter, 0), u = e.undef(t.extraFileUploadParams, {}), l = e.undef(t.filePostName, "imgFile"), f = e.undef(t.uploadJson, t.basePath + "_404.html"), p = e.undef(t.formatUploadUrl, !0), m = t.uploadCompress, g = e.undef(t.imageTabIndex, 1), y = (t.pluginsPath + "", e.undef(t.fillDescAfterUploadImage, !1)), w = t.lang(n + ".");
      t.plugin.imageDialog = function(b) {
        function _(Q, X) {
          Q && H.val(Q), X && j.val(X);
        }
        var M = e.undef(b.showRemote, !0), N = e.undef(b.showLocal, !0), A = e.undef(b.tabIndex, 0), P = b.clickFn, B = ("" + new Date().getTime(), []);
        for (var E in u)
          B.push('<input type="hidden" name="' + E + '" value="' + u[E] + '" />');
        var T, x = ['<div style="padding:20px;">', '<div class="tabs"></div>', '<div class="tab1" style="display:none;">', '<div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' + w.remoteUrl + "</label>", '<input type="text" id="remoteUrl" class="ke-input-text" name="url" value="" style="width:' + (c ? 250 : 360) + 'px;" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (c ? 12 : 0) + 'px">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + w.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="remoteWidth" style="width:60px;">' + w.size + "</label>", w.width + '\uFF1A<input type="text" id="remoteWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" style="width:130px;margin-right:10px" />', w.height + '\uFF1A<input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" style="width:130px;margin-right:10px" />', '<span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-refresh-bold ke-refresh-btn"></span>', "</div>", '<div class="ke-dialog-row">', '<label style="width:60px;">' + w.align + "</label>", '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-default"></span><text style="margin-right:30px;">&nbsp;\u9ED8\u8BA4</text>', ' <input type="radio" name="align" class="ke-inline-block" value="left" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-left"></span><text style="margin-right:30px;">&nbsp;\u5DE6\u5BF9\u9F50</text>', ' <input type="radio" name="align" class="ke-inline-block" value="right" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-right"></span><text style="margin-right:30px;" >&nbsp;\u53F3\u5BF9\u9F50</text>', "</div>", '<div class="ke-dialog-row">', '<label for="remoteTitle" style="width:60px;">' + w.imgTitle + "</label>", '<input type="text" id="remoteTitle" class="ke-input-text" name="title" value="" style="width:360px;" />', "</div>", "</div>", '<div class="tab2" style="display:none;">', '<div class="ke-dialog-row">', '<label style="width:60px;">' + w.localUrl + "</label>", '<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:270px;" readonly="true" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + w.upload + '" />', "</div>", "</div>", "</div>"].join(""), C = 480, D = M ? 340 : 220, I = t.createDialog({ name: n, width: C, height: D + 3, title: t.lang(n), body: x, yesBtn: { name: t.lang("yes"), click: function(Q) {
          if (!I.isLoading) {
            if (N && M && T && T.selectedIndex === 1 || !M)
              return ae.fileBox.val() == "" ? void alert(t.lang("pleaseSelectFile")) : (I.showLoading(t.lang("uploadLoading")), ae.submit(), void O.val(""));
            var X = e.trim(R.val()), We = H.val(), Dt = j.val(), dt = le.val(), Mt = "";
            return K.each(function() {
              return this.checked ? (Mt = this.value, !1) : void 0;
            }), X == "http://" || e.invalidUrl(X) ? (alert(t.lang("invalidUrl")), void R[0].focus()) : /^\d*$/.test(We) ? /^\d*$/.test(Dt) ? void P.call(t, X, dt, We, Dt, 0, Mt) : (alert(t.lang("invalidHeight")), void j[0].focus()) : (alert(t.lang("invalidWidth")), void H[0].focus());
          }
        } }, beforeRemove: function() {
          U.unbind(), H.unbind(), j.unbind(), W.unbind();
        } }), L = I.div, R = e('[name="url"]', L), O = e('[name="localUrl"]', L), U = e('[name="viewServer"]', L), H = e('.tab1 [name="width"]', L), j = e('.tab1 [name="height"]', L), W = e(".ke-refresh-btn", L), le = e('.tab1 [name="title"]', L), K = e('.tab1 [name="align"]', L);
        M && N ? (T = e.tabs({ src: e(".tabs", L), afterSelect: function(Q) {
        } }), T.add({ title: w.remoteImage, panel: e(".tab1", L) }), T.add({ title: w.localImage, panel: e(".tab2", L) }), T.select(A)) : M ? e(".tab1", L).show() : N && e(".tab2", L).show();
        var ae = e.uploadbutton({ button: e(".ke-upload-button", L)[0], width: "auto", fieldName: l, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: s, uploadData: u, uploadUrl: e.addParam(f, "dir=image"), uploadResponseFilter: d, uploadCompress: m, afterUpload: function(Q) {
          if (I.hideLoading(), Q.error === 0) {
            var X = Q.url;
            p && (X = e.formatUrl(X, "absolute")), t.afterUpload && t.afterUpload.call(t, X, Q, n), y ? (e(".ke-dialog-row #remoteUrl", L).val(X), e(".ke-tabs-li", L)[0].click(), e(".ke-refresh-btn", L).click()) : P.call(t, X, Q.title, Q.width, Q.height, Q.border, Q.align);
          } else
            alert(Q.message), setTimeout(function() {
              O.val("");
            }, 100);
        }, afterError: function(Q) {
          I.hideLoading(), t.errorDialog(Q);
        } });
        ae.fileBox.change(function(Q) {
          O.val(ae.fileBox.val());
        }), c ? U.click(function(Q) {
          t.loadPlugin("filemanager", function() {
            t.plugin.filemanagerDialog({ viewType: "VIEW", dirName: "image", clickFn: function(X, We) {
              t.dialogs.length > 1 && (e('[name="url"]', L).val(X), t.afterSelectFile && t.afterSelectFile.call(t, X), t.hideDialog());
            } });
          });
        }) : U.hide();
        var ge = 0, fe = 0, ne = t.plugin.getSelectedImage();
        if (ne && ne.get) {
          var xe = ne.get();
          xe && (ge = xe.naturalWidth, fe = xe.naturalHeight, xe.width, xe.height);
        }
        return W.click(function(Q) {
          if (ge * fe > 0)
            return void _(ge, fe);
          var X = new Image();
          X.onload = function() {
            _(this.width, this.height), X = null;
          }, X.src = R.val();
        }), H.change(function(Q) {
          /^\d+$/.test(this.value) && this.value > 0 && j.val(Math.round(fe / ge * parseInt(this.value, 10)));
        }), j.change(function(Q) {
          /^\d+$/.test(this.value) && this.value > 0 && H.val(Math.round(ge / fe * parseInt(this.value, 10)));
        }), R.val(b.imageUrl), _(b.imageWidth, b.imageHeight), le.val(b.imageTitle), K.each(function() {
          return this.value === b.imageAlign ? (this.checked = !0, !1) : void 0;
        }), M && A === 0 && (R[0].focus(), R[0].select()), I;
      }, t.plugin.image = { edit: function() {
        var b = t.plugin.getSelectedImage();
        t.plugin.imageDialog({ imageUrl: b ? b.attr("data-ke-src") : "http://", imageWidth: b ? b.attr("width") : "", imageHeight: b ? b.attr("height") : "", imageTitle: b ? b.attr("title") : "", imageAlign: b ? b.attr("align") : "", showRemote: i, showLocal: o, tabIndex: b ? 0 : g, clickFn: function(_, M, N, A, P, B) {
          b ? (b.attr("src", _), b.attr("data-ke-src", _), N ? b.attr("width", N) : b.removeAttr("width"), A ? b.attr("height", A) : b.removeAttr("height"), M ? b.attr("title", M) : b.removeAttr("title"), B ? b.attr("align", B) : b.removeAttr("align"), M ? b.attr("alt", M) : b.removeAttr("alt")) : (t.exec("insertimage", _, M, N, A, P, B, "ke-image"), setTimeout(function() {
        ...
        var b = t.plugin.getSelectedImage();
        b.parent().name == "a" && (b = b.parent()), b.remove(), t.addBookmark();
      } }, t.clickToolbar(n, t.plugin.image.edit);
    }), KindEditor.plugin("insertfile", function(e) {
      var t = this, n = "insertfile", o = e.undef(t.allowFileUpload, !0), i = e.undef(t.allowFileManager, !1), c = e.undef(t.uploadHeader, {}), s = e.undef(t.uploadFileSizeLimit, "20MB"), a = e.undef(t.uploadFileTypeLimit, "*.mp3;*.wav;*.mp4;*.wmv;*.rmvb;*.avi,*.jpg;*.gif;*.png;*.jpeg,*.bmp"), r = e.undef(t.uploadResponseFilter, 0), d = e.undef(t.extraFileUploadParams, {}), u = e.undef(t.filePostName, "imgFile"), l = e.undef(t.uploadJson, t.basePath + "_404.html"), f = e.undef(t.formatUploadUrl, !0), p = t.lang(n + ".");
      t.plugin.fileDialog = function(m) {
        var g = e.undef(m.fileUrl, "http://"), y = e.undef(m.fileTitle, ""), w = m.clickFn, b = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + p.url + "</label>", '<input type="text" id="keUrl" name="url" class="ke-input-text" style="width:' + (i ? 160 : 260) + 'px;" />', '<input type="button" class="ke-upload-button" value="' + p.upload + '" />', '<span class="ke-button-common ke-button-outer" style="margin-left:' + (i ? 5 : 0) + 'px" >', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + p.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keTitle" style="width:60px;">' + p.title + "</label>", '<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:160px;" /></div>', "</div>", "</form>", "</div>"].join(""), _ = t.createDialog({ name: n, width: 450, height: 220, title: t.lang(n), body: b, yesBtn: { name: t.lang("yes"), click: function(E) {
          var T = e.trim(N.val()), x = P.val();
          return T == "http://" || e.invalidUrl(T) ? (alert(t.lang("invalidUrl")), void N[0].focus()) : (e.trim(x) === "" && (x = T), void w.call(t, T, x));
        } } }), M = _.div, N = e('[name="url"]', M), A = e('[name="viewServer"]', M), P = e('[name="title"]', M);
        if (o) {
          var B = e.uploadbutton({ button: e(".ke-upload-button", M)[0], width: "auto", fieldName: u, fileSizeLimit: s, fileTypeLimit: a, uploadHeader: c, uploadData: d, uploadUrl: e.addParam(l, "dir=file"), uploadResponseFilter: r, afterUpload: function(E) {
          ...
          B.fileBox.change(function(E) {
            var T = e("input[type='file']", B.form[0]).val();
            T && (_.showLoading(t.lang("uploadLoading")), B.submit());
          });
        } else
          e(".ke-upload-button", M).hide();
        i ? A.click(function(E) {
          t.loadPlugin("filemanager", function() {
            t.plugin.filemanagerDialog({ viewType: "LIST", dirName: "file", clickFn: function(T, x) {
              t.dialogs.length > 1 && (e('[name="url"]', M).val(T), t.afterSelectFile && t.afterSelectFile.call(t, T), t.hideDialog());
            } });
          });
        }) : A.hide(), N.val(g), P.val(y), N[0].focus(), N[0].select();
      }, t.clickToolbar(n, function() {
        t.plugin.fileDialog({ clickFn: function(m, g) {
          var y = '<a class="ke-insertfile" href="' + m + '" data-ke-src="' + m + '" target="_blank">' + g + "</a>";
          t.insertHtml(y).hideDialog().focus();
        } });
      });
    }), KindEditor.plugin("lineheight", function(e) {
      var t = this, n = "lineheight", o = t.lang(n + ".");
      t.clickToolbar(n, function() {
        var i = "", c = t.cmd.commonNode({ "*": ".line-height" });
        c && (i = c.css("line-height"));
        var s = t.createMenu({ name: n, width: 150 });
        e.each(o.lineHeight, function(a, r) {
          e.each(r, function(d, u) {
            s.addItem({ title: u, checked: i === d, click: function() {
      ...
      t.plugin.link = { edit: function() {
        var o = t.lang(n + "."), i = '<div style="padding:20px;"><div class="ke-dialog-row"><label for="keUrl" style="width:60px;">' + o.url + '</label><input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:260px;" /></div><div class="ke-dialog-row""><label for="keType" style="width:60px;">' + o.linkType + '</label><select id="keType" name="type"></select></div></div>', c = t.createDialog({ name: n, width: 450, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(u) {
          var l = e.trim(a.val());
          return l == "http://" || e.invalidUrl(l) ? (alert(t.lang("invalidUrl")), void a[0].focus()) : void t.exec("createlink", l, r.val()).hideDialog().focus();
        } } }), s = c.div, a = e('input[name="url"]', s), r = e('select[name="type"]', s);
      ...
      var t = this, n = "media", o = t.lang(n + "."), i = e.undef(t.allowMediaUpload, !0), c = e.undef(t.allowFileManager, !1), s = e.undef(t.uploadHeader, {}), a = e.undef(t.uploadFileSizeLimit, "20MB"), r = e.undef(t.uploadFileTypeLimit, "*.mp3;*.wav;*.mp4;*.wmv;*.rmvb;*.avi"), d = e.undef(t.uploadResponseFilter, 0), u = e.undef(t.extraFileUploadParams, {}), l = e.undef(t.filePostName, "imgFile"), f = e.undef(t.uploadJson, t.basePath + "_404.html"), p = e.undef(t.formatUploadUrl, !0), m = function(g) {
        for (var y = e(g.commonAncestor()); y && (y.type != 1 || y.isStyle()); )
          y = y.parent();
        return y;
      };
      t.plugin.media = { edit: function() {
        var g = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + o.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:' + (c ? 160 : 260) + 'px;" />', '<input type="button" class="ke-upload-button" value="' + o.upload + '" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (c ? 5 : 0) + 'px" >', '<input type="button" class="ke-button-common ke-button " name="viewServer" value="' + o.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + o.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="320" maxlength="4" />', '<label for="keHeight" style="width:60px;text-align:left;margin-left:30px">' + o.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="auto" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="kePreload" style="width:60px;">\u9884\u52A0\u8F7D</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="kePreload" name="preload" value="" /></div>', '<label for="keAutostart" style="width:60px;text-align:left;margin-left:30px">\u81EA\u52A8\u64AD\u653E</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keAutostart" name="autoplay" value="" /></div>', "</div>", '<div class="ke-dialog-row">', '<label for="keControls" style="width:60px;">\u63A7\u5236\u6309\u94AE</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keControls" name="controls" checked value="" /></div>', '<label for="keLoop" style="width:60px;text-align:left;margin-left:30px">\u5FAA\u73AF\u64AD\u653E</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keLoop" name="loop" checked value="" /></div>', "</div>", "</div>"].join(""), y = t.createDialog({ name: n, width: 450, height: 300, title: t.lang(n), body: g, yesBtn: { name: t.lang("yes"), click: function(x) {
          var C = e.trim(b.val()), D = M.val(), I = N.val(), L = P[0].checked, R = A[0].checked, O = B[0].checked, U = E[0].checked;
          if (C == "http://" || e.invalidUrl(C))
            return alert(t.lang("invalidUrl")), void b[0].focus();
          if (D != "auto" && !/^\d*$/.test(D))
            return alert(t.lang("invalidWidth")), void M[0].focus();
          if (I != "auto" && !/^\d*$/.test(I))
            return alert(t.lang("invalidHeight")), void N[0].focus();
          var H = "video";
          /\.(mp3|wav|ogg|acc)(\?|$)/i.test(C) && (H = "audio");
          var j = ["<p><" + H, 'data-ke-class="ke-audio"', 'class="ke-media"', 'style="display:inline;"', 'src="' + C + '"', 'width="' + D + '"', 'height="' + I + '"', L ? "preload" : "", R ? "autoplay" : "", O ? "controls" : "", U ? "loop" : "", "></" + H + "><span>\u200B\u3000</span></p>"].join(" "), W = m(t.cmd.range);
          W && W.name != "p" ? t.insertHtml(j).hideDialog().focus() : (e(W).after(j), t.hideDialog().focus());
        } } }), w = y.div, b = e('[name="url"]', w), _ = e('[name="viewServer"]', w), M = e('[name="width"]', w), N = e('[name="height"]', w), A = e('[name="autoplay"]', w), P = e('[name="preload"]', w), B = e('[name="controls"]', w), E = e('[name="loop"]', w);
        if (b.val("http://"), i) {
          var T = e.uploadbutton({ button: e(".ke-upload-button", w)[0], width: "auto", fieldName: l, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: s, uploadData: u, uploadUrl: e.addParam(f, "dir=media"), uploadResponseFilter: d, afterUpload: function(x) {
            if (y.hideLoading(), x.error === 0) {
              var C = x.url;
              p && (C = e.formatUrl(C, "absolute")), b.val(C), t.afterUpload && t.afterUpload.call(t, C, x, n);
            } else
              alert(x.message), setTimeout(function() {
                b.val("http://");
              }, 100);
          }, afterError: function(x) {
            y.hideLoading(), t.errorDialog(x);
          } });
          T.fileBox.change(function(x) {
            var C = e("input[type='file']", T.form[0]).val();
            C && (y.showLoading(t.lang("uploadLoading")), T.submit());
          });
        } else
          e(".ke-upload-button", w).hide();
        c ? _.click(function(x) {
          t.loadPlugin("filemanager", function() {
            t.plugin.filemanagerDialog({ viewType: "LIST", dirName: "media", clickFn: function(C, D) {
              t.dialogs.length > 1 && (e('[name="url"]', w).val(C), t.afterSelectFile && t.afterSelectFile.call(t, C), t.hideDialog());
            } });
          });
        }) : _.hide();
      }, delete: function() {
      ...
      e.extend(t, { init: function(n) {
        ...
        var c = "ke_multi_upload_btn" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999), s = "ke_multi_upload_dragbody" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999), a = "ke_multi_upload_error" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999);
        i.div = e(n.container).html(['<div class="ke-swfupload">', '<div class="ke-swfupload-top" >', '<div class="ke-inline-block ke-swfupload-button" id="' + c + '" style="width: 86px;">', "</div>", '<div class="ke-inline-block ke-swfupload-desc">' + n.uploadDesc + "</div>", '<span class="ke-button-common ke-button-outer ke-swfupload-startupload">', '<input type="button" class="ke-button-common ke-button ke-startup-upload-button" value="' + n.startButtonValue + '" />', "</span>", "</div>", '<div class="ke-swfupload-body" id="' + s + '"></div>', '<div class="upload-error-result" id="' + a + '"></div>', "</div>"].join("")), i.bodyDiv = e(".ke-swfupload-body", i.div), i.uploader = WebUploader.create({ server: i.options.uploadUrl, pick: "#" + c, resize: !1, fileVal: "file", accept: { title: "Images", extensions: n.fileTypes.replace(/\*\./g, "").replace(/;/g, ","), mimeTypes: "image/*" }, uploadBeforeSend: function(r, d, u) {
        }, headers: n.uploadHeader, formData: n.uploadData, fileNumLimit: n.fileUploadLimit, fileSingleSizeLimit: 1 * n.fileSizeLimit.replace(/MB/g, "") * 1024 * 1024 }), i.options.uploadCompress !== void 0 && (i.uploader.options.compress = i.options.uploadCompress), i.uploader.on("fileQueued", function(r) {
          i.uploader.makeThumb(r, function(d, u) {
            d && (u = i.options.fileIconUrl), r.url = u, i.appendFile(r);
          }, 80, 80);
        }), i.uploader.on("uploadStart", function(r) {
          var d = this, u = e('div[data-id="' + r.id + '"]', d.bodyDiv);
          e(".ke-status > div", u).hide(), e(".ke-progressbar", u).show();
        }), i.uploader.on("uploadProgress", function(r, d) {
          var u = i.progressbars[r.id], l = Math.floor(100 * d);
          u.bar.css("width", l + "%");
          var f = l >= 100 ? "\u4E0A\u4F20\u6210\u529F" : l + "%";
          u.percent.html(f).show();
        }), i.uploader.on("uploadSuccess", function(r, d) {
          var u = d;
          n.uploadResponseFilter && (u = n.uploadResponseFilter.call(null, d));
          var l = e('div[data-id="' + r.id + '"]', i.bodyDiv).eq(0), f = u;
          if (f.error !== 0)
            return void o(l, f.message || i.options.errorMessage);
          var p = f.url;
          p = i.options.formatUploadUrl ? r.url = e.formatUrl(f.url, "absolute") : r.url = f.url, e(".ke-img", l).attr("src", r.url).attr("data-status", "1").data("data", { url: p, title: r.name + "", width: (r._info || { width: "auto" }).width + "", height: "", border: "", align: "" });
        }), i.uploader.on("uploadError", function(r, d) {
          if (r) {
            var u = e('div[data-id="' + r.id + '"]', i.bodyDiv).eq(0);
        ...
        o.bodyDiv.append(i);
        var c = e('<div class="ke-inline-block ke-photo"></div>').mouseover(function(r) {
          e(this).addClass("ke-on");
        }).mouseout(function(r) {
          e(this).removeClass("ke-on");
        });
        i.append(c);
        var s = e('<img class="ke-multi-image ke-img" src="' + n.url + '" class="ke-img" draggable="false" data-status="0" alt="' + n.name + '" />');
        c.append(s), e('<span class="ke-delete"></span>').appendTo(c).click(function() {
          o.removeFile(n.id);
        });
        var a = e('<div class="ke-status"></div>').appendTo(c);
        e(['<div class="ke-progressbar">', '<div class="ke-progressbar-bar"><div class="ke-progressbar-bar-inner"></div></div>', '<div class="ke-progressbar-percent">0%</div></div>'].join("")).hide().appendTo(a), e('<div class="ke-message">' + o.options.pendingMessage + "</div>").appendTo(a), i.append('<div class="ke-name">' + n.name + "</div>"), o.progressbars[n.id] = { bar: e(".ke-progressbar-bar-inner", c), percent: e(".ke-progressbar-percent", c) };
      }, remove: function() {
        var n = this;
      ...
      var t = this, n = "multiimage", o = (e.undef(t.formatUploadUrl, !0), e.undef(t.uploadJson, t.basePath + "_404.html")), i = e.undef(t.uploadHeader, {}), c = e.undef(t.extraFileUploadParams, {}), s = t.pluginsPath + "multiimage/images/", a = e.undef(t.imageSizeLimit, "1MB"), r = (e.undef(t.imageFileTypes, "*.jpg;*.gif;*.png"), e.undef(t.uploadResponseFilter, 0)), d = e.undef(t.imageUploadLimit, 20), u = e.undef(t.filePostName, "imgFile"), l = t.lang(n + ".");
      t.plugin.multiImageDialog = function(f) {
        var p = f.clickFn, m = e.tmpl(l.uploadDesc, { uploadLimit: d, sizeLimit: a }), g = ['<div style="padding:10px 20px;">', '<div class="swfupload">', "</div>", "</div>"].join(""), y = t.createDialog({ name: n, width: 650, height: 500, title: t.lang(n), body: g, previewBtn: { name: l.insertAll, click: function(_) {
          p.call(t, b.getUrlList());
        } }, yesBtn: { name: l.clearAll, click: function(_) {
          b.removeFiles();
        } }, beforeRemove: function() {
          b.destroy();
        } }), w = y.div, b = e.swfupload({ container: e(".swfupload", w), buttonImageUrl: s + (t.langType == "zh-CN" ? "select-files-zh-CN.png" : "select-files-en.png"), buttonWidth: t.langType == "zh-CN" ? 72 : 88, buttonHeight: 23, fileIconUrl: s + "image.png", uploadDesc: m, startButtonValue: l.startUpload, uploadUrl: e.addParam(o, "dir=image"), uploadData: c, uploadHeader: i, uploadResponseFilter: r, uploadCompress: t.uploadCompress, formatUploadUrl: t.formatUploadUrl, flashUrl: s + "swfupload.swf", filePostName: u, fileTypes: "*.jpg;*.jpeg;*.gif;*.png;*.bmp", fileTypesDesc: "Image Files", fileUploadLimit: d, fileSizeLimit: a, postParams: e.undef(t.extraFileUploadParams, {}), queueLimitExceeded: l.queueLimitExceeded, fileExceedsSizeLimit: l.fileExceedsSizeLimit, zeroByteFile: l.zeroByteFile, invalidFiletype: l.invalidFiletype, unknownError: l.unknownError, pendingMessage: l.pending, errorMessage: l.uploadError, afterError: function(_) {
          t.errorDialog(_);
        } });
        return e(b.bodyDiv).bind("drop", function(_) {
          _.preventDefault(), _.event.preventDefault();
          var M = [];
          [].forEach.call(_.event.dataTransfer.files, function(N) {
            M.push(N);
          }, !1), M.length > 0 && b.uploader.addFiles(M), e(b.bodyDiv).removeClass("drag-hover");
        }), e(b.bodyDiv).bind("dragenter", function(_) {
          e(b.bodyDiv).addClass("drag-hover");
        }), e(b.bodyDiv).bind("dragover", function(_) {
          _.preventDefault();
        ...
        t.plugin.multiImageDialog({ clickFn: function(f) {
          f.length !== 0 && (e.each(f, function(p, m) {
            t.afterUpload && t.afterUpload.call(t, m.url, m, "multiimage"), t.exec("insertimage", m.url, m.title, m.width, m.height, m.border, m.align, "ke-image", "p");
          }), setTimeout(function() {
            t.hideDialog().focus();
          }, 0));
        } });
      ...
      t.clickToolbar(n, function() {
        var i = t.cmd, c = i.range;
        t.focus();
        var s = t.newlineTag == "br" || e.WEBKIT ? "" : '<span id="__kindeditor_tail_tag__"></span>';
        if (t.insertHtml(o + s), s !== "") {
          var a = e("#__kindeditor_tail_tag__", t.edit.doc);
          c.selectNodeContents(a[0]), a.removeAttr("id"), i.select();
        }
      });
    }), KindEditor.plugin("plainpaste", function(e) {
      var t = this, n = "plainpaste";
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><textarea class="ke-textarea" style="width:518px;height:260px;"></textarea></div>', c = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(a) {
          var r = s.val();
      ...
      t.clickToolbar(n, function() {
        var o = (t.lang(n + "."), '<div style="padding:10px 20px;"><iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe></div>'), i = t.createDialog({ name: n, width: 750, title: t.lang(n), body: o }), c = e("iframe", i.div), s = e.iframeDoc(c);
        s.open(), s.write(t.fullHtml()), s.close(), e(s.body).css("background-color", "#FFF"), c[0].contentWindow.focus();
      });
    }), KindEditor.plugin("quote", function(e) {
      function t(i) {
        for (var c = e(i.commonAncestor()); c && (c.type != 1 || c.isStyle()); )
          c = c.parent();
        return c;
      }
      var n = this, o = "quote";
      n.clickToolbar(o, function() {
        n.focus();
        var i = "\u200B", c = n.cmd.range, s = t(n.cmd.range);
        if (c) {
          var a = c.extractContents(), r = e(a).outer();
          i = r || e(a).html();
        }
        i = i || "\u200B";
        ...
        if (s && ["p", "h1", "h2", "h3", "h4", "h5", "h6"].indexOf(s.name) > -1) {
          e(s).after(d);
          var u = e(s).next();
          n.cmd.range.selectNodeContents(u).collapse(), n.cmd.select(), u.focus();
        } else {
          n.insertHtml(d);
          for (var l = s; l && l.children && l.children().length; )
            l = l.children();
      ...
      n.clickToolbar(o, function() {
        n.focus();
        for (var c, s = n.edit.doc, a = n.cmd.range, r = e(s.body).first(), d = [], u = [], l = a.createBookmark(!0); r; ) {
          c = r.next();
          var f = t(r);
          f && f.name == "img" || (i[r.name] ? (r.html(r.html().replace(/^(\s|&nbsp;|　)+/gi, "")), r.css("text-indent", "2em")) : u.push(r), (!c || i[c.name] || i[r.name] && !i[c.name]) && (u.length > 0 && d.push(u), u = [])), r = c;
        }
        e.each(d, function(p, m) {
          var g = e('<p style="text-indent:2em;"></p>', s);
          m[0].before(g), e.each(m, function(y, w) {
            g.append(w);
          });
      ...
      function n(d, u) {
        ...
        u.bind("click,mousedown", function(f) {
          ...
          l();
          var p = e(this), m = p.pos(), g = e.colorpicker({ x: m.x, y: m.y + p.height(), z: 811214, selectedColor: e(this).html(), colors: i.colorTable, noColor: i.lang("noColor"), shadowMode: i.shadowMode, click: function(y) {
            t(p, y), l();
          } });
      ...
      var i = this, c = "table", s = i.lang(c + "."), a = "ke-zeroborder", r = [];
      i.plugin.table = { prop: function(d) {
        var u = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keRows" style="width:90px;">' + s.cells + "</label>", s.rows + ' <input type="text" id="keRows" class="ke-input-text ke-input-number" name="rows" value="" maxlength="4" /> &nbsp; ', s.cols + ' <input type="text" class="ke-input-text ke-input-number" name="cols" value="" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + s.size + "</label>", s.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select> &nbsp; ", s.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="kePadding" style="width:90px;">' + s.space + "</label>", s.padding + ' <input type="text" id="kePadding" class="ke-input-text ke-input-number" name="padding" value="" maxlength="4" /> &nbsp; ', s.spacing + ' <input type="text" class="ke-input-text ke-input-number" name="spacing" value="" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + s.align + "</label>", '<select id="keAlign" name="align">', '<option value="">' + s.alignDefault + "</option>", '<option value="left">' + s.alignLeft + "</option>", '<option value="center">' + s.alignCenter + "</option>", '<option value="right">' + s.alignRight + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + s.border + "</label>", s.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', s.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', "</div>", '<div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + s.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span>', "</div>", "</div>"].join(""), l = i.cmd.range.createBookmark(), f = i.createDialog({ name: c, width: 500, title: i.lang(c), body: u, beforeRemove: function() {
          B.unbind();
        }, yesBtn: { name: i.lang("yes"), click: function(D) {
          var I = m.val(), L = g.val(), R = y.val(), O = w.val(), U = b.val(), H = _.val(), j = M.val(), W = N.val(), le = A.val(), K = P.val(), ae = e(B[0]).html() || "", ge = e(B[1]).html() || "";
          if (I == 0 || !/^\d+$/.test(I))
            return alert(i.lang("invalidRows")), void m[0].focus();
          if (L == 0 || !/^\d+$/.test(L))
            return alert(i.lang("invalidRows")), void g[0].focus();
          if (!/^\d*$/.test(R))
            return alert(i.lang("invalidWidth")), void y[0].focus();
          if (!/^\d*$/.test(O))
            return alert(i.lang("invalidHeight")), void w[0].focus();
          if (!/^\d*$/.test(j))
            return alert(i.lang("invalidPadding")), void M[0].focus();
          if (!/^\d*$/.test(W))
            return alert(i.lang("invalidSpacing")), void N[0].focus();
          if (!/^\d*$/.test(K))
            return alert(i.lang("invalidBorder")), void P[0].focus();
          if (E)
            return R !== "" ? E.width(R + U) : E.css("width", ""), E[0].width !== void 0 && E.removeAttr("width"), O !== "" ? E.height(O + H) : E.css("height", ""), E[0].height !== void 0 && E.removeAttr("height"), E.css("background-color", ge), E[0].bgColor !== void 0 && E.removeAttr("bgColor"), j !== "" ? E[0].cellPadding = j : E.removeAttr("cellPadding"), W !== "" ? E[0].cellSpacing = W : E.removeAttr("cellSpacing"), le !== "" ? E[0].align = le : E.removeAttr("align"), K !== "" ? E.attr("border", K) : E.removeAttr("border"), K === "" || K === "0" ? E.addClass(a) : E.removeClass(a), ae !== "" ? E.attr("borderColor", ae) : E.removeAttr("borderColor"), i.hideDialog().focus(), i.cmd.range.moveToBookmark(l), i.cmd.select(), void i.addBookmark();
          var fe = "";
          R !== "" && (fe += "width:" + R + U + ";"), O !== "" && (fe += "height:" + O + H + ";"), ge !== "" && (fe += "background-color:" + ge + ";");
          var ne = "<table";
          fe !== "" && (ne += ' style="' + fe + '"'), j !== "" && (ne += ' cellpadding="' + j + '"'), W !== "" && (ne += ' cellspacing="' + W + '"'), le !== "" && (ne += ' align="' + le + '"'), K !== "" && (ne += ' border="' + K + '"'), (K === "" || K === "0") && (ne += ' class="' + a + '"'), ae !== "" && (ne += ' bordercolor="' + ae + '"'), ne += ">";
          for (var xe = 0; I > xe; xe++) {
            ne += "<tr>";
            for (var Q = 0; L > Q; Q++)
              ne += "<td>" + (e.IE ? "&nbsp;" : "<br />") + "</td>";
            ne += "</tr>";
          }
          ne += "</table>", e.IE || (ne += "<br />"), i.insertHtml(ne), i.select().hideDialog().focus(), i.addBookmark();
        } } }), p = f.div, m = e('[name="rows"]', p).val(3), g = e('[name="cols"]', p).val(2), y = e('[name="width"]', p).val(100), w = e('[name="height"]', p), b = e('[name="widthType"]', p), _ = e('[name="heightType"]', p), M = e('[name="padding"]', p).val(2), N = e('[name="spacing"]', p).val(0), A = e('[name="align"]', p), P = e('[name="border"]', p).val(1), B = e(".ke-input-color", p);
        n(p, B.eq(0)), n(p, B.eq(1)), t(B.eq(0), "#000000"), t(B.eq(1), ""), m[0].focus(), m[0].select();
        var E;
        if (!d && (E = i.plugin.getSelectedTable())) {
          ...
          var T, x = E[0].style.width || E[0].width, C = E[0].style.height || E[0].height;
          x !== void 0 && (T = /^(\d+)((?:px|%)*)$/.exec(x)) ? (y.val(T[1]), b.val(T[2])) : y.val(""), C !== void 0 && (T = /^(\d+)((?:px|%)*)$/.exec(C)) && (w.val(T[1]), _.val(T[2])), M.val(E[0].cellPadding || ""), N.val(E[0].cellSpacing || ""), A.val(E[0].align || ""), P.val(E[0].border === void 0 ? "" : E[0].border), t(B.eq(0), e.toHex(E.attr("borderColor") || "")), t(B.eq(1), e.toHex(E[0].style.backgroundColor || E[0].bgColor || "")), y[0].focus(), y[0].select();
        }
      }, cellprop: function() {
        var d = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + s.size + "</label>", s.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select> &nbsp; ", s.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + s.align + "</label>", s.textAlign + ' <select id="keAlign" name="textAlign">', '<option value="">' + s.alignDefault + "</option>", '<option value="left">' + s.alignLeft + "</option>", '<option value="center">' + s.alignCenter + "</option>", '<option value="right">' + s.alignRight + "</option>", "</select> ", s.verticalAlign + ' <select name="verticalAlign">', '<option value="">' + s.alignDefault + "</option>", '<option value="top">' + s.alignTop + "</option>", '<option value="middle">' + s.alignMiddle + "</option>", '<option value="bottom">' + s.alignBottom + "</option>", '<option value="baseline">' + s.alignBaseline + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + s.border + "</label>", s.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', s.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', "</div>", '<div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + s.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span>', "</div>", "</div>"].join(""), u = i.cmd.range.createBookmark(), l = i.createDialog({ name: c, width: 500, title: i.lang("tablecell"), body: d, beforeRemove: function() {
          A.unbind();
        }, yesBtn: { name: i.lang("yes"), click: function(C) {
          var D = p.val(), I = m.val(), L = g.val(), R = y.val(), O = (w.val(), b.val(), _.val()), U = M.val(), H = N.val(), j = e(A[0]).html() || "", W = e(A[1]).html() || "";
          return /^\d*$/.test(D) ? /^\d*$/.test(I) ? /^\d*$/.test(H) ? (B.css({ width: D !== "" ? D + L : "", height: I !== "" ? I + R : "", "background-color": W, "text-align": O, "vertical-align": U, "border-width": H, "border-style": H !== "" ? "solid" : "", "border-color": j }), i.hideDialog().focus(), i.cmd.range.moveToBookmark(u), i.cmd.select(), void i.addBookmark()) : (alert(i.lang("invalidBorder")), void N[0].focus()) : (alert(i.lang("invalidHeight")), void m[0].focus()) : (alert(i.lang("invalidWidth")), void p[0].focus());
        } } }), f = l.div, p = e('[name="width"]', f).val(100), m = e('[name="height"]', f), g = e('[name="widthType"]', f), y = e('[name="heightType"]', f), w = e('[name="padding"]', f).val(2), b = e('[name="spacing"]', f).val(0), _ = e('[name="textAlign"]', f), M = e('[name="verticalAlign"]', f), N = e('[name="border"]', f).val(1), A = e(".ke-input-color", f);
        n(f, A.eq(0)), n(f, A.eq(1)), t(A.eq(0), "#000000"), t(A.eq(1), ""), p[0].focus(), p[0].select();
        var P, B = i.plugin.getSelectedCell(), E = B[0].style.width || B[0].width || "", T = B[0].style.height || B[0].height || "";
        (P = /^(\d+)((?:px|%)*)$/.exec(E)) ? (p.val(P[1]), g.val(P[2])) : p.val(""), (P = /^(\d+)((?:px|%)*)$/.exec(T)) && (m.val(P[1]), y.val(P[2])), _.val(B[0].style.textAlign || ""), M.val(B[0].style.verticalAlign || "");
        var x = B[0].style.borderWidth || "";
        x && (x = parseInt(x)), N.val(x), t(A.eq(0), e.toHex(B[0].style.borderColor || "")), t(A.eq(1), e.toHex(B[0].style.backgroundColor || "")), p[0].focus(), p[0].select();
      }, insert: function() {
        this.prop(!0);
      }, delete: function() {
        ...
        var u = i.plugin.getSelectedTable()[0], l = i.plugin.getSelectedRow()[0], f = i.plugin.getSelectedCell()[0], p = f.cellIndex + d;
        p += u.rows[0].cells.length - l.cells.length;
        for (var m = 0, g = u.rows.length; g > m; m++) {
          var y = u.rows[m], w = y.insertCell(p);
          w.innerHTML = e.IE ? "" : "<br />", p = o(u, y, w);
        }
        ...
        var u = i.plugin.getSelectedTable()[0], l = i.plugin.getSelectedRow()[0], f = i.plugin.getSelectedCell()[0], p = l.rowIndex;
        ...
        for (var m = u.insertRow(p), g = 0, y = l.cells.length; y > g; g++) {
          ...
          var w = m.insertCell(g);
          d === 1 && l.cells[g].colSpan > 1 && (w.colSpan = l.cells[g].colSpan), w.innerHTML = e.IE ? "" : "<br />";
        }
        for (var b = p; b >= 0; b--) {
          var _ = u.rows[b].cells;
          if (_.length > g) {
            for (var M = f.cellIndex; M >= 0; M--)
              _[M].rowSpan > 1 && (_[M].rowSpan += 1);
            break;
          }
        }
        i.cmd.range.selectNodeContents(f).collapse(!0), i.cmd.select(), i.addBookmark();
        ...
        var d = i.plugin.getSelectedTable()[0], u = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = u.rowIndex, p = f + l.rowSpan, m = d.rows[p];
        if (!(d.rows.length <= p)) {
          var g = l.cellIndex;
          if (!(m.cells.length <= g)) {
            var y = m.cells[g];
            l.colSpan === y.colSpan && (l.rowSpan += y.rowSpan, m.deleteCell(g), i.cmd.range.selectNodeContents(l).collapse(!0), i.cmd.select(), i.addBookmark());
          }
        }
      }, colmerge: function() {
        var d = (i.plugin.getSelectedTable()[0], i.plugin.getSelectedRow()[0]), u = i.plugin.getSelectedCell()[0], l = (d.rowIndex, u.cellIndex), f = l + 1;
        if (!(d.cells.length <= f)) {
          var p = d.cells[f];
          u.rowSpan === p.rowSpan && (u.colSpan += p.colSpan, d.deleteCell(f), i.cmd.range.selectNodeContents(u).collapse(!0), i.cmd.select(), i.addBookmark());
        }
      }, rowsplit: function() {
        var d = i.plugin.getSelectedTable()[0], u = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = u.rowIndex;
        if (l.rowSpan !== 1) {
          for (var p = o(d, u, l), m = 1, g = l.rowSpan; g > m; m++) {
            var y = d.rows[f + m], w = y.insertCell(p);
            l.colSpan > 1 && (w.colSpan = l.colSpan), w.innerHTML = e.IE ? "" : "<br />", p = o(d, y, w);
          }
          e(l).removeAttr("rowSpan"), i.cmd.range.selectNodeContents(l).collapse(!0), i.cmd.select(), i.addBookmark();
        }
      }, colsplit: function() {
        var d = (i.plugin.getSelectedTable()[0], i.plugin.getSelectedRow()[0]), u = i.plugin.getSelectedCell()[0], l = u.cellIndex;
        if (u.colSpan !== 1) {
          for (var f = 1, p = u.colSpan; p > f; f++) {
            var m = d.insertCell(l + f);
            u.rowSpan > 1 && (m.rowSpan = u.rowSpan), m.innerHTML = e.IE ? "" : "<br />";
          }
          e(u).removeAttr("colSpan"), i.cmd.range.selectNodeContents(u).collapse(!0), i.cmd.select(), i.addBookmark();
        }
      }, coldelete: function() {
        for (var d = i.plugin.getSelectedTable()[0], u = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = l.cellIndex, p = 0, m = d.rows.length; m > p; p++) {
        ...
        u.cells.length === 0 ? (i.cmd.range.setStartBefore(d).collapse(!0), i.cmd.select(), e(d).remove()) : i.cmd.selection(!0), i.addBookmark();
      }, rowdelete: function() {
        for (var d = i.plugin.getSelectedTable()[0], u = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = u.rowIndex, p = l.rowSpan - 1; p >= 0; p--)
          d.deleteRow(f + p);
        d.rows.length === 0 ? (i.cmd.range.setStartBefore(d).collapse(!0), i.cmd.select(), e(d).remove()) : i.cmd.selection(!0), i.addBookmark();
      } }, i.clickToolbar(c, i.plugin.table.prop);
    }), KindEditor.plugin("template", function(e) {
      var t = this, n = "template", o = (t.lang(n + "."), t.pluginsPath + n + "", e.undef(t.templates, e.Templates));
      t.clickToolbar(n, function() {
        var i = t.lang(n + "."), c = ['<div style="padding:10px 20px;">', '<div class="ke-header">', '<div class="ke-left">', i.selectTemplate + " <select>"];
        e.each(o, function(u, l) {
          c.push("<option value='" + l.content + "'>" + l.name + "</option>");
        ...
        var s = t.createDialog({ name: n, width: 560, title: t.lang(n), body: Et, yesBtn: { name: t.lang("yes"), click: function(u) {
          t[r[0].checked ? "html" : "insertHtml"](a.val()).hideDialog().focus();
        } } }), a = e("select", s.div), r = e('[name="replaceFlag"]', s.div), d = e(".ke-temp-preview", s.div);
      ...
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:518px;height:260px;"></iframe></div>', c = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(d) {
          var u = r.body.innerHTML;
          u = e.clearMsWord(u, t.filterMode ? t.htmlTags : e.options.htmlTags), t.insertHtml(u).hideDialog().focus();
        } } }), s = c.div, a = e("iframe", s), r = e.iframeDoc(a);
      ...
      function t() {
        var c = e(".ke-toolbar"), s = e(c).parent();
        e(".ke-toolbar").width(), e(window).bind("resize", function() {
          c.css("width", e(s).width() - 2 + "px");
        }), c.css("width", e(s).width() + "px"), e(i).bind("scroll", function() {
          var a = s.pos().y, r = i.pos().y;
          r >= a ? (c.css("position", "fixed"), c.css("top", r + "px"), c.css("border-top", "1px solid #ccc")) : (c.css("position", "static"), c.css("top", "auto"), c.css("border-top", "none"));
        });
      }
      var n = this, o = e("body");
      if (n.fixToolBar) {
...
const pt = KindEditor, zi = ["id"], Pi = {
  ...
  setup(Ve, { emit: ht }) {
    ...
    var ie = null;
    Ni(() => {
      pt.remove("#" + te), ie = pt.create("#" + te, Ke), ee && ee.modelValue && ie.html(ee.modelValue);
    }), Ii(() => {
      pt.remove("#" + te), ie && ie.remove(), ie = null;
    }), Ai(() => {
      pt.remove("#" + te), ie = pt.create("#" + te, Ke), ee && ee.modelValue && ie.html(ee.modelValue);
    });
    const he = (J = ee.configs) == null ? void 0 : J.afterBlur, z = (Z = ee.configs) == null ? void 0 : Z.afterChange, te = ee.id;
    var Ke = Object.assign(
      ...
      ee.configs,
      {
        ...
        allowFileManager: !1,
        afterBlur: function() {
          this.sync(), he && he.call(this);
        },
        afterChange: function() {
          ie && ht("update:modelValue", ie.html()), z && z.call(this);
        }
      }
    );
    return Ri(
...
const Hi = {
  install(Ve, ht) {
    const ee = ht || { name: "VKindEditor" };
    Ve.component(ee.name, Pi);
  }
};
export {
  Hi as default
