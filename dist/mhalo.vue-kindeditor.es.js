  ...
  (function(ee, re) {
    ...
    function he(e, t, n) {
      ...
      if (t) {
        ...
        i.prototype = t.prototype, o = new i(), j(n, function(u, s) {
          o[u] = s;
        });
      } else
        o = n;
    ...
    function Ue(e, t, n) {
      if (t.indexOf(",") >= 0)
        return void j(t.split(","), function() {
          Ue(e, this, n);
        });
      var o = Et(e);
      o || (o = Kn(e)), le[o] === void 0 && (le[o] = {});
      var i = le[o][t];
      i && i.length > 0 ? ht(e, t, i[0]) : (le[o][t] = [], le[o].el = e), i = le[o][t], i.length === 0 && (i[0] = function(u) {
        var s = u ? new Xt(e, u) : void 0;
        j(i, function(a, r) {
          a > 0 && r && r.call(e, s);
        });
      }), pe(n, i) < 0 && i.push(n), Vn(e, t, i[0]);
    }
    function Ge(e, t, n) {
      if (t && t.indexOf(",") >= 0)
        return void j(t.split(","), function() {
      ...
      if (o) {
        if (t === void 0)
          return void (o in le && (j(le[o], function(s, a) {
            s != "el" && a.length > 0 && ht(e, s, a[0]);
          }), delete le[o], Jt(e)));
        if (le[o]) {
          var i = le[o][t];
          if (i && i.length > 0) {
            n === void 0 ? (ht(e, t, i[0]), delete le[o][t]) : (j(i, function(s, a) {
              s > 0 && a === n && i.splice(s, 1);
            }), i.length == 1 && (ht(e, t, i[0]), delete le[o][t]));
            var u = 0;
            j(le[o], function() {
              u++;
            }), 2 > u && (delete le[o], Jt(e));
          }
        }
      }
    }
    ...
    function je(e) {
      ...
      for (var t, n = {}, o = /\s*([\w\-]+)\s*:([^;]*)(;|$)/g; t = o.exec(e); ) {
        var i = te(t[1].toLowerCase()), u = te(pt(t[2]));
        n[i] = u;
      }
      return n;
    }
    ...
    function Yn(e) {
      var t = "";
      return j(je(e), function(n, o) {
        t += n + ":" + o + ";";
      }), t;
    }
    function Qe(e, t, n, o) {
      function i(r) {
        for (var d = r.split("/"), c = [], l = 0, f = d.length; f > l; l++) {
          var p = d[l];
          p == ".." ? c.length > 0 && c.pop() : p !== "" && p != "." && c.push(p);
        }
        return "/" + c.join("/");
      }
      function u(r, d) {
        if (e.substr(0, r.length) === r) {
          for (var c = [], l = 0; d > l; l++)
            c.push("..");
          var f = ".";
          return c.length > 0 && (f += "/" + c.join("/")), o == "/" && (f += "/"), f + e.substr(r.length);
        }
    ...
    function Ie(e, t, n, o, i) {
      e == null && (e = ""), n = n || "", o = $(o, !1), i = $(i, "	");
      var u = "xx-small,x-small,small,medium,large,x-large,xx-large".split(",");
      e = e.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/gi, function(d, c, l, f) {
        return c + l.replace(/<(?:br|br\s[^>]*)>/gi, `
`) + f;
      ...
      return e = e.replace(a, function(d, c, l, f, p, m, g) {
        var v = d, b = c || "", C = l || "", T = f.toLowerCase(), N = p || "", M = m ? " " + m : "", A = g || "";
        if (t && !s[T])
          return "";
        if (M === "" && An[T] && (M = " /"), Nn[T] && (b && (b = " "), A && (A = " ")), Vt[T] && (C ? A = `
` : b = `
`), o && T == "br" && (A = `
`), In[T] && !Vt[T])
          if (o) {
            C && r.length > 0 && r[r.length - 1] === T ? r.pop() : r.push(T), b = `
`, A = `
`;
            for (var z = 0, R = C ? r.length : r.length - 1; R > z; z++)
              b += i, C || (A += i);
            M ? r.pop() : C || (A += i);
          } else
            b = A = "";
        if (N !== "") {
          ...
          if (T === "font") {
            var S = {}, w = "";
            j(D, function(x, _) {
              x === "color" && (S.color = _, delete D[x]), x === "size" && (S["font-size"] = u[parseInt(_, 10) - 1] || "", delete D[x]), x === "face" && (S["font-family"] = _, delete D[x]), x === "style" && (w = _);
            }), w && !/;$/.test(w) && (w += ";"), j(S, function(x, _) {
              _ !== "" && (/\s/.test(_) && (_ = "'" + _ + "'"), w += x + ":" + _ + ";");
            }), D.style = w;
          }
          j(D, function(x, _) {
            if (xi[x] && (D[x] = x), pe(x, ["src", "href"]) >= 0 && (D[x] = Qe(_, n)), (t && x !== "style" && !s[T]["*"] && !s[T][x] || T === "body" && x === "contenteditable" || /^kindeditor_\d+$/.test(x)) && delete D[x], x === "style" && _ !== "") {
              var I = je(_);
              j(I, function(L, U) {
                !t || s[T].style || s[T]["." + L] || delete I[L];
              });
              var O = "";
              j(I, function(L, U) {
                O += L + ":" + U + ";";
            ...
            (x !== "style" || _ !== "") && (_ = _.replace(/"/g, "&quot;"), N += " " + x + '="' + _ + '"');
          });
        }
        return T === "font" && (T = "span"), b + "<" + C + T + N + M + ">" + A;
      }), e = e.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/gi, function(d, c, l, f) {
...
`), te(e);
    ...
    function on(e, t) {
      var n = t.width, o = t.height, i = t.type || nn(t.src), u = Mt(t), s = "";
      /\D/.test(n) ? s += "width:" + n + ";" : n > 0 && (s += "width:" + n + "px;"), /\D/.test(o) ? s += "height:" + o + ";" : o > 0 && (s += "height:" + o + "px;");
      var a = '<img class="' + Zn(i) + '" src="' + e + '" ';
      return s !== "" && (a += 'style="' + s + '" '), a += 'data-ke-tag="' + escape(u) + '" alt="" />';
    }
    function Xn(e, t) {
    ...
    function vt(e, t) {
      ...
      function u(x, _, I) {
        var O = [], L = I.ownerDocument || I, U = L.getElementById(o(x));
        return U && i(_, U.nodeName) && mt(I, U) && O.push(U), O;
      }
      function s(x, _, I) {
        var O, L, U, F, W = I.ownerDocument || I, P = [];
        if (I.getElementsByClassName)
          for (O = I.getElementsByClassName(o(x)), L = 0, U = O.length; U > L; L++)
            F = O[L], i(_, F.nodeName) && P.push(F);
        else if (W.querySelectorAll)
          for (O = W.querySelectorAll((I.nodeName !== "#document" ? I.nodeName + " " : "") + _ + "." + x), L = 0, U = O.length; U > L; L++)
            F = O[L], mt(I, F) && P.push(F);
        else
          for (O = I.getElementsByTagName(_), x = " " + x + " ", L = 0, U = O.length; U > L; L++)
            if (F = O[L], F.nodeType == 1) {
              var V = F.className;
              V && (" " + V + " ").indexOf(x) > -1 && P.push(F);
            }
        return P;
      }
      function a(x, _, I) {
        for (var O, L = [], U = I.ownerDocument || I, F = U.getElementsByName(o(x)), W = 0, P = F.length; P > W; W++)
          O = F[W], i(_, O.nodeName) && mt(I, O) && O.getAttribute("name") !== null && L.push(O);
        return L;
      }
      function r(x, _, I, O) {
        for (var L, U = [], F = O.getElementsByTagName(I), W = 0, P = F.length; P > W; W++)
      ...
      function d(x, _) {
        ...
        if (I = /#((?:[\w\-]|\\.)+)$/.exec(x))
          ...
          O = r(I[1].toLowerCase(), null, L, _);
        else if (I = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(x)) {
          var U = I[1].toLowerCase(), F = I[2];
          O = U === "id" ? u(F, L, _) : U === "class" ? s(F, L, _) : U === "name" ? a(F, L, _) : r(U, F, L, _);
        } else
          for (var W, P = _.getElementsByTagName(L), V = 0, ne = P.length; ne > V; V++)
            W = P[V], W.nodeType == 1 && O.push(W);
        return O;
      }
      var c = e.split(",");
      if (c.length > 1) {
      ...
      if (p.length == 1)
        return d(p[0], t);
      var v, b, C, T, N, M, A, z, R, D, S, w = !1;
      for (M = 0, R = p.length; R > M; M++)
        if (v = p[M], v !== ">") {
          if (M > 0) {
            for (b = [], A = 0, D = g.length; D > A; A++)
              for (T = g[A], C = d(v, T), z = 0, S = C.length; S > z; z++)
                N = C[z], w ? T === N.parentNode && b.push(N) : b.push(N);
            g = b;
          } else
            g = d(v, t);
          if (g.length === 0)
    ...
    function At(e, t, n) {
      function o(T, N, M) {
        var A, z = T.nodeValue.length;
        if (t) {
          var R = T.cloneNode(!0);
          A = N > 0 ? R.splitText(N) : R, z > M && A.splitText(M - N);
        }
        if (n) {
          var D = T;
          if (N > 0 && (D = T.splitText(N), e.setStart(T, N)), z > M) {
            var S = D.splitText(M - N);
            e.setEnd(S, 0);
          }
          a.push(D);
        }
      ...
      function u(T, N) {
        for (var M, A = T.firstChild; A; ) {
          var z = new we(s).selectNode(A);
          if (d = z.compareBoundaryPoints(lt, e), d >= 0 && 0 >= c && (c = z.compareBoundaryPoints(ot, e)), c >= 0 && 0 >= l && (l = z.compareBoundaryPoints(He, e)), l >= 0 && 0 >= f && (f = z.compareBoundaryPoints(at, e)), f >= 0)
            return !1;
          if (M = A.nextSibling, d > 0) {
            if (A.nodeType == 1)
              if (c >= 0 && 0 >= l)
                t && N.appendChild(A.cloneNode(!0)), n && a.push(A);
              else {
                var R;
                if (t && (R = A.cloneNode(!1), N.appendChild(R)), u(A, R) === !1)
                  return !1;
              }
            else if (A.nodeType == 3) {
              var D;
              if (D = A == r.startContainer ? o(A, r.startOffset, A.nodeValue.length) : A == r.endContainer ? o(A, 0, r.endOffset) : o(A, 0, A.nodeValue.length), t)
                try {
                  N.appendChild(D);
                } catch {
                }
      ...
      var s = e.doc, a = [], r = e.cloneRange().down(), d = -1, c = -1, l = -1, f = -1, p = e.commonAncestor(), m = s.createDocumentFragment();
      if (p.nodeType == 3) {
        var g = o(p, e.startOffset, e.endOffset);
        return t && m.appendChild(g), i(), t ? m : e;
      }
      u(p, m), n && e.up().collapse(!0);
      for (var v = 0, b = a.length; b > v; v++) {
        var C = a[v];
    ...
    function cn(e, t) {
      ...
      if (u.length === 0)
        return { node: i.parentNode, offset: y(i).index() };
      var s = n, a = 0, r = -1, d = e.duplicate();
      Ye(d, i);
      for (var c = 0, l = u.length; l > c; c++) {
        var f = u[c];
        if (r = d.compareEndPoints("StartToStart", o), r === 0)
          return { node: f.parentNode, offset: c };
        if (f.nodeType == 1) {
          var p, m = e.duplicate(), g = y(f), v = f;
          g.isControl() && (p = n.createElement("span"), g.after(p), v = p, a += g.text().replace(/\r\n|\n|\r/g, "").length), Ye(m, v), d.setEndPoint("StartToEnd", m), r > 0 ? a += m.text.replace(/\r\n|\n|\r/g, "").length : a = 0, p && y(p).remove();
        } else
          f.nodeType == 3 && (d.moveStart("character", f.nodeValue.length), a += f.nodeValue.length);
        0 > r && (s = f);
      }
      if (0 > r && s.nodeType == 1)
        return { node: i, offset: y(i.lastChild).index() + 1 };
      if (r > 0)
        for (; s.nextSibling && s.nodeType == 1; )
          s = s.nextSibling;
      if (d = e.duplicate(), Ye(d, i), d.setEndPoint("StartToEnd", o), a -= d.text.replace(/\r\n|\n|\r/g, "").length, r > 0 && s.nodeType == 3)
        for (var b = s.previousSibling; b && b.nodeType == 3; )
    ...
    function un(e, t) {
      ...
      if (e.nodeType == 1 && e.childNodes.length > 0) {
        var i, u, s = e.childNodes;
        if (t === 0 ? (u = s[0], i = !0) : (u = s[t - 1], i = !1), !u)
          return o;
        if (y(u).name === "head")
          return t === 1 && (i = !0), t === 2 && (i = !1), o.collapse(i), o;
        if (u.nodeType == 1) {
          var a, r = y(u);
          return r.isControl() && (a = n.createElement("span"), i ? r.before(a) : r.after(a), u = a), Ye(o, u), o.collapse(i), a && y(a).remove(), o;
        }
        e = u, t = i ? 0 : u.nodeValue.length;
      }
      var d = n.createElement("span");
      return y(e).before(d), Ye(o, d), o.moveStart("character", t), y(d).remove(), o;
    }
    function dn(e) {
      function t(a) {
        y(a.node).name == "tr" && (a.node = a.node.cells[a.offset], a.offset = 0);
      }
      var n, o;
      if (ye) {
        if (e.item)
        ...
        var i = cn(e, !0), u = cn(e, !1);
        return t(i), t(u), o = new we(n), o.setStart(i.node, i.offset), o.setEnd(u.node, u.offset), o;
      }
      var s = e.startContainer;
      return n = s.ownerDocument || s, o = new we(n), o.setStart(s, e.startOffset), o.setEnd(e.endContainer, e.endOffset), o;
    }
    function we(e) {
      this.init(e);
    }
    ...
    function hn(e, t, n) {
      ...
      if (!o[n])
        return !1;
      for (var i = o[n].split(","), u = 0, s = i.length; s > u; u++) {
        var a = i[u];
        if (a === "*")
          return !0;
    ...
    function mn(e, t, n) {
      if (n = n || e.name, e.type === 1) {
        var o = pn(t);
        if (o[n]) {
          for (var i = o[n].split(","), u = !1, s = 0, a = i.length; a > s; s++) {
            var r = i[s];
            if (r === "*") {
              u = !0;
              break;
            ...
            var d = /^(\.?)([^=]+)(?:=([^=]*))?$/.exec(r);
            r = d[2], d[1] ? (r = Ke(r), e[0].style[r] && (e[0].style[r] = "")) : e.removeAttr(r);
          }
          u && e.remove(!0);
        }
      }
    ...
    function ri(e, t) {
      e = e.clone(!0);
      for (var n = Ft(e), o = e, i = !1; t; ) {
        for (; o; )
          o.name === t.name && (li(o, t.attr(), t.css()), i = !0), o = o.first();
    ...
    function oi(e, t) {
      ...
      return t = ri(o, t), i.firstChild && Ft(t).append(i), o.replaceWith(t), t;
    }
    function li(e, t, n) {
      j(t, function(o, i) {
        o !== "style" && e.attr(o, i);
    ...
    function Ut(e) {
      var t = e.moveEl, n = e.moveFn, o = e.clickEl || t, i = e.beforeDrag, u = e.iframeFix === void 0 ? !0 : e.iframeFix, s = [document];
      u && y("iframe").each(function() {
        ...
        if (!/^https?:\/\//.test(a)) {
          ...
          if (r) {
            var d = y(this).pos();
            y(r).data("pos-x", d.x), y(r).data("pos-y", d.y), s.push(r);
          }
        }
      }), o.mousedown(function(a) {
        function r(C) {
          C.preventDefault();
          var T = y(Ae(C.target)), N = De((T.data("pos-x") || 0) + C.pageX - v), M = De((T.data("pos-y") || 0) + C.pageY - b);
          n.call(o, f, p, m, g, N, M);
        }
        function d(C) {
          C.preventDefault();
        }
        function c(C) {
          C.preventDefault(), y(s).unbind("mousemove", r).unbind("mouseup", c).unbind("selectstart", d), l.releaseCapture && l.releaseCapture();
        }
        if (a.button === 0 || a.button === 1) {
          a.stopPropagation();
          var l = o.get(), f = X(t.css("left")), p = X(t.css("top")), m = t.width(), g = t.height(), v = a.pageX, b = a.pageY;
          i && i(), y(s).mousemove(r).mouseup(c).bind("selectstart", d), l.setCapture && l.setCapture();
        }
      });
    }
    function Te(e) {
...
`);
    ...
    function ui(e) {
      e = e || {};
      var t = e.name || "", n = y('<span class="ke-button-common ke-button-outer" title="' + t + '"></span>'), o = y('<input class="ke-button-common ke-button" type="button" value="' + t + '" />');
    ...
    function di(e) {
      var t = jt(e), n = t.remove, o = e.afterSelect, i = t.div, u = [];
      i.addClass("ke-tabs").bind("contextmenu,mousedown,mousemove", function(a) {
        a.preventDefault();
      });
      var s = y('<ul class="ke-tabs-ul ke-clearfix"></ul>');
      return i.append(s), t.add = function(a) {
        var r = y('<li class="ke-tabs-li">' + a.title + "</li>");
        r.data("tab", a), u.push(r), s.append(r);
      }, t.selectedIndex = 0, t.select = function(a) {
        t.selectedIndex = a, j(u, function(r, d) {
          d.unbind(), r === a ? (d.addClass("ke-tabs-li-selected"), y(d.data("tab").panel).show("")) : (d.removeClass("ke-tabs-li-selected").removeClass("ke-tabs-li-on").mouseover(function() {
            y(this).addClass("ke-tabs-li-on");
          }).mouseout(function() {
            y(this).removeClass("ke-tabs-li-on");
          }).click(function() {
            t.select(r);
          }), y(d.data("tab").panel).hide());
        }), o && o.call(t, a);
      }, t.remove = function() {
        j(u, function() {
          this.remove();
    ...
    function Wt(e) {
      for (var t = document.getElementsByTagName("head")[0] || (Ee ? document.body : document.documentElement), n = document.createElement("link"), o = xn(Qe(e, "absolute")), i = y('link[rel="stylesheet"]', t), u = 0, s = i.length; s > u; u++)
        if (xn(Qe(i[u].href, "absolute")) === o)
          return;
    ...
    function Tn(e, t) {
      if (t = t === void 0 ? y.options.langType : t, typeof e == "string") {
        if (!Ce[t])
          return "no language";
        var n = e.length - 1;
        if (e.substr(n) === ".")
      ...
      j(e, function(i, u) {
        var s = _n(i);
        Ce[t] || (Ce[t] = {}), Ce[t][s.ns] || (Ce[t][s.ns] = {}), Ce[t][s.ns][s.key] = u;
      });
    }
    function kt(e, t) {
      if (!e.collapsed) {
    ...
    function pi() {
      ...
      y(t).contextmenu(function(n) {
        ...
        if (e._contextmenus.length !== 0) {
          ...
          var u = null;
          if (j(i, function(c) {
            this.title == "-" && u.title == "-" && delete i[c], u = this;
          }), i.length > 0) {
            n.preventDefault();
            var s = y(e.edit.iframe).pos(), a = Pt({ x: s.x + n.clientX, y: s.y + n.clientY, width: o, css: { visibility: "hidden" }, shadowMode: e.shadowMode });
            j(i, function() {
              this.title && a.addItem(this);
            });
            var r = ge(a.doc), d = a.div.height();
    ...
    function hi() {
      function e(s) {
        for (var a = y(s.commonAncestor()); a && (a.type != 1 || a.isStyle()); )
          a = a.parent();
        return a;
      }
      ...
      if (!(Z && o !== "br" || Re && 3 > ce && o !== "p" || $t && 9 > ce)) {
        ...
        y(n).keydown(function(s) {
          if (!(s.which != 13 || s.shiftKey || s.ctrlKey || s.altKey)) {
            t.cmd.selection();
            var a = e(t.cmd.range), r = (y(a).prev(), y(a).parent(), a.name);
            if (r != "marquee" && r != "select")
              return o !== "br" || i[r] ? void (u[r] || _e(n, "formatblock", "<p>")) : (s.preventDefault(), void t.insertHtml("<br />" + (Z && 9 > ce ? "" : "\u200B")));
          }
        }), y(n).keyup(function(s) {
          if (!(s.which != 13 || s.shiftKey || s.ctrlKey || s.altKey) && o != "br") {
            ...
            t.cmd.selection();
            var d = e(t.cmd.range), c = y(d).prev(), l = y(d).parent(), f = d.name, p = l && l.name ? l.name : "", m = c && c.html ? c.html() : "";
            if (p == "blockquote" && m == "<br />") {
              s.preventDefault(), y(c).remove(), y(d).remove(), y(l).after("<p>\u200B</p>");
              var g = y(l).next();
              return t.cmd.range.selectNodeContents(g).collapse(!0), t.cmd.select(), void g.focus();
            }
            f != "marquee" && f != "select" && (u[f] || _e(n, "formatblock", "<p>"));
          }
        });
      }
    }
    function mi() {
      var e = this, t = e.edit.doc;
      y(t).keydown(function(n) {
        if (n.which == 9) {
          if (n.preventDefault(), e.afterTab)
            return void e.afterTab.call(e, n);
          var o = e.cmd, i = o.range;
          i.shrink(), i.collapsed && i.startContainer.nodeType == 1 && (i.insertNode(y("@&nbsp;", t)[0]), o.select()), e.insertHtml("&nbsp;&nbsp;&nbsp;&nbsp;");
        }
      });
    }
    function gi() {
      var e = this;
      y(e.edit.textarea[0], e.edit.win).focus(function(t) {
    ...
    function En(e, t) {
      var n, o, i = this, u = i.edit, s = u.doc.body;
      if (e.length === 0)
        return i;
      u.designMode ? (n = i.cmd.range, o = n.createBookmark(!0), o.html = s.innerHTML) : o = { html: s.innerHTML }, Sn(t, o);
      var a = e.pop();
      return Se(o.html) === Se(a.html) && e.length > 0 && (a = e.pop()), u.designMode ? (u.html(a.html), a.start && (n.moveToBookmark(a), i.select())) : y(s).html(Se(a.html)), i;
    }
    function it(e) {
      function t(i, u) {
        it.prototype[i] === void 0 && (n[i] = u), n.options[i] = u;
      }
      var n = this;
      n.options = {}, j(e, function(i, u) {
        t(i, e[i]);
      }), j(y.options, function(i, u) {
        n[i] === void 0 && t(i, u);
      });
      var o = y(n.srcElement || "<textarea/>");
    ...
    function Dn(e, t) {
      function n(s) {
        return j(xe, function(a, r) {
          re(r) && (r.call(s, KindEditor), s._pluginStatus || (s._pluginStatus = {}), s._pluginStatus[a] = "inited");
        }), s.create();
      }
      if (t = t || {}, t.basePath = $(t.basePath, y.basePath), t.themesPath = $(t.themesPath, t.basePath + "themes/"), t.langPath = $(t.langPath, t.basePath + "lang/"), t.pluginsPath = $(t.pluginsPath, t.basePath + "plugins/"), $(t.loadStyleMode, y.options.loadStyleMode)) {
        var o = $(t.themeType, y.options.themeType);
      ...
      if (i && i.length !== 0) {
        ...
        t.srcElement = i[0];
        var u = new it(t);
        return st.push(u), Ce[u.langType] ? n(u) : (qt(u.langPath + u.langType + ".js?ver=" + encodeURIComponent(y.DEBUG ? xt : wt), function() {
          n(u);
        }), u);
      }
    }
    function rt(e, t) {
      y(e).each(function(n, o) {
        y.each(st, function(i, u) {
    ...
    (function(e) {
      ...
      var t = function() {
        ...
        function r(h) {
          var k = !!h && "length" in h && h.length, E = S.type(h);
          return E != "function" && !i(h) && (E == "array" || k === 0 || typeof k == "number" && k > 0 && k - 1 in h);
        }
        function d(h) {
        ...
        function f(h) {
          return h in P ? P[h] : P[h] = new RegExp("(^|\\s)" + h + "(\\s|$)");
        }
        function p(h, k) {
        ...
        function m(h) {
          var k, E;
          return W[h] || (k = F.createElement(h), F.body.appendChild(k), E = getComputedStyle(k, "").getPropertyValue("display"), k.parentNode.removeChild(k), E == "none" && (E = "block"), W[h] = E), W[h];
        }
        function g(h) {
        ...
        function b(h, k, E) {
          for (D in k)
            E && (a(k[D]) || qe(k[D])) ? (a(k[D]) && !a(h[D]) && (h[D] = {}), qe(k[D]) && !qe(h[D]) && (h[D] = []), b(h[D], k[D], E)) : k[D] !== R && (h[D] = k[D]);
        }
        function C(h, k) {
          return k == null ? S(h) : S(h).filter(k);
        }
        function T(h, k, E, B) {
          return o(k) ? k.call(h, E, B) : k;
        }
        function N(h, k, E) {
          E == null ? h.removeAttribute(k) : h.setAttribute(k, E);
        }
        function M(h, k) {
          var E = h.className || "", B = E && E.baseVal !== R;
          return k === R ? B ? E.baseVal : E : void (B ? E.baseVal = k : h.className = k);
        }
        function A(h) {
          try {
        ...
        function z(h, k) {
          k(h);
          for (var E = 0, B = h.childNodes.length; B > E; E++)
            z(h.childNodes[E], k);
        }
        var R, D, S, w, x, _, I = [], O = I.concat, L = I.filter, U = I.slice, F = e.document, W = {}, P = {}, V = { "column-count": 1, columns: 1, "font-weight": 1, "line-height": 1, opacity: 1, "z-index": 1, zoom: 1 }, ne = /^\s*<(\w+|!)[^>]*>/, K = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ae = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Y = /^(?:body|html)$/i, Q = /([A-Z])/g, ie = ["val", "css", "html", "text", "data", "width", "height", "offset"], Oe = ["after", "prepend", "before", "append"], Me = F.createElement("table"), ct = F.createElement("tr"), zn = { tr: F.createElement("tbody"), tbody: Me, thead: Me, tfoot: Me, td: ct, th: ct, "*": F.createElement("div") }, Di = /^[\w-]*$/, Qt = {}, Mi = Qt.toString, G = {}, Pn = F.createElement("div"), Yt = { tabindex: "tabIndex", readonly: "readOnly", for: "htmlFor", class: "className", maxlength: "maxLength", cellspacing: "cellSpacing", cellpadding: "cellPadding", rowspan: "rowSpan", colspan: "colSpan", usemap: "useMap", frameborder: "frameBorder", contenteditable: "contentEditable" }, qe = Array.isArray || function(h) {
          return h instanceof Array;
        };
        return G.matches = function(h, k) {
          if (!k || !h || h.nodeType !== 1)
            return !1;
          var E = h.matches || h.webkitMatchesSelector || h.mozMatchesSelector || h.oMatchesSelector || h.matchesSelector;
          if (E)
            return E.call(h, k);
          var B, q = h.parentNode, H = !q;
          return H && (q = Pn).appendChild(h), B = ~G.qsa(q, k).indexOf(h), H && Pn.removeChild(h), B;
        }, x = function(h) {
          return h.replace(/-+(.)?/g, function(k, E) {
            return E ? E.toUpperCase() : "";
          });
        }, _ = function(h) {
          return L.call(h, function(k, E) {
            return h.indexOf(k) == E;
          });
        }, G.fragment = function(h, k, E) {
          var B, q, H;
          return K.test(h) && (B = S(F.createElement(RegExp.$1))), B || (h.replace && (h = h.replace(ae, "<$1></$2>")), k === R && (k = ne.test(h) && RegExp.$1), k in zn || (k = "*"), H = zn[k], H.innerHTML = "" + h, B = S.each(U.call(H.childNodes), function() {
            H.removeChild(this);
          })), a(E) && (q = S(B), S.each(E, function(me, fe) {
          ...
          if (typeof h == "string")
            if (h = h.trim(), h[0] == "<" && ne.test(h))
              E = G.fragment(h, RegExp.$1, k), h = null;
            else {
              if (k !== R)
                return S(k).find(h);
              E = G.qsa(F, h);
            ...
            if (qe(h))
              ...
              E = G.fragment(h.trim(), RegExp.$1, k), h = null;
            else {
              if (k !== R)
                return S(k).find(h);
              E = G.qsa(F, h);
          ...
          var k, E = U.call(arguments, 1);
          return typeof h == "boolean" && (k = h, h = E.shift()), E.forEach(function(B) {
            b(h, B, k);
          }), h;
        }, G.qsa = function(h, k) {
          var E, B = k[0] == "#", q = !B && k[0] == ".", H = B || q ? k.slice(1) : k, me = Di.test(H);
          return h.getElementById && me && B ? (E = h.getElementById(H)) ? [E] : [] : h.nodeType !== 1 && h.nodeType !== 9 && h.nodeType !== 11 ? [] : U.call(me && !B && h.getElementsByClassName ? q ? h.getElementsByClassName(H) : h.getElementsByTagName(k) : h.querySelectorAll(k));
          ...
          for (; k && (k = k.parentNode); )
            if (k === h)
              return !0;
          return !1;
        }, S.type = n, S.isFunction = o, S.isWindow = i, S.isArray = qe, S.isPlainObject = a, S.isEmptyObject = function(h) {
          var k;
          for (k in h)
            return !1;
          return !0;
        }, S.isNumeric = function(h) {
          var k = Number(h), E = typeof h;
          return h != null && E != "boolean" && (E != "string" || h.length) && !isNaN(k) && isFinite(k) || !1;
        }, S.inArray = function(h, k, E) {
          return I.indexOf.call(k, h, E);
          ...
          if (r(h))
            for (B = 0; B < h.length; B++)
              E = k(h[B], B), E != null && H.push(E);
          else
            for (q in h)
              E = k(h[q], q), E != null && H.push(E);
          return c(H);
        }, S.each = function(h, k) {
          var E, B;
          if (r(h)) {
            for (E = 0; E < h.length; E++)
              if (k.call(h[E], E, h[E]) === !1)
                return h;
          } else
            for (B in h)
        ...
        }), S.fn = { constructor: G.Z, length: 0, forEach: I.forEach, reduce: I.reduce, push: I.push, sort: I.sort, splice: I.splice, indexOf: I.indexOf, concat: function() {
          var h, k, E = [];
          for (h = 0; h < arguments.length; h++)
            k = arguments[h], E[h] = G.isZ(k) ? k.toArray() : k;
          return O.apply(G.isZ(this) ? this.toArray() : this, E);
        }, map: function(h) {
          return S(S.map(this, function(k, E) {
            return h.call(k, E, k);
          }));
        }, slice: function() {
          ...
          return I.every.call(this, function(k, E) {
            return h.call(k, E, k) !== !1;
          }), this;
        }, filter: function(h) {
          ...
          if (o(h) && h.call !== R)
            ...
            var E = typeof h == "string" ? this.filter(h) : r(h) && o(h.item) ? U.call(h) : S(h);
            this.forEach(function(B) {
              E.indexOf(B) < 0 && k.push(B);
            });
          }
          return S(k);
        }, has: function(h) {
          return this.filter(function() {
            return s(h) ? S.contains(this, h) : S(this).find(h).size();
          });
        }, eq: function(h) {
          ...
          return h ? typeof h == "object" ? S(h).filter(function() {
            var E = this;
            return I.some.call(k, function(B) {
              return S.contains(B, E);
            });
          }) : this.length == 1 ? S(G.qsa(this[0], h)) : this.map(function() {
            return G.qsa(this, h);
          }) : S();
        }, closest: function(h, k) {
          var E = [], B = typeof h == "object" && S(h);
          return this.each(function(q, H) {
            for (; H && !(B ? B.indexOf(H) >= 0 : G.matches(H, h)); )
              H = H !== k && !u(H) && H.parentNode;
            H && E.indexOf(H) < 0 && E.push(H);
          }), S(E);
        }, parents: function(h) {
          for (var k = [], E = this; E.length > 0; )
            E = S.map(E, function(B) {
              return (B = B.parentNode) && !u(B) && k.indexOf(B) < 0 ? (k.push(B), B) : void 0;
            });
          return C(k, h);
        }, parent: function(h) {
          ...
          return C(this.map(function(k, E) {
            return L.call(g(E.parentNode), function(B) {
              return B !== E;
            });
          }), h);
        }, empty: function() {
          ...
          var k = o(h);
          if (this[0] && !k)
            var E = S(h).get(0), B = E.parentNode || this.length > 1;
          return this.each(function(q) {
            S(this).wrapAll(k ? h.call(this, q) : B ? E.cloneNode(!0) : E);
          });
        }, wrapAll: function(h) {
          if (this[0]) {
          ...
          return this.each(function(E) {
            var B = S(this), q = B.contents(), H = k ? h.call(this, E) : h;
          ...
          return 0 in arguments ? this.each(function(k) {
            ...
            S(this).empty().append(T(this, h, k, E));
          }) : 0 in this ? this[0].innerHTML : null;
        }, text: function(h) {
          return 0 in arguments ? this.each(function(k) {
            var E = T(this, h, k, this.textContent);
          ...
          return typeof h != "string" || 1 in arguments ? this.each(function(B) {
            if (this.nodeType === 1)
              if (s(h))
                ...
                N(this, h, T(this, k, B, this.getAttribute(h)));
          }) : 0 in this && this[0].nodeType == 1 && (E = this[0].getAttribute(h)) != null ? E : R;
          ...
          return h = Yt[h] || h, typeof h != "string" || 1 in arguments ? this.each(function(E) {
            if (s(h))
              for (D in h)
                this[Yt[D] || D] = h[D];
            else
              this[h] = T(this, k, E, this[h]);
          }) : this[0] && this[0][h];
          ...
          var E = "data-" + h.replace(Q, "-$1").toLowerCase(), B = 1 in arguments ? this.attr(E, k) : this.attr(E);
          return B !== null ? A(B) : R;
        }, val: function(h) {
          return 0 in arguments ? (h == null && (h = ""), this.each(function(k) {
            this.value = T(this, h, k, this.value);
          ...
          if (h)
            return this.each(function(E) {
              var B = S(this), q = T(this, h, E, B.offset()), H = B.offsetParent().offset(), me = { top: q.top - H.top, left: q.left - H.left };
          ...
          if (arguments.length < 2) {
            var E = this[0];
            if (typeof h == "string")
              return E ? E.style[x(h)] || getComputedStyle(E, "").getPropertyValue(h) : void 0;
            if (qe(h)) {
              if (!E)
                return;
              var B = {}, q = getComputedStyle(E, "");
              return S.each(h, function(me, fe) {
                B[fe] = E.style[x(fe)] || q.getPropertyValue(fe);
              }), B;
            }
          }
          var H = "";
          ...
          return this.each(function(k) {
            if ("className" in this) {
              if (h === R)
                return M(this, "");
              w = M(this), T(this, h, k, w).split(/\s+/g).forEach(function(E) {
                w = w.replace(f(E), " ");
              }), M(this, w.trim());
            }
          });
          ...
          return h ? this.each(function(E) {
            var B = S(this), q = T(this, h, E, M(this));
          ...
          if (this.length) {
            var h = this[0], k = this.offsetParent(), E = this.offset(), B = Y.test(k[0].nodeName) ? { top: 0, left: 0 } : k.offset();
            return E.top -= parseFloat(S(h).css("margin-top")) || 0, E.left -= parseFloat(S(h).css("margin-left")) || 0, B.top += parseFloat(S(k[0]).css("border-top-width")) || 0, B.left += parseFloat(S(k[0]).css("border-left-width")) || 0, { top: E.top - B.top, left: E.left - B.left };
          }
          ...
          var k = h.replace(/./, function(E) {
            return E[0].toUpperCase();
          });
          S.fn[h] = function(E) {
            var B, q = this[0];
            return E === R ? i(q) ? q["inner" + k] : u(q) ? q.documentElement["scroll" + k] : (B = this.offset()) && B[h] : this.each(function(H) {
              q = S(this), q.css(h, T(this, E, H, q[h]()));
            });
          };
          ...
          S.fn[h] = function() {
            ...
            return H.length < 1 ? this : this.each(function(fe, ue) {
              q = E ? ue : ue.parentNode, ue = k == 0 ? ue.nextSibling : k == 1 ? ue.firstChild : k == 2 ? ue : null;
              ...
              H.forEach(function(ut) {
                if (me)
                  ...
                  return S(ut).remove();
                q.insertBefore(ut, ue), Fe && z(ut, function(Ne) {
          ...
          }, S.fn[E ? h + "To" : "insert" + (k ? "Before" : "After")] = function(B) {
            return S(B)[h](this), this;
          };
        }), G.Z.prototype = v.prototype = S.fn, G.uniq = _, G.deserializeValue = A, S.zepto = G, S;
      }();
      return e.Zepto = t, e.$ === void 0 && (e.$ = t), function(n) {
        ...
        function i(w, x, _, I) {
          ...
          return (C[o(w)] || []).filter(function(L) {
            return L && (!x.e || L.e == x.e) && (!x.ns || O.test(L.ns)) && (!_ || o(L.fn) === o(_)) && (!I || L.sel == I);
          });
        }
        function u(w) {
          var x = ("" + w).split(".");
        ...
        function a(w, x) {
          return w.del && !N && w.e in M || !!x;
        }
        function r(w) {
          return A[w] || N && M[w] || w;
        }
        function d(w, x, _, I, O, L, U) {
          var F = o(w), W = C[F] || (C[F] = []);
          x.split(/\s/).forEach(function(P) {
            if (P == "ready")
            ...
            }, V.i = W.length, W.push(V), "addEventListener" in w && w.addEventListener(r(V.e), V.proxy, a(V, U));
          });
        }
        function c(w, x, _, I, O) {
          var L = o(w);
          (x || "").split(/\s/).forEach(function(U) {
            i(w, U, _, I).forEach(function(F) {
              delete C[L][F.i], "removeEventListener" in w && w.removeEventListener(r(F.e), F.proxy, a(F, O));
            });
          });
        }
        function l(w, x) {
          if (x || !w.isDefaultPrevented) {
            x || (x = w), n.each(S, function(_, I) {
              var O = x[_];
              w[_] = function() {
                return this[I] = z, O && O.apply(x, arguments);
              }, w[I] = R;
            });
            try {
            ...
            (x.defaultPrevented !== p ? x.defaultPrevented : "returnValue" in x ? x.returnValue === !1 : x.getPreventDefault && x.getPreventDefault()) && (w.isDefaultPrevented = z);
          }
          return w;
        }
        function f(w) {
        ...
        var p, m = 1, g = Array.prototype.slice, v = n.isFunction, b = function(w) {
          return typeof w == "string";
        }, C = {}, T = {}, N = "onfocusin" in e, M = { focus: "focusin", blur: "focusout" }, A = { mouseenter: "mouseover", mouseleave: "mouseout" };
        T.click = T.mousedown = T.mouseup = T.mousemove = "MouseEvents", n.event = { add: d, remove: c }, n.proxy = function(w, x) {
          ...
          return this.off(w, x);
        }, n.fn.one = function(w, x, _, I) {
          return this.on(w, x, _, I, 1);
        };
        var z = function() {
          return !0;
        }, R = function() {
        ...
        n.fn.delegate = function(w, x, _) {
        ...
        }, n.fn.on = function(w, x, _, I, O) {
          var L, U, F = this;
          return w && !b(w) ? (n.each(w, function(W, P) {
            F.on(W, x, _, P, O);
          }), F) : (b(x) || v(I) || I === !1 || (I = _, _ = x, x = p), (I === p || _ === !1) && (I = _, _ = p), I === !1 && (I = R), F.each(function(W, P) {
            O && (L = function(V) {
              return c(P, V.type, I), I.apply(this, arguments);
            }), x && (U = function(V) {
              var ne, K = n(V.target).closest(x, P).get(0);
              return K && K !== P ? (ne = n.extend(f(V), { currentTarget: K, liveFired: P }), (L || I).apply(K, [ne].concat(g.call(arguments, 1)))) : void 0;
            }), d(P, w, I, _, x, U || L);
          }));
          ...
          return w && !b(w) ? (n.each(w, function(O, L) {
            I.off(O, x, L);
          }), I) : (b(x) || v(_) || _ === !1 || (_ = x, x = p), _ === !1 && (_ = R), I.each(function() {
            c(this, w, _, x);
          }));
        }, n.fn.trigger = function(w, x) {
          return w = b(w) || n.isPlainObject(w) ? n.Event(w) : l(w), w._args = x, this.each(function() {
            w.type in M && typeof this[w.type] == "function" ? this[w.type]() : "dispatchEvent" in this ? this.dispatchEvent(w) : n(this).triggerHandler(w, x);
          });
        }, n.fn.triggerHandler = function(w, x) {
          var _, I;
          return this.each(function(O, L) {
            _ = f(b(w) ? n.Event(w) : w), _._args = x, _.target = L, n.each(i(L, w.type || w), function(U, F) {
              return I = F.proxy(_), _.isImmediatePropagationStopped() ? !1 : void 0;
            });
          }), I;
          ...
          b(w) || (x = w, w = x.type);
          var _ = document.createEvent(T[w] || "Events"), I = !0;
          if (x)
            for (var O in x)
              O == "bubbles" ? I = !!x[O] : _[O] = x[O];
          return _.initEvent(w, I, !0), l(_);
        };
      }(t), function(n) {
        function o(u) {
          var s = [["resolve", "done", n.Callbacks({ once: 1, memory: 1 }), "resolved"], ["reject", "fail", n.Callbacks({ once: 1, memory: 1 }), "rejected"], ["notify", "progress", n.Callbacks({ memory: 1 })]], a = "pending", r = { state: function() {
            ...
            return c != null ? n.extend(c, r) : r;
          } }, d = {};
          return n.each(s, function(c, l) {
            var f = l[2], p = l[3];
            r[l[1]] = f.add, p && f.add(function() {
              a = p;
            }, s[1 ^ c][2].disable, s[2][2].lock), d[l[0]] = function() {
        ...
        n.when = function(u) {
          var s, a, r, d = i.call(arguments), c = d.length, l = 0, f = c !== 1 || u && n.isFunction(u.promise) ? c : 0, p = f === 1 ? u : o(), m = function(g, v, b) {
            return function(C) {
              v[g] = this, b[g] = arguments.length > 1 ? i.call(arguments) : C, b === s ? p.notifyWith(v, b) : --f || p.resolveWith(v, b);
            };
          };
          if (c > 1)
            for (s = new Array(c), a = new Array(c), r = new Array(c); c > l; ++l)
        ...
        n.Callbacks = function(o) {
          o = n.extend({}, o);
          var i, u, s, a, r, d, c = [], l = !o.once && [], f = function(m) {
            for (i = o.memory && m, u = !0, d = a || 0, a = 0, r = c.length, s = !0; c && r > d; ++d)
              if (c[d].apply(m[0], m[1]) === !1 && o.stopOnFalse) {
                i = !1;
                break;
              }
            s = !1, c && (l ? l.length && f(l.shift()) : i ? c.length = 0 : p.disable());
          }, p = { add: function() {
            if (c) {
              var m = c.length, g = function(v) {
                n.each(v, function(b, C) {
                  typeof C == "function" ? o.unique && p.has(C) || c.push(C) : C && C.length && typeof C != "string" && g(C);
                });
              };
              g(arguments), s ? r = c.length : i && (a = m, f(i));
            }
            return this;
          }, remove: function() {
            return c && n.each(arguments, function(m, g) {
              for (var v; (v = n.inArray(g, c, v)) > -1; )
                c.splice(v, 1), s && (r >= v && --r, d >= v && --d);
            }), this;
          }, has: function(m) {
            return !(!c || !(m ? n.inArray(m, c) > -1 : c.length));
          }, empty: function() {
            return r = c.length = 0, this;
          }, disable: function() {
            return c = l = i = void 0, this;
          }, disabled: function() {
            return !c;
          }, lock: function() {
            ...
            return !c || u && !l || (g = g || [], g = [m, g.slice ? g.slice() : g], s ? l.push(g) : f(g)), this;
          }, fire: function() {
      ...
      var n, o = {}, i = function(c, l) {
        var f, p, m;
        if (typeof c == "string")
          return a(c);
        for (f = [], p = c.length, m = 0; p > m; m++)
          f.push(a(c[m]));
        ...
        var p, m = { exports: l };
        typeof l == "function" && (f.length || (f = [i, m.exports, m]), p = l.apply(null, f), p !== void 0 && (m.exports = p)), o[c] = m.exports;
      }, a = function(c) {
        var l = o[c] || e[c];
        if (!l)
        ...
        for (l in o)
          if (f = c, o.hasOwnProperty(l)) {
            for (p = l.split("/"), g = v(p.pop()); m = v(p.shift()); )
              f[m] = f[m] || {}, f = f[m];
            f[g] = o[l];
          }
        return c;
      }, d = function(c) {
        return e.__dollar = c, r(t(e, u, i));
      };
      ...
      return t("dollar-third", [], function() {
        ...
        function a(c) {
          var l;
          return Object.create ? Object.create(c) : (l = function() {
          }, l.prototype = c, new l());
        }
        var r = function() {
        }, d = Function.call;
        return { version: "0.1.8-alpha", $: o, Deferred: i.Deferred, isPromise: i.isPromise, when: i.when, browser: function(c) {
          var l = {}, f = c.match(/WebKit\/([\d.]+)/), p = c.match(/Chrome\/([\d.]+)/) || c.match(/CriOS\/([\d.]+)/), m = c.match(/MSIE\s([\d\.]+)/) || c.match(/(?:trident)(?:.*rv:([\w.]+))?/i), g = c.match(/Firefox\/([\d.]+)/), v = c.match(/Safari\/([\d.]+)/), b = c.match(/OPR\/([\d.]+)/);
          return f && (l.webkit = parseFloat(f[1])), p && (l.chrome = parseFloat(p[1])), m && (l.ie = parseFloat(m[1])), g && (l.firefox = parseFloat(g[1])), v && (l.safari = parseFloat(v[1])), b && (l.opera = parseFloat(b[1])), l;
        }(navigator.userAgent), os: function(c) {
          var l = {}, f = c.match(/(?:Android);?[\s\/]+([\d.]+)?/), p = c.match(/(?:iPad|iPod|iPhone).*OS\s([\d_]+)/);
          return f && (l.android = parseFloat(f[1])), p && (l.ios = parseFloat(p[1].replace(/_/g, "."))), l;
        }(navigator.userAgent), inherits: function(c, l, f) {
          var p;
          return typeof l == "function" ? (p = l, l = null) : p = l && l.hasOwnProperty("constructor") ? l.constructor : function() {
            return c.apply(this, arguments);
          }, o.extend(!0, p, c, f || {}), p.__super__ = c.prototype, p.prototype = a(c.prototype), l && o.extend(!0, p.prototype, l), p;
          ...
          return function(l) {
            ...
            return (l || "wu_") + f + (c++).toString(32);
          };
        }(), formatSize: function(c, l, f) {
          var p;
          for (f = f || ["B", "K", "M", "G", "TB"]; (p = f.shift()) && c > 1024; )
            c /= 1024;
          return (p === "B" ? c : c.toFixed(l || 2)) + p;
        } };
        ...
        function u(l, f, p) {
          r.each((l || "").split(c), function(m, g) {
            p(g, f);
          });
        }
        function s(l, f) {
          for (var p, m = !1, g = -1, v = l.length; ++g < v; )
        ...
        var a, r = o.$, d = [].slice, c = /\s+/;
        return a = { on: function(l, f, p) {
          var m, g = this;
          return f ? (m = this._events || (this._events = []), u(l, f, function(v, b) {
            var C = { e: v };
            C.cb = b, C.ctx = p, C.ctx2 = p || g, C.id = m.length, m.push(C);
          }), this) : this;
        }, once: function(l, f, p) {
          var m = this;
          return f && u(l, f, function(g, v) {
            var b = function() {
              return m.off(g, b), v.apply(p || m, arguments);
            };
            b._cb = v, m.on(g, b, p);
          }), m;
        }, off: function(l, f, p) {
          var m = this._events;
          return m ? l || f || p ? (u(l, f, function(g, v) {
            r.each(i(m, g, v, p), function() {
              delete m[this.id];
            });
        ...
        function u(a) {
          this.options = s.extend(!0, {}, u.options, a), this._init(this.options);
        }
        var s = o.$;
        return u.options = {}, i.installTo(u.prototype), s.each({ upload: "start-upload", stop: "stop-upload", getFile: "get-file", getFiles: "get-files", addFile: "add-file", addFiles: "add-file", sort: "sort-files", removeFile: "remove-file", cancelFile: "cancel-file", skipFile: "skip-file", retry: "retry", isInProgress: "is-in-progress", makeThumb: "make-thumb", md5File: "md5-file", getDimension: "get-dimension", addButton: "add-btn", predictRuntimeType: "predict-runtime-type", refresh: "refresh", disable: "disable", enable: "enable", reset: "reset" }, function(a, r) {
          u.prototype[a] = function() {
            return this.request(r, arguments);
          };
        }), s.extend(u.prototype, { state: "pending", _init: function(a) {
          var r = this;
          ...
          var r = [].slice.call(arguments, 1), d = this.options, c = "on" + a.substring(0, 1).toUpperCase() + a.substring(1);
          return !(i.trigger.apply(this, arguments) === !1 || s.isFunction(d[c]) && d[c].apply(this, r) === !1 || s.isFunction(this[c]) && this[c].apply(this, r) === !1 || i.trigger.apply(i, [this, a].concat(r)) === !1);
        }, destroy: function() {
        ...
        return s.extend(u.prototype, { getContainer: function() {
          var d, c, l = this.options;
          return this._container ? this._container : (d = s(l.container || document.body), c = s(document.createElement("div")), c.attr("id", "rt_" + this.uid), c.css({ position: "absolute", top: "0px", left: "0px", width: "1px", height: "1px", overflow: "hidden", cursor: "pointer", lineHeight: "0" }), d.append(c), d.addClass("webuploader-container"), this._container = c, this._parent = d, c);
        ...
        } }), u.orders = "html5,flash", u.addRuntime = function(d, c) {
          a[d] = c;
        }, u.hasRuntime = function(d) {
          return !!(d ? a[d] : r(a));
        }, u.create = function(d, c) {
          var l;
          if (c = c || u.orders, s.each(c.split(/\s*,\s*/g), function() {
        ...
        function s(r, d) {
          ...
          this.uid = o.guid("client_"), this.runtimeReady = function(f) {
            ...
            return l.done(p), typeof f == "string" && a.get(f) && (c = a.get(f)), c = c || a.get(null, d), c ? (o.$.extend(c.options, f), c.__promise.then(l.resolve), c.__client++) : (c = u.create(f, f.runtimeOrder), c.__promise = l.promise(), c.once("ready", l.resolve), c.init(), a.add(c), c.__client = 1), d && (c.__standalone = d), c;
          }, this.getRuntime = function() {
            return c;
          }, this.disconnectRuntime = function() {
            c && (c.__client--, c.__client <= 0 && (a.remove(c), delete c.__promise, c.destroy()), c = null);
          }, this.exec = function() {
            if (c) {
              var f = o.slice(arguments);
              return r && f.unshift(r), c.exec.apply(this, f);
            }
        ...
        function s(r) {
          r = this.options = a.extend({}, s.options, r), r.container = a(r.container), r.container.length && u.call(this, "DragAndDrop");
        }
        var a = o.$;
        return s.options = { accept: null, disableGlobalDnd: !1 }, o.inherits(u, { constructor: s, init: function() {
          var r = this;
        ...
        var a = o.$, r = i.prototype._init, d = i.prototype.destroy, c = {}, l = [];
        return a.extend(s.prototype, { init: o.noop, invoke: function(f, p) {
          var m = this.responseMap;
          return m && f in m && m[f] in this && a.isFunction(this[m[f]]) ? this[m[f]].apply(this, p) : c;
        }, request: function() {
          return this.owner.request.apply(this.owner, arguments);
        } }), a.extend(i.prototype, { _init: function() {
          var f = this, p = f._widgets = [], m = f.options.disableWidgets || "";
          return a.each(l, function(g, v) {
            (!m || !~m.indexOf(v._name)) && p.push(new v(f));
          }), r.apply(f, arguments);
        }, request: function(f, p, m) {
          var g, v, b, C, T = 0, N = this._widgets, M = N && N.length, A = [], z = [];
          for (p = u(p) ? p : [p]; M > T; T++)
            g = N[T], v = g.invoke(f, p), v !== c && (o.isPromise(v) ? z.push(v) : A.push(v));
          return m || z.length ? (b = o.when.apply(o, z), C = b.pipe ? "pipe" : "then", b[C](function() {
          ...
          return arguments.length === 1 ? (p = f, a.each(p, function(v) {
            return v[0] === "_" || v === "name" ? void (v === "name" && (g.name = p.name)) : void (g[v.replace(/[A-Z]/g, "-$&").toLowerCase()] = v);
        ...
        return i.options.dnd = "", i.register({ name: "dnd", init: function(a) {
          if (a.dnd && this.request("predict-runtime-type") === "html5") {
            var r, d = this, c = o.Deferred(), l = s.extend({}, { disableGlobalDnd: a.disableGlobalDnd, container: a.dnd, accept: a.accept });
            return this.dnd = r = new u(l), r.once("ready", c.resolve), r.on("drop", function(f) {
        ...
        var a = o.$;
        return o.inherits(u, { constructor: s, init: function() {
          var r = this;
          r.connectRuntime(r.options, function() {
            r.exec("init"), r.trigger("ready");
          });
        ...
        return i.register({ name: "paste", init: function(a) {
          if (a.paste && this.request("predict-runtime-type") === "html5") {
            var r, d = this, c = o.Deferred(), l = s.extend({}, { container: a.paste, accept: a.accept });
            return this.paste = r = new u(l), r.once("ready", c.resolve), r.on("paste", function(f) {
        ...
        return o.inherits(i, { constructor: u, slice: function(s, a) {
        ...
        function u(r, d) {
          var c;
          this.name = d.name || "untitled" + s++, c = a.exec(d.name) ? RegExp.$1.toLowerCase() : "", !c && d.type && (c = /\/(jpg|jpeg|png|gif|bmp)$/i.exec(d.type) ? RegExp.$1.toLowerCase() : "", this.name += "." + c), this.ext = c, this.lastModifiedDate = d.lastModifiedDate || d.lastModified && new Date(d.lastModified).toLocaleString() || new Date().toLocaleString(), i.apply(this, arguments);
        }
        var s = 1, a = /\.([^.]+)$/;
        ...
        return s.options = { button: null, container: null, label: null, innerHTML: null, multiple: !0, accept: null, name: "file", style: "webuploader-pick" }, o.inherits(i, { constructor: s, init: function() {
          var r = this, d = r.options, c = d.button, l = d.style;
          l && c.addClass("webuploader-pick"), r.on("all", function(f) {
            var p;
            switch (f) {
              case "mouseenter":
                l && c.addClass("webuploader-pick-hover");
                break;
              case "mouseleave":
                l && c.removeClass("webuploader-pick-hover");
                break;
              case "change":
          ...
          var r = this.getRuntime().getContainer(), d = this.options.button, c = d[0] && d[0].offsetWidth || d.outerWidth() || d.width(), l = d[0] && d[0].offsetHeight || d.outerHeight() || d.height(), f = d.offset();
          c && l && r.css({ bottom: "auto", right: "auto", width: c + "px", height: l + "px" }).offset(f);
        }, enable: function() {
        ...
        return s.extend(i.options, { pick: null, accept: null }), i.register({ name: "picker", init: function(a) {
          ...
          var r = this, d = r.options, c = d.accept, l = [];
          return a ? (s.isPlainObject(a) || (a = { id: a }), s(a.id).each(function() {
            var f, p, m;
            m = o.Deferred(), f = s.extend({}, a, { accept: s.isPlainObject(c) ? [c] : c, swf: d.swf, runtimeOrder: d.runtimeOrder, id: this }), p = new u(f), p.once("ready", m.resolve), p.on("select", function(g) {
        ...
        var s, a = o.$;
        return s = function(r) {
          var d = 0, c = [], l = function() {
            for (var f; c.length && r > d; )
              f = c.shift(), d += f[0], f[1]();
          };
          return function(f, p, m) {
            c.push([p, m]), f.once("destroy", function() {
              d -= p, setTimeout(l, 1);
            }), setTimeout(l, 1);
          };
        }(5242880), a.extend(i.options, { thumb: { width: 110, height: 110, quality: 70, allowMagnify: !0, crop: !0, preserveHeaders: !1, type: "image/jpeg" }, compress: { width: 1600, height: 1600, quality: 90, allowMagnify: !1, crop: !1, preserveHeaders: !0 } }), i.register({ name: "image", makeThumb: function(r, d, c, l) {
          var f, p;
          return r = this.request("get-file", r), r.type.match(/^image/) ? (f = a.extend({}, this.options.thumb), a.isPlainObject(c) && (f = a.extend(f, c), c = null), c = c || f.width, l = l || f.height, p = new u(f), p.once("load", function() {
            r._info = r._info || p.info(), r._meta = r._meta || p.meta(), 1 >= c && c > 0 && (c = r._info.width * c), 1 >= l && l > 0 && (l = r._info.height * l), p.resize(c, l);
          ...
          var d, c, l = this.options.compress || this.options.resize, f = l && l.compressSize || 0, p = l && l.noCompressIfLarger || !1;
          return r = this.request("get-file", r), !l || !~"image/jpeg,image/jpg".indexOf(r.type) || r.size < f || r._compressed ? void 0 : (l = a.extend({}, l), c = o.Deferred(), d = new u(l), c.always(function() {
            d.destroy(), d = null;
          }), d.once("error", c.reject), d.once("load", function() {
            ...
            var m, g;
            try {
              m = d.getAsBlob(l.type), g = r.size, (!p || m.size < g) && (r.source = m, r.size = m.size, r.trigger("resize", m.size, g)), r._compressed = !0, c.resolve();
            } catch {
              c.resolve();
            }
          }), r._info && d.info(r._info), r._meta && d.meta(r._meta), d.loadFromBlob(r.source), c.promise());
        } });
        ...
        function s(f) {
          this.name = f.name || "Untitled", this.size = f.size || 0, this.type = f.type || "application/octet-stream", this.lastModifiedDate = f.lastModifiedDate || 1 * new Date(), this.id = u(), this.ext = c.exec(this.name) ? RegExp.$1 : "", this.statusText = "", l[this.id] = s.Status.INITED, this.source = f, this.loaded = 0, this.on("error", function(p) {
            this.setStatus(s.Status.ERROR, p);
          });
        }
        var a = o.$, r = "WU_FILE_", d = 0, c = /\.([^.]+)$/, l = {};
        ...
        return a.extend(s.prototype, { append: function(d) {
          ...
          var c, l, f = this._queue.length;
          for (d = d || r.QUEUED, c = 0; f > c; c++)
            if (l = this._queue[c], d === l.getStatus())
              return l;
          return null;
        }, sort: function(d) {
          typeof d == "function" && this._queue.sort(d);
        }, getFiles: function() {
          for (var d, c = [].slice.call(arguments, 0), l = [], f = 0, p = this._queue.length; p > f; f++)
            d = this._queue[f], (!c.length || ~a.inArray(d.getStatus(), c)) && l.push(d);
          return l;
        }, removeFile: function(d) {
          var c = this._map[d.id];
          c && (delete this._map[d.id], this._delFile(d), d.destroy(), this.stats.numOfDeleted++);
        }, _fileAdded: function(d) {
          var c = this, l = this._map[d.id];
          l || (this._map[d.id] = d, d.on("statuschange", function(f, p) {
            c._onFileStatusChange(f, p);
          }));
        }, _delFile: function(d) {
          for (var c = this._queue.length - 1; c >= 0; c--)
            if (this._queue[c] == d) {
              this._queue.splice(c, 1);
              break;
            }
        }, _onFileStatusChange: function(d, c) {
          var l = this.stats;
          switch (c) {
            case r.PROGRESS:
              l.numOfProgress--;
      ...
      }), t("widgets/queue", ["base", "uploader", "queue", "file", "lib/file", "runtime/client", "widgets/widget"], function(o, i, u, s, a, r) {
        var d = o.$, c = /\.\w+$/, l = s.Status;
        return i.register({ name: "queue", init: function(f) {
          var p, m, g, v, b, C, T, N = this;
          if (d.isPlainObject(f.accept) && (f.accept = [f.accept]), f.accept) {
            for (b = [], g = 0, m = f.accept.length; m > g; g++)
              v = f.accept[g].extensions, v && b.push(v);
            b.length && (C = "\\." + b.join(",").replace(/,/g, "$|\\.").replace(/\*/g, ".*") + "$"), N.accept = new RegExp(C, "i");
          }
          return N.queue = new u(), N.stats = N.queue.stats, this.request("predict-runtime-type") === "html5" ? (p = o.Deferred(), this.placeholder = T = new r("Placeholder"), T.connectRuntime({ runtimeOrder: "html5" }, function() {
            N._ruid = T.getRuid(), p.resolve();
          }), p.promise()) : void 0;
          ...
          var p = !f || !f.size || this.accept && c.exec(f.name) && !this.accept.test(f.name);
          return !p;
        }, _addFile: function(f) {
          var p = this;
          ...
          for (m = b.queue.getFiles(l.ERROR), g = 0, v = m.length; v > g; g++)
        ...
        return o.support = function() {
          ...
          var u, s, a = this.options.runtimeOrder || i.orders, r = this.type;
          if (!r) {
            for (a = a.split(/\s*,\s*/g), u = 0, s = a.length; s > u; u++)
              if (i.hasRuntime(a[u])) {
                this.type = r = a[u];
                break;
              }
        ...
        var a = o.$;
        return s.options = { server: "", method: "POST", withCredentials: !1, fileVal: "file", timeout: 12e4, formData: {}, headers: {}, sendAsBinary: !1 }, a.extend(s.prototype, { appendBlob: function(r, d, c) {
          var l = this, f = l.options;
          l.getRuid() && l.disconnectRuntime(), l.connectRuntime(d.ruid, function() {
            l.exec("init");
          }), l._blob = d, f.fileVal = r || f.fileVal, f.filename = c || f.filename;
        }, append: function(r, d) {
        ...
        } }), u.installTo(s.prototype), s;
      }), t("widgets/upload", ["base", "uploader", "file", "lib/transport", "widgets/widget"], function(o, i, u, s) {
        function a(l, f) {
          var p, m, g = [], v = l.source, b = v.size, C = f ? Math.ceil(b / f) : 1, T = 0, N = 0;
          for (m = { file: l, has: function() {
            ...
            p = Math.min(f, b - T), g.push({ file: l, start: T, end: f ? T + p : b, total: b, chunks: C, chunk: N++, cuted: m }), T += p;
          return l.blocks = g.concat(), l.remaning = g.length, m;
        }
        var r = o.$, d = o.isPromise, c = u.Status;
        r.extend(i.options, { prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, chunkRetryDelay: 1e3, threads: 3, formData: {} }), i.register({ name: "upload", init: function() {
          ...
          var f = this;
          if (r.each(f.request("get-files", c.INVALID), function() {
            f.request("remove-file", this);
          }), l ? (l = l.id ? l : f.request("get-file", l), l.getStatus() === c.INTERRUPT ? (l.setStatus(c.QUEUED), r.each(f.pool, function(m, g) {
            g.file === l && (g.transport && g.transport.send(), l.setStatus(c.PROGRESS));
          })) : l.getStatus() !== c.PROGRESS && l.setStatus(c.QUEUED)) : r.each(f.request("get-files", [c.INITED]), function() {
          ...
          l || r.each(f.pool, function(m, g) {
            var v = g.file;
            if (v.getStatus() === c.INTERRUPT) {
              if (f._trigged = !1, p.push(v), g.waiting)
                return;
              g.transport ? g.transport.send() : f._doSend(g);
            }
          }), r.each(p, function() {
            this.setStatus(c.PROGRESS);
          }), l || r.each(f.request("get-files", c.INTERRUPT), function() {
            this.setStatus(c.PROGRESS);
          ...
          if (l === !0 && (f = l, l = null), p.runing !== !1) {
            if (l)
              return l = l.id ? l : p.request("get-file", l), l.getStatus() !== c.PROGRESS && l.getStatus() !== c.QUEUED ? void 0 : (l.setStatus(c.INTERRUPT), r.each(p.pool, function(m, g) {
                g.file === l && (g.transport && g.transport.abort(), f && (p._putback(g), p._popBlock(g)));
              }), p.owner.trigger("stopUpload", l), o.nextTick(p.__tick));
            p.runing = !1, this._promise && this._promise.file && this._promise.file.setStatus(c.INTERRUPT), f && r.each(p.pool, function(m, g) {
              g.transport && g.transport.abort(), g.file.setStatus(c.INTERRUPT);
          ...
          }), l.setStatus(c.CANCELLED), this.owner.trigger("fileDequeued", l);
        }, isInProgress: function() {
          return !!this.progress;
        }, _getStats: function() {
          return this.request("get-stats");
        }, skipFile: function(l, f) {
          l = l.id ? l : this.request("get-file", l), l.setStatus(f || c.COMPLETE), l.skipped = !0, l.blocks && r.each(l.blocks, function(p, m) {
            var g = m.transport;
          ...
          for (var l, f = 0; l = this.stack[f++]; ) {
            if (l.has() && l.file.getStatus() === c.PROGRESS)
              return l;
            (!l.has() || l.file.getStatus() !== c.PROGRESS && l.file.getStatus() !== c.INTERRUPT) && this.stack.splice(--f, 1);
          }
          return null;
        }, _nextBlock: function() {
          var l, f, p, m, g = this, v = g.options;
          return (l = this._getStack()) ? (v.prepareNextFile && !g.pending.length && g._prepareNextFile(), l.shift()) : g.runing ? (!g.pending.length && g._getStats().numOfQueue && g._prepareNextFile(), f = g.pending.shift(), p = function(b) {
            return b ? (l = a(b, v.chunked ? v.chunkSize : 0), g.stack.push(l), l.shift()) : null;
          ...
          p && (l = f.request("before-send-file", p, function() {
            return p.getStatus() === c.PROGRESS || p.getStatus() === c.INTERRUPT ? p : f._finishFile(p);
          }), f.owner.trigger("uploadStart", p), p.setStatus(c.PROGRESS), l.file = p, l.done(function() {
            var g = r.inArray(l, m);
            ~g && m.splice(g, 1, p);
          }), l.fail(function(g) {
            p.setStatus(c.ERROR, g), f.owner.trigger("uploadError", p, g), f.owner.trigger("uploadComplete", p);
          }), m.push(l));
          ...
          return m.getStatus() !== c.PROGRESS ? void (m.getStatus() === c.INTERRUPT && p._putback(l)) : (p.pool.push(l), p.remaning++, l.blob = l.chunks === 1 ? m.source : m.source.slice(l.start, l.end), l.waiting = f = p.request("before-send", l, function() {
            delete l.waiting, m.getStatus() === c.PROGRESS ? p._doSend(l) : l.file.getStatus() !== c.INTERRUPT && p._popBlock(l), o.nextTick(p.__tick);
          ...
          var f, p, m = this, g = m.owner, v = r.extend({}, m.options, l.options), b = l.file, C = new s(v), T = r.extend({}, v.formData), N = r.extend({}, v.headers);
          l.transport = C, C.on("destroy", function() {
            delete l.transport, m._popBlock(l), o.nextTick(m.__tick);
          }), C.on("progress", function(M) {
            l.percentage = M, m.updateFileProgress(b);
          }), f = function(M) {
            var A;
            return p = C.getResponseAsJson() || {}, p._raw = C.getResponse(), p._headers = C.getResponseHeaders(), l.response = p, A = function(z) {
              M = z;
            }, g.trigger("uploadAccept", l, p, A) || (M = M || "server"), M;
          }, C.on("error", function(M, A) {
            var z, R, D = M.split("|");
            M = D[0], z = parseFloat(D[1]), R = D[2], l.retried = l.retried || 0, l.chunks > 1 && ~"http,abort,server".indexOf(M.replace(/-.*/, "")) && l.retried < v.chunkRetry ? (l.retried++, m.retryTimer = setTimeout(function() {
              C.send();
            }, v.chunkRetryDelay || 1e3)) : (A || M !== "server" || (M = f(M)), b.setStatus(c.ERROR, M), g.trigger("uploadError", b, M, z, R), g.trigger("uploadComplete", b));
          }), C.on("load", function() {
            var M;
            return (M = f()) ? void C.trigger("error", M, !0) : void (b.remaning === 1 ? m._finishFile(b, p) : C.destroy());
          }), T = r.extend(T, { id: b.id, name: b.name, type: b.type, lastModifiedDate: b.lastModifiedDate, size: b.size }), l.chunks > 1 && r.extend(T, { chunks: l.chunks, chunk: l.chunk }), g.trigger("uploadBeforeSend", l, T, N), C.appendBlob(v.fileVal, l.blob, b.name), C.append(T), C.setRequestHeader(N), C.send();
        }, _finishFile: function(l, f, p) {
          var m = this.owner;
          return m.request("after-send-file", arguments, function() {
            l.setStatus(c.COMPLETE), m.trigger("uploadSuccess", l, f, p);
          }).fail(function(g) {
            l.getStatus() === c.PROGRESS && l.setStatus(c.ERROR, g), m.trigger("uploadError", l, g);
          }).always(function() {
        ...
        var s, a = o.$, r = {};
        return s = { addValidator: function(d, c) {
          r[d] = c;
          ...
          var d = this, c = d.options, l = 0, f = parseInt(c.fileNumLimit, 10), p = !0;
          ...
          var d = this, c = d.options, l = 0, f = parseInt(c.fileSizeLimit, 10), p = !0;
          f && (d.on("beforeFileQueued", function(m) {
            var g = l + m.size > f;
          ...
          var d = this, c = d.options, l = c.fileSingleSizeLimit;
          ...
          function d(p) {
            for (var m, g = 0, v = 0, b = p.length; b > v; v++)
              m = p.charCodeAt(v), g = m + (g << 6) + (g << 16) - g;
            return g;
          }
          var c = this, l = c.options, f = {};
          l.duplicate || (c.on("beforeFileQueued", function(p) {
            var m = p.__hash || (p.__hash = d(p.name + p.size + p.lastModifiedDate));
            return f[m] ? (this.trigger("error", "F_DUPLICATE", p), !1) : void 0;
          }), c.on("fileQueued", function(p) {
            var m = p.__hash;
            m && (f[m] = !0);
          }), c.on("fileDequeued", function(p) {
            var m = p.__hash;
            m && delete f[m];
          }), c.on("reset", function() {
            f = {};
        ...
        function s() {
          var d = {}, c = this, l = this.destroy;
          i.apply(c, arguments), c.type = a, c.exec = function(f, p) {
            var m, g = this, v = g.uid, b = o.slice(arguments, 2);
            return r[f] && (m = d[v] = d[v] || new r[f](g, c), m[p]) ? m[p].apply(m, b) : void 0;
          }, c.destroy = function() {
        ...
        return i.register("DragAndDrop", { init: function() {
          ...
          var d, c = this, l = c._denied || !1;
          return r = r.originalEvent || r, c.dndOver || (c.dndOver = !0, d = r.dataTransfer.items, d && d.length && (c._denied = l = !c.trigger("accept", d)), c.elem.addClass(a + "over"), c.elem[l ? "addClass" : "removeClass"](a + "denied")), r.dataTransfer.dropEffect = l ? "none" : "copy", !1;
          ...
          var d, c, l = this, f = l.getRuid(), p = l.elem.parent().get(0);
          ...
          return l.dndOver = !1, l.elem.removeClass(a + "over"), d && !c ? (l._getTansferFiles(d, function(m) {
            l.trigger("drop", s.map(m, function(g) {
              return new u(f, g);
            }));
          }), !1) : void 0;
        }, _getTansferFiles: function(r, d) {
          var c, l, f, p, m, g, v, b = [], C = [];
          for (c = r.items, l = r.files, v = !(!c || !c[0].webkitGetAsEntry), m = 0, g = l.length; g > m; m++)
            f = l[m], p = c && c[m], v && p.webkitGetAsEntry().isDirectory ? C.push(this._traverseDirectoryTree(p.webkitGetAsEntry(), b)) : b.push(f);
          o.when.apply(o, C).done(function() {
            b.length && d(b);
          });
        }, _traverseDirectoryTree: function(r, d) {
          var c = o.Deferred(), l = this;
          return r.isFile ? r.file(function(f) {
            d.push(f), c.resolve();
          }) : r.isDirectory && r.createReader().readEntries(function(f) {
            var p, m = f.length, g = [], v = [];
            for (p = 0; m > p; p++)
              g.push(l._traverseDirectoryTree(f[p], v));
            o.when.apply(o, g).then(function() {
              d.push.apply(d, v), c.resolve();
            }, c.reject);
          }), c.promise();
        }, destroy: function() {
          var r = this.elem;
        ...
        return i.register("FilePaste", { init: function() {
          var s, a, r, d, c = this.options, l = this.elem = c.container, f = ".*";
          if (c.accept) {
            for (s = [], a = 0, r = c.accept.length; r > a; a++)
              d = c.accept[a].mimeTypes, d && s.push(d);
          ...
          var a, r, d, c, l, f = [], p = this.getRuid();
          for (s = s.originalEvent || s, a = s.clipboardData.items, c = 0, l = a.length; l > c; c++)
            r = a[c], r.kind === "file" && (d = r.getAsFile()) && f.push(new u(p, d));
        ...
        return i.register("FilePicker", { init: function() {
          var s, a, r, d, c, l = this.getRuntime().getContainer(), f = this, p = f.owner, m = f.options, g = this.label = u(document.createElement("label")), v = this.input = u(document.createElement("input"));
          if (v.attr("type", "file"), v.attr("capture", "camera"), v.attr("name", m.name), v.addClass("webuploader-element-invisible"), g.on("click", function(b) {
            v.trigger("click"), b.stopPropagation(), p.trigger("dialogopen");
          }), g.css({ opacity: 0, width: "100%", height: "100%", display: "block", cursor: "pointer", background: "#ffffff" }), m.multiple && v.attr("multiple", "multiple"), m.accept && m.accept.length > 0) {
            for (s = [], a = 0, r = m.accept.length; r > a; a++)
              s.push(m.accept[a].mimeTypes);
            v.attr("accept", s.join(","));
          }
          l.append(v), l.append(g), d = function(b) {
            p.trigger(b.type);
          }, c = function(b) {
            var C;
            return b.target.files.length === 0 ? !1 : (f.files = b.target.files, C = this.cloneNode(!0), C.value = null, this.parentNode.replaceChild(C, this), v.off(), v = u(C).on("change", c).on("mouseenter mouseleave", d), void p.trigger("change"));
          }, v.on("change", c), g.on("mouseenter mouseleave", d);
        }, getFiles: function() {
          return this.files;
        }, destroy: function() {
        ...
        var i = e.createObjectURL && e || e.URL && URL.revokeObjectURL && URL || e.webkitURL, u = o.noop, s = u;
        return i && (u = function() {
          return i.createObjectURL.apply(i, arguments);
        }, s = function() {
          return i.revokeObjectURL.apply(i, arguments);
        }), { createObjectURL: u, revokeObjectURL: s, dataURL2Blob: function(a) {
          var r, d, c, l, f, p;
          for (p = a.split(","), r = ~p[0].indexOf("base64") ? atob(p[1]) : decodeURIComponent(p[1]), c = new ArrayBuffer(r.length), d = new Uint8Array(c), l = 0; l < r.length; l++)
            d[l] = r.charCodeAt(l);
          return f = p[0].split(":")[1].split(";")[0], this.arrayBufferToBlob(c, f);
        }, dataURL2ArrayBuffer: function(a) {
          var r, d, c, l;
          for (l = a.split(","), r = ~l[0].indexOf("base64") ? atob(l[1]) : decodeURIComponent(l[1]), d = new Uint8Array(r.length), c = 0; c < r.length; c++)
            d[c] = r.charCodeAt(c);
          return d.buffer;
        }, arrayBufferToBlob: function(a, r) {
          var d, c = e.BlobBuilder || e.WebKitBlobBuilder;
          return c ? (d = new c(), d.append(a), d.getBlob(r)) : new Blob([a], r ? { type: r } : {});
        ...
        var i;
        return i = { parsers: { 65505: [] }, maxMetaDataSize: 262144, parse: function(u, s) {
          ...
          if (!(u.byteLength < 6)) {
            var a, r, d, c, l = new DataView(u), f = 2, p = l.byteLength - 4, m = f, g = {};
        ...
        }, updateImageHead: function(u, s) {
          var a, r, d, c = this._parse(u, !0);
          return d = 2, c.imageHead && (d = 2 + c.imageHead.byteLength), r = u.slice ? u.slice(d) : new Uint8Array(u).subarray(d), a = new Uint8Array(s.byteLength + 2 + r.byteLength), a[0] = 255, a[1] = 216, a.set(new Uint8Array(s), 2), a.set(new Uint8Array(r), s.byteLength + 2), a.buffer;
        ...
        return u.ExifMap = function() {
          return this;
        }, u.ExifMap.prototype.map = { Orientation: 274 }, u.ExifMap.prototype.get = function(s) {
          return this[s] || this[this.map[s]];
        }, u.exifTagTypes = { 1: { getValue: function(s, a) {
          return s.getUint8(a);
        ...
        }, size: 8 } }, u.exifTagTypes[7] = u.exifTagTypes[1], u.getExifValue = function(s, a, r, d, c, l) {
          var f, p, m, g, v, b, C = u.exifTagTypes[d];
          if (!C)
            return void o.log("Invalid Exif data: Invalid tag type.");
          if (f = C.size * c, p = f > 4 ? a + s.getUint32(r + 8, l) : r + 8, p + f > s.byteLength)
            return void o.log("Invalid Exif data: Invalid data offset.");
          if (c === 1)
            return C.getValue(s, p, l);
          for (m = [], g = 0; c > g; g += 1)
            m[g] = C.getValue(s, p + g * C.size, l);
          if (C.ascii) {
            for (v = "", g = 0; g < m.length && (b = m[g], b !== "\0"); g += 1)
              v += b;
            return v;
          }
          return m;
        }, u.parseExifTag = function(s, a, r, d, c) {
          var l = s.getUint16(r, d);
          c.exif[l] = u.getExifValue(s, a, r, s.getUint16(r + 2, d), s.getUint32(r + 4, d), d);
        }, u.parseExifTags = function(s, a, r, d, c) {
          var l, f, p;
          if (r + 6 > s.byteLength)
          ...
          for (p = 0; l > p; p += 1)
            this.parseExifTag(s, a, r + 2 + 12 * p, d, c);
          return s.getUint32(f, d);
        }, u.parseExifData = function(s, a, r, d) {
          var c, l, f = a + 10;
          if (s.getUint32(a + 4) === 1165519206) {
            ...
            if (s.getUint16(f + 2, c) !== 42)
              return void o.log("Invalid Exif data: Missing TIFF marker.");
            l = s.getUint32(f + 4, c), d.exif = new u.ExifMap(), l = u.parseExifTags(s, f, f + l, c, d);
          }
        ...
        return i.register("Image", { modified: !1, init: function() {
          ...
          r.onload = function() {
            a._info = { type: a.type, width: this.width, height: this.height }, a._metas || a.type !== "image/jpeg" ? a.owner.trigger("load") : u.parseMeta(a._blob, function(d, c) {
        ...
        }, crop: function(a, r, d, c, l) {
          var f = this._canvas || (this._canvas = document.createElement("canvas")), p = this.options, m = this._img, g = m.naturalWidth, v = m.naturalHeight, b = this.getOrientation();
          l = l || 1, f.width = d, f.height = c, p.preserveHeaders || this._rotate2Orientaion(f, b), this._renderImageToCanvas(f, m, -a, -r, g * l, v * l), this._blob = null, this.modified = !0, this.owner.trigger("complete", "crop");
        }, getAsBlob: function(a) {
          var r, d = this._blob, c = this.options;
          if (a = a || this.type, this.modified || this.type !== a) {
            if (r = this._canvas, a === "image/jpeg") {
              if (d = u.canvasToDataUrl(r, a, c.quality), c.preserveHeaders && this._metas && this._metas.imageHead)
        ...
        }, _resize: function(a, r, d, c) {
          var l, f, p, m, g, v = this.options, b = a.width, C = a.height, T = this.getOrientation();
          ~[5, 6, 7, 8].indexOf(T) && (d ^= c, c ^= d, d ^= c), l = Math[v.crop ? "max" : "min"](d / b, c / C), v.allowMagnify || (l = Math.min(1, l)), f = b * l, p = C * l, v.crop ? (r.width = d, r.height = c) : (r.width = f, r.height = p), m = (r.width - f) / 2, g = (r.height - p) / 2, v.preserveHeaders || this._rotate2Orientaion(r, T), this._renderImageToCanvas(r, a, m, g, f, p);
        }, _rotate2Orientaion: function(a, r) {
          var d = a.width, c = a.height, l = a.getContext("2d");
          switch (r) {
            case 5:
            case 6:
            case 7:
          ...
          switch (r) {
            case 2:
              ...
              break;
            case 3:
              l.translate(d, c), l.rotate(Math.PI);
              break;
            case 4:
              l.translate(0, c), l.scale(1, -1);
              break;
            case 5:
              l.rotate(0.5 * Math.PI), l.scale(1, -1);
              break;
            case 6:
              l.rotate(0.5 * Math.PI), l.translate(0, -c);
              break;
            case 7:
              l.rotate(0.5 * Math.PI), l.translate(d, -c), l.scale(-1, 1);
              break;
            case 8:
          ...
          function a(d, c, l) {
            var f, p, m, g = document.createElement("canvas"), v = g.getContext("2d"), b = 0, C = l, T = l;
            for (g.width = 1, g.height = l, v.drawImage(d, 0, 0), f = v.getImageData(0, 0, 1, l).data; T > b; )
              p = f[4 * (T - 1) + 3], p === 0 ? C = T : b = T, T = C + b >> 1;
            return m = T / l, m === 0 ? 1 : m;
          }
          function r(d) {
            var c, l, f = d.naturalWidth, p = d.naturalHeight;
            return f * p > 1048576 ? (c = document.createElement("canvas"), c.width = c.height = 1, l = c.getContext("2d"), l.drawImage(d, -f + 1, 0), l.getImageData(0, 0, 1, 1).data[3] === 0) : !1;
          }
          return o.os.ios ? o.os.ios >= 7 ? function(d, c, l, f, p, m) {
            var g = c.naturalWidth, v = c.naturalHeight, b = a(c, g, v);
            return d.getContext("2d").drawImage(c, 0, 0, g * b, v * b, l, f, p, m);
          } : function(d, c, l, f, p, m) {
            var g, v, b, C, T, N, M, A = c.naturalWidth, z = c.naturalHeight, R = d.getContext("2d"), D = r(c), S = this.type === "image/jpeg", w = 1024, x = 0, _ = 0;
            for (D && (A /= 2, z /= 2), R.save(), g = document.createElement("canvas"), g.width = g.height = w, v = g.getContext("2d"), b = S ? a(c, A, z) : 1, C = Math.ceil(w * p / A), T = Math.ceil(w * m / z / b); z > x; ) {
              for (N = 0, M = 0; A > N; )
                v.clearRect(0, 0, w, w), v.drawImage(c, -N, -x), R.drawImage(g, 0, 0, w, w, l + M, f + _, C, T), N += w, M += C;
              x += w, _ += T;
            }
            R.restore(), g = v = null;
          } : function(d) {
            var c = o.slice(arguments, 1), l = d.getContext("2d");
            l.drawImage.apply(l, c);
          };
        }() });
        ...
        return i.register("Transport", { init: function() {
          ...
          var a, r, d, c = this.owner, l = this.options, f = this._initAjax(), p = c._blob, m = l.server;
          l.sendAsBinary ? (m += l.attachInfoToQuery !== !1 ? (/\?/.test(m) ? "&" : "?") + s.param(c._formData) : "", r = p.getSource()) : (a = new FormData(), s.each(c._formData, function(g, v) {
            a.append(g, v);
          }), a.append(l.fileVal, p.getSource(), l.filename || c._formData.name || "")), l.withCredentials && "withCredentials" in f ? (f.open(l.method, m, !0), f.withCredentials = !0) : f.open(l.method, m), this._setRequestHeader(f, l.headers), r ? (f.overrideMimeType && f.overrideMimeType("application/octet-stream"), o.os.android ? (d = new FileReader(), d.onload = function() {
          ...
          var r = {};
          return a && a.replace(/^([^\:]+):(.*)$/gm, function(d, c, l) {
            r[c.trim()] = l.trim();
          }), r;
        }, _initAjax: function() {
          var a = this, r = new XMLHttpRequest(), d = this.options;
          return !d.withCredentials || "withCredentials" in r || typeof XDomainRequest > "u" || (r = new XDomainRequest()), r.upload.onprogress = function(c) {
            var l = 0;
            return c.lengthComputable && (l = c.loaded / c.total), a.trigger("progress", l);
          }, r.onreadystatechange = function() {
            if (r.readyState === 4) {
              r.upload.onprogress = u, r.onreadystatechange = u, a._xhr = null, a._status = r.status;
              var c = "|", l = c + r.status + c + r.statusText;
          ...
          s.each(r, function(d, c) {
            a.setRequestHeader(d, c);
          });
    ...
    he(Xt, { init: function(e, t) {
      ...
      if (n.event = t, j(Ti, function(s, a) {
        n[a] = t[a];
    ...
    }), y.ctrl = Dt, y.ready = Gn, y.formatUrl = Qe, y.formatHtml = Ie, y.getCssList = je, y.getAttrList = ke, y.mediaType = nn, y.mediaAttrs = rn, y.mediaEmbed = Mt, y.mediaImg = on, y.clearMsWord = tn, y.tmpl = Xn;
    var Un = document.createElement("div");
    Un.setAttribute("className", "t");
    var Si = Un.className !== "t";
    y.query = Jn, y.queryAll = vt, he(de, { init: function(e) {
      var t = this;
      e = ee(e) ? e : [e];
      ...
      var n = this;
      return e === void 0 ? ke(n.outer()) : typeof e == "object" ? (j(e, function(o, i) {
        n.attr(o, i);
      ...
      var n = this;
      return e === void 0 ? je(n.attr("style")) : typeof e == "object" ? (j(e, function(o, i) {
        n.css(o, i);
      ...
      if (t)
        if (t.getBoundingClientRect) {
          var i = t.getBoundingClientRect(), u = ze(e.doc);
    ...
    } }), j("blur,focus,focusin,focusout,load,resize,scroll,unload,click,dblclick,mousedown,mouseup,mousemove,mouseover,mouseout,mouseenter,mouseleave,change,select,submit,keydown,keypress,keyup,error,contextmenu".split(","), function(e, t) {
    ...
    y = function(e, t) {
      ...
      if (e != null) {
        if (typeof e == "string") {
          ...
          if (e.charAt(0) === "@" && (e = e.substr(1)), e.length !== o || /<.+>/.test(e)) {
            var i = t ? t.ownerDocument || t : document, u = i.createElement("div"), s = [];
      ...
      y[e] = t;
    }), y.NodeClass = de, window.KindEditor = y;
    var ot = 0, lt = 1, He = 2, at = 3, jn = 0;
    he(we, { init: function(e) {
      ...
      for (var t, n, o = e(this.startContainer), i = e(this.endContainer), u = 0, s = o.length, a = i.length; ++u && (t = o[s - u], n = i[a - u], t && n && t === n); )
        ;
      return o[s - u + 1];
      ...
      return this.setStart(e.parentNode || this.doc, y(e).index());
    }, setStartAfter: function(e) {
      return this.setStart(e.parentNode || this.doc, y(e).index() + 1);
    }, setEndBefore: function(e) {
      return this.setEnd(e.parentNode || this.doc, y(e).index());
    }, setEndAfter: function(e) {
      return this.setEnd(e.parentNode || this.doc, y(e).index() + 1);
      ...
      var i = {};
      i[ot] = "StartToStart", i[lt] = "EndToStart", i[He] = "EndToEnd", i[at] = "StartToEnd";
      var u = n.compareEndPoints(i[e], o);
      if (u !== 0)
        return u;
      var s, a, r, d, c;
      if ((e === ot || e === at) && (s = this.startContainer, d = this.startOffset), (e === lt || e === He) && (s = this.endContainer, d = this.endOffset), (e === ot || e === lt) && (a = t.startContainer, c = t.startOffset), (e === He || e === at) && (a = t.endContainer, c = t.endOffset), s === a) {
        var l = d - c;
      ...
      for (r = a; r && r.parentNode !== s; )
        r = r.parentNode;
      if (r)
        return y(r).index() >= d ? -1 : 1;
      for (r = s; r && r.parentNode !== a; )
        r = r.parentNode;
      return r ? y(r).index() >= c ? 1 : -1 : (r = y(a).next(), r && r.contains(s) ? 1 : (r = y(s).next(), r && r.contains(a) ? -1 : void 0));
    }, cloneRange: function() {
      ...
      var t, n, o, i = this, u = i.startContainer, s = i.startOffset, a = i.endContainer, r = i.endOffset, d = 1;
      return e.nodeName.toLowerCase() === "#document-fragment" && (t = e.firstChild, n = e.lastChild, d = e.childNodes.length), u.nodeType == 1 ? (o = u.childNodes[s], o ? (u.insertBefore(e, o), u === a && (r += d)) : u.appendChild(e)) : u.nodeType == 3 && (s === 0 ? (u.parentNode.insertBefore(e, u), u.parentNode === a && (r += d)) : s >= u.nodeValue.length ? u.nextSibling ? u.parentNode.insertBefore(e, u.nextSibling) : u.parentNode.appendChild(e) : (o = s > 0 ? u.splitText(s) : u, u.parentNode.insertBefore(e, o), u === a && (a = o, r -= s))), t ? i.setStartBefore(t).setEndAfter(n) : i.selectNode(e), i.compareBoundaryPoints(He, i.cloneRange().setEnd(a, r)) >= 1 ? i : i.setEnd(a, r);
      ...
      return t.nodeType == 1 && t === o && n + 1 === i && y(t.childNodes[n]).isControl();
    }, get: function(e) {
      ...
      return t = o.body.createTextRange(), t.setEndPoint("StartToStart", un(i.startContainer, i.startOffset)), t.setEndPoint("EndToStart", un(i.endContainer, i.endOffset)), t;
    }, html: function() {
      return y(this.cloneContents()).outer();
    }, down: function() {
      function e(n, o, i) {
        if (n.nodeType == 1) {
          var u = y(n).children();
          if (u.length !== 0) {
            var s, a, r, d;
            o > 0 && (s = u.eq(o - 1)), o < u.length && (a = u.eq(o)), s && s.type == 3 && (r = s[0], d = r.nodeValue.length), a && a.type == 3 && (r = a[0], d = 0), r && (i ? t.setStart(r, d) : t.setEnd(r, d));
          }
        }
      }
      var t = this;
      ...
      function t(o, i, u) {
        ...
        if (!(a.type == 3 || Ct[a.name] || !e && a.isBlock())) {
          if (i === 0) {
            for (; !a.prev() && (s = a.parent(), s && !Ct[s.name] && (e || !s.isBlock())); )
              a = s;
            u ? n.setStartBefore(a[0]) : n.setEndBefore(a[0]);
          } else if (i == a.children().length) {
            for (; !a.next() && (s = a.parent(), s && !Ct[s.name] && (e || !s.isBlock())); )
              a = s;
      ...
      for (var e, t = this, n = t.collapsed; t.startContainer.nodeType == 1 && (e = t.startContainer.childNodes[t.startOffset]) && e.nodeType == 1 && !y(e).isSingle(); )
        t.setStart(e, 0);
      if (n)
        return t.collapse(n);
      for (; t.endContainer.nodeType == 1 && t.endOffset > 0 && (e = t.endContainer.childNodes[t.endOffset - 1]) && e.nodeType == 1 && !y(e).isSingle(); )
        t.setEnd(e, e.childNodes.length);
      return t;
    }, createBookmark: function(e) {
      var t, n = this, o = n.doc, i = y('<span style="display:none;"></span>', o)[0];
      return i.id = "__kindeditor_bookmark_start_" + jn++ + "__", n.collapsed || (t = i.cloneNode(!0), t.id = "__kindeditor_bookmark_end_" + jn++ + "__"), t && n.cloneRange().collapse(!1).insertNode(t).setEndBefore(t), n.insertNode(i).setStartAfter(i), { start: e ? "#" + i.id : i, end: t ? e ? "#" + t.id : t : null };
    }, moveToBookmark: function(e) {
      var t = this, n = t.doc, o = y(e.start, n), i = e.end ? y(e.end, n) : null;
    ...
    } }), y.RangeClass = we, y.range = Lt, y.START_TO_START = ot, y.START_TO_END = lt, y.END_TO_END = He, y.END_TO_START = at, he(Ze, { init: function(e, t) {
      var n = this, o = e.doc;
      n.doc = o, n.win = Le(o), n.sel = Rt(o), n.range = e, n.editorOptions = t;
    }, selection: function(e) {
      var t = this, n = t.doc, o = ii(n);
      return t.sel = Rt(n), o ? (t.range = Lt(o), y(t.range.startContainer).name == "html" && t.range.selectNodeContents(n.body).collapse(!1), t) : (e && t.range.selectNodeContents(n.body).collapse(!1), t);
    }, select: function(e) {
      e = $(e, !0);
      var t, n = this, o = n.sel, i = n.range.cloneRange().shrink(), u = i.startContainer, s = i.startOffset, a = (i.endContainer, i.endOffset, Ae(u)), r = n.win, d = !1;
      if (e && u.nodeType == 1 && i.collapsed) {
        if (ye) {
          var c = y("<span>&nbsp;</span>", a);
          i.insertNode(c[0]), t = a.body.createTextRange();
          try {
            t.moveToElementText(c[0]);
          } catch {
          }
          return t.collapse(!1), t.select(), c.remove(), r.focus(), n;
        }
        if (Be) {
          var l = u.childNodes;
          (y(u).isInline() || s > 0 && y(l[s - 1]).isInline() || l[s] && y(l[s]).isInline()) && (i.insertNode(a.createTextNode("\u200B")), d = !0);
        }
      }
      if (ye)
        try {
        ...
        var p = y(t.endContainer).pos();
        r.scrollTo(p.x, p.y);
      }
      return r.focus(), n;
    }, wrap: function(e) {
      var t, n = this, o = n.doc, i = n.range;
      if (t = y(e, o), i.collapsed)
        return i.shrink(), i.insertNode(t[0]).selectNodeContents(t[0]), n;
      if (t.isBlock()) {
        for (var u = t.clone(!0), s = u; s.first(); )
          s = s.first();
        return s.append(i.extractContents()), i.insertNode(u[0]).selectNode(u[0]), n;
      }
      i.enlarge();
      var a = i.createBookmark(), r = i.commonAncestor(), d = !1;
      return y(r).scan(function(c) {
        if (!d && c == a.start)
          return void (d = !0);
        if (d) {
          if (c == a.end)
          ...
          if (ai(l))
            return;
          if (l.type == 3 && te(c.nodeValue).length > 0) {
      ...
      for (var n, o = this.range, i = o.doc, u = o.cloneRange().collapse(e), s = u.startContainer, a = u.startOffset, r = s.nodeType == 3 ? s.parentNode : s, d = !1; r && r.parentNode; ) {
        if (n = y(r), t) {
          if (!n.isStyle() || !Bt(n, t))
            break;
        } else if (Ct[n.name])
      ...
      if (d) {
        ...
        o.cloneRange().collapse(!e).insertNode(c), e ? u.setStartBefore(r.firstChild).setEnd(s, a) : u.setStart(s, a).setEndAfter(r.lastChild);
        var l = u.extractContents(), f = l.firstChild, p = l.lastChild;
        e ? (u.insertNode(l), o.setStartAfter(p).setEndBefore(c)) : (r.appendChild(l), o.setStartBefore(c).setEndBefore(f));
        var m = c.parentNode;
        if (m == o.endContainer) {
          var g = y(c).prev(), v = y(c).next();
          g && v && g.type == 3 && v.type == 3 ? o.setEnd(g[0], g[0].nodeValue.length) : e || o.setEnd(o.endContainer, o.endOffset - 1);
        }
        m.removeChild(c);
      }
      return this;
      ...
      if (o.enlarge(), o.startOffset === 0) {
        for (var i, u = y(o.startContainer); (i = u.parent()) && i.isStyle() && i.children().length == 1; )
          u = i;
        o.setStart(u[0], 0), u = y(o.startContainer), u.isBlock() && Ot(u, e);
        var s = u.parent();
        s && s.isBlock() && Ot(s, e);
      }
      var a, r;
      if (o.collapsed) {
        if (t.split(!0, e), a = o.startContainer, r = o.startOffset, r > 0) {
          var d = y(a.childNodes[r - 1]);
          d && Pe(d) && (d.remove(), o.setStart(a, r - 1));
        }
        var c = y(a.childNodes[r]);
        return c && Pe(c) && c.remove(), Pe(a) && (o.startBefore(a), a.remove()), o.collapse(!0), t;
      }
      ...
      var p = [], m = !1;
      y(o.commonAncestor()).scan(function(M) {
        return m || M != l ? M == f ? !1 : void (m && p.push(M)) : void (m = !0);
      }), y(l).remove(), y(f).remove(), a = o.startContainer, r = o.startOffset;
      var g = o.endContainer, v = o.endOffset;
      if (r > 0) {
        var b = y(a.childNodes[r - 1]);
        b && Pe(b) && (b.remove(), o.setStart(a, r - 1), a == g && o.setEnd(g, v - 1));
        var C = y(a.childNodes[r]);
        C && Pe(C) && (C.remove(), a == g && o.setEnd(g, v - 1));
      }
      var T = y(g.childNodes[o.endOffset]);
      T && Pe(T) && T.remove();
      var N = o.createBookmark(!0);
      return j(p, function(M, A) {
        Ot(y(A), e);
      ...
      var n = this.range, o = n.endContainer, i = n.endOffset, u = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], s = t(u);
      if (s)
        return s;
      if (!u)
        return null;
      ...
      var n = this.range, o = n.startContainer, i = n.startOffset, u = n.endContainer, s = n.endOffset, a = o.nodeType == 3 || i === 0 ? o : o.childNodes[i - 1], r = u.nodeType == 3 || s === 0 ? u : u.childNodes[s - 1], d = t(a), c = t(r);
      return d && c && d === c ? y(d) : null;
    }, state: function(e) {
      ...
      n.range, e = t(e);
      var i, u = "";
      return e === "fontfamily" || e === "fontname" ? (u = fn(o, "fontname"), u = u.replace(/['"]/g, ""), t(u)) : e === "formatblock" ? (u = fn(o, e), u === "" && (i = n.commonNode({ "h1,h2,h3,h4,h5,h6,p,div,pre,address": "*" }), i && (u = i.name)), u === "Normal" && (u = "p"), t(u)) : e === "fontsize" ? (i = n.commonNode({ "*": ".font-size" }), i && (u = i.css("font-size")), t(u)) : e === "forecolor" ? (i = n.commonNode({ "*": ".color" }), i && (u = i.css("color")), u = pt(u), u === "" && (u = "default"), t(u)) : e === "hilitecolor" ? (i = n.commonNode({ "*": ".background-color" }), i && (u = i.css("background-color")), u = pt(u), u === "" && (u = "default"), t(u)) : u;
    }, toggle: function(e, t) {
      var n = this;
      ...
      function n(s, a) {
        ...
        var c = dn(r);
        s.setEnd(c.endContainer, c.endOffset), s.collapse(!1), i.select(!1);
      }
      function o(s, a) {
    ...
    }, insertimage: function(e, t, n, o, i, u, s, a) {
      t = $(t, ""), s = $(s, "");
      ...
      function n(m, g, v) {
        y(m).attr("href", g).attr("data-ke-src", g), v ? y(m).attr("target", v) : y(m).removeAttr("target");
      }
      var o = this, i = o.doc, u = o.range;
      o.select();
      var s = o.commonNode({ a: "*" });
      s && !u.isControl() && (u.selectNode(s.get()), o.select());
      var a = '<a href="' + se(e) + '" data-ke-src="' + se(e) + '" ';
      if (t && (a += ' target="' + se(t) + '"'), u.collapsed)
        return a += ">" + se(e) + "</a>", o.inserthtml(a);
      if (u.isControl()) {
        var r = y(u.startContainer.childNodes[u.startOffset]);
        return a += "></a>", r.after(y(a, i)), r.next().append(r), u.selectNode(r[0]), o.select();
      }
      var d = u.startContainer, c = u.startOffset, l = u.endContainer, f = u.endOffset;
      if (d.nodeType == 1 && d === l && c + 1 === f) {
        var p = d.childNodes[c];
        if (p.nodeName.toLowerCase() == "a")
          return n(p, e, t), o;
      }
      return _e(i, "createlink", "__kindeditor_temp_url__"), y('a[href="__kindeditor_temp_url__"]', i).each(function() {
        n(this, e, t);
      }), o;
    }, unlink: function() {
      ...
      if (e.select(), n.collapsed) {
        ...
        if (o && (n.selectNode(o.get()), e.select()), _e(t, "unlink", null), Be && y(n.startContainer).name === "img") {
          var i = y(n.startContainer).parent();
          i.name === "a" && i.remove(!0);
        }
      } else
        _e(t, "unlink", null);
      return e;
    } }), j("formatblock,selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript".split(","), function(e, t) {
    ...
    }), j("cut,copy,paste".split(","), function(e, t) {
    ...
    }), y.CmdClass = Ze, y.cmd = gn, he(Te, { init: function(e) {
      var t = this;
      if (t.name = e.name || "", t.doc = e.doc || document, t.win = Le(t.doc), t.x = J(e.x), t.y = J(e.y), t.z = e.z, t.width = J(e.width), t.height = J(e.height), t.div = y('<div style="display:block;"></div>'), t.options = e, t._alignEl = e.alignEl, t.width && t.div.css("width", t.width), t.height && t.div.css("height", t.height), t.z && t.div.css({ position: "absolute", left: t.x, top: t.y, "z-index": t.z }), !t.z || t.x !== void 0 && t.y !== void 0 || t.autoPos(t.width, t.height), e.cls && t.div.addClass(e.cls), e.shadowMode && t.div.addClass("ke-shadow"), e.css && t.div.css(e.css), e.src ? y(e.src).replaceWith(t.div) : y(t.doc.body).append(t.div), e.html && t.div.html(e.html), e.autoScroll)
        if (Z && 7 > ce || Ee) {
          var n = ze();
          y(t.win).bind("scroll", function(o) {
            var i = ze(), u = i.x - n.x, s = i.y - n.y;
            t.pos(X(t.x) + u, X(t.y) + s, !1);
          });
        } else
      ...
      var n, o, i = this, u = X(e) || 0, s = X(t) || 0, a = ze();
      if (i._alignEl) {
        var r = y(i._alignEl), d = r.pos(), c = De(r[0].clientWidth / 2 - u / 2), l = De(r[0].clientHeight / 2 - s / 2);
        n = 0 > c ? d.x : d.x + c, o = 0 > l ? d.y : d.y + l;
      } else {
        var f = ge(i.doc);
        n = De(a.x + (f.clientWidth - u) / 2), o = De(a.y + (f.clientHeight - s) / 2);
      }
      return Z && 7 > ce || Ee || (n -= a.x, o -= a.y), i.pos(n, o);
    }, remove: function() {
      var e = this;
      return (Z && 7 > ce || Ee) && y(e.win).unbind("scroll"), e.div.remove(), j(e, function(t) {
        e[t] = null;
      }), this;
    }, show: function() {
      ...
      var t = this;
      return e = e || {}, e.moveEl = t.div, e.moveFn = function(n, o, i, u, s, a) {
        (n += s) < 0 && (n = 0), (o += a) < 0 && (o = 0), t.pos(n, o);
      }, Ut(e), t;
    } }), y.WidgetClass = Te, y.widget = jt;
    var Tt, Gt = "";
    (Tt = document.getElementsByTagName("html")) && (Gt = Tt[0].dir), he(Je, Te, { init: function(e) {
      function t() {
        var c = zt(n.iframe);
        c.open(), a && (c.domain = document.domain), c.write(si(o, i, u, s)), c.close(), n.win = n.iframe[0].contentWindow, n.doc = c;
        var l = gn(c, e.editorOptions);
        n.afterChange(function(f) {
          l.selection();
        }), Be && y(c).click(function(f) {
          (y(f.target).name === "img" || y(f.target).name === "audio" || y(f.target).name === "video") && (l.selection(!0), l.range.selectNode(f.target), l.select());
        }), Z && (n._mousedownHandler = function() {
          var f = l.range.cloneRange();
          f.shrink(), f.isControl() && n.blur();
        }, y(document).mousedown(n._mousedownHandler), y(c).keydown(function(f) {
          if (f.which == 8) {
            l.selection();
            var p = l.range;
            p.isControl() && (p.collapse(!0), y(p.startContainer.childNodes[p.startOffset]).remove(), f.preventDefault());
          }
        })), n.cmd = l, n.html(Xe(n.srcElement)), Z ? (c.body.disabled = !0, c.body.contentEditable = !0, c.body.removeAttribute("disabled")) : c.designMode = "on", e.afterCreate && e.afterCreate.call(n);
      }
      var n = this;
      Je.parent.init.call(n, e), n.srcElement = y(e.srcElement), n.div.addClass("ke-edit"), n.designMode = $(e.designMode, !0), n.beforeGetHtml = e.beforeGetHtml, n.beforeSetHtml = e.beforeSetHtml, n.afterSetHtml = e.afterSetHtml;
      var o = $(e.themesPath, ""), i = e.bodyClass, u = e.cssPath, s = e.cssData, a = location.protocol != "res:" && location.host.replace(/:\d+/, "") !== document.domain, r = "document.open();" + (a ? 'document.domain="' + document.domain + '";' : "") + "document.close();", d = Z ? ' src="javascript:void(function(){' + encodeURIComponent(r) + '}())"' : "";
      n.iframe = y('<iframe class="ke-edit-iframe" hidefocus="true" frameborder="0"' + d + "></iframe>").css("width", "100%"), n.textarea = y('<textarea class="ke-edit-textarea" hidefocus="true"></textarea>').css("width", "100%"), n.tabIndex = isNaN(parseInt(e.tabIndex, 10)) ? n.srcElement.attr("tabindex") : parseInt(e.tabIndex, 10), n.iframe.attr("tabindex", n.tabIndex), n.textarea.attr("tabindex", n.tabIndex), n.width && n.setWidth(n.width), n.height && n.setHeight(n.height), n.designMode ? n.textarea.hide() : n.iframe.hide(), a && n.iframe.bind("load", function(c) {
      ...
      var e = this, t = e.doc;
      y(t.body).unbind(), y(t).unbind(), y(e.win).unbind(), e._mousedownHandler && y(document).unbind("mousedown", e._mousedownHandler), Xe(e.srcElement, e.html()), e.srcElement.show(), e.iframe.unbind(), e.textarea.unbind(), Je.parent.remove.call(e);
    }, html: function(e, t) {
      var n = this, o = n.doc;
      if (n.designMode) {
        var i = o.body;
        return e === void 0 ? (e = t ? "<!doctype html><html>" + i.parentNode.innerHTML + "</html>" : i.innerHTML, n.beforeGetHtml && (e = n.beforeGetHtml(e)), Re && e == "<br />" && (e = ""), e) : (n.beforeSetHtml && (e = n.beforeSetHtml(e)), Z && ce >= 9 && (e = e.replace(/(<.*?checked=")checked(".*>)/gi, "$1$2")), y(i).html(e), n.afterSetHtml && n.afterSetHtml(), n);
      }
      ...
      var e = this;
      if (Z) {
        var t = y('<input type="text" style="float:left;width:0;height:0;padding:0;margin:0;border:0;" value="" />', e.div);
      ...
      if (e)
        return y(o).keyup(function(u) {
          u.ctrlKey || u.altKey || !Kt[u.which] || e(u);
        }), y(o).mouseup(e).contextmenu(e), y(n.win).blur(e), y(i).bind("paste", t), y(i).bind("cut", t), n;
    } }), y.EditClass = Je, y.edit = vn, y.iframeDoc = zt, he(yt, Te, { init: function(e) {
      function t(i) {
        var u = y(i);
      ...
      var o = this;
      yt.parent.init.call(o, e), o.disableMode = $(e.disableMode, !1), o.noDisableItemMap = oe($(e.noDisableItems, [])), o._itemMap = {}, o.div.addClass("ke-toolbar").bind("contextmenu,mousedown,mousemove", function(i) {
        i.preventDefault();
      ...
      return this._itemMap[e] ? this._itemMap[e] : this._itemMap[e] = y("span.ke-icon-" + e, this.div).parent();
    }, select: function(e) {
      ...
      return t && (o = oe(t)), (e === void 0 ? !n.disableMode : e) ? (y("span.ke-outline", n.div).each(function() {
        var i = y(this), u = i[0].getAttribute("data-name", 2);
        o[u] || n.disable(i);
      }), n.disableMode = !0) : (y("span.ke-outline", n.div).each(function() {
        var i = y(this), u = i[0].getAttribute("data-name", 2);
        o[u] || n.enable(i);
      }), n.disableMode = !1), n;
    } }), y.ToolbarClass = yt, y.toolbar = kn, he(et, Te, { init: function(e) {
      var t = this;
      ...
      var t = this;
      if (e.title === "-")
        return void t.div.append(y('<div class="ke-menu-separator"></div>'));
      var n = y('<div class="ke-menu-item" unselectable="on"></div>'), o = y('<div class="ke-inline-block ke-menu-item-left"></div>'), i = y('<div class="ke-inline-block ke-menu-item-right"></div>'), u = J(e.height), s = $(e.iconClass, "");
      t.div.append(n), u && (n.css("height", u), i.css("line-height", u));
      var a;
      return t.centerLineMode && (a = y('<div class="ke-inline-block ke-menu-item-center"></div>'), u && a.css("height", u)), n.mouseover(function(r) {
        y(this).addClass("ke-menu-item-on"), a && a.addClass("ke-menu-item-center-on");
      }).mouseout(function(r) {
        y(this).removeClass("ke-menu-item-on"), a && a.removeClass("ke-menu-item-center-on");
      }).click(function(r) {
        e.click.call(y(this)), r.stopPropagation();
      ...
      var e = this;
      return e.options.beforeRemove && e.options.beforeRemove.call(e), y(".ke-menu-item", e.div[0]).unbind(), et.parent.remove.call(e), e;
    } }), y.MenuClass = et, y.menu = Pt, he(tt, Te, { init: function(e) {
      var t = this;
      ...
      for (var s = 0; s < n.length; s++) {
        ...
        for (var a = 0; a < n[s].length; a++)
          u = i.insertCell(a), t._addAttr(u, n[s][a], "ke-colorpicker-cell");
      }
    }, _addAttr: function(e, t, n) {
      var o = this;
      e = y(e).addClass(n), o.selectedColor === t.toLowerCase() && e.addClass("ke-colorpicker-cell-selected"), e.attr("title", t || o.options.noColor), e.mouseover(function(i) {
        y(this).addClass("ke-colorpicker-cell-on");
      }), e.mouseout(function(i) {
        y(this).removeClass("ke-colorpicker-cell-on");
      }), e.click(function(i) {
        i.stop(), o.options.click.call(y(this), t);
      }), t ? e.append(y('<div class="ke-colorpicker-cell-color" unselectable="on"></div>').css("background-color", t)) : e.html(o.options.noColor), y(e).attr("unselectable", "on"), o._cells.push(e);
    }, remove: function() {
      var e = this;
      return j(e._cells, function() {
        this.unbind();
      }), tt.parent.remove.call(e), e;
    } }), y.ColorPickerClass = tt, y.colorpicker = bn, he(Ht, { init: function(e) {
      var t = this, n = y(e.button), o = e.fieldName || "file", i = e.url || "", u = n.val(), s = e.extraParams || {}, a = n[0].className || "", r = e.target || "kindeditor_upload_iframe_" + new Date().getTime();
      e.afterError = e.afterError || function(v) {
        alert(v);
      };
      var d = [];
      for (var c in s)
        d.push('<input type="hidden" name="' + c + '" value="' + s[c] + '" />');
      var l = ['<div class="ke-inline-block ' + a + '">', e.target ? "" : '<iframe name="' + r + '" style="display:none;"></iframe>', e.form ? '<div class="ke-upload-area">' : '<form class="ke-upload-area ke-form" method="post" enctype="multipart/form-data" target="' + r + '" action="' + i + '">', '<span class="ke-button-common">', d.join(""), '<input type="button" class="ke-button-common ke-button" value="' + u + '" />', "</span>", '<input type="file" class="ke-upload-file" name="' + o + '" tabindex="-1" />', e.form ? "</div>" : "</form>", "</div>"].join(""), f = y(l, n.doc);
      n.hide(), n.before(f), t.div = f, t.button = n, t.fileBox = y(".ke-upload-file", f), t.form = e.form ? y(e.form) : y("form", f);
      var p = y.undef(e.fileSizeLimit, "1MB"), m = y.undef(e.fileTypeLimit, "*.jpg;*.gif;*.png");
      t.uploader = WebUploader.create({ server: e.uploadUrl, resize: !1, fileVal: "file", accept: { title: "upload", extensions: m.replace(/\*\./g, "").replace(/;/g, ","), mimeTypes: "image/*" }, headers: e.uploadHeader, formData: e.uploadData, fileNumLimit: 1, fileSingleSizeLimit: 1 * p.replace(/MB/g, "") * 1024 * 1024 }), t.uploader.on("uploadStart", function(v) {
      }), t.uploader.on("uploadSuccess", function(v, b) {
        t.options.afterUpload.call(t, b.data);
      }), t.uploader.on("error", function(v) {
        var b = "\u6587\u4EF6\u4E0A\u4F20\u51FA\u73B0\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\uFF01";
        v === "Q_TYPE_DENIED" ? b = "[" + arguments[1].name + "]\u6587\u4EF6\u7C7B\u578B\u4E0D\u6B63\u786E\uFF01" : v === "F_EXCEED_SIZE" ? b = "\u6587\u4EF6\u5927\u5C0F\u8D85\u51FA\u9650\u5236\uFF08\u6700\u5927" + 1 * e.fileSizeLimit.replace(/MB/g, "") + "M\uFF09\uFF01" : v === "F_DUPLICATE" && (b = "[" + arguments[1].name + "]\u6587\u4EF6\u5DF2\u5B58\u5728\u4E8E\u5F85\u4E0A\u4F20\u5217\u8868\u4E2D\uFF01"), console.error("\u6587\u4EF6\u4E0A\u4F20\u51FA\u73B0\u9519\u8BEF\uFF0C\u8BF7\u68C0\u67E5\u540E\u91CD\u8BD5\uFF01", arguments), t.options.afterUpload.call(t, { error: 1, message: b }), t.uploader.reset(), t.form && t.form[0] && t.form[0].reset && t.form[0].reset();
      }), t.fileBox.bind("change", function() {
        t.uploader.reset(), this.files && t.uploader.addFiles(this.files);
      });
      var g = e.width || y(".ke-button-common", f).width();
      y(".ke-upload-area", f).width(g), t.options = e;
    }, submit: function() {
    ...
    } }), y.UploadButtonClass = Ht, y.uploadbutton = ci, he(nt, Te, { init: function(e) {
      var t = this, n = $(e.shadowMode, !0);
      e.z = e.z || 811213, e.shadowMode = !1, e.autoScroll = $(e.autoScroll, !0), nt.parent.init.call(t, e);
      var o = e.title, i = y(e.body, t.doc), u = e.previewBtn, s = e.yesBtn, a = e.noBtn, r = e.closeBtn, d = $(e.showMask, !0);
      t.div.addClass("ke-dialog").bind("click,mousedown", function(b) {
        b.stopPropagation();
      });
      var c = y('<div class="ke-dialog-content"></div>').appendTo(t.div);
      Z && 7 > ce ? t.iframeMask = y('<iframe src="about:blank" class="ke-dialog-shadow"></iframe>').appendTo(t.div) : n && y('<div class="ke-dialog-shadow"></div>').appendTo(t.div);
      var l = y('<div class="ke-dialog-header"></div>');
      c.append(l), l.html(o), t.closeIcon = y('<span class="ke-dialog-icon-close" title="' + r.name + '"></span>').click(r.click), l.append(t.closeIcon), t.draggable({ clickEl: l, beforeDrag: e.beforeDrag });
      var f = y('<div class="ke-dialog-body"></div>');
      c.append(f), f.append(i);
      var p = y('<div class="ke-dialog-footer"></div>');
      if ((u || s || a) && c.append(p), j([{ btn: u, name: "preview" }, { btn: s, name: "yes" }, { btn: a, name: "no" }], function() {
        if (this.btn) {
          var b = ui(this.btn);
        ...
        var m = ge(t.doc), g = Math.max(m.scrollWidth, m.clientWidth), v = Math.max(m.scrollHeight, m.clientHeight);
        t.mask = jt({ x: 0, y: 0, z: t.z - 1, cls: "ke-dialog-mask", width: g, height: v });
      }
      ...
      return t.loading = y('<div class="ke-dialog-loading"><div class="ke-inline-block ke-dialog-loading-content" style="margin-top:' + Math.round(n.height() / 3) + 'px;">' + e + "</div></div>").width(n.width()).height(n.height()).css("top", t.headerDiv.height() + "px"), n.css("visibility", "hidden").after(t.loading), t.isLoading = !0, t;
    }, hideLoading: function() {
      return this.loading && this.loading.remove(), this.bodyDiv.css("visibility", "visible"), this.isLoading = !1, this;
    }, remove: function() {
      var e = this;
      return e.options.beforeRemove && e.options.beforeRemove.call(e), e.mask && e.mask.remove(), e.iframeMask && e.iframeMask.remove(), e.closeIcon.unbind(), y("input", e.div).unbind(), y("button", e.div).unbind(), e.footerDiv.unbind(), e.bodyDiv.unbind(), e.headerDiv.unbind(), y("iframe", e.div).each(function() {
        y(this).remove();
      }), nt.parent.remove.call(e), e;
    } }), y.DialogClass = nt, y.dialog = wn, y.tabs = di, y.loadScript = qt, y.loadStyle = Wt, y.ajax = fi;
    var xe = {}, Ce = {};
    it.prototype = { lang: function(e) {
      ...
      return o || (o = this._pluginStatus = {}), xe[e] ? re(xe[e]) ? (o[e] || (xe[e].call(n, KindEditor), o[e] = "inited"), t && t.call(n), n) : (setTimeout(function() {
        n.loadPlugin(e, t);
      }, 100), n) : (xe[e] = "loading", qt(n.pluginsPath + e + "/" + e + ".js?ver=" + encodeURIComponent(y.DEBUG ? xt : wt), function() {
        setTimeout(function() {
      ...
      var n = this;
      return n._handlers[e] || (n._handlers[e] = []), re(t) ? (n._handlers[e].push(t), n) : (j(n._handlers[e], function() {
        t = this.call(n, t);
      }), t);
      ...
      var e = this;
      return j("justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,subscript,superscript,bold,italic,underline,strikethrough".split(","), function(t, n) {
      ...
      var o = n ? ge().clientWidth + "px" : t.width, i = n ? ge().clientHeight + "px" : t.height;
      (Z && 8 > ce || Ee) && (i = J(X(i) + 2));
      var u = t.container = y(t.layout);
      n ? y(document.body).append(u) : t.srcElement.before(u);
      var s = y(".toolbar", u), a = y(".edit", u), r = t.statusbar = y(".statusbar", u);
      u.removeClass("container").addClass("ke-container ke-container-" + t.themeType).css("width", o), n ? (u.css({ position: "absolute", left: 0, top: 0, "z-index": 811211 }), Re || (t._scrollPos = ze()), window.scrollTo(0, 0), y(document.body).css({ height: "1px", overflow: "hidden" }), y(document.body.parentNode).css("overflow", "hidden"), t._fullscreenExecuted = !0) : (t._fullscreenExecuted && (y(document.body).css({ height: "", overflow: "" }), y(document.body.parentNode).css("overflow", "")), t._scrollPos && window.scrollTo(t._scrollPos.x, t._scrollPos.y));
      var d = [];
      y.each(t.items, function(p, m) {
      ...
      var c = t.toolbar = kn({ src: s, html: d.join(""), noDisableItems: t.noDisableItems, click: function(p, m) {
        if (p.stop(), t.menu) {
          var g = t.menu.name;
          if (t.hideMenu(), g === m)
            return;
        ...
        t.clickToolbar(m);
      } }), l = X(i) - c.div.height(), f = t.edit = vn({ height: l > 0 && X(i) > t.minHeight ? l : t.minHeight, src: a, srcElement: t.srcElement, designMode: t.designMode, themesPath: t.themesPath, bodyClass: t.bodyClass, cssPath: t.cssPath, cssData: t.cssData, editorOptions: t.options, beforeGetHtml: function(p) {
        ...
        if (t.edit = f = this, t.cmd = f.cmd, t._docMousedownFn = function(m) {
          t.menu && t.hideMenu();
        }, y(f.doc, document).mousedown(t._docMousedownFn), pi.call(t), hi.call(t), mi.call(t), gi.call(t), f.afterChange(function(m) {
      ...
      return r.removeClass("statusbar").addClass("ke-statusbar").append('<span class="ke-inline-block ke-statusbar-center-icon"><i></i><i></i><i></i></span>').append('<span class="ke-inline-block ke-statusbar-right-icon"></span>'), t._fullscreenResizeHandler && (y(window).unbind("resize", t._fullscreenResizeHandler), t._fullscreenResizeHandler = null), e(), n ? (t._fullscreenResizeHandler = function(p) {
        t.isCreated && t.resize(ge().clientWidth, ge().clientHeight, !1);
      }, y(window).bind("resize", t._fullscreenResizeHandler), c.select("fullscreen"), r.first().css("visibility", "hidden"), r.last().css("visibility", "hidden")) : (Re && y(window).bind("scroll", function(p) {
        t._scrollPos = ze();
      }), t.resizeType > 0 ? Ut({ moveEl: u, clickEl: r, moveFn: function(p, m, g, v, b, C) {
        v += C, t.resize(null, v);
      } }) : r.first().css("visibility", "hidden"), t.resizeType === 2 ? Ut({ moveEl: u, clickEl: r.last(), moveFn: function(p, m, g, v, b, C) {
        g += b, v += C, t.resize(g, v);
      } }) : r.last().css("visibility", "hidden")), setTimeout(function() {
        t.focus && t.focus();
      }, 100), t;
    }, remove: function() {
      var e = this;
      return e.isCreated && (e.beforeRemove(), e.srcElement.data("kindeditor", ""), e.menu && e.hideMenu(), j(e.dialogs, function() {
        e.hideDialog();
      }), y(document).unbind("mousedown", e._docMousedownFn), e.toolbar.remove(), e.edit.remove(), e.statusbar.last().unbind(), e.statusbar.unbind(), e.container.remove(), e.container = e.toolbar = e.edit = e.menu = null, e.dialogs = [], e.isCreated = !1), e;
      ...
      e = $(e, !0);
      var t, n = this, o = n.edit, i = o.doc.body, u = bt(i.innerHTML);
      if (e && n._undoStack.length > 0) {
        var s = n._undoStack[n._undoStack.length - 1];
        if (Math.abs(u.length - Se(s.html).length) < n.minChangeSize)
          return n;
      }
      if (o.designMode && !n._firstAddBookmark) {
        var a = n.cmd.range;
        t = a.createBookmark(!0), t.html = bt(i.innerHTML), a.moveToBookmark(t);
      } else
        t = { html: u };
      ...
      t.designMode ? t.toolbar.disableAll(e, []) : j(t.noDisableItems, function() {
      ...
      return e.x = i.x, e.y = i.y + o.height(), e.z = t.options.zIndex, e.shadowMode = $(e.shadowMode, t.shadowMode), e.selectedColor !== void 0 ? (e.cls = "ke-colorpicker-" + t.themeType, e.noColor = t.lang("noColor"), t.menu = bn(e)) : (e.cls = "ke-menu-" + t.themeType, e.centerLineMode = !1, t.menu = Pt(e)), t.menu;
    }, hideMenu: function() {
      ...
      var t = this;
      if (e.name, e.z = t.options.zIndex, e.shadowMode = $(e.shadowMode, t.shadowMode), e.closeBtn = $(e.closeBtn, { name: t.lang("close"), click: function(u) {
        t.hideDialog(), Z && t.cmd && t.cmd.select();
      } }), e.noBtn = $(e.noBtn, { name: t.lang(e.yesBtn ? "no" : "close"), click: function(u) {
        t.hideDialog(), Z && t.cmd && t.cmd.select();
      ...
      var t = this, n = t.createDialog({ width: 750, title: t.lang("uploadError"), body: '<div style="padding:10px 20px;"><iframe frameborder="0" style="width:708px;height:400px;"></iframe></div>' }), o = y("iframe", n.div), i = y.iframeDoc(o);
      return i.open(), i.write(e), i.close(), y(i.body).css("background-color", "#FFF"), o[0].contentWindow.focus(), t;
    } };
    var st = [];
    return y.remove = function(e) {
      rt(e, function(t) {
    ...
    }, Z && 7 > ce && _e(document, "BackgroundImageCache", !0), y.EditorClass = it, y.editor = vi, y.create = Dn, y.instances = st, y.plugin = Cn, y.lang = Tn, Cn("core", function(e) {
      ...
      j("undo,redo".split(","), function(i, u) {
        n[u] && t.afterCreate(function() {
          Dt(this.edit.doc, n[u], function() {
            t.clickToolbar(u);
          });
        ...
        var i = t.lang("formatblock.formatBlock"), u = { h1: 28, h2: 24, h3: 18, H4: 14, p: 12 }, s = t.cmd.val("formatblock"), a = t.createMenu({ name: "formatblock", width: t.langType == "en" ? 200 : 150 });
        j(i, function(r, d) {
          var c = "font-size:" + u[r] + "px;";
          r.charAt(0) === "h" && (c += "font-weight:bold;"), a.addItem({ title: '<span style="' + c + '" unselectable="on">' + d + "</span>", height: u[r] + 12, checked: s === r || s === d, click: function() {
        ...
        j(t.lang("fontname.fontName"), function(s, a) {
          u.addItem({ title: '<span style="font-family: ' + s + ';" unselectable="on">' + a + "</span>", height: 30, checked: i === s.toLowerCase() || i === a.toLowerCase(), click: function() {
        ...
        j(t.fontSizeTable, function(s, a) {
      ...
      }), j("forecolor,hilitecolor".split(","), function(i, u) {
        t.clickToolbar(u, function() {
          t.createMenu({ name: u, selectedColor: t.cmd.val(u) || "default", colors: t.colorTable, click: function(s) {
            t.exec(u, s).hideMenu();
          } });
        });
      }), j("cut,copy,paste".split(","), function(i, u) {
        t.clickToolbar(u, function() {
          t.focus();
          try {
            t.exec(u, null);
        ...
        var i = '<div style="margin:20px;"><div>KindEditor ' + wt + '</div><div>Copyright &copy; <a href="http://www.kindsoft.net/" target="_blank">kindsoft.net</a> All rights reserved.</div></div>';
        ...
        return kt(t.edit.cmd.range, function(i) {
      ...
      }, j("link,image,flash,media,anchor".split(","), function(i, u) {
        var s = u.charAt(0).toUpperCase() + u.substr(1);
        j("edit,delete".split(","), function(a, r) {
          t.addContextmenu({ title: t.lang(r + s), click: function() {
            t.loadPlugin(u, function() {
              t.plugin[u][r](), t.hideMenu();
            });
          }, cond: t.plugin["getSelected" + s], width: 150, iconClass: r == "edit" ? "ke-icon-" + u : void 0 });
      ...
      }, j("prop,cellprop,colinsertleft,colinsertright,rowinsertabove,rowinsertbelow,rowmerge,colmerge,rowsplit,colsplit,coldelete,rowdelete,insert,delete".split(","), function(i, u) {
        var s = pe(u, ["prop", "delete"]) < 0 ? t.plugin.getSelectedCell : t.plugin.getSelectedTable;
        t.addContextmenu({ title: t.lang("table" + u), click: function() {
          t.loadPlugin("table", function() {
            t.plugin.table[u](), t.hideMenu();
          });
        }, cond: s, width: 170, iconClass: "ke-icon-table" + u });
      }), t.addContextmenu({ title: "-" }), j("selectall,justifyleft,justifycenter,justifyright,justifyfull,insertorderedlist,insertunorderedlist,indent,outdent,subscript,superscript,hr,print,bold,italic,underline,strikethrough,removeformat,unlink".split(","), function(i, u) {
        n[u] && t.afterCreate(function() {
          Dt(this.edit.doc, n[u], function() {
        ...
        function i() {
          u.range.moveToBookmark(s), u.select(), Be && (e("div." + d, a).each(function() {
...
`), l = l.replace(/<[^>]+>/g, ""), l = l.replace(/ {2}/g, " &nbsp;"), t.newlineTag == "p" ? /\n/.test(l) && (l = l.replace(/^/, "<p>").replace(/$/, "<br /></p>").replace(/\n/g, "<br /></p><p>")) : l = l.replace(/\n/g, "<br />$&")), t.insertHtml(l, !0));
        ...
        var u, s, a, r = t.edit.doc, d = "__kindeditor_paste__", c = !1;
        e(r.body).bind("paste", function(l) {
          if (t.pasteType === 0)
            return void l.stop();
          if (!c) {
            if (c = !0, e("div." + d, r).remove(), u = t.cmd.selection(), s = u.range.createBookmark(), a = e('<div class="' + d + '"></div>', r).css({ position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: e(s.start).pos().y + "px", "white-space": "nowrap" }), e(r.body).append(a), Z) {
              var f = u.range.get(!0);
...
Allowed file extension: swf,flv,mp3,wav,wma,wmv,mid,avi,mpg,asf,rm,rmvb`, invalidWidth: "The width must be number.", invalidHeight: "The height must be number.", invalidBorder: "The border must be number.", invalidUrl: "Please type valid URL.", invalidRows: "Invalid rows.", invalidCols: "Invalid columns.", invalidPadding: "The padding must be number.", invalidSpacing: "The spacing must be number.", invalidJson: "Invalid JSON string.", uploadSuccess: "Upload success.", cutError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+X) instead.", copyError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+C) instead.", pasteError: "Currently not supported by your browser, use keyboard shortcut(Ctrl+V) instead.", ajaxLoading: "Loading ...", uploadLoading: "Uploading ...", uploadError: "Upload Error", "plainpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "wordpaste.comment": "Use keyboard shortcut(Ctrl+V) to paste the text into the window.", "code.pleaseInput": "Please input code.", "link.url": "URL", "link.linkType": "Target", "link.newWindow": "New window", "link.selfWindow": "Same window", "flash.url": "URL", "flash.width": "Width", "flash.height": "Height", "flash.upload": "Upload", "flash.viewServer": "Browse", "media.url": "URL", "media.width": "Width", "media.height": "Height", "media.autostart": "Auto start", "media.upload": "Upload", "media.viewServer": "Browse", "image.remoteImage": "Insert URL", "image.localImage": "Upload", "image.remoteUrl": "URL", "image.localUrl": "File", "image.size": "Size", "image.width": "Width", "image.height": "Height", "image.resetSize": "Reset dimensions", "image.align": "Align", "image.defaultAlign": "Default", "image.leftAlign": "Left", "image.rightAlign": "Right", "image.imgTitle": "Title", "image.upload": "Browse", "image.viewServer": "Browse", "multiimage.uploadDesc": "Allows users to upload <%=uploadLimit%> images, single image size not exceeding <%=sizeLimit%>", "multiimage.startUpload": "Start upload", "multiimage.clearAll": "Clear all", "multiimage.insertAll": "Insert all", "multiimage.queueLimitExceeded": "Queue limit exceeded.", "multiimage.fileExceedsSizeLimit": "File exceeds size limit.", "multiimage.zeroByteFile": "Zero byte file.", "multiimage.invalidFiletype": "Invalid file type.", "multiimage.unknownError": "Unknown upload error.", "multiimage.pending": "Pending ...", "multiimage.uploadError": "Upload error", "filemanager.emptyFolder": "Blank", "filemanager.moveup": "Parent folder", "filemanager.viewType": "Display: ", "filemanager.viewImage": "Thumbnails", "filemanager.listImage": "List", "filemanager.orderType": "Sorting: ", "filemanager.fileName": "By name", "filemanager.fileSize": "By size", "filemanager.fileType": "By type", "insertfile.url": "URL", "insertfile.title": "Title", "insertfile.upload": "Upload", "insertfile.viewServer": "Browse", "table.cells": "Cells", "table.rows": "Rows", "table.cols": "Columns", "table.size": "Dimensions", "table.width": "Width", "table.height": "Height", "table.percent": "%", "table.px": "px", "table.space": "Space", "table.padding": "Padding", "table.spacing": "Spacing", "table.align": "Align", "table.textAlign": "Horizontal", "table.verticalAlign": "Vertical", "table.alignDefault": "Default", "table.alignLeft": "Left", "table.alignCenter": "Center", "table.alignRight": "Right", "table.alignTop": "Top", "table.alignMiddle": "Middle", "table.alignBottom": "Bottom", "table.alignBaseline": "Baseline", "table.border": "Border", "table.borderWidth": "Width", "table.borderColor": "Color", "table.backgroundColor": "Background", "map.address": "Address: ", "map.search": "Search", "baidumap.address": "Address: ", "baidumap.search": "Search", "baidumap.insertDynamicMap": "Dynamic Map", "anchor.name": "Anchor name", "formatblock.formatBlock": { h1: "Heading 1", h2: "Heading 2", h3: "Heading 3", h4: "Heading 4", p: "Normal" }, "fontname.fontName": { Arial: "Arial", "Arial Black": "Arial Black", "Comic Sans MS": "Comic Sans MS", "Courier New": "Courier New", Garamond: "Garamond", Georgia: "Georgia", Tahoma: "Tahoma", "Times New Roman": "Times New Roman", "Trebuchet MS": "Trebuchet MS", Verdana: "Verdana" }, "lineheight.lineHeight": [{ 1: "Line height 1" }, { 1.5: "Line height 1.5" }, { 2: "Line height 2" }, { 2.5: "Line height 2.5" }, { 3: "Line height 3" }], "template.selectTemplate": "Template", "template.replaceContent": "Replace current content", "template.fileList": { "1.html": "Image and Text", "2.html": "Table", "3.html": "List" } }, "en"), KindEditor.each(KindEditor.options.items, function(e, t) {
      ...
      t.plugin.anchor = { edit: function() {
        ...
        } } }), s = u.div, a = e('input[name="name"]', s), r = t.plugin.getSelectedAnchor();
      ...
      function n() {
        if (!i.fullscreenMode) {
          var s = i.edit, a = s.doc.body;
          s.iframe.height(u);
          var r = i.toolbar, d = e(r.div).height(), c = Math.max(e.IE ? a.scrollHeight : a.offsetHeight, u, e(a).height()) + d + 30;
          i.resize(null, c), a.scrollTo({ top: 0 });
        }
      }
      function o() {
      ...
      var t = this, n = "baidumap", o = t.lang(n + "."), i = e.undef(t.baiduMapAk, "9yfaQtWDimlbXuo4TMLmIk7yDjl36eCy"), u = e.undef(t.mapWidth, 558), s = e.undef(t.mapHeight, 360);
      t.clickToolbar(n, function() {
        function a() {
          r = v[0].contentWindow, d = e.iframeDoc(v), d.open(), d.write(g), d.close();
        }
        var r, d, c = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', o.address + ' <input id="kindeditor_plugin_map_address" name="address" class="ke-input-text" value="" style="width:450px;" /> ', '<span class="ke-button-common ke-button-outer">', '<input type="button" name="searchBtn" class="ke-button-common ke-button" value="' + o.search + '" />', "</span>", "</div>", '<div class="ke-map" style="width:' + u + "px;height:" + s + 'px;"></div>', "</div>"].join(""), l = t.createDialog({ name: n, width: u + 42, title: t.lang(n), body: c, yesBtn: { name: t.lang("yes"), click: function(b) {
          var C = r.map, T = C.getCenter(), N = T.lng + "," + T.lat, M = C.getZoom(), A = ["http://api.map.baidu.com/staticimage/v2?ak=" + i, "&center=" + encodeURIComponent(N), "&zoom=" + encodeURIComponent(M), "&width=" + 2 * u, "&height=" + 2 * s, "&markers=" + encodeURIComponent(N), "&markerStyles=" + encodeURIComponent("l,A")].join("");
          t.exec("insertimage", A, "title", u + "", s + "", 0), t.hideDialog().focus();
        } }, beforeRemove: function() {
          m.remove(), d && d.write(""), v.remove();
...
`), v = e('<iframe class="ke-textarea" frameborder="0" style="width:558px;height:360px;"></iframe>');
        v.bind("load", function() {
          v.unbind("load"), e.IE ? a() : setTimeout(a, 0);
        }), e(".ke-map", f).replaceWith(v), m.click(function() {
          r.search(p.val());
        });
      });
      ...
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = ['<div style="padding:10px 20px;">', '<div class="ke-dialog-row">', '<select class="ke-code-type">', '<option value="js">JavaScript</option>', '<option value="html">HTML</option>', '<option value="css">CSS</option>', '<option value="php">PHP</option>', '<option value="pl">Perl</option>', '<option value="py">Python</option>', '<option value="rb">Ruby</option>', '<option value="java">Java</option>', '<option value="vb">ASP/VB</option>', '<option value="cpp">C/C++</option>', '<option value="cs">C#</option>', '<option value="xml">XML</option>', '<option value="bsh">Shell</option>', '<option value="">Other</option>', "</select>", "</div>", '<textarea class="ke-textarea" style="width:518px;height:260px;"></textarea>', "</div>"].join(""), u = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(a) {
          var r = e(".ke-code-type", u.div).val(), d = s.val().replace(/^\s+/g, "").replace(/\s+$/g, `
`).replace(/(\s*<!--)/g, `
$1`).replace(/>(\s*)(?=<!--\s*\/)/g, "> "), c = r === "" ? "" : " lang-" + r, l = '<pre class="' + c + `">
` + e.escape(d) + `
</pre> `;
      ...
      t.emojiConfig && t.emojiConfig instanceof Function && t.emojiConfig.call(null, o, i), t.clickToolbar(n, function() {
        function u(T, N) {
          T.mouseover(function() {
            ...
            t.insertHtml(N).hideMenu().focus(), M.stop();
          });
        }
        function s(T, N) {
          var M = document.createElement("ul");
          N.append(M), M.className = "ke-ul";
          for (var A, z = Math.ceil(o[T].length / i.cols), R = 0; z > R; R++) {
            var D = document.createElement("li");
            e(D).addClass("ke-li"), e(M).append(D);
            for (var S = 0; S < i.cols; S++)
              if (A = o[T][i.cols * R + S], A !== void 0) {
                var w = e('<span class="ke-emoji">' + A + "</span>");
                u(w, A), e(D).append(w), c.push(w);
              }
          }
          return M;
        }
        ...
        function r(T, N) {
          T.click(function(M) {
            a(), b.parentNode.removeChild(b), v.remove(), b = s(N, l), d(N), i.current = N, M.stop();
          });
        }
        function d(T) {
          v = e('<div class="ke-page"></div>'), l.append(v);
          for (var N in i.tags) {
            var M = i.tags[N];
            if (N !== T) {
              var A = e('<span class="ke-page-item"><a href="javascript:;">[' + M + "]</a></span>");
              r(A, N), v.append(A), c.push(A);
            } else
              v.append(e('<span class="ke-page-item">[' + M + "]</span>"));
          }
        }
        var c = [], l = e('<div class="ke-plugin-emoji"></div>'), f = t.createMenu({ name: n, beforeRemove: function() {
          a();
        } }), p = e(".ke-toolbar .ke-icon-emoticons").pos().x, m = e(".ke-toolbar .ke-icon-emoticons").width(), g = e(document.body).width();
        f.div.append(l);
        var v, b = s(i.current, l), C = e(l).width();
      ...
      t.symbolConfig && t.symbolConfig instanceof Function && t.symbolConfig.call(null, o, i), t.clickToolbar(n, function() {
        ...
        function s(T, N) {
          var M = document.createElement("ul");
          N.append(M), M.className = "ke-ul";
          for (var A, z = o[T].split(","), R = Math.ceil(z.length / i.cols), D = 0; R > D; D++) {
            var S = document.createElement("li");
            e(S).addClass("ke-li"), e(M).append(S);
            for (var w = 0; w < i.cols; w++)
              if (A = z[i.cols * D + w], A !== void 0) {
                var x = e('<span class="ke-symbol">' + A + "</span>");
                u(x, A), e(S).append(x), c.push(x);
              }
          }
          return M;
        }
        ...
        function d(T) {
          ...
          for (var N in i.tags) {
            ...
            if (N !== T) {
              ...
              v.append(e('<span class="ke-page-item ke-page-active">[' + M + "]</span>"));
          }
        }
        var c = [], l = e('<div class="ke-plugin-symbol"></div>'), f = t.createMenu({ name: n, beforeRemove: function() {
          a();
      ...
      function t(r, d, c) {
        return r + " (" + Math.ceil(d / 1024) + "KB, " + c + ")";
      }
      function n(r, d) {
        d.is_dir ? r.attr("title", d.filename) : r.attr("title", t(d.filename, d.filesize, d.datetime));
      }
      var o = this, i = "filemanager", u = e.undef(o.fileManagerJson, o.basePath + "php/file_manager_json.php"), s = o.pluginsPath + i + "/images/", a = o.lang(i + ".");
      o.plugin.filemanagerDialog = function(r) {
        function d(w, x, _) {
          var I = "path=" + w + "&order=" + x + "&dir=" + v;
          N.showLoading(o.lang("ajaxLoading")), e.ajax(e.addParam(u, I + "&" + new Date().getTime()), function(O) {
            N.hideLoading(), _(O);
          });
        }
        function c(w, x, _, I) {
        ...
        function l(w, x) {
          ...
          e.each(S, function() {
            this.unbind();
          }), z.unbind(), R.unbind(), D.unbind(), w.current_dir_path && z.click(function(I) {
        ...
        function f(w) {
          ...
          for (var _ = w.file_list, I = 0, O = _.length; O > I; I++) {
            var L = _[I], U = e(x.insertRow(I));
            U.mouseover(function(V) {
              e(this).addClass("ke-on");
            }).mouseout(function(V) {
              e(this).removeClass("ke-on");
            });
            var F = s + (L.is_dir ? "folder-16.gif" : "file-16.gif"), W = e('<img src="' + F + '" width="16" height="16" alt="' + L.filename + '" align="absmiddle" />'), P = e(U[0].insertCell(0)).addClass("ke-cell ke-name").append(W).append(document.createTextNode(" " + L.filename));
            !L.is_dir || L.has_file ? (U.css("cursor", "pointer"), P.attr("title", L.filename), c(P, w, L, f)) : P.attr("title", a.emptyFolder), e(U[0].insertCell(1)).addClass("ke-cell ke-size").html(L.is_dir ? "-" : Math.ceil(L.filesize / 1024) + "KB"), e(U[0].insertCell(2)).addClass("ke-cell ke-datetime").html(L.datetime);
          }
        }
        function p(w) {
          l(w, p);
          for (var x = w.file_list, _ = 0, I = x.length; I > _; _++) {
            ...
            L.append(U);
            var F = w.current_url + O.filename, W = O.is_dir ? s + "folder-64.gif" : O.is_photo ? F : s + "file-64.gif", P = e('<img src="' + W + '" width="80" height="80" alt="' + O.filename + '" />');
            !O.is_dir || O.has_file ? (U.css("cursor", "pointer"), n(U, O), c(U, w, O, p)) : U.attr("title", a.emptyFolder), U.append(P), L.append('<div class="ke-name" title="' + O.filename + '">' + O.filename + "</div>");
          }
        }
        var m = e.undef(r.width, 650), g = e.undef(r.height, 510), v = e.undef(r.dirName, ""), b = e.undef(r.viewType, "VIEW").toUpperCase(), C = r.clickFn, T = ['<div style="padding:10px 20px;">', '<div class="ke-plugin-filemanager-header">', '<div class="ke-left">', '<img class="ke-inline-block" name="moveupImg" src="' + s + 'go-up.gif" width="16" height="16" border="0" alt="" /> ', '<a class="ke-inline-block" name="moveupLink" href="javascript:;">' + a.moveup + "</a>", "</div>", '<div class="ke-right">', a.viewType + ' <select class="ke-inline-block" name="viewType">', '<option value="VIEW">' + a.viewImage + "</option>", '<option value="LIST">' + a.listImage + "</option>", "</select> ", a.orderType + ' <select class="ke-inline-block" name="orderType">', '<option value="NAME">' + a.fileName + "</option>", '<option value="SIZE">' + a.fileSize + "</option>", '<option value="TYPE">' + a.fileType + "</option>", "</select>", "</div>", '<div class="ke-clearfix"></div>', "</div>", '<div class="ke-plugin-filemanager-body"></div>', "</div>"].join(""), N = o.createDialog({ name: i, width: m, height: g, title: o.lang(i), body: T }), M = N.div, A = e(".ke-plugin-filemanager-body", M), z = (e('[name="moveupImg"]', M), e('[name="moveupLink"]', M)), R = (e('[name="viewServer"]', M), e('[name="viewType"]', M)), D = e('[name="orderType"]', M), S = [];
        return R.val(b), d("", D.val(), b == "VIEW" ? p : f), N;
      };
    }), KindEditor.plugin("image", function(e) {
      var t = this, n = "image", o = e.undef(t.allowImageUpload, !0), i = e.undef(t.allowImageRemote, !0), u = e.undef(t.allowFileManager, !1), s = e.undef(t.uploadHeader, {}), a = e.undef(t.uploadFileSizeLimit, "2MB"), r = e.undef(t.uploadFileTypeLimit, "*.jpg;*.gif;*.png;*.jpeg,*.bmp"), d = e.undef(t.extraFileUploadParams, {}), c = e.undef(t.filePostName, "imgFile"), l = e.undef(t.uploadJson, t.basePath + "_404.html"), f = e.undef(t.formatUploadUrl, !0), p = e.undef(t.imageTabIndex, 1), m = (t.pluginsPath + "", e.undef(t.fillDescAfterUploadImage, !1)), g = t.lang(n + ".");
      t.plugin.imageDialog = function(v) {
        function b(Y, Q) {
          U.val(Y), F.val(Q), K = Y, ae = Q;
        }
        var C = (v.imageUrl, e.undef(v.imageWidth, ""), e.undef(v.imageHeight, ""), e.undef(v.imageTitle, ""), e.undef(v.imageAlign, ""), e.undef(v.showRemote, !0)), T = e.undef(v.showLocal, !0), N = e.undef(v.tabIndex, 0), M = v.clickFn, A = ("" + new Date().getTime(), []);
        for (var z in d)
          A.push('<input type="hidden" name="' + z + '" value="' + d[z] + '" />');
        var R, D = ['<div style="padding:20px;">', '<div class="tabs"></div>', '<div class="tab1" style="display:none;">', '<div class="ke-dialog-row">', '<label for="remoteUrl" style="width:60px;">' + g.remoteUrl + "</label>", '<input type="text" id="remoteUrl" class="ke-input-text" name="url" value="" style="width:' + (u ? 250 : 360) + 'px;" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (u ? 12 : 0) + 'px">', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + g.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="remoteWidth" style="width:60px;">' + g.size + "</label>", g.width + '\uFF1A<input type="text" id="remoteWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" style="width:130px;margin-right:10px" />', g.height + '\uFF1A<input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" style="width:130px;margin-right:10px" />', '<span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-refresh-bold"></span>', "</div>", '<div class="ke-dialog-row">', '<label style="width:60px;">' + g.align + "</label>", '<input type="radio" name="align" class="ke-inline-block" value="" checked="checked" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-default"></span><text style="margin-right:30px;">&nbsp;\u9ED8\u8BA4</text>', ' <input type="radio" name="align" class="ke-inline-block" value="left" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-left"></span><text style="margin-right:30px;">&nbsp;\u5DE6\u5BF9\u9F50</text>', ' <input type="radio" name="align" class="ke-inline-block" value="right" /><span class="ke-inline-block ke-toolbar-icon icon-ke-font ke-icon-float-right"></span><text style="margin-right:30px;" >&nbsp;\u53F3\u5BF9\u9F50</text>', "</div>", '<div class="ke-dialog-row">', '<label for="remoteTitle" style="width:60px;">' + g.imgTitle + "</label>", '<input type="text" id="remoteTitle" class="ke-input-text" name="title" value="" style="width:360px;" />', "</div>", "</div>", '<div class="tab2" style="display:none;">', '<div class="ke-dialog-row">', '<label style="width:60px;">' + g.localUrl + "</label>", '<input type="text" name="localUrl" class="ke-input-text" tabindex="-1" style="width:270px;" readonly="true" /> &nbsp;', '<input type="button" class="ke-upload-button" value="' + g.upload + '" />', "</div>", "</div>", "</div>"].join(""), S = 480, w = C ? 340 : 220, x = t.createDialog({ name: n, width: S, height: w + 3, title: t.lang(n), body: D, yesBtn: { name: t.lang("yes"), click: function(Y) {
          if (!x.isLoading) {
            if (T && C && R && R.selectedIndex === 1 || !C)
              return ne.fileBox.val() == "" ? void alert(t.lang("pleaseSelectFile")) : (x.showLoading(t.lang("uploadLoading")), ne.submit(), void O.val(""));
            var Q = e.trim(I.val()), ie = U.val(), Oe = F.val(), Me = P.val(), ct = "";
            return V.each(function() {
              return this.checked ? (ct = this.value, !1) : void 0;
            }), Q == "http://" || e.invalidUrl(Q) ? (alert(t.lang("invalidUrl")), void I[0].focus()) : /^\d*$/.test(ie) ? /^\d*$/.test(Oe) ? void M.call(t, Q, Me, ie, Oe, 0, ct) : (alert(t.lang("invalidHeight")), void F[0].focus()) : (alert(t.lang("invalidWidth")), void U[0].focus());
          }
        } }, beforeRemove: function() {
          L.unbind(), U.unbind(), F.unbind(), W.unbind();
        } }), _ = x.div, I = e('[name="url"]', _), O = e('[name="localUrl"]', _), L = e('[name="viewServer"]', _), U = e('.tab1 [name="width"]', _), F = e('.tab1 [name="height"]', _), W = e(".ke-refresh-btn", _), P = e('.tab1 [name="title"]', _), V = e('.tab1 [name="align"]', _);
        C && T ? (R = e.tabs({ src: e(".tabs", _), afterSelect: function(Y) {
        } }), R.add({ title: g.remoteImage, panel: e(".tab1", _) }), R.add({ title: g.localImage, panel: e(".tab2", _) }), R.select(N)) : C ? e(".tab1", _).show() : T && e(".tab2", _).show();
        var ne = e.uploadbutton({ button: e(".ke-upload-button", _)[0], width: "auto", fieldName: c, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: s, uploadData: d, uploadUrl: e.addParam(l, "dir=image"), afterUpload: function(Y) {
          if (x.hideLoading(), Y.error === 0) {
            var Q = Y.url;
            f && (Q = e.formatUrl(Q, "absolute")), t.afterUpload && t.afterUpload.call(t, Q, Y, n), m ? (e(".ke-dialog-row #remoteUrl", _).val(Q), e(".ke-tabs-li", _)[0].click(), e(".ke-refresh-btn", _).click()) : M.call(t, Q, Y.title, Y.width, Y.height, Y.border, Y.align);
          } else
        ...
        return W.click(function(Y) {
          var Q = e('<img src="' + I.val() + '" />', document).css({ position: "absolute", visibility: "hidden", top: 0, left: "-1000px" });
        ...
        }), I.val(v.imageUrl), b(v.imageWidth, v.imageHeight), P.val(v.imageTitle), V.each(function() {
          return this.value === v.imageAlign ? (this.checked = !0, !1) : void 0;
        }), C && N === 0 && (I[0].focus(), I[0].select()), x;
      }, t.plugin.image = { edit: function() {
        var v = t.plugin.getSelectedImage();
        t.plugin.imageDialog({ imageUrl: v ? v.attr("data-ke-src") : "http://", imageWidth: v ? v.width() : "", imageHeight: v ? v.height() : "", imageTitle: v ? v.attr("title") : "", imageAlign: v ? v.attr("align") : "", showRemote: i, showLocal: o, tabIndex: v ? 0 : p, clickFn: function(b, C, T, N, M, A) {
          v ? (v.attr("src", b), v.attr("data-ke-src", b), v.attr("width", T), v.attr("height", N), v.attr("title", C), v.attr("align", A), v.attr("alt", C)) : (t.exec("insertimage", b, C, T, N, M, A, "ke-image"), setTimeout(function() {
        ...
        var v = t.plugin.getSelectedImage();
        v.parent().name == "a" && (v = v.parent()), v.remove(), t.addBookmark();
      } }, t.clickToolbar(n, t.plugin.image.edit);
    }), KindEditor.plugin("insertfile", function(e) {
      var t = this, n = "insertfile", o = e.undef(t.allowFileUpload, !0), i = e.undef(t.allowFileManager, !1), u = e.undef(t.uploadHeader, {}), s = e.undef(t.uploadFileSizeLimit, "20MB"), a = e.undef(t.uploadFileTypeLimit, "*.mp3;*.wav;*.mp4;*.wmv;*.rmvb;*.avi,*.jpg;*.gif;*.png;*.jpeg,*.bmp"), r = e.undef(t.extraFileUploadParams, {}), d = e.undef(t.filePostName, "imgFile"), c = e.undef(t.uploadJson, t.basePath + "_404.html"), l = e.undef(t.formatUploadUrl, !0), f = t.lang(n + ".");
      t.plugin.fileDialog = function(p) {
        var m = e.undef(p.fileUrl, "http://"), g = e.undef(p.fileTitle, ""), v = p.clickFn, b = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + f.url + "</label>", '<input type="text" id="keUrl" name="url" class="ke-input-text" style="width:' + (i ? 160 : 260) + 'px;" />', '<input type="button" class="ke-upload-button" value="' + f.upload + '" />', '<span class="ke-button-common ke-button-outer" style="margin-left:' + (i ? 5 : 0) + 'px" >', '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + f.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keTitle" style="width:60px;">' + f.title + "</label>", '<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:160px;" /></div>', "</div>", "</form>", "</div>"].join(""), C = t.createDialog({ name: n, width: 450, height: 220, title: t.lang(n), body: b, yesBtn: { name: t.lang("yes"), click: function(R) {
          var D = e.trim(N.val()), S = A.val();
          return D == "http://" || e.invalidUrl(D) ? (alert(t.lang("invalidUrl")), void N[0].focus()) : (e.trim(S) === "" && (S = D), void v.call(t, D, S));
        } } }), T = C.div, N = e('[name="url"]', T), M = e('[name="viewServer"]', T), A = e('[name="title"]', T);
        if (o) {
          var z = e.uploadbutton({ button: e(".ke-upload-button", T)[0], width: "auto", fieldName: d, fileSizeLimit: s, fileTypeLimit: a, uploadHeader: u, uploadData: r, uploadUrl: e.addParam(c, "dir=file"), afterUpload: function(R) {
            if (C.hideLoading(), R.error === 0) {
              var D = R.url;
              l && (D = e.formatUrl(D, "absolute")), N.val(D), t.afterUpload && t.afterUpload.call(t, D, R, n);
            } else
              alert(R.message);
          }, afterError: function(R) {
            C.hideLoading(), t.errorDialog(R);
          } });
          z.fileBox.change(function(R) {
            var D = e("input[type='file']", z.form[0]).val();
            D && (C.showLoading(t.lang("uploadLoading")), z.submit());
          });
        } else
          e(".ke-upload-button", T).hide();
        i ? M.click(function(R) {
          t.loadPlugin("filemanager", function() {
            t.plugin.filemanagerDialog({ viewType: "LIST", dirName: "file", clickFn: function(D, S) {
              t.dialogs.length > 1 && (e('[name="url"]', T).val(D), t.afterSelectFile && t.afterSelectFile.call(t, D), t.hideDialog());
            } });
          });
        }) : M.hide(), N.val(m), A.val(g), N[0].focus(), N[0].select();
      }, t.clickToolbar(n, function() {
      ...
      t.clickToolbar(n, function() {
        ...
        e.each(o.lineHeight, function(a, r) {
          e.each(r, function(d, c) {
            s.addItem({ title: c, checked: i === d, click: function() {
      ...
      t.plugin.link = { edit: function() {
        ...
        } } }), s = u.div, a = e('input[name="url"]', s), r = e('select[name="type"]', s);
      ...
      var t = this, n = "media", o = t.lang(n + "."), i = e.undef(t.allowMediaUpload, !0), u = e.undef(t.allowFileManager, !1), s = e.undef(t.uploadHeader, {}), a = e.undef(t.uploadFileSizeLimit, "20MB"), r = e.undef(t.uploadFileTypeLimit, "*.mp3;*.wav;*.mp4;*.wmv;*.rmvb;*.avi"), d = e.undef(t.extraFileUploadParams, {}), c = e.undef(t.filePostName, "imgFile"), l = e.undef(t.uploadJson, t.basePath + "_404.html"), f = e.undef(t.formatUploadUrl, !0), p = function(m) {
      ...
      t.plugin.media = { edit: function() {
        var m = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keUrl" style="width:60px;">' + o.url + "</label>", '<input class="ke-input-text" type="text" id="keUrl" name="url" value="" style="width:' + (u ? 160 : 260) + 'px;" />', '<input type="button" class="ke-upload-button" value="' + o.upload + '" />', '<span class="ke-button-common ke-button-outer"  style="margin-left:' + (u ? 5 : 0) + 'px" >', '<input type="button" class="ke-button-common ke-button " name="viewServer" value="' + o.viewServer + '" />', "</span>", "</div>", '<div class="ke-dialog-row">', '<label for="keWidth" style="width:60px;">' + o.width + "</label>", '<input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="320" maxlength="4" />', '<label for="keHeight" style="width:60px;text-align:left;margin-left:30px">' + o.height + "</label>", '<input type="text" id="keHeight" class="ke-input-text ke-input-number" name="height" value="auto" maxlength="4" />', "</div>", '<div class="ke-dialog-row">', '<label for="kePreload" style="width:60px;">preload</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="kePreload" name="preload" value="" /></div>', '<label for="keAutostart" style="width:60px;text-align:left;margin-left:30px">autoplay</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keAutostart" name="autoplay" value="" /></div>', "</div>", '<div class="ke-dialog-row">', '<label for="keControls" style="width:60px;">controls</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keControls" name="controls" checked value="" /></div>', '<label for="keLoop" style="width:60px;text-align:left;margin-left:30px">loop</label>', '<div style="width:80px;display:inline-block;"><input type="checkbox" id="keLoop" name="loop" checked value="" /></div>', "</div>", "</div>"].join(""), g = t.createDialog({ name: n, width: 450, height: 300, title: t.lang(n), body: m, yesBtn: { name: t.lang("yes"), click: function(S) {
          var w = e.trim(b.val()), x = T.val(), _ = N.val(), I = A[0].checked, O = M[0].checked, L = z[0].checked, U = R[0].checked;
          if (w == "http://" || e.invalidUrl(w))
            return alert(t.lang("invalidUrl")), void b[0].focus();
          if (x != "auto" && !/^\d*$/.test(x))
            return alert(t.lang("invalidWidth")), void T[0].focus();
          if (_ != "auto" && !/^\d*$/.test(_))
            return alert(t.lang("invalidHeight")), void N[0].focus();
          var F = "video";
          /\.(mp3|wav|ogg|acc)(\?|$)/i.test(w) && (F = "audio");
          var W = ["<p><" + F, 'data-ke-class="ke-audio"', 'class="ke-media"', 'style="display:inline;"', 'src="' + w + '"', 'width="' + x + '"', 'height="' + _ + '"', I ? "preload" : "", O ? "autoplay" : "", L ? "controls" : "", U ? "loop" : "", "></" + F + "><span>\u200B\u3000</span></p>"].join(" "), P = p(t.cmd.range);
          P && P.name != "p" ? t.insertHtml(W).hideDialog().focus() : (e(P).after(W), t.hideDialog().focus());
        } } }), v = g.div, b = e('[name="url"]', v), C = e('[name="viewServer"]', v), T = e('[name="width"]', v), N = e('[name="height"]', v), M = e('[name="autoplay"]', v), A = e('[name="preload"]', v), z = e('[name="controls"]', v), R = e('[name="loop"]', v);
        if (b.val("http://"), i) {
          var D = e.uploadbutton({ button: e(".ke-upload-button", v)[0], width: "auto", fieldName: c, fileSizeLimit: a, fileTypeLimit: r, uploadHeader: s, uploadData: d, uploadUrl: e.addParam(l, "dir=media"), afterUpload: function(S) {
          ...
          e(".ke-upload-button", v).hide();
        u ? C.click(function(S) {
          t.loadPlugin("filemanager", function() {
            t.plugin.filemanagerDialog({ viewType: "LIST", dirName: "media", clickFn: function(w, x) {
              t.dialogs.length > 1 && (e('[name="url"]', v).val(w), t.afterSelectFile && t.afterSelectFile.call(t, w), t.hideDialog());
            } });
          });
        }) : C.hide();
      }, delete: function() {
      ...
      e.extend(t, { init: function(n) {
        ...
        var u = "ke_multi_upload_btn" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999), s = "ke_multi_upload_dragbody" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999), a = "ke_multi_upload_error" + 1 * new Date() + "_" + Math.floor(9e4 * Math.random() + 9999);
        i.div = e(n.container).html(['<div class="ke-swfupload">', '<div class="ke-swfupload-top" >', '<div class="ke-inline-block ke-swfupload-button" id="' + u + '" style="width: 86px;">', "</div>", '<div class="ke-inline-block ke-swfupload-desc">' + n.uploadDesc + "</div>", '<span class="ke-button-common ke-button-outer ke-swfupload-startupload">', '<input type="button" class="ke-button-common ke-button ke-startup-upload-button" value="' + n.startButtonValue + '" />', "</span>", "</div>", '<div class="ke-swfupload-body" id="' + s + '"></div>', '<div class="upload-error-result" id="' + a + '"></div>', "</div>"].join("")), i.bodyDiv = e(".ke-swfupload-body", i.div), i.uploader = WebUploader.create({ server: i.options.uploadUrl, pick: "#" + u, resize: !1, fileVal: "file", accept: { title: "Images", extensions: n.fileTypes.replace(/\*\./g, "").replace(/;/g, ","), mimeTypes: "image/*" }, uploadBeforeSend: function(r, d, c) {
          ...
          i.uploader.makeThumb(r, function(d, c) {
            d && (c = i.options.fileIconUrl), r.url = c, i.appendFile(r);
          }, 80, 80);
        }), i.uploader.on("uploadStart", function(r) {
          var d = this, c = e('div[data-id="' + r.id + '"]', d.bodyDiv);
          e(".ke-status > div", c).hide(), e(".ke-progressbar", c).show();
        }), i.uploader.on("uploadProgress", function(r, d) {
          var c = i.progressbars[r.id], l = Math.floor(100 * d);
          c.bar.css("width", l + "%");
          var f = l >= 100 ? "\u4E0A\u4F20\u6210\u529F" : l + "%";
          c.percent.html(f).show();
        }), i.uploader.on("uploadSuccess", function(r, d) {
          var c = e('div[data-id="' + r.id + '"]', i.bodyDiv).eq(0), l = d.data;
          if (l.error !== 0)
            return void o(c, l.message || i.options.errorMessage);
          var f = l.url;
          console.info("self.options.formatUploadUrl", i.options.formatUploadUrl), f = i.options.formatUploadUrl ? r.url = e.formatUrl(l.url, "absolute") : r.url = l.url, e(".ke-img", c).attr("src", r.url).attr("data-status", "1").data("data", { url: f, title: r.name + "", width: (r._info || { width: "auto" }).width + "", height: "", border: "", align: "" });
        }), i.uploader.on("uploadError", function(r, d) {
          if (r) {
            var c = e('div[data-id="' + r.id + '"]', i.bodyDiv).eq(0);
            console.info("reason", d), o(c, "ERROR:" + d);
          }
        ...
        u.append(s), e('<span class="ke-delete"></span>').appendTo(u).click(function() {
          o.removeFile(n.id);
        });
      ...
      var t = this, n = "multiimage", o = (e.undef(t.formatUploadUrl, !0), e.undef(t.uploadJson, t.basePath + "php/upload_json.php")), i = e.undef(t.uploadHeader, t.basePath + "php/upload_json.php"), u = e.undef(t.uploadData, t.basePath + "php/upload_json.php"), s = t.pluginsPath + "multiimage/images/", a = e.undef(t.imageSizeLimit, "1MB"), r = (e.undef(t.imageFileTypes, "*.jpg;*.gif;*.png"), e.undef(t.imageUploadLimit, 20)), d = e.undef(t.filePostName, "imgFile"), c = t.lang(n + ".");
      t.plugin.multiImageDialog = function(l) {
        var f = l.clickFn, p = e.tmpl(c.uploadDesc, { uploadLimit: r, sizeLimit: a }), m = ['<div style="padding:10px 20px;">', '<div class="swfupload">', "</div>", "</div>"].join(""), g = t.createDialog({ name: n, width: 650, height: 500, title: t.lang(n), body: m, previewBtn: { name: c.insertAll, click: function(C) {
          f.call(t, b.getUrlList());
        } }, yesBtn: { name: c.clearAll, click: function(C) {
          b.removeFiles();
        } }, beforeRemove: function() {
          b.destroy();
        } }), v = g.div, b = e.swfupload({ container: e(".swfupload", v), buttonImageUrl: s + (t.langType == "zh-CN" ? "select-files-zh-CN.png" : "select-files-en.png"), buttonWidth: t.langType == "zh-CN" ? 72 : 88, buttonHeight: 23, fileIconUrl: s + "image.png", uploadDesc: p, startButtonValue: c.startUpload, uploadUrl: e.addParam(o, "dir=image"), uploadData: u, uploadHeader: i, uploadCompress: t.uploadCompress, formatUploadUrl: t.formatUploadUrl, flashUrl: s + "swfupload.swf", filePostName: d, fileTypes: "*.jpg;*.jpeg;*.gif;*.png;*.bmp", fileTypesDesc: "Image Files", fileUploadLimit: r, fileSizeLimit: a, postParams: e.undef(t.extraFileUploadParams, {}), queueLimitExceeded: c.queueLimitExceeded, fileExceedsSizeLimit: c.fileExceedsSizeLimit, zeroByteFile: c.zeroByteFile, invalidFiletype: c.invalidFiletype, unknownError: c.unknownError, pendingMessage: c.pending, errorMessage: c.uploadError, afterError: function(C) {
          t.errorDialog(C);
        } });
        return e(b.bodyDiv).bind("drop", function(C) {
          C.preventDefault(), C.event.preventDefault();
          var T = [];
          [].forEach.call(C.event.dataTransfer.files, function(N) {
            T.push(N);
          }, !1), T.length > 0 && b.uploader.addFiles(T), e(b.bodyDiv).removeClass("drag-hover");
      ...
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><textarea class="ke-textarea" style="width:518px;height:260px;"></textarea></div>', u = t.createDialog({
          name: n,
          width: 560,
          title: t.lang(n),
          body: i,
          yesBtn: { name: t.lang("yes"), click: function(a) {
            var r = s.val();
      ...
      t.clickToolbar(n, function() {
        var o = (t.lang(n + "."), '<div style="padding:10px 20px;"><iframe class="ke-textarea" frameborder="0" style="width:708px;height:400px;"></iframe></div>'), i = t.createDialog({ name: n, width: 750, title: t.lang(n), body: o }), u = e("iframe", i.div), s = e.iframeDoc(u);
        s.open(), s.write(t.fullHtml()), s.close(), e(s.body).css("background-color", "#FFF"), u[0].contentWindow.focus();
      });
      ...
      n.clickToolbar(o, function() {
        n.focus();
        var i = "\u200B", u = n.cmd.range, s = t(n.cmd.range);
        if (u) {
        ...
        if (s && ["p", "h1", "h2", "h3", "h4", "h5", "h6"].indexOf(s.name) > -1) {
          e(s).after(d);
          var c = e(s).next();
          n.cmd.range.selectNodeContents(c).collapse(), n.cmd.select(), c.focus();
        } else {
          n.insertHtml(d);
      ...
      n.clickToolbar(o, function() {
        n.focus();
        for (var u, s = n.edit.doc, a = n.cmd.range, r = e(s.body).first(), d = [], c = [], l = a.createBookmark(!0); r; ) {
          u = r.next();
          var f = t(r);
          f && f.name == "img" || (i[r.name] ? (r.html(r.html().replace(/^(\s|&nbsp;|　)+/gi, "")), r.css("text-indent", "2em")) : c.push(r), (!u || i[u.name] || i[r.name] && !i[u.name]) && (c.length > 0 && d.push(c), c = [])), r = u;
        }
        e.each(d, function(p, m) {
          var g = e('<p style="text-indent:2em;"></p>', s);
          m[0].before(g), e.each(m, function(v, b) {
            g.append(b);
          });
      ...
      function t(d, c) {
        c = c.toUpperCase(), d.css("background-color", c), d.css("color", c === "#000000" ? "#FFFFFF" : "#000000"), d.html(c);
      }
      function n(d, c) {
        function l() {
          e.each(r, function() {
        ...
        c.bind("click,mousedown", function(f) {
          f.stopPropagation();
        }), c.click(function(f) {
          l();
          var p = e(this), m = p.pos(), g = e.colorpicker({ x: m.x, y: m.y + p.height(), z: 811214, selectedColor: e(this).html(), colors: i.colorTable, noColor: i.lang("noColor"), shadowMode: i.shadowMode, click: function(v) {
            t(p, v), l();
          } });
      ...
      i.plugin.table = { prop: function(d) {
        ...
        if (!d && (D = i.plugin.getSelectedTable())) {
          ...
          w !== void 0 && (S = /^(\d+)((?:px|%)*)$/.exec(w)) ? (v.val(S[1]), C.val(S[2])) : v.val(""), x !== void 0 && (S = /^(\d+)((?:px|%)*)$/.exec(x)) && (b.val(S[1]), T.val(S[2])), N.val(D[0].cellPadding || ""), M.val(D[0].cellSpacing || ""), A.val(D[0].align || ""), z.val(D[0].border === void 0 ? "" : D[0].border), t(R.eq(0), e.toHex(D.attr("borderColor") || "")), t(R.eq(1), e.toHex(D[0].style.backgroundColor || D[0].bgColor || "")), v[0].focus(), v[0].select();
        }
      }, cellprop: function() {
        var d = ['<div style="padding:20px;">', '<div class="ke-dialog-row">', '<label for="keWidth" style="width:90px;">' + s.size + "</label>", s.width + ' <input type="text" id="keWidth" class="ke-input-text ke-input-number" name="width" value="" maxlength="4" /> &nbsp; ', '<select name="widthType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select> &nbsp; ", s.height + ' <input type="text" class="ke-input-text ke-input-number" name="height" value="" maxlength="4" /> &nbsp; ', '<select name="heightType">', '<option value="%">' + s.percent + "</option>", '<option value="px">' + s.px + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keAlign" style="width:90px;">' + s.align + "</label>", s.textAlign + ' <select id="keAlign" name="textAlign">', '<option value="">' + s.alignDefault + "</option>", '<option value="left">' + s.alignLeft + "</option>", '<option value="center">' + s.alignCenter + "</option>", '<option value="right">' + s.alignRight + "</option>", "</select> ", s.verticalAlign + ' <select name="verticalAlign">', '<option value="">' + s.alignDefault + "</option>", '<option value="top">' + s.alignTop + "</option>", '<option value="middle">' + s.alignMiddle + "</option>", '<option value="bottom">' + s.alignBottom + "</option>", '<option value="baseline">' + s.alignBaseline + "</option>", "</select>", "</div>", '<div class="ke-dialog-row">', '<label for="keBorder" style="width:90px;">' + s.border + "</label>", s.borderWidth + ' <input type="text" id="keBorder" class="ke-input-text ke-input-number" name="border" value="" maxlength="4" /> &nbsp; ', s.borderColor + ' <span class="ke-inline-block ke-input-color"></span>', "</div>", '<div class="ke-dialog-row">', '<label for="keBgColor" style="width:90px;">' + s.backgroundColor + "</label>", '<span class="ke-inline-block ke-input-color"></span>', "</div>", "</div>"].join(""), c = i.cmd.range.createBookmark(), l = i.createDialog({ name: u, width: 500, title: i.lang("tablecell"), body: d, beforeRemove: function() {
          A.unbind();
        }, yesBtn: { name: i.lang("yes"), click: function(x) {
          var _ = p.val(), I = m.val(), O = g.val(), L = v.val(), U = (b.val(), C.val(), T.val()), F = N.val(), W = M.val(), P = e(A[0]).html() || "", V = e(A[1]).html() || "";
          return /^\d*$/.test(_) ? /^\d*$/.test(I) ? /^\d*$/.test(W) ? (R.css({ width: _ !== "" ? _ + O : "", height: I !== "" ? I + L : "", "background-color": V, "text-align": U, "vertical-align": F, "border-width": W, "border-style": W !== "" ? "solid" : "", "border-color": P }), i.hideDialog().focus(), i.cmd.range.moveToBookmark(c), i.cmd.select(), void i.addBookmark()) : (alert(i.lang("invalidBorder")), void M[0].focus()) : (alert(i.lang("invalidHeight")), void m[0].focus()) : (alert(i.lang("invalidWidth")), void p[0].focus());
        } } }), f = l.div, p = e('[name="width"]', f).val(100), m = e('[name="height"]', f), g = e('[name="widthType"]', f), v = e('[name="heightType"]', f), b = e('[name="padding"]', f).val(2), C = e('[name="spacing"]', f).val(0), T = e('[name="textAlign"]', f), N = e('[name="verticalAlign"]', f), M = e('[name="border"]', f).val(1), A = e(".ke-input-color", f);
        n(f, A.eq(0)), n(f, A.eq(1)), t(A.eq(0), "#000000"), t(A.eq(1), ""), p[0].focus(), p[0].select();
        var z, R = i.plugin.getSelectedCell(), D = R[0].style.width || R[0].width || "", S = R[0].style.height || R[0].height || "";
        (z = /^(\d+)((?:px|%)*)$/.exec(D)) ? (p.val(z[1]), g.val(z[2])) : p.val(""), (z = /^(\d+)((?:px|%)*)$/.exec(S)) && (m.val(z[1]), v.val(z[2])), T.val(R[0].style.textAlign || ""), N.val(R[0].style.verticalAlign || "");
        var w = R[0].style.borderWidth || "";
        w && (w = parseInt(w)), M.val(w), t(A.eq(0), e.toHex(R[0].style.borderColor || "")), t(A.eq(1), e.toHex(R[0].style.backgroundColor || "")), p[0].focus(), p[0].select();
      }, insert: function() {
        this.prop(!0);
      }, delete: function() {
        ...
        var c = i.plugin.getSelectedTable()[0], l = i.plugin.getSelectedRow()[0], f = i.plugin.getSelectedCell()[0], p = f.cellIndex + d;
        p += c.rows[0].cells.length - l.cells.length;
        for (var m = 0, g = c.rows.length; g > m; m++) {
          var v = c.rows[m], b = v.insertCell(p);
          b.innerHTML = e.IE ? "" : "<br />", p = o(c, v, b);
        }
        ...
        var c = i.plugin.getSelectedTable()[0], l = i.plugin.getSelectedRow()[0], f = i.plugin.getSelectedCell()[0], p = l.rowIndex;
        d === 1 && (p = l.rowIndex + (f.rowSpan - 1) + d);
        for (var m = c.insertRow(p), g = 0, v = l.cells.length; v > g; g++) {
          l.cells[g].rowSpan > 1 && (v -= l.cells[g].rowSpan - 1);
          var b = m.insertCell(g);
          d === 1 && l.cells[g].colSpan > 1 && (b.colSpan = l.cells[g].colSpan), b.innerHTML = e.IE ? "" : "<br />";
        }
        for (var C = p; C >= 0; C--) {
          var T = c.rows[C].cells;
          if (T.length > g) {
            for (var N = f.cellIndex; N >= 0; N--)
              T[N].rowSpan > 1 && (T[N].rowSpan += 1);
            break;
          }
        }
        i.cmd.range.selectNodeContents(f).collapse(!0), i.cmd.select(), i.addBookmark();
        ...
        var d = i.plugin.getSelectedTable()[0], c = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = c.rowIndex, p = f + l.rowSpan, m = d.rows[p];
        if (!(d.rows.length <= p)) {
          var g = l.cellIndex;
          if (!(m.cells.length <= g)) {
            var v = m.cells[g];
            l.colSpan === v.colSpan && (l.rowSpan += v.rowSpan, m.deleteCell(g), i.cmd.range.selectNodeContents(l).collapse(!0), i.cmd.select(), i.addBookmark());
          }
        }
      }, colmerge: function() {
        var d = (i.plugin.getSelectedTable()[0], i.plugin.getSelectedRow()[0]), c = i.plugin.getSelectedCell()[0], l = (d.rowIndex, c.cellIndex), f = l + 1;
        if (!(d.cells.length <= f)) {
          var p = d.cells[f];
          c.rowSpan === p.rowSpan && (c.colSpan += p.colSpan, d.deleteCell(f), i.cmd.range.selectNodeContents(c).collapse(!0), i.cmd.select(), i.addBookmark());
        }
      }, rowsplit: function() {
        var d = i.plugin.getSelectedTable()[0], c = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = c.rowIndex;
        if (l.rowSpan !== 1) {
          for (var p = o(d, c, l), m = 1, g = l.rowSpan; g > m; m++) {
            var v = d.rows[f + m], b = v.insertCell(p);
            l.colSpan > 1 && (b.colSpan = l.colSpan), b.innerHTML = e.IE ? "" : "<br />", p = o(d, v, b);
          }
          e(l).removeAttr("rowSpan"), i.cmd.range.selectNodeContents(l).collapse(!0), i.cmd.select(), i.addBookmark();
        }
      }, colsplit: function() {
        var d = (i.plugin.getSelectedTable()[0], i.plugin.getSelectedRow()[0]), c = i.plugin.getSelectedCell()[0], l = c.cellIndex;
        if (c.colSpan !== 1) {
          for (var f = 1, p = c.colSpan; p > f; f++) {
            var m = d.insertCell(l + f);
            c.rowSpan > 1 && (m.rowSpan = c.rowSpan), m.innerHTML = e.IE ? "" : "<br />";
          }
          e(c).removeAttr("colSpan"), i.cmd.range.selectNodeContents(c).collapse(!0), i.cmd.select(), i.addBookmark();
        }
      }, coldelete: function() {
        for (var d = i.plugin.getSelectedTable()[0], c = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = l.cellIndex, p = 0, m = d.rows.length; m > p; p++) {
          var g = d.rows[p], v = g.cells[f];
          v.colSpan > 1 ? (v.colSpan -= 1, v.colSpan === 1 && e(v).removeAttr("colSpan")) : g.deleteCell(f), v.rowSpan > 1 && (p += v.rowSpan - 1);
        }
        c.cells.length === 0 ? (i.cmd.range.setStartBefore(d).collapse(!0), i.cmd.select(), e(d).remove()) : i.cmd.selection(!0), i.addBookmark();
      }, rowdelete: function() {
        for (var d = i.plugin.getSelectedTable()[0], c = i.plugin.getSelectedRow()[0], l = i.plugin.getSelectedCell()[0], f = c.rowIndex, p = l.rowSpan - 1; p >= 0; p--)
          d.deleteRow(f + p);
      ...
      t.clickToolbar(n, function() {
        ...
        var s = t.createDialog({ name: n, width: 560, title: t.lang(n), body: Tt, yesBtn: { name: t.lang("yes"), click: function(c) {
      ...
      t.clickToolbar(n, function() {
        var o = t.lang(n + "."), i = '<div style="padding:10px 20px;"><div style="margin-bottom:10px;">' + o.comment + '</div><iframe class="ke-textarea" frameborder="0" style="width:518px;height:260px;"></iframe></div>', u = t.createDialog({ name: n, width: 560, title: t.lang(n), body: i, yesBtn: { name: t.lang("yes"), click: function(d) {
          var c = r.body.innerHTML;
          c = e.clearMsWord(c, t.filterMode ? t.htmlTags : e.options.htmlTags), t.insertHtml(c).hideDialog().focus();
        } } }), s = u.div, a = e("iframe", s), r = e.iframeDoc(a);
      ...
      function t() {
        var u = e(".ke-toolbar"), s = e(u).parent();
        e(".ke-toolbar").width(), e(window).bind("resize", function() {
          u.css("width", e(s).width() - 2 + "px");
        }), u.css("width", e(s).width() + "px"), e(i).bind("scroll", function() {
...
const dt = KindEditor, ji = ["id"], zi = {
  ...
  setup(We, { emit: ft }) {
    ...
    const pe = (J = ee.configs) == null ? void 0 : J.afterBlur, j = (X = ee.configs) == null ? void 0 : X.afterChange, te = ee.id;
    var $e = Object.assign(
      {
        loadStyleMode: !1,
        resizeType: 1,
      ...
      ee.configs,
      {
        ...
        afterChange: function() {
          re && ft("update:modelValue", re.html()), j && j.call(this);
        }
      }
    );
    return Li(
